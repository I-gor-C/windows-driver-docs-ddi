...
ms.date: 2/8/2018
ms.keywords: SENSOR_PROPERTY_LIST_SIZE, sensorsdef/SENSOR_PROPERTY_LIST_SIZE, sensors.sensor_property_list_size, SENSOR_PROPERTY_LIST_SIZE function [Sensor Devices]
