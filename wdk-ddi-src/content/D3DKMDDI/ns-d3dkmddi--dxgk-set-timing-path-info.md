...
title: DXGK_SET_TIMING_PATH_INFO
...
ms.keywords: DXGK_SET_TIMING_PATH_INFO, DXGK_SET_TIMING_PATH_INFO
req.iface: 
---
...
## -description
<p>Structure to hold information to modify SetTiming path.</p>
...
<dd>
<p>A <a href="https://msdn.microsoft.com/24CC6A10-6462-4681-B340-E887B679F456">D3DKMDT_WIRE_FORMAT_AND_PREFERENCE</a> value which indicates the wire format to be set for the path. The Preference field is reserved in this context so should be ignored by the driver.  In the remaining five bit-fields, the OS will set one of the thirty bits to indicate which color encoding and at which bit depth the link should be driven.</p>
</dd>
...
<p>Fields in the DXGK_SET_TIMING_PATH_INFO structure are excluded from this summary so the driver always needs to evaluate these fields for any changes.  
...
<p>If the target state is unchanged, this field should contain a copy of the last state reported on the target, including the same ConnectionChangeId which was previously reported.</p>
