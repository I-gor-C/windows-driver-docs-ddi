...
### -param <i>pSetTargetContentTypeArg</i> [in]

<dd>
<p>A pointer to a <a href="https://msdn.microsoft.com/BD849954-97CC-4314-B375-22829B0CEE86">DXGKARG_SETTARGETCONTENTTYPE</a> structure that provides the target to be modified and the new type of content being displayed on it.</p>
</dd>
</dl>
