...
<dd>
<p>A pointer to a <a href="https://msdn.microsoft.com/94BA40BD-3B56-44EF-BAD4-49556E68C550">DXGKARG_SETTARGETGAMMA</a> structure that provides the target id to be modified and provides the gamma ramp to be set.</p>
</dd>
</dl>
