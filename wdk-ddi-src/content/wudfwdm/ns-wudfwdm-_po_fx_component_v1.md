...
ms.date: 2/16/2018
ms.keywords: PPO_FX_COMPONENT_V2, PO_FX_COMPONENT structure [Kernel-Mode Driver Architecture], PO_FX_COMPONENT, PO_FX_COMPONENT_V1, _PO_FX_COMPONENT_V2, *PPO_FX_COMPONENT, PO_FX_COMPONENT_V2 structure [Kernel-Mode Driver Architecture], PPO_FX_COMPONENT_V2 structure pointer [Kernel-Mode Driver Architecture], wdm/PO_FX_COMPONENT_V2, PO_FX_COMPONENT_V2, kernel.po_fx_component, *PPO_FX_COMPONENT_V2, *PPO_FX_COMPONENT_V1, _PO_FX_COMPONENT_V1, wdm/PPO_FX_COMPONENT_V2, wdm/PO_FX_COMPONENT
