...
req.dll: 
req.irql: 
ms.keywords: IDebugControl3, GetSpecificFilterParameters, IDebugControl3::GetSpecificFilterParameters
...
<dd>
<p>Receives the parameters for the specific event filters.  <i>Params</i> is an array of elements of type <a href="https://msdn.microsoft.com/library/windows/hardware/ff541637">DEBUG_SPECIFIC_FILTER_PARAMETERS</a>.</p>
</dd>
</dl>
