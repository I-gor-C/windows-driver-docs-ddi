...
<p>The <b>WDF_READ_REGISTER_ULONG</b> function reads a ULONG value from the specified register address.</p>
...
## -returns
<p><b>WDF_READ_REGISTER_ULONG</b> returns the ULONG value that is read from the specified port address.</p>
