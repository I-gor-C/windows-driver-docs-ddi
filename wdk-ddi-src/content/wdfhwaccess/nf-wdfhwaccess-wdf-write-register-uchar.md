...
title: WDF_WRITE_REGISTER_UCHAR
...
<p>The <b>WDF_WRITE_REGISTER_UCHAR</b> routine writes a byte to the specified address.</p>
...
<dd>
<p>Specifies a byte to write to the register.</p>
</dd>
</dl>
