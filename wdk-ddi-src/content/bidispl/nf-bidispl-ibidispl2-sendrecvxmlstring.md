...
ms.date : 1/18/2018
ms.keywords : IBidiSpl2::SendRecvXMLString method [Print Devices], IBidiSpl2 interface, IBidiSpl2::SendRecvXMLString method [Print Devices], _win32_IBidiSpl2_SendRecvXMLString, IBidiSpl2 interface [Print Devices], IBidiSpl2::SendRecvXMLString method, print.ibidispl2_ibidispl2__sendrecvxmlstring, bidispl/IBidiSpl2::IBidiSpl2::SendRecvXMLString, IBidiSpl2::IBidiSpl2::SendRecvXMLString, gdi.ibidispl2_ibidispl2__sendrecvxmlstring, IBidiSpl2, SendRecvXMLString, IBidiSpl2::SendRecvXMLString
