...
ms.keywords: IMiniportAudioEngineNode, GetDeviceChannelVolume, IMiniportAudioEngineNode::GetDeviceChannelVolume
...
### -param <i>plVolume</i> [out]

<dd>
<p>The current volume level for the audio device channel.</p>
</dd>
</dl>

## -returns
<p><b>GetDeviceChannelVolume</b> returns S_OK, if the call was successful. Otherwise, the method returns an appropriate error 
