...
Specifies one of the system-defined FILE_DEVICE_<i>XXX</i> constants that indicate the type of device (such as FILE_DEVICE_DISK, FILE_DEVICE_KEYBOARD, and so on), or a vendor-defined value for a new type of device. For more information, see <a href="https://msdn.microsoft.com/library/windows/hardware/ff563821">Specifying Device Types</a>. (Because a bus driver might not have information about a device's type, a device type value for a <a href="wdkgloss.p#wdkgloss.pdo#wdkgloss.pdo"><i>PDO</i></a> can be specified in an <a href="https://msdn.microsoft.com/e8162e20-0d8c-4400-9f4d-5f4abe81305b">INF AddReg directive</a>.)
