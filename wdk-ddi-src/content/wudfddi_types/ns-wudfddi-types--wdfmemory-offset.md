...
<p>
      The <a href="..\wudfddi_types\ns-wudfddi-types--wdfmemory-offset.md">WDFMEMORY_OFFSET</a> structure describes the location and size of information that is accessed within a memory block.</p>
...
## -remarks
<p>A UMDF driver supplies a pointer to a <a href="..\wudfddi_types\ns-wudfddi-types--wdfmemory-offset.md">WDFMEMORY_OFFSET</a> structure to the <a href="wdf.iwdfmemory_copyfrommemory">IWDFMemory::CopyFromMemory</a> method to describe information to copy from a memory block.</p>
