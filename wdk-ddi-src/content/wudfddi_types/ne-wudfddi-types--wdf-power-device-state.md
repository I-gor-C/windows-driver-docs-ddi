...
<p>
      The <a href="..\wudfddi_types\ne-wudfddi-types--wdf-power-device-state.md">WDF_POWER_DEVICE_STATE</a> enumeration contains values that identify the power state that a device might support.</p>
...
## -remarks
<p>The framework supplies one of the values of <a href="..\wudfddi_types\ne-wudfddi-types--wdf-power-device-state.md">WDF_POWER_DEVICE_STATE</a> to the <a href="wdf.ipnpcallback_ond0entry">IPnpCallback::OnD0Entry</a> or <a href="wdf.ipnpcallback_ond0exit">IPnpCallback::OnD0Exit</a> method to notify the UMDF driver about the power state of the device.</p>
