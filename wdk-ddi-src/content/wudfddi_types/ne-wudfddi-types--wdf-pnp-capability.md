...
## -remarks
<p>A UMDF driver supplies one of the values of <b>WDF_PNP_CAPABILITY</b> to the <a href="wdf.iwdfdeviceinitialize_getpnpcapability">IWDFDeviceInitialize::GetPnpCapability</a> or <a href="wdf.iwdfdeviceinitialize_setpnpcapability">IWDFDeviceInitialize::SetPnpCapability</a> method to identify the PnP capability to retrieve or set status for.</p>
