...
ms.date: 2/21/2018
ms.keywords: audio.ioctl_usbsbaud_get_shadow_resources, IOCTL_USBSBAUD_GET_SHADOW_RESOURCES control code [Audio Devices], IOCTL_USBSBAUD_GET_SHADOW_RESOURCES, usbsidebandaudio/IOCTL_USBSBAUD_GET_SHADOW_RESOURCES
