...
ms.date: 12/15/2017
ms.keywords: _MSiSCSI_RequestTimeStatistics, PMSiSCSI_RequestTimeStatistics, *PMSiSCSI_RequestTimeStatistics, MSiSCSI_RequestTimeStatistics
...
A 64-bit integer that uniquely identifies an HBA initiator and a loaded instance of a storage miniport driver that manages the HBA. The initiator should use the address of the adapter extension or another address that the device driver owns to construct this identifier (ID). The initiator reports this value in the UniqueAdapterId member of the <a href="storage.msiscsi_hbainformation">MSiSCSI_HBAInformation</a> structure.
