...
title: MOUNTMGR_CREATE_POINT_INPUT
...
req.dll: 
req.irql: 
ms.keywords: MOUNTMGR_CREATE_POINT_INPUT, MOUNTMGR_CREATE_POINT_INPUT, *PMOUNTMGR_CREATE_POINT_INPUT
req.iface: 
---

# MOUNTMGR_CREATE_POINT_INPUT structure
