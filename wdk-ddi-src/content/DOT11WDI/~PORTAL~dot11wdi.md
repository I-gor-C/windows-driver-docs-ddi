# Declarations in the dot11wdi header
This header Dot11Wdi contains these programming interfaces:
...
| [MINIPORT_WDI_STOP_ADAPTER_OPERATION callback function](nc-dot11wdi-miniport-wdi-stop-adapter-operation.md) | TBD |
...
| [MINIPORT_WDI_TX_SUSPECT_FRAME_LIST_ABORT callback function](nc-dot11wdi-miniport-wdi-tx-suspect-frame-list-abort.md) | TBD |
...
| [NDIS_WDI_TX_QUERY_SUSPECT_FRAME_COMPLETE_STATUS callback function](nc-dot11wdi-ndis-wdi-tx-query-suspect-frame-complete-status.md) | TBD |
| [MINIPORT_WDI_START_ADAPTER_OPERATION callback function](nc-dot11wdi-miniport-wdi-start-adapter-operation.md) | TBD |
...
| [WDI_MAC_ADDRESS structure](ns-dot11wdi--wdi-mac-address~r1.md) | TBD |
| [WDI_P2P_SERVICE_NAME_HASH structure](ns-dot11wdi--wdi-p2p-service-name-hash~r1.md) | TBD |
...
| Title        | Description    |
| ------------- |:-------------:|
| [Wdi_NdisMOidRequestComplete function](nf-dot11wdi-wdi-ndismoidrequestcomplete.md) | TBD |
| [Wdi_NdisMRegisterWdiMiniportDriver function](nf-dot11wdi-wdi-ndismregisterwdiminiportdriver.md) | TBD |
| [WDI_DEFINE_INDICATION function](nf-dot11wdi-wdi-define-indication.md) | TBD |
...
| [WDI_DEFINE_OID function](nf-dot11wdi-wdi-define-oid.md) | TBD |
...
| [Wdi_NdisMIndicateStatusEx function](nf-dot11wdi-wdi-ndismindicatestatusex.md) | TBD |
| [Wdi_NdisMDeregisterWdiMiniportDriver function](nf-dot11wdi-wdi-ndismderegisterwdiminiportdriver.md) | TBD |
