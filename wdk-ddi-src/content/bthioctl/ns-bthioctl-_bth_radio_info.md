...
ms.date: 12/21/2017
ms.keywords: bthioctl/PBTH_RADIO_INFO, BTH_RADIO_INFO, _BTH_RADIO_INFO, *PBTH_RADIO_INFO, bltooth.bth_radio_info, BTH_RADIO_INFO structure [Bluetooth Devices], PBTH_RADIO_INFO, PBTH_RADIO_INFO structure pointer [Bluetooth Devices], bthioctl/BTH_RADIO_INFO, bth_structs_5fa8e736-47a7-4ba5-bd40-f375ac6db8af.xml
