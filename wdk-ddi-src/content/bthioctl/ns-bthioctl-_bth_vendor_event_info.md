...
ms.date: 12/21/2017
ms.keywords: BTH_VENDOR_EVENT_INFO structure [Bluetooth Devices], _BTH_VENDOR_EVENT_INFO, PBTH_VENDOR_EVENT_INFO, bthioctl/PBTH_VENDOR_EVENT_INFO, bth_ref_039b7b82-a08d-41a4-9566-2a5192a23ac2.xml, PBTH_VENDOR_EVENT_INFO structure pointer [Bluetooth Devices], BTH_VENDOR_EVENT_INFO, bthioctl/BTH_VENDOR_EVENT_INFO, *PBTH_VENDOR_EVENT_INFO, bltooth.bth_vendor_event_info
