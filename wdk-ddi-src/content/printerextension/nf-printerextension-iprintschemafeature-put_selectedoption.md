...
ms.date: 2/2/2018
ms.keywords: IPrintSchemaFeature.SelectedOption, put_SelectedOption, SelectedOption property [Print Devices], IPrintSchemaFeature interface, IPrintSchemaFeature, printerextension/IPrintSchemaFeature::put_SelectedOption, get_SelectedOption, IPrintSchemaFeature::put_SelectedOption, IPrintSchemaFeature::get_SelectedOption, SelectedOption property [Print Devices], printerextension/IPrintSchemaFeature::SelectedOption, print.iprintschemafeature_put_selectedoption, IPrintSchemaFeature interface [Print Devices], SelectedOption property
