...
| Method | Description |
| ---- |:---- |
| [IPrinterBidiSetRequestCallback::Completed](nf-printerextension-iprinterbidisetrequestcallback-completed.md) | Invoked when the Bidi “Set”” operation is completed. |
