...
req.dll: 
req.irql: <= APC_LEVEL
ms.keywords: IPrinterBidiSetRequestCallback, Completed, IPrinterBidiSetRequestCallback::Completed
req.iface: IPrinterBidiSetRequestCallback
