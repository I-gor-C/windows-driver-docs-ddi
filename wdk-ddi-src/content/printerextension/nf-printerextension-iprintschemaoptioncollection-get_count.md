...
ms.date: 2/21/2018
ms.keywords: IPrintSchemaOptionCollection, Count property [Print Devices], IPrintJobCollection, get_Count, Count property [Print Devices], IPrinterExtensionContextCollection interface, printerextension/IPrinterExtensionContextCollection::get_Count, IPrinterExtensionContextCollection.Count, IPrinterExtensionContextCollection interface [Print Devices], Count property, IPrintJobCollection::get_Count, IPrinterExtensionContextCollection::get_Count, print.iprinterextensioncontextcollection_count, IPrintSchemaOptionCollection::get_Count, printerextension/IPrinterExtensionContextCollection::Count, IPrinterExtensionContextCollection
