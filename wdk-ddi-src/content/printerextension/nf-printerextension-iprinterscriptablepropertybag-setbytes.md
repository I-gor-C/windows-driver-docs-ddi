...
ms.date: 11/24/2017
ms.keywords: IPrinterScriptablePropertyBag, SetBytes, IPrinterScriptablePropertyBag::SetBytes
...
## -remarks
<p>A call to <b>SetBytes</b> will throw an exception, if the specified property is not found. We recommend that you use a try-catch statement around calls to this method, to allow your app to handle any failures gracefully.</p>
