...
ms.date: 2/21/2018
ms.keywords: SetBytes method [Print Devices], IPrinterScriptablePropertyBag interface, print.iprinterscriptablepropertybag_setbytes, IPrinterScriptablePropertyBag, printerextension/IPrinterScriptablePropertyBag::SetBytes, IPrinterScriptablePropertyBag::SetBytes, SetBytes, IPrinterScriptablePropertyBag interface [Print Devices], SetBytes method, SetBytes method [Print Devices]
