...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: IPrintSchemaAsyncOperation.Start
...
req.dll: 
req.irql: <= APC_LEVEL
ms.keywords: IPrintSchemaAsyncOperation, Start, IPrintSchemaAsyncOperation::Start
