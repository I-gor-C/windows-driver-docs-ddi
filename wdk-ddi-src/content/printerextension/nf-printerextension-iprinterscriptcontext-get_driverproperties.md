...
ms.date: 2/2/2018
ms.keywords: get_DriverProperties, IPrinterScriptContext, IPrinterExtensionContext.DriverProperties, IPrinterExtensionContext::get_DriverProperties, IPrinterExtensionContext interface [Print Devices], DriverProperties property, printerextension/IPrinterExtensionContext::get_DriverProperties, IPrinterExtensionContext, printerextension/IPrinterExtensionContext::DriverProperties, IPrinterScriptContext::get_DriverProperties, DriverProperties property [Print Devices], DriverProperties property [Print Devices], IPrinterExtensionContext interface, print.iprinterextensioncontext_driverproperties
