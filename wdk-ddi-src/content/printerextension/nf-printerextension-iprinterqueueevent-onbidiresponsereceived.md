...
ms.date: 2/21/2018
ms.keywords: IPrinterQueueEvent::OnBidiResponseReceived, IPrinterQueueEvent interface [Print Devices], OnBidiResponseReceived method, print.iprinterqueueevent_onbidiresponsereceived, OnBidiResponseReceived, OnBidiResponseReceived method [Print Devices], OnBidiResponseReceived method [Print Devices], IPrinterQueueEvent interface, IPrinterQueueEvent, printerextension/IPrinterQueueEvent::OnBidiResponseReceived
