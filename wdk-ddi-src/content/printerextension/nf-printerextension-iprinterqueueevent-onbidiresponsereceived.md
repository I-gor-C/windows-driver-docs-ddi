...
ms.date: 2/2/2018
ms.keywords: OnBidiResponseReceived method [Print Devices], IPrinterQueueEvent interface, IPrinterQueueEvent, OnBidiResponseReceived, print.iprinterqueueevent_onbidiresponsereceived, IPrinterQueueEvent interface [Print Devices], OnBidiResponseReceived method, printerextension/IPrinterQueueEvent::OnBidiResponseReceived, OnBidiResponseReceived method [Print Devices], IPrinterQueueEvent::OnBidiResponseReceived
