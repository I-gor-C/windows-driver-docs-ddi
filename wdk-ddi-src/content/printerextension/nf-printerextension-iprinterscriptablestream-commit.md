...
ms.date: 2/21/2018
ms.keywords: IPrinterScriptableStream, IPrinterScriptableStream::Commit, print.iprinterscriptablestream__commit, IPrinterScriptableStream interface [Print Devices], Commit method, printerextension/IPrinterScriptableStream::Commit, Commit, Commit method [Print Devices], Commit method [Print Devices], IPrinterScriptableStream interface
