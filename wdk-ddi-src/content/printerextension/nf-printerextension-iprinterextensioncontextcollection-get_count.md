...
ms.date: 2/21/2018
ms.keywords: Count property [Print Devices], get_Count, Count property [Print Devices], IPrinterExtensionContextCollection interface, printerextension/IPrinterExtensionContextCollection::get_Count, IPrinterExtensionContextCollection.Count, IPrinterExtensionContextCollection interface [Print Devices], Count property, IPrinterExtensionContextCollection::get_Count, print.iprinterextensioncontextcollection_count, printerextension/IPrinterExtensionContextCollection::Count, IPrinterExtensionContextCollection
