...
ms.date: 2/21/2018
ms.keywords: GetFeature method [Print Devices], GetFeature, IPrintSchemaTicket, print.iprintschematicket_getfeature, IPrintSchemaTicket interface [Print Devices], GetFeature method, GetFeature method [Print Devices], IPrintSchemaTicket interface, printerextension/IPrintSchemaTicket::GetFeature, IPrintSchemaTicket::GetFeature
