...
ms.date: 1/9/2018
ms.keywords: PKS_DATARANGE_DV_AVC structure pointer [Streaming Media Devices], tagKS_DATARANGE_DV_AVC, stream.ks_datarange_dv_avc, avcstrm/PKS_DATARANGE_DV_AVC, KS_DATARANGE_DV_AVC structure [Streaming Media Devices], avcsref_e5ebf0ed-91f2-415a-a6b1-346cfebf16b5.xml, PKS_DATARANGE_DV_AVC, avcstrm/KS_DATARANGE_DV_AVC, KS_DATARANGE_DV_AVC, *PKS_DATARANGE_DV_AVC
