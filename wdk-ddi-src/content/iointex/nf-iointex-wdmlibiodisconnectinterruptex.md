...
## -description
<p>The  <b>WdmlibIoDisconnectInterruptEx</b> function unregisters an interrupt service routine (ISR) that was registered by a previous call to the <a href="..\iointex\nf-iointex-wdmlibioconnectinterruptex.md">WdmlibIoConnectInterruptEx</a> function.</p>
...
<dl>
<dt>
<a href="..\wdm\ns-wdm--io-disconnect-interrupt-parameters.md">IO_DISCONNECT_INTERRUPT_PARAMETERS</a>
</dt>
<dt>
