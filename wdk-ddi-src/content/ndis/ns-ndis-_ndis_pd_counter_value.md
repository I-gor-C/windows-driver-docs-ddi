...
ms.date: 1/18/2018
ms.keywords: netvista.ndis_pd_counter_value, NDIS_PD_COUNTER_VALUE, _NDIS_PD_COUNTER_VALUE, NDIS_PD_COUNTER_VALUE union [Network Drivers Starting with Windows Vista], PNDIS_PD_COUNTER_VALUE union pointer [Network Drivers Starting with Windows Vista], ndis/NDIS_PD_COUNTER_VALUE, *PNDIS_PD_COUNTER_VALUE, PNDIS_PD_COUNTER_VALUE, ndis/PNDIS_PD_COUNTER_VALUE
