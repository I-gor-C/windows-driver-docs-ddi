...
<dt><b>NDIS_STATUS_PENDING</b></dt>
       ...
       <a href="netvista.ndismrestartcomplete">NdisMRestartComplete</a> function when
...
Can provide status indications with the 
      <a href="netvista.ndismindicatestatusex">
...
Can modify the media-specific attributes in the list of restart attributes. If the miniport driver
      ...
      <a href="netvista.ndisfreememory">NdisFreeMemory</a> function and allocate a
...
Should make sure that the 
      ...
      <a href="netvista.ndis_object_header">NDIS_OBJECT_HEADER</a> structure that is
      specified in the 
...
After the miniport driver successfully restarts the send and receive operations, it must complete the
    ...
    driver calls the 
    <a href="netvista.ndismrestartcomplete">NdisMRestartComplete</a> function. After
...
<dt>
<a href="netvista.ndismrestartcomplete">NdisMRestartComplete</a>
</dt>
<dt>
...
<a href="mailto:wsddocfb@microsoft.com?subject=Documentation%20feedback [NetVista\netvista]:%20MINIPORT_RESTART callback function%20 RELEASE:%20(12/14/2017)&amp;body=%0A%0APRIVACY STATEMENT%0A%0AWe use your feedback to improve the documentation. We don't use your email address for any other purpose, and we'll remove your email address from our system after the issue that you're reporting is fixed. While we're working to fix this issue, we might send you an email message to ask for more info. Later, we might also send you an email message to let you know that we've addressed your feedback.%0A%0AFor more info about Microsoft's privacy policy, see http://privacy.microsoft.com/en-us/default.aspx." title="Send comments about this topic to Microsoft">Send comments about this topic to Microsoft</a>
