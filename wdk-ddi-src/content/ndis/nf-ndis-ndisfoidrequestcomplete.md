...
<p>Filter drivers call the 
  ...
  <a href="..\ndis\nc-ndis-filter-oid-request.md">FilterOidRequest</a> function returned
...
<p>A pointer to a buffer formatted as an 
     ...
     <a href="..\ndis\nc-ndis-filter-oid-request.md">FilterOidRequest</a> function.</p>
</dd>
...
<p>A filter driver that returns NDIS_STATUS_PENDING from its 
    <a href="..\ndis\nc-ndis-filter-oid-request.md">FilterOidRequest</a> function must call
    the 
