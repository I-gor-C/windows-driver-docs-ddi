...
title: NDIS_NBL_MEDIA_SPECIFIC_INFORMATION_EX
...
ms.date: 11/22/2017
ms.keywords: NDIS_NBL_MEDIA_SPECIFIC_INFORMATION_EX, NDIS_NBL_MEDIA_SPECIFIC_INFORMATION_EX, *PNDIS_NBL_MEDIA_SPECIFIC_INFORMATION_EX
...
## -description
<p>The <b>NDIS_NBL_MEDIA_SPECIFIC_INFORMATION_EX</b> structure defines media-specific information that is
  associated with a 
...
<p>The 
     ...
     <b>Size</b> member to NDIS_SIZEOF_NBL_MEDIA_SPECIFIC_INFO_REVISION_1.</p>
</dd>

### -field <b>NextEntry</b>

<dd>
<p>A pointer to the next NDIS_NBL_MEDIA_SPECIFIC_INFORMATION_EX structure in a linked list of
     ...
     NDIS_NBL_REMOVE_MEDIA_SPECIFIC_INFO_EX</a> macros to manipulate this list.</p>
</dd>

### -field <b>Tag</b>

<dd>
<p>A unique value (assigned by Microsoft) that identifies the type of media-specific information.
...
<dd>
<p>A pointer to a buffer that contains the media-specific information.</p>
</dd>
</dl>

## -remarks
<p>NDIS 6.20 and later drivers should use the NDIS_NBL_MEDIA_SPECIFIC_INFORMATION_EX structure to specify
    ...
    driver-defined data.</p>

<p>Structures in the list contain any media-specific out-of-band (OOB) data that accompanies the 
...
<p>To get the first element in the linked list, an NDIS driver calls the 
    <a href="https://msdn.microsoft.com/library/windows/hardware/ff568401">NET_BUFFER_LIST_INFO</a> macro and specifies
    the 
    <b>MediaSpecificInformationEx</b> information type.</p>

<p>To add, get, and remove NDIS_NBL_MEDIA_SPECIFIC_INFORMATION_EX structures in the linked list, use the 
    <a href="netvista.ndis_nbl_add_media_specific_info_ex">
    NDIS_NBL_ADD_MEDIA_SPECIFIC_INFO_EX</a>, 
    <a href="netvista.ndis_nbl_get_media_specific_info_ex">
    NDIS_NBL_GET_MEDIA_SPECIFIC_INFO_EX</a>, and 
    <a href="netvista.ndis_nbl_remove_media_specific_info_ex">
    NDIS_NBL_REMOVE_MEDIA_SPECIFIC_INFO_EX</a> macros.</p>
