...
ms.date: 1/18/2018
ms.keywords: PNDIS_MINIPORT_PNP_CHARACTERISTICS, _NDIS_MINIPORT_PNP_CHARACTERISTICS, *PNDIS_MINIPORT_PNP_CHARACTERISTICS, netvista.ndis_miniport_pnp_characteristics, NDIS_MINIPORT_PNP_CHARACTERISTICS structure [Network Drivers Starting with Windows Vista], ndis_msix_ref_0f6182d0-b82c-4420-828e-e59d98fc82da.xml, ndis/PNDIS_MINIPORT_PNP_CHARACTERISTICS, PNDIS_MINIPORT_PNP_CHARACTERISTICS structure pointer [Network Drivers Starting with Windows Vista], NDIS_MINIPORT_PNP_CHARACTERISTICS, ndis/NDIS_MINIPORT_PNP_CHARACTERISTICS
