...
ms.date: 1/18/2018
ms.keywords: ndis/NdisMInvalidateConfigBlock, NdisMInvalidateConfigBlock function [Network Drivers Starting with Windows Vista], NdisMInvalidateConfigBlock, netvista.ndisminvalidateconfigblock
