...
ms.date: 1/18/2018
ms.keywords: NdisMInvalidateConfigBlock, ndis/NdisMInvalidateConfigBlock, netvista.ndisminvalidateconfigblock, NdisMInvalidateConfigBlock function [Network Drivers Starting with Windows Vista]
