...
<p><i>ProtocolBindAdapterEx</i> passes 
    ...
    <a href="..\ntddndis\ne-ntddndis--ndis-medium.md">NDIS_MEDIUM</a> types. NDIS indicates the selected
    medium type at the 
...
<p>Protocol drivers should use the 
    <a href="..\ndis\ns-ndis--ndis-bind-parameters.md">NDIS_BIND_PARAMETERS</a> structure to
    ...
    <a href="netvista.protocol_driver_oid_requests">Protocol Driver OID Requests</a>.</p>
...
<p>Every protocol driver should allocate sufficient 
    ...
    <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> structure pools. The driver
