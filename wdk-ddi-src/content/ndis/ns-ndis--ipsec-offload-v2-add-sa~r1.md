---
UID: NS.ndis._IPSEC_OFFLOAD_V2_ADD_SA~r1
...
## -remarks
<p>This structure is obsolete, use <a href="..\ndis\ns-ndis--ipsec-offload-v2-add-sa-ex.md">IPSEC_OFFLOAD_V2_ADD_SA_EX</a> instead.</p>
...
<td width="70%">
<p>Supported in NDIS 6.1 and 6.20. For NDIS 6.30 and later, use <a href="..\ndis\ns-ndis--ipsec-offload-v2-add-sa-ex.md">IPSEC_OFFLOAD_V2_ADD_SA_EX</a>.</p>
</td>
</tr>
<tr>
<th width="30%">
...
<dl>
<dt>
<a href="..\ndis\ns-ndis--ipsec-offload-v2-add-sa-ex.md">IPSEC_OFFLOAD_V2_ADD_SA_EX</a>
</dt>
<dt>
