...
ms.date: 1/18/2018
ms.keywords: ndis/PNET_BUFFER_SHARED_MEMORY, NET_BUFFER_SHARED_MEMORY, NET_BUFFER_SHARED_MEMORY structure [Network Drivers Starting with Windows Vista], PNET_BUFFER_SHARED_MEMORY structure pointer [Network Drivers Starting with Windows Vista], PNET_BUFFER_SHARED_MEMORY, _NET_BUFFER_SHARED_MEMORY, ndis/NET_BUFFER_SHARED_MEMORY, netvista.net_buffer_shared_memory, ndis_netbuf_macros_media_specific_5b9066cf-413a-4483-9b05-e06ceed9081e.xml, *PNET_BUFFER_SHARED_MEMORY
