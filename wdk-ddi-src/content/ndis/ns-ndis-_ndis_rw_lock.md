...
ms.date: 1/18/2018
ms.keywords: NDIS_RW_LOCK, PNDIS_RW_LOCK, ndis_processor_group_ref_4680aefb-5db5-4e48-aec2-a7c6769892aa.xml, _NDIS_RW_LOCK, netvista.ndis_rw_lock, ndis/NDIS_RW_LOCK, ndis/PNDIS_RW_LOCK, NDIS_RW_LOCK structure [Network Drivers Starting with Windows Vista], PNDIS_RW_LOCK structure pointer [Network Drivers Starting with Windows Vista], *PNDIS_RW_LOCK
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | Supported in NDIS 6.0 and 6.1. For NDIS 6.20 and later, use NDIS_RW_LOCK_EX instead. Supported in NDIS 6.0 and 6.1. For NDIS 6.20 and later, use NDIS_RW_LOCK_EX instead. |
