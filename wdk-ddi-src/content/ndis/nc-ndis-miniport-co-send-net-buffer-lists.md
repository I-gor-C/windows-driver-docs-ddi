...
<p>A pointer to the first 
     ...
     <a href="..\ndis\ns-ndis--net-buffer.md">NET_BUFFER</a> structures. Each <b>NET_BUFFER</b> structure
...
<p>In addition, you should assume that the miniport driver cannot access the <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> structures
    and other associated resources as soon as the driver calls 
    <a href="..\ndis\nf-ndis-ndismcosendnetbufferlistscomplete.md">NdisMCoSendNetBufferListsComplete</a>.</p>
