...
ms.date: 1/18/2018
ms.keywords: ndis/PNDIS_PD_QUEUE, PNDIS_PD_QUEUE, ndis/NDIS_PD_QUEUE, PNDIS_PD_QUEUE structure pointer [Network Drivers Starting with Windows Vista], netvista.ndis_pd_queue, _NDIS_PD_QUEUE, NDIS_PD_QUEUE, NDIS_PD_QUEUE structure [Network Drivers Starting with Windows Vista]
