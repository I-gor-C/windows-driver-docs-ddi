...
ms.date : 1/18/2018
ms.keywords : netvista.filterdirectoidrequestcomplete, FilterDirectOidRequestComplete callback function [Network Drivers Starting with Windows Vista], FilterDirectOidRequestComplete, FILTER_DIRECT_OID_REQUEST_COMPLETE, FILTER_DIRECT_OID_REQUEST_COMPLETE, ndis/FilterDirectOidRequestComplete, ndis_request_direct_ref_7c57d5c9-2a37-4602-b94e-df700652b1a9.xml
...
# FILTER_DIRECT_OID_REQUEST_COMPLETE function
NDIS calls the 
...
A pointer to the 
     ...
     <mshelp:link keywords="netvista.ndisfdirectoidrequest" tabindex="0"><b>
     NdisFDirectOidRequest</b></mshelp:link> function.
...
<i>FilterDirectOidRequestComplete</i> is an optional function. If a filter driver does not use direct OID
    ...
    NdisFRegisterFilterDriver</b></mshelp:link> function. If a filter driver defines a 
...
If a filter driver forwarded a request that it received in the 
    ...
    NdisFDirectOidRequestComplete</b></mshelp:link> function. In this case, the filter driver must call 
...
<h3><a id="Examples"></a><a id="examples"></a><a id="EXAMPLES"></a>Examples</h3>To define a <i>FilterDirectOidRequestComplete</i> function, you must first provide a function declaration that identifies the type of function you're defining. Windows provides a set of function types for drivers. Declaring a function using the function types helps <a href="https://msdn.microsoft.com/2F3549EF-B50F-455A-BDC7-1F67782B8DCA">Code Analysis for Drivers</a>, <a href="https://msdn.microsoft.com/74feeb16-387c-4796-987a-aff3fb79b556">Static Driver Verifier</a> (SDV), and other verification tools find errors, and it's a requirement for writing drivers for the Windows operating system.
