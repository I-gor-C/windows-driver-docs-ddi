...
ms.date: 1/18/2018
ms.keywords: NDIS_PD_FILTER_COUNTER structure [Network Drivers Starting with Windows Vista], ndis/PNDIS_PD_FILTER_COUNTER, PNDIS_PD_FILTER_COUNTER, PNDIS_PD_FILTER_COUNTER structure pointer [Network Drivers Starting with Windows Vista], netvista.ndis_pd_filter_counter, NDIS_PD_FILTER_COUNTER, _NDIS_PD_FILTER_COUNTER, ndis/NDIS_PD_FILTER_COUNTER
