...
ms.date: 1/18/2018
ms.keywords: ndis/NDIS_PD_FILTER_COUNTER, _NDIS_PD_FILTER_COUNTER, ndis/PNDIS_PD_FILTER_COUNTER, NDIS_PD_FILTER_COUNTER structure [Network Drivers Starting with Windows Vista], PNDIS_PD_FILTER_COUNTER, netvista.ndis_pd_filter_counter, NDIS_PD_FILTER_COUNTER, PNDIS_PD_FILTER_COUNTER structure pointer [Network Drivers Starting with Windows Vista]
