...
<dd>
<p>A pointer to a linked list of <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> structures. The filter driver received the
...
<p>The filter driver can complete send requests in any order. For example, the filter driver could
    concatenate the <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> structure lists from multiple 
