...
ms.date : 1/18/2018
ms.keywords : ndis/NDIS_PD_COUNTER_PARAMETERS, PNDIS_PD_COUNTER_PARAMETERS structure pointer [Network Drivers Starting with Windows Vista], netvista.ndis_pd_counter_parameters, ndis/PNDIS_PD_COUNTER_PARAMETERS, NDIS_PD_COUNTER_PARAMETERS structure [Network Drivers Starting with Windows Vista], PNDIS_PD_COUNTER_PARAMETERS, _NDIS_PD_COUNTER_PARAMETERS, NDIS_PD_COUNTER_PARAMETERS
