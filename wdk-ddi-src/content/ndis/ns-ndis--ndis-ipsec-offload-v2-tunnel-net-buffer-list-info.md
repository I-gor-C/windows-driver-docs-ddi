...
title: NDIS_IPSEC_OFFLOAD_V2_TUNNEL_NET_BUFFER_LIST_INFO
...
ms.date: 11/28/2017
ms.keywords: NDIS_IPSEC_OFFLOAD_V2_TUNNEL_NET_BUFFER_LIST_INFO, NDIS_IPSEC_OFFLOAD_V2_TUNNEL_NET_BUFFER_LIST_INFO, *PNDIS_IPSEC_OFFLOAD_V2_TUNNEL_NET_BUFFER_LIST_INFO
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: NDIS_IPSEC_OFFLOAD_V2_TUNNEL_NET_BUFFER_LIST_INFO
req.alt-loc: ndis.h
req.ddi-compliance: 
req.unicode-ansi: 
req.idl: 
...
<p>The NDIS_IPSEC_OFFLOAD_V2_TUNNEL_NET_BUFFER_LIST_INFO structure specifies the security association
  (SA) offload handle to the tunnel portion of a send packet.</p>
...
### -field <b>TunnelHandle</b>

<dd>
<p>The tunnel SA handle in transport over tunnel.</p>
</dd>
</dl>
</dd>
</dl>
...
## -remarks
<p>Before the TCP/IP transport passes a send packet that a NIC will perform Internet protocol security
...
<p>The TCP/IP transport supplies a handle in the 
    ...
    to the outbound SA for the tunnel portion of the send packet.</p>
...
<p>To set and get the IPsec tunnel information, use the 
    ...
    NET_BUFFER_LIST_INFO returns an NDIS_IPSEC_OFFLOAD_V2_TUNNEL_NET_BUFFER_LIST_INFO structure.</p>
