...
<dd>
<p>A pointer to the 
     <a href="..\ndis\ns-ndis--ndis-oid-request.md">NDIS_OID_REQUEST</a> structure that the filter
...
<p><i>FilterOidRequestComplete</i> is an optional function. If a filter driver does not use OID requests, it
    ...
    <a href="..\ndis\nc-ndis-filter-oid-request.md">FilterOidRequest</a> function, it must
    provide the 
...
<p>If a filter driver forwarded a request that it received in the 
    <a href="..\ndis\nc-ndis-filter-oid-request.md">FilterOidRequest</a> function, 
