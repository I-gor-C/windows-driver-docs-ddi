...
ms.date: 1/18/2018
ms.keywords: "_NDIS_RSC_NBL_INFO, *PNDIS_RSC_NBL_INFO, ndis/NDIS_RSC_NBL_INFO, netvista.ndis_rsc_nbl_info, NDIS_RSC_NBL_INFO union [Network Drivers Starting with Windows Vista], PNDIS_RSC_NBL_INFO union pointer [Network Drivers Starting with Windows Vista], NDIS_RSC_NBL_INFO, ndis/PNDIS_RSC_NBL_INFO, PNDIS_RSC_NBL_INFO"
