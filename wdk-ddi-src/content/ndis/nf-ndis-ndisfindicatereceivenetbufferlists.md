...
<p>A filter driver must set the 
    <b>SourceHandle</b> member of each <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> structure that it originates to the same value as the 
...
<p>The filter driver must properly initialize the <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> structures, attached 
...
<p>If a filter driver calls the 
    ...
    <i>ReceiveFlags</i> parameter, NDIS returns the indicated <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> structures to the filter
    driver's 
...
<p>If a filter driver calls 
    ...
    <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> structures immediately. In this case, NDIS does not call the filter driver's 
...
<p>Setting the <b>NDIS_RECEIVE_FLAG_RESOURCES</b> flag in the 
    ...
    <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> structures to the filter driver.</p>
