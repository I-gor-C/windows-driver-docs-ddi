...
<p>A pointer to a linked list of 
     <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> structures that specify
     lists of 
     <a href="..\ndis\ns-ndis--net-buffer.md">NET_BUFFER</a> structures. Each <b>NET_BUFFER</b> in the
...
<p>Specifies that NDIS should check for loopback. By default, NDIS does not loop back data to the
        ...
        this flag. When this flag is set, NDIS identifies all the <a href="..\ndis\ns-ndis--net-buffer.md">NET_BUFFER</a> structures that contain data
...
<p>If the filter driver specifies a 
    ...
    a list of 
    <a href="..\ndis\ns-ndis--net-buffer.md">NET_BUFFER</a> structures over the network. NDIS
...
<p>The filter driver can filter the data and send the filtered data to underlying drivers. For each
    <a href="..\ndis\ns-ndis--net-buffer.md">NET_BUFFER</a> structure submitted to 
...
<p>Reject the buffer by calling the 
      <a href="..\ndis\nf-ndis-ndisfsendnetbufferlistscomplete.md">NdisFSendNetBufferListsComplete</a> function.</p>
...
<p>If a filter module is in the 
    ...
    complete status in each <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> structure to NDIS_STATUS_PAUSED.</p>
