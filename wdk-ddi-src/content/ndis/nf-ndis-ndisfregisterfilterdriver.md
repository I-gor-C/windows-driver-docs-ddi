...
<p>Drivers that call <b>
    NdisFRegisterFilterDriver</b> must be prepared for an immediate call to any of their <i>FilterXxx</i> functions. For more information see <a href="netvista.initializing_a_filter_driver">Initializing a Filter Driver</a>.</p>
