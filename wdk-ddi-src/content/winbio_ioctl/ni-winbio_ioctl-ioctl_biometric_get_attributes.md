...
The <b>AssociatedIrp</b>.<b>SystemBuffer</b> member points to a buffer that contains a <a href="biometric.winbio_sensor_attributes">WINBIO_SENSOR_ATTRIBUTES</a> structure.</p>The <b>AssociatedIrp</b>AssociatedIrp.<b>SystemBuffer</b>SystemBuffer member points to a buffer that contains a <a href="biometric.winbio_sensor_attributes">WINBIO_SENSOR_ATTRIBUTES</a><b>WINBIO_SENSOR_ATTRIBUTES</b>WINBIO_SENSOR_ATTRIBUTES structure.
