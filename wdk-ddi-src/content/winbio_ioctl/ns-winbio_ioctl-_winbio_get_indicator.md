...
ms.date: 12/14/2017
ms.keywords: PWINBIO_GET_INDICATOR structure pointer [Biometric Devices], winbio_ioctl/WINBIO_GET_INDICATOR, biometric_ref_2ff9c2b7-38fd-4419-aa90-a87cceef3cda.xml, WINBIO_GET_INDICATOR structure [Biometric Devices], PWINBIO_GET_INDICATOR, biometric.winbio_get_indicator, *PWINBIO_GET_INDICATOR, winbio_ioctl/PWINBIO_GET_INDICATOR, _WINBIO_GET_INDICATOR, WINBIO_GET_INDICATOR
