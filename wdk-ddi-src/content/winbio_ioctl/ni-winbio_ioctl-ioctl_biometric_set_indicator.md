...
<a href="biometric.winbio_set_indicator">WINBIO_SET_INDICATOR</a><b>WINBIO_SET_INDICATOR</b>WINBIO_SET_INDICATOR
...
The AssociatedIrp.SystemBuffer member points to a buffer that contains a WINBIO_BLANK_PAYLOAD structure.</p>The AssociatedIrp.SystemBuffer member points to a buffer that contains a WINBIO_BLANK_PAYLOAD structure.
