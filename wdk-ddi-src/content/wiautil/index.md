...
| [wiauRegGetDwordA](nf-wiautil-wiaureggetdworda.md) | The wiauRegGetDword function gets a DWORD value from the DeviceData section of the registry. |
| [wiauRegGetDwordW](nf-wiautil-wiaureggetdwordw.md) | The wiauRegGetDword function gets a DWORD value from the DeviceData section of the registry. |
| [wiauRegGetStrA](nf-wiautil-wiaureggetstra.md) | The wiauRegGetStr function gets a string value from the DeviceData section of the registry. |
| [wiauRegGetStrW](nf-wiautil-wiaureggetstrw.md) | The wiauRegGetStr function gets a string value from the DeviceData section of the registry. |
| [wiauRegOpenDataA](nf-wiautil-wiauregopendataa.md) | The wiauRegOpenData function opens the DeviceData registry key. |
| [wiauRegOpenDataW](nf-wiautil-wiauregopendataw.md) | The wiauRegOpenData function opens the DeviceData registry key. |
