...
title: NdisInterlockedInsertHeadList
...
req.target-min-winverclnt: Supported for NDIS 6.0 and NDIS 5.1 drivers (see 
   ...
   NdisInterlockedInsertHeadList (NDIS 5.1)) in Windows Vista. Supported for NDIS 5.1 drivers (see 
   
   NdisInterlockedInsertHeadList (NDIS 5.1)) in Windows XP.
...
<dd>
<p>A pointer to the entry to be inserted at the head of the list.</p>
</dd>
...
## -returns
<p><b>NdisInterlockedInsertHeadList</b> returns a pointer to the entry that was at the head of the queue
...
<p><b>NdisInterlockedInsertHeadList</b> raises IRQL to DISPATCH_LEVEL when it acquires the given spin lock
    and restores the original IRQL before it returns control. Consequently, any driver function that calls 
    <b>NdisInterlockedInsertHeadList</b> cannot be pageable code.</p>

<p>Most NDIS drivers process packets in FIFO order, so any driver that uses an interlocked queue tends to
    cal thel 
    ...
    <b>NdisInterlockedInsertHeadList</b> only to requeue a packet for a retry operation.</p>
...
<p>Supported for NDIS 6.0 and NDIS 5.1 drivers (see 
   ...
   <b>
   NdisInterlockedInsertHeadList (NDIS 5.1)</b>) in Windows XP.</p>
</td>
</tr>
<tr>
<th width="30%">
