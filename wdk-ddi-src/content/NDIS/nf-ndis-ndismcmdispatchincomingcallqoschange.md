...
req.target-min-winverclnt: Supported for NDIS 6.0 and NDIS 5.1 drivers (see 
   ...
   NdisMCmDispatchIncomingCallQoSChange (NDIS 5.1)) in Windows Vista. Supported for NDIS 5.1 drivers
   (see 
   
   NdisMCmDispatchIncomingCallQoSChange (NDIS 5.1)) in Windows XP.
