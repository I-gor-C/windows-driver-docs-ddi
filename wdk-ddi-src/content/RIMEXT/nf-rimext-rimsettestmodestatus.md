---
UID: NF.rimext.RIMSetTestModeStatus
title: RIMSetTestModeStatus
author: windows-driver-content
description: 
ms.assetid: ab50aade-a731-4fec-92cd-042fbcd38a97
ms.author: windowsdriverdev
ms.date: 
ms.topic: function
ms.prod: windows-hardware
ms.technology: windows-devices
ms.keywords: RIMSetTestModeStatus
req.iface: 
req.header: rimext.h
req.include-header:
req.target-type:
