# Declarations in the ndkpi header
This header Ndkpi contains these programming interfaces:
...
| [NDK_CQ structure](ns-ndkpi--ndk-cq.md) | TBD |
| [NDK_CONNECTOR structure](ns-ndkpi--ndk-connector.md) | TBD |
...
| [NDK_MR structure](ns-ndkpi--ndk-mr.md) | TBD |
...
| [NDK_QP structure](ns-ndkpi--ndk-qp.md) | TBD |
| [NDK_SHARED_ENDPOINT structure](ns-ndkpi--ndk-shared-endpoint.md) | TBD |
...
| [NDK_LISTENER structure](ns-ndkpi--ndk-listener.md) | TBD |
...
| [NDK_SRQ structure](ns-ndkpi--ndk-srq.md) | TBD |
| [NDK_PD structure](ns-ndkpi--ndk-pd.md) | TBD |
...
| [NDK_ADAPTER structure](ns-ndkpi--ndk-adapter.md) | TBD |
| [NDK_MW structure](ns-ndkpi--ndk-mw.md) | TBD |
...
| [NDK_FN_DISCONNECT_EX callback function](nc-ndkpi-ndk-fn-disconnect-ex.md) | TBD |
...
| [NDK_FN_QUERY_ADAPTER_INFO_EX callback function](nc-ndkpi-ndk-fn-query-adapter-info-ex.md) | TBD |
