...
## -description
<p>The <b>SetThreadForOperation</b> function sets the thread to use for the next <a href="debugger.stacktrace">StackTrace</a> call.</p>
...
## -remarks
<p>If you are writing 64-bit code, you should use <a href="..\wdbgexts\nf-wdbgexts-setthreadforoperation64.md">SetThreadForOperation64</a> instead. See <a href="https://msdn.microsoft.com/library/windows/hardware/ff537780">32-Bit Pointers and 64-Bit Pointers</a> for details.</p>
