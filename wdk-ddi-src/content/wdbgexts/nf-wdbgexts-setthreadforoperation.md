...
## -description
The <b>SetThreadForOperation</b> function sets the thread to use for the next <a href="debugger.stacktrace">StackTrace</a> call.
...
## -remarks
If you are writing 64-bit code, you should use <a href="debugger.setthreadforoperation64">SetThreadForOperation64</a> instead. See <a href="https://msdn.microsoft.com/library/windows/hardware/ff537780">32-Bit Pointers and 64-Bit Pointers</a> for details.
