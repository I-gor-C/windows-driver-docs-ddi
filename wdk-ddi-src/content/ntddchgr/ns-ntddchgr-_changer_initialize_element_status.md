...
ms.date : 1/10/2018
ms.keywords : CHANGER_INITIALIZE_ELEMENT_STATUS structure [Storage Devices], PCHANGER_INITIALIZE_ELEMENT_STATUS structure pointer [Storage Devices], *PCHANGER_INITIALIZE_ELEMENT_STATUS, PCHANGER_INITIALIZE_ELEMENT_STATUS, CHANGER_INITIALIZE_ELEMENT_STATUS, ntddchgr/PCHANGER_INITIALIZE_ELEMENT_STATUS, _CHANGER_INITIALIZE_ELEMENT_STATUS, structs-changer_94235bd7-09e6-47a1-b30c-0d5d12ca7917.xml, ntddchgr/CHANGER_INITIALIZE_ELEMENT_STATUS, storage.changer_initialize_element_status
