...
ms.date: 12/15/2017
ms.keywords: _CHANGER_EXCHANGE_MEDIUM, CHANGER_EXCHANGE_MEDIUM, *PCHANGER_EXCHANGE_MEDIUM, PCHANGER_EXCHANGE_MEDIUM
...
Indicates which transport element to use for the exchange operation. This member contains a structure of type <a href="storage.changer_element">CHANGER_ELEMENT</a>. The <b>ElementType</b> member of the CHANGER_ELEMENT structure must be assigned a value of <b>ChangerTransport</b>. 
