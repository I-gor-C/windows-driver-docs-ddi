...
ms.date: 1/10/2018
ms.keywords: PCHANGER_MOVE_MEDIUM, _CHANGER_MOVE_MEDIUM, PCHANGER_MOVE_MEDIUM structure pointer [Storage Devices], ntddchgr/PCHANGER_MOVE_MEDIUM, CHANGER_MOVE_MEDIUM, ntddchgr/CHANGER_MOVE_MEDIUM, storage.changer_move_medium, *PCHANGER_MOVE_MEDIUM, structs-changer_866dd781-90cd-41be-84ce-61c16d31a369.xml, CHANGER_MOVE_MEDIUM structure [Storage Devices]
