...
### -input-buffer-length
<b>Parameters.DeviceIoControl.InputBufferLength</b> in the I/O stack location indicates the size, in bytes, of the parameter buffer, which must be &gt;= <b>sizeof</b>(<a href="storage.changer_send_volume_tag_information">CHANGER_SEND_VOLUME_TAG_INFORMATION</a>). 


### -output-buffer
The driver returns the <a href="storage.read_element_address_info">READ_ELEMENT_ADDRESS_INFO</a> data in the buffer at <b>Irp-&gt;AssociatedIrp.SystemBuffer</b>. 
