...
The <b>WDF_INTERRUPT_EXTENDED_POLICY_INIT</b> function initializes a <a href="wdf.wdf_interrupt_extended_policy">WDF_INTERRUPT_EXTENDED_POLICY</a> structure.
...
## -remarks
The <b>WDF_INTERRUPT_EXTENDED_POLICY_INIT</b> function zeros the specified <a href="wdf.wdf_interrupt_extended_policy">WDF_INTERRUPT_EXTENDED_POLICY</a> structure and sets the structure's <b>Size</b> member. It also sets the structure's <b>Policy</b> member to <b>WdfIrqPolicyMachineDefault</b> and sets the structure's <b>Priority</b> member to <b>WdfIrqPriorityUndefined</b>.

For a code example that uses <b>WDF_INTERRUPT_EXTENDED_POLICY_INIT</b>, see <a href="wdf.wdfinterruptsetextendedpolicy">WdfInterruptSetExtendedPolicy</a>. 
