...
ms.date: 1/9/2018
ms.keywords: VIDEO_GETERRORTEXT_PARMS structure [Streaming Media Devices], stream.video_geterrortext_parms, LPVIDEO_GETERRORTEXT_PARMS structure pointer [Streaming Media Devices], VIDEO_GETERRORTEXT_PARMS, *LPVIDEO_GETERRORTEXT_PARMS, msviddrv/LPVIDEO_GETERRORTEXT_PARMS, tag_video_geterrortext_parms, msviddrv/VIDEO_GETERRORTEXT_PARMS, LPVIDEO_GETERRORTEXT_PARMS
