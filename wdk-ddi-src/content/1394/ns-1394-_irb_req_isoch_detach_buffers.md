...
ms.date: 12/14/2017
ms.keywords: 1394/IRB_REQ_ISOCH_DETACH_BUFFERS, IEEE.irb_req_isoch_detach_buffers, _IRB_REQ_ISOCH_DETACH_BUFFERS, IRB_REQ_ISOCH_DETACH_BUFFERS structure [Buses], IRB_REQ_ISOCH_DETACH_BUFFERS
