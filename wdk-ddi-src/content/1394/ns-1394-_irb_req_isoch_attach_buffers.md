...
ms.date: 12/14/2017
ms.keywords: IRB_REQ_ISOCH_ATTACH_BUFFERS structure [Buses], 1394/IRB_REQ_ISOCH_ATTACH_BUFFERS, IEEE.irb_req_isoch_attach_buffers, IRB_REQ_ISOCH_ATTACH_BUFFERS, _IRB_REQ_ISOCH_ATTACH_BUFFERS
