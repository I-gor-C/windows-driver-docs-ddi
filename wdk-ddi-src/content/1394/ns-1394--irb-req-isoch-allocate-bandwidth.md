...
title: IRB_REQ_ISOCH_ALLOCATE_BANDWIDTH
...
# IRB_REQ_ISOCH_ALLOCATE_BANDWIDTH structure



## -description
<p>This structure contains the fields necessary in order for the Bus driver to carry out an <b>IsochAllocateBandwidth</b> request.</p>
