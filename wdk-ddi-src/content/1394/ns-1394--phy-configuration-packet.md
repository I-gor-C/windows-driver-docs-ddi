...
title: PHY_CONFIGURATION_PACKET
...
# PHY_CONFIGURATION_PACKET structure



## -description
<p>The PHY_CONFIGURATION_PACKET structure contains a raw PHY configuration packet.</p>
...
## -remarks
<p>For an explanation of the function of the PHY configuration packet, see the IEEE 1394 specification.</p>
