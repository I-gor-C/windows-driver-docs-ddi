...
ms.date: 12/14/2017
ms.keywords: NOTIFICATION_INFO, _NOTIFICATION_INFO_WXP, 1394/NOTIFICATION_INFO, NOTIFICATION_INFO_W2K, NOTIFICATION_INFO_WXP, NOTIFICATION_INFO structure [Buses], _NOTIFICATION_INFO_W2K, PNOTIFICATION_INFO, PNOTIFICATION_INFO structure pointer [Buses], 1394stct_db1356d4-c42d-46a4-bbc4-ed8452dc2212.xml, IEEE.notification_info, *PNOTIFICATION_INFO_WXP, *PNOTIFICATION_INFO_W2K, *PNOTIFICATION_INFO, 1394/PNOTIFICATION_INFO
