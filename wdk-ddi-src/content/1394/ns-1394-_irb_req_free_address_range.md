...
ms.date: 12/14/2017
ms.keywords: IEEE.irb_req_free_address_range, IRB_REQ_FREE_ADDRESS_RANGE structure [Buses], 1394/IRB_REQ_FREE_ADDRESS_RANGE, IRB_REQ_FREE_ADDRESS_RANGE, _IRB_REQ_FREE_ADDRESS_RANGE
