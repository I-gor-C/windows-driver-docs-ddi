...
ms.date: 12/14/2017
ms.keywords: IRB_REQ_GET_GENERATION_COUNT, IEEE.irb_req_get_generation_count, IRB_REQ_GET_GENERATION_COUNT structure [Buses], _IRB_REQ_GET_GENERATION_COUNT, 1394/IRB_REQ_GET_GENERATION_COUNT
