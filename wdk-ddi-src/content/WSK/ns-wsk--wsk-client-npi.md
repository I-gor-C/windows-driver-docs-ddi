...
ms.keywords: WSK_CLIENT_NPI, WSK_CLIENT_NPI, *PWSK_CLIENT_NPI
req.iface: 
req.product: Windows 10 or later.
---

# WSK_CLIENT_NPI structure



## -description
<p>The WSK_CLIENT_NPI structure identifies a 
  <a href="netvista.network_programming_interface">Network Programming Interface
  (NPI)</a> implemented by a WSK client.</p>
...
<dd>
<p>A pointer to the context for the WSK application's binding to the WSK subsystem.</p>
</dd>
...
<p>A pointer to a constant 
     <a href="https://msdn.microsoft.com/library/windows/hardware/ff571159">WSK_CLIENT_DISPATCH</a> structure.</p>
</dd>
</dl>
