...
ms.date: 1/10/2018
ms.keywords: mpiowmi/PDSM_COUNTERS, PDSM_COUNTERS structure pointer [Storage Devices], *PDSM_COUNTERS, storage.dsm_counters, _DSM_COUNTERS, DSM_COUNTERS structure [Storage Devices], PDSM_COUNTERS, mpiowmi/DSM_COUNTERS, DSM_COUNTERS, structs-scsibus_bfb9b1ff-6274-47b9-b817-254428b02f17.xml
