...
ms.date: 1/10/2018
ms.keywords: PMPIO_DISK_INFO structure pointer [Storage Devices], storage.mpio_disk_info, *PMPIO_DISK_INFO, mpiowmi/MPIO_DISK_INFO, MPIO_DISK_INFO, PMPIO_DISK_INFO, mpiowmi/PMPIO_DISK_INFO, MPIO_DISK_INFO structure [Storage Devices], structs-scsibus_d58f08a1-1534-4f93-83d4-031ce1dee9bf.xml, _MPIO_DISK_INFO
