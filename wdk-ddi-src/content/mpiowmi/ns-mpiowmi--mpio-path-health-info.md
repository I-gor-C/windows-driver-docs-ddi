...
ms.date: 11/15/2017
ms.keywords: MPIO_PATH_HEALTH_INFO, MPIO_PATH_HEALTH_INFO, *PMPIO_PATH_HEALTH_INFO
...
## -description
<p>The MPIO_PATH_HEALTH_INFO structure is used to query the available health information for every path that is exposed to the system.</p>
