...
title: WdfCommonBufferGetLength
...
<p>The <b>WdfCommonBufferGetLength</b> method returns the length of a specified common buffer. </p>
...
## -returns
<p><b>WdfCommonBufferGetLength</b> returns the length, in bytes, of the buffer that is associated with the common buffer that the <i>CommonBuffer</i> parameter specifies.</p>
...
<p>The following code example obtains the length of a specified common buffer.</p>
