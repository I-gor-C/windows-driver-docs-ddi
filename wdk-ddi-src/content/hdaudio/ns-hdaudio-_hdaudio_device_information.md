...
ms.date: 2/8/2018
ms.keywords: hdaudio/PHDAUDIO_DEVICE_INFORMATION, _HDAUDIO_DEVICE_INFORMATION, aud-prop2_3350e3d4-dfbe-4002-b237-2395f4a07c7f.xml, PHDAUDIO_DEVICE_INFORMATION structure pointer [Audio Devices], PHDAUDIO_DEVICE_INFORMATION, *PHDAUDIO_DEVICE_INFORMATION, audio.hdaudio_device_information, HDAUDIO_DEVICE_INFORMATION, hdaudio/HDAUDIO_DEVICE_INFORMATION, HDAUDIO_DEVICE_INFORMATION structure [Audio Devices]
