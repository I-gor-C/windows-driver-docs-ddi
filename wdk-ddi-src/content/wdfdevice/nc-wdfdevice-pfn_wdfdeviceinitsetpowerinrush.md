...
title: PFN_WDFDEVICEINITSETPOWERINRUSH function
...
ms.date: 12/29/2017
ms.keywords: PFN_WDFDEVICEINITSETPOWERINRUSH
...
# PFN_WDFDEVICEINITSETPOWERINRUSH function
...
If your driver calls <b>WdfDeviceInitSetPowerInrush</b>, the framework makes it <a href="wdf.creating_pageable_code_in_a_kmdf_driver">nonpageable</a> during power state transitions and the driver must not call <a href="..\wdfdevice\nf-wdfdevice-wdfdeviceinitsetpowerpageable.md">WdfDeviceInitSetPowerPageable</a>. 
