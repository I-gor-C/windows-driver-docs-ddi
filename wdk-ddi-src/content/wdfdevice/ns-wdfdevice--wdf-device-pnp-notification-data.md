...
## -remarks
<p>The WDF_DEVICE_PNP_NOTIFICATION_DATA structure is an input argument to a driver's <a href="..\wdfdevice\nc-wdfdevice-evt-wdf-device-pnp-state-change-notification.md">EvtDevicePnpStateChange</a> callback function.</p>
