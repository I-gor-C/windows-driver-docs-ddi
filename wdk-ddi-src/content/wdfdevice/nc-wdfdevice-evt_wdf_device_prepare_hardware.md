...
title: EVT_WDF_DEVICE_PREPARE_HARDWARE function
...
ms.date: 1/11/2018
ms.keywords: EVT_WDF_DEVICE_PREPARE_HARDWARE
...
# EVT_WDF_DEVICE_PREPARE_HARDWARE function
...
Optionally, your driver's <i>EvtDevicePrepareHardware</i> callback function might queue a work item to complete any other time-intensive configuration tasks. Using a work item for such operations can help ensure that your device's start up time does not increase the system boot time. For more information, see <a href="https://msdn.microsoft.com/d7e6d187-bed4-4071-a50b-90f32c4f0d5a">Using Framework Work Items</a>.
