...
ms.date: 12/21/2017
ms.keywords: bltooth.channel_config_results, CHANNEL_CONFIG_RESULTS, _CHANNEL_CONFIG_RESULTS, PCHANNEL_CONFIG_RESULTS, CHANNEL_CONFIG_RESULTS structure [Bluetooth Devices], bthddi/PCHANNEL_CONFIG_RESULTS, *PCHANNEL_CONFIG_RESULTS, bthddi/CHANNEL_CONFIG_RESULTS, PCHANNEL_CONFIG_RESULTS structure pointer [Bluetooth Devices], bth_structs_9c4ea05f-7bee-473c-a311-e68f49c3013a.xml
