...
ms.date : 12/21/2017
ms.keywords : "*PENUMERATOR_ACTION, ENUMERATOR_ACTION, bthddi/ENUMERATOR_ACTION_REMOVE, bthddi/ENUMERATOR_ACTION_DESTROY, bthddi/ENUMERATOR_ACTION_MAX, _ENUMERATOR_ACTION, ENUMERATOR_ACTION enumeration [Bluetooth Devices], ENUMERATOR_ACTION_CREATE, PENUMERATOR_ACTION, bthddi/PENUMERATOR_ACTION, bthddi/ENUMERATOR_ACTION_CREATE, bthddi/ENUMERATOR_ACTION, ENUMERATOR_ACTION enumeration pointer [Bluetooth Devices], bltooth.enumerator_action, PENUMERATOR_ACTION enumeration pointer [Bluetooth Devices], bth_enums_5ffc09cb-5aae-408c-ba92-b1872890541a.xml, ENUMERATOR_ACTION_MAX, ENUMERATOR_ACTION_DESTROY, ENUMERATOR_ACTION_REMOVE"
