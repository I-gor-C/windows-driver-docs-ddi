...
ms.date: 12/21/2017
ms.keywords: bthddi/ENUMERATOR_ACTION, bthddi/ENUMERATOR_ACTION_MAX, ENUMERATOR_ACTION enumeration pointer [Bluetooth Devices], ENUMERATOR_ACTION, _ENUMERATOR_ACTION, bth_enums_5ffc09cb-5aae-408c-ba92-b1872890541a.xml, bthddi/ENUMERATOR_ACTION_REMOVE, PENUMERATOR_ACTION enumeration pointer [Bluetooth Devices], ENUMERATOR_ACTION_DESTROY, ENUMERATOR_ACTION_MAX, bthddi/ENUMERATOR_ACTION_CREATE, bltooth.enumerator_action, *PENUMERATOR_ACTION, bthddi/PENUMERATOR_ACTION, ENUMERATOR_ACTION_REMOVE, ENUMERATOR_ACTION_CREATE, ENUMERATOR_ACTION enumeration [Bluetooth Devices], bthddi/ENUMERATOR_ACTION_DESTROY, PENUMERATOR_ACTION
