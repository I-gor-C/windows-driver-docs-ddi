...
# BRB_ACL_GET_MODE structure



## -description
<p>The _BRB_ACL_GET_MODE structure describes the ACL mode for the specified remote device.</p>
...
## -remarks
<p>To get the current ACL connection state for a remote device, profile drivers should 
    <a href="https://msdn.microsoft.com/53a692e7-9c71-4dca-9331-32ac97b94179">build and send</a> a 
    <a href="https://msdn.microsoft.com/library/windows/hardware/ff536609">BRB_ACL_GET_MODE</a> request.</p>
