...
ms.date: 12/21/2017
ms.keywords: PPCM_DATA_FORMAT enumeration pointer [Bluetooth Devices], bthddi/, *PPCM_DATA_FORMAT, bthddi/PCM_DATA_FORMAT, PPCM_DATA_FORMAT, _PCM_DATA_FORMAT, bltooth.pcm_data_format, bthddi/PPCM_DATA_FORMAT, PCM_DATA_FORMAT enumeration [Bluetooth Devices], PCM_DATA_FORMAT
