...
ms.date : 12/21/2017
ms.keywords : bth_structs_970b0c43-701b-4219-b05c-aa49f8e6a09e.xml, _BRB_SCO_GET_SYSTEM_INFO structure [Bluetooth Devices], bltooth._brb_sco_get_system_info, _BRB_SCO_GET_SYSTEM_INFO, bthddi/_BRB_SCO_GET_SYSTEM_INFO
