...
After a PSM has been registered, the profile driver can receive connection notifications from remote
    ...
    BRB_L2CA_OPEN_CHANNEL_RESPONSE</b></mshelp:link> requests to accept incoming connections.
...
Profile drivers cannot register a PSM that has already been registered by another driver. If one
    ...
    <mshelp:link keywords="bltooth.ioctl_bth_sdp_submit_record" tabindex="0"><b>
    IOCTL_BTH_SDP_SUBMIT_RECORD</b></mshelp:link> IOCTL.
...
A <b>BRB_UNREGISTER_PSM</b> request has no effect on SDP records that attempt to connect to the PSM. Profile
    ...
    <mshelp:link keywords="bltooth.ioctl_bth_sdp_remove_record" tabindex="0"><b>
    IOCTL_BTH_SDP_REMOVE_RECORD</b></mshelp:link> IOCTL.
