# Declarations in the ndiswwan header
This header Ndiswwan contains these programming interfaces:
...
| [NDIS_WWAN_IMS_VOICE_STATE structure](ns-ndiswwan--ndis-wwan-ims-voice-state.md) | TBD |
...
| [NDIS_WWAN_SET_SIGNAL_INDICATION_EX structure](ns-ndiswwan--ndis-wwan-set-signal-indication-ex.md) | TBD |
| [NDIS_WWAN_SAR_TRANSMISSION_STATUS_INFO structure](ns-ndiswwan--ndis-wwan-sar-transmission-status-info.md) | TBD |
...
| [NDIS_WWAN_UICC_RESPONSE structure](ns-ndiswwan--ndis-wwan-uicc-response.md) | TBD |
| [NDIS_WWAN_ATR_INFO structure](ns-ndiswwan--ndis-wwan-atr-info.md) | TBD |
...
| [NDIS_WWAN_SET_PROVISIONED_CONTEXT_V2 structure](ns-ndiswwan--ndis-wwan-set-provisioned-context-v2.md) | TBD |
| [NDIS_WWAN_SET_UICC_APDU structure](ns-ndiswwan--ndis-wwan-set-uicc-apdu.md) | TBD |
| [NDIS_WWAN_SET_LTE_ATTACH_CONTEXT structure](ns-ndiswwan--ndis-wwan-set-lte-attach-context.md) | TBD |
...
| [NDIS_WWAN_NITZ_INFO structure](ns-ndiswwan--ndis-wwan-nitz-info.md) | TBD |
...
| [NDIS_WWAN_LOCATION_STATE_INFO structure](ns-ndiswwan--ndis-wwan-location-state-info.md) | TBD |
...
| [NDIS_WWAN_SET_IMS_VOICE_STATE structure](ns-ndiswwan--ndis-wwan-set-ims-voice-state.md) | TBD |
