...
ms.date: 2/8/2018
ms.keywords: ISensorClassExtension::ProcessIoControl, sensors.isensorclassextension_processiocontrol, ProcessIoControl, ProcessIoControl method [Sensor Devices], ISensorClassExtension
