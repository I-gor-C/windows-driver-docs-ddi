...
ms.date: 2/8/2018
ms.keywords: OnClientSubscribeToEvents method [Sensor Devices], ISensorDriver, ISensorDriver::OnClientSubscribeToEvents, sensors.isensordriver_onclientsubscribetoevents, OnClientSubscribeToEvents
