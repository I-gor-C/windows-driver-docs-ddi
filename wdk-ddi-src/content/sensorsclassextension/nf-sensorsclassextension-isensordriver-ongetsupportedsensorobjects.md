...
ms.date: 12/14/2017
ms.keywords: OnGetSupportedSensorObjects method [Sensor Devices], OnGetSupportedSensorObjects, sensors.isensordriver_ongetsupportedsensorobjects, ISensorDriver::OnGetSupportedSensorObjects, ISensorDriver
