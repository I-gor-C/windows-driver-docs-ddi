...
ms.date : 12/14/2017
ms.keywords : ISensorClassExtension, ISensorClassExtension::Uninitialize, Uninitialize method [Sensor Devices], Uninitialize, sensors.isensorclassextension_uninitialize
