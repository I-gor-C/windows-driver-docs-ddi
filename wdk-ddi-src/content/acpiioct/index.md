...
| [ACPI_EVAL_INPUT_BUFFER_COMPLEX_V1 structure](ns-acpiioct--acpi-eval-input-buffer-complex-v1~r1.md) | This topic describes the ACPI_EVAL_INPUT_BUFFER_COMPLEX_V1 structure. |
...
| [ACPI_EVAL_INPUT_BUFFER_COMPLEX_V1_EX structure](ns-acpiioct--acpi-eval-input-buffer-complex-v1-ex~r1.md) | This topic describes the ACPI_EVAL_INPUT_BUFFER_COMPLEX_V1_EX structure. |
...
| [ACPI_EVAL_INPUT_BUFFER_SIMPLE_INTEGER_V1 structure](ns-acpiioct--acpi-eval-input-buffer-simple-integer-v1~r1.md) | This topic describes the ACPI_EVAL_INPUT_BUFFER_SIMPLE_INTEGER_V1 structure. |
...
| [ACPI_EVAL_INPUT_BUFFER_SIMPLE_INTEGER_V1_EX structure](ns-acpiioct--acpi-eval-input-buffer-simple-integer-v1-ex~r1.md) | This topic describes the ACPI_EVAL_INPUT_BUFFER_SIMPLE_INTEGER_V1_EX structure. |
...
| [ACPI_EVAL_INPUT_BUFFER_SIMPLE_STRING_V1 structure](ns-acpiioct--acpi-eval-input-buffer-simple-string-v1~r1.md) | This topic describes the ACPI_EVAL_INPUT_BUFFER_SIMPLE_STRING_V1 structure. |
...
| [ACPI_EVAL_INPUT_BUFFER_SIMPLE_STRING_V1_EX structure](ns-acpiioct--acpi-eval-input-buffer-simple-string-v1-ex~r1.md) | This topic describes the ACPI_EVAL_INPUT_BUFFER_SIMPLE_STRING_V1_EX structure. |
...
| [ACPI_EVAL_INPUT_BUFFER_V1 structure](ns-acpiioct--acpi-eval-input-buffer-v1~r1.md) | This topic describes the ACPI_EVAL_INPUT_BUFFER_V1 structure. |
...
| [ACPI_EVAL_INPUT_BUFFER_V1_EX structure](ns-acpiioct--acpi-eval-input-buffer-v1-ex~r1.md) | This topic describes the ACPI_EVAL_INPUT_BUFFER_V1_EX structure. |
...
| [ACPI_EVAL_OUTPUT_BUFFER_V1 structure](ns-acpiioct--acpi-eval-output-buffer-v1~r1.md) | This topic describes the ACPI_EVAL_OUTPUT_BUFFER_V1 structure. |
| [ACPI_EVAL_OUTPUT_BUFFER_V1 structure](ns-acpiioct--acpi-eval-output-buffer-v1~r2.md) | This topic describes the ACPI_EVAL_OUTPUT_BUFFER_V1 structure. |
