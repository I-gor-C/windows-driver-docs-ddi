...
ms.date: 12/31/2017
ms.keywords: PACPI_EVAL_INPUT_BUFFER_COMPLEX_V2, _ACPI_EVAL_INPUT_BUFFER_COMPLEX_V2, ACPI_EVAL_INPUT_BUFFER_COMPLEX_V2, acpiioct/ACPI_EVAL_INPUT_BUFFER_COMPLEX_V2, acpiioct/PACPI_EVAL_INPUT_BUFFER_COMPLEX_V2, PACPI_EVAL_INPUT_BUFFER_COMPLEX_V2 structure pointer [ACPI Devices], ACPI_EVAL_INPUT_BUFFER_COMPLEX_V2 structure [ACPI Devices], *PACPI_EVAL_INPUT_BUFFER_COMPLEX_V2, acpi.acpi_eval_input_buffer_complex_v2
