...
title: PEP_ACPI_INITIALIZE_GPIO_IO_RESOURCE
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: PEP_ACPI_INITIALIZE_GPIO_IO_RESOURCE
req.alt-loc: pepfx.h
req.ddi-compliance: 
req.unicode-ansi: 
req.idl: 
...
req.dll: 
req.irql: 
ms.keywords: PEP_ACPI_INITIALIZE_GPIO_IO_RESOURCE
req.iface: 
---
...
## -description
<p>The <b>PEP_ACPI_INITIALIZE_GPIO_IO_RESOURCE</b> function initializes a platform extension plug-in's (PEP) <a href="https://msdn.microsoft.com/library/windows/hardware/mt186671">PEP_ACPI_GPIO_RESOURCE</a> structure.</p>
...
### -param <i>DriveStrength</i> [in]

<dd></dd>

### -param <i>IoRestriction</i> [in]
