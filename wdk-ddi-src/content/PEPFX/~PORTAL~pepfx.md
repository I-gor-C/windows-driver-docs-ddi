# Declarations in the pepfx header
This header Pepfx contains these programming interfaces:
...
| [PEP_PPM_LPI_COORDINATED_STATES structure](ns-pepfx--pep-ppm-lpi-coordinated-states.md) | TBD |
...
| [PEP_PPM_LPI_REGISTER structure](ns-pepfx--pep-ppm-lpi-register.md) | TBD |
...
| [PEP_QUERY_CURRENT_COMPONENT_PERF_STATE structure](ns-pepfx--pep-query-current-component-perf-state.md) | TBD |
