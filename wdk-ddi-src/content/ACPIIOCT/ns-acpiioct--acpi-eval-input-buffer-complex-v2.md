...
title: ACPI_EVAL_INPUT_BUFFER_COMPLEX_V2
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: ACPI_EVAL_INPUT_BUFFER_COMPLEX_V2
...
req.dll: 
req.irql: 
ms.keywords: ACPI_EVAL_INPUT_BUFFER_COMPLEX_V2, ACPI_EVAL_INPUT_BUFFER_COMPLEX_V2, *PACPI_EVAL_INPUT_BUFFER_COMPLEX_V2
---

# ACPI_EVAL_INPUT_BUFFER_COMPLEX_V2 structure



## -description
<p>This topic describes the <b>ACPI_EVAL_INPUT_BUFFER_COMPLEX_V2</b> structure.</p>
