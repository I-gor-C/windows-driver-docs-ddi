...
ms.date: 2/20/2018
ms.keywords: MIRACAST_DRIVER_INTERFACE, MIRACAST_DRIVER_INTERFACE structure [Display Devices], PMIRACAST_DRIVER_INTERFACE, netdispumdddi/PMIRACAST_DRIVER_INTERFACE, netdispumdddi/MIRACAST_DRIVER_INTERFACE, display.miracast_driver_interface, PMIRACAST_DRIVER_INTERFACE structure pointer [Display Devices], *PMIRACAST_DRIVER_INTERFACE, _MIRACAST_DRIVER_INTERFACE
