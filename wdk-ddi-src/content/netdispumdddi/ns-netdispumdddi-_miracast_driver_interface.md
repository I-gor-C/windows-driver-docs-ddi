...
ms.date: 12/29/2017
ms.keywords: "*PMIRACAST_DRIVER_INTERFACE, display.miracast_driver_interface, netdispumdddi/PMIRACAST_DRIVER_INTERFACE, netdispumdddi/MIRACAST_DRIVER_INTERFACE, PMIRACAST_DRIVER_INTERFACE structure pointer [Display Devices], MIRACAST_DRIVER_INTERFACE structure [Display Devices], MIRACAST_DRIVER_INTERFACE, PMIRACAST_DRIVER_INTERFACE, _MIRACAST_DRIVER_INTERFACE"
