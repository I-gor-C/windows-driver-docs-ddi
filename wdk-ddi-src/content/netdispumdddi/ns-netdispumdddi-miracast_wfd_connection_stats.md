...
ms.date: 12/29/2017
ms.keywords: MIRACAST_WFD_CONNECTION_STATS, display.miracast_wfd_connection_stats, MIRACAST_WFD_CONNECTION_STATS structure [Display Devices], netdispumdddi/MIRACAST_WFD_CONNECTION_STATS
