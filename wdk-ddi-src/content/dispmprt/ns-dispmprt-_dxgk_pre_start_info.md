...
ms.date: 12/29/2017
ms.keywords: DXGK_PRE_START_INFO structure [Display Devices], PDXGK_PRE_START_INFO structure pointer [Display Devices], dispmprt/PDXGK_PRE_START_INFO, PDXGK_PRE_START_INFO, DXGK_PRE_START_INFO, dispmprt/DXGK_PRE_START_INFO, _DXGK_PRE_START_INFO, display.dxgk_pre_start_info, *PDXGK_PRE_START_INFO
