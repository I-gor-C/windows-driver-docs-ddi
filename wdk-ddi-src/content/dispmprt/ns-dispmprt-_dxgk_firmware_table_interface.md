...
ms.date: 12/29/2017
ms.keywords: dispmprt/DXGK_FIRMWARE_TABLE_INTERFACE, PDXGK_FIRMWARE_TABLE_INTERFACE, DXGK_FIRMWARE_TABLE_INTERFACE, PDXGK_FIRMWARE_TABLE_INTERFACE structure pointer [Display Devices], DXGK_FIRMWARE_TABLE_INTERFACE structure [Display Devices], dispmprt/PDXGK_FIRMWARE_TABLE_INTERFACE, display.dxgk_firmware_table_interface, *PDXGK_FIRMWARE_TABLE_INTERFACE, _DXGK_FIRMWARE_TABLE_INTERFACE
