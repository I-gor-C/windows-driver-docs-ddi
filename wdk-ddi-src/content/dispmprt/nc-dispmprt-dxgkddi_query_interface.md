...
<i>DxgkDdiQueryInterface</i> should fill in the members of the <a href="..\miniport\ns-miniport-_interface.md">INTERFACE</a> structure that <i>QueryInterface</i>-&gt;<b>Interface</b> points to as follows:
