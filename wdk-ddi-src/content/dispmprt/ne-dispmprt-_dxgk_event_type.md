...
ms.date: 12/6/2017
ms.keywords: _DXGK_EVENT_TYPE, DXGK_EVENT_TYPE, *PDXGK_EVENT_TYPE
...
## -description
The DXGK_EVENT_TYPE enumeration indicates the event type in a call to the display miniport driver's <a href="display.dxgkddinotifyacpievent">DxgkDdiNotifyAcpiEvent</a> function.
