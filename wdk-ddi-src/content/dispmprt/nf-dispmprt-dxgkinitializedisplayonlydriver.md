...
ms.date : 12/29/2017
ms.keywords : display.dxgkinitializedisplayonlydriver, DxgkInitializeDisplayOnlyDriver, DxgkInitializeDisplayOnlyDriver function [Display Devices], dispmprt/DxgkInitializeDisplayOnlyDriver
