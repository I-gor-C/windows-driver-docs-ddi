...
ms.date: 2/20/2018
ms.keywords: dispmprt/PDXGK_CHILD_DEVICE_TYPE, PDXGK_CHILD_DEVICE_TYPE, dispmprt/DXGK_CHILD_DEVICE_TYPE, _DXGK_CHILD_DEVICE_TYPE, PDXGK_CHILD_DEVICE_TYPE enumeration pointer [Display Devices], dispmprt/TypeUninitialized, dispmprt/TypeIntegratedDisplay, TypeUninitialized, TypeIntegratedDisplay, *PDXGK_CHILD_DEVICE_TYPE, dispmprt/TypeVideoOutput, DmEnums_afd3654c-ffb4-49d6-ba59-235148e59d2c.xml, dispmprt/TypeOther, TypeVideoOutput, DXGK_CHILD_DEVICE_TYPE, TypeOther, DXGK_CHILD_DEVICE_TYPE enumeration [Display Devices], display.dxgk_child_device_type
...
<a href="mailto:wsddocfb@microsoft.com?subject=Documentation%20feedback [display\display]:%20DXGK_CHILD_DEVICE_TYPE enumeration%20 RELEASE:%20(2/20/2018)&amp;body=%0A%0APRIVACY STATEMENT%0A%0AWe use your feedback to improve the documentation. We don't use your email address for any other purpose, and we'll remove your email address from our system after the issue that you're reporting is fixed. While we're working to fix this issue, we might send you an email message to ask for more info. Later, we might also send you an email message to let you know that we've addressed your feedback.%0A%0AFor more info about Microsoft's privacy policy, see http://privacy.microsoft.com/en-us/default.aspx." title="Send comments about this topic to Microsoft">Send comments about this topic to Microsoft</a>