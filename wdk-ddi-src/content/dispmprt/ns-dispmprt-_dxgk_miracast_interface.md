...
ms.date: 12/29/2017
ms.keywords: "*PDXGK_MIRACAST_DISPLAY_INTERFACE, dispmprt/DXGK_MIRACAST_DISPLAY_INTERFACE, dispmprt/PDXGK_MIRACAST_DISPLAY_INTERFACE, DXGK_MIRACAST_DISPLAY_INTERFACE structure [Display Devices], DXGK_MIRACAST_DISPLAY_INTERFACE, display.dxgk_miracast_display_interface, _DXGK_MIRACAST_INTERFACE, PDXGK_MIRACAST_DISPLAY_INTERFACE, PDXGK_MIRACAST_DISPLAY_INTERFACE structure pointer [Display Devices]"
