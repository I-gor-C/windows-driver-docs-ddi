...
ms.date: 12/14/2017
ms.keywords: _NET_DMA_PROVIDER_ATTRIBUTES, *PNET_DMA_PROVIDER_ATTRIBUTES, PNET_DMA_PROVIDER_ATTRIBUTES, NET_DMA_PROVIDER_ATTRIBUTES
...
To start a DMA provider, the DMA provider driver supplies a NET_DMA_PROVIDER_ATTRIBUTES structure at
    ...
    <a href="netvista.netdmaproviderstart">NetDmaProviderStart</a> function.
