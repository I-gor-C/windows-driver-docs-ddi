...
## -description
The <b>RtlUnicodeStringCchCatN</b> function concatenates two strings that are contained in <a href="kernel.unicode_string">UNICODE_STRING</a> structures while limiting the size of the copied string.
...
The <i>SourceString</i> and <i>DestinationString</i> pointers cannot be <b>NULL</b>. If you need to handle <b>NULL</b> pointer values, use the <a href="kernel.rtlunicodestringcchcatnex">RtlUnicodeStringCchCatNEx</a> function.
