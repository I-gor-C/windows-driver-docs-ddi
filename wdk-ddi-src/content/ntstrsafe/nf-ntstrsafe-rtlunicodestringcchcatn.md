...
## -description
<p>The <b>RtlUnicodeStringCchCatN</b> function concatenates two strings that are contained in <a href="..\wudfwdm\ns-wudfwdm--unicode-string.md">UNICODE_STRING</a> structures while limiting the size of the copied string.</p>
...
<p>The <i>SourceString</i> and <i>DestinationString</i> pointers cannot be <b>NULL</b>. If you need to handle <b>NULL</b> pointer values, use the <a href="..\ntstrsafe\nf-ntstrsafe-rtlunicodestringcchcatnex.md">RtlUnicodeStringCchCatNEx</a> function.</p>
