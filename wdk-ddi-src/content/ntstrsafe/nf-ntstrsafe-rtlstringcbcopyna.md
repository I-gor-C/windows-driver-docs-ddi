...
Neither <i>pszSrc</i> nor <i>pszDest</i> can be <b>NULL</b>. If you need to handle <b>NULL</b> string pointer values, see <a href="kernel.rtlstringcbcopynex">RtlStringCbCopyNEx</a>.
...
<td width="70%">
<b>RtlStringCbCopyNW</b> (Unicode) and <b>RtlStringCbCopyNA</b> (ANSI)
