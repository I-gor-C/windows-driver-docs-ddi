...
title: RtlUnicodeStringCchCatNEx
...
<dd>
<p>If this flag is set, the source or destination pointer, or both, can be <b>NULL</b>. <b>RtlUnicodeStringCchCatNEx</b> treats <b>NULL</b> source buffer pointers like empty strings (TEXT("")), which can be copied. <b>NULL</b> destination buffer pointers cannot receive nonempty strings.</p>
</dd>
...
## -returns
<p><b>RtlUnicodeStringCchCatNEx</b> returns one of the following NTSTATUS values. </p><dl>
...
<p><b>RtlUnicodeStringCchCatNEx</b> returns the STATUS_INVALID_PARAMETER value when:</p>
