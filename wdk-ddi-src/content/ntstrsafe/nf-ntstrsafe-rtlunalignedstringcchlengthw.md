...
## -description
<p>The <b>RtlUnalignedStringCchLengthW</b> function is a version of the <a href="kernel.rtlstringcchlength">RtlStringCchLength</a> function that accepts an unaligned pointer to a string of Unicode characters.</p>
