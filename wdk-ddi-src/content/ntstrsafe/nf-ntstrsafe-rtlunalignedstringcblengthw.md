...
## -description
The <b>RtlUnalignedStringCbLengthW</b> function is a version of the <a href="kernel.rtlstringcblength">RtlStringCbLength</a> function that accepts an unaligned pointer to a string of Unicode characters.
