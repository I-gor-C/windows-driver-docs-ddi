...
## -description
The <b>RtlUnicodeStringCchCopyN</b> function copies a string from one <a href="kernel.unicode_string">UNICODE_STRING</a> structure to another while limiting the size of the copied string.
...
The <i>SourceString</i> and <i>DestinationString</i> pointers cannot be <b>NULL</b>. If you need to handle <b>NULL</b> pointer values, use the <a href="kernel.rtlunicodestringcchcopynex">RtlUnicodeStringCchCopyNEx</a> function.
