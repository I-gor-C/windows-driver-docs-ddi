...
## -description
The <b>RtlUnicodeStringCatString</b> function concatenates two strings when the destination string is contained in a <a href="kernel.unicode_string">UNICODE_STRING</a> structure.
...
The <i>pszSrc</i> and <i>DestinationString</i> pointers cannot be <b>NULL</b>. If you need to handle <b>NULL</b> pointer values, use the <a href="kernel.rtlunicodestringcatstringex">RtlUnicodeStringCatStringEx</a> function.
...
<dl>
<dt>
<a href="kernel.rtlunicodestringcatstringex">RtlUnicodeStringCatStringEx</a>
</dt>
<dt>
