...
## -description
<p>The <b>RtlUnicodeStringCbCatN</b> function concatenates two strings that are contained in <a href="..\wudfwdm\ns-wudfwdm--unicode-string.md">UNICODE_STRING</a> structures while limiting the size of the copied string.</p>
