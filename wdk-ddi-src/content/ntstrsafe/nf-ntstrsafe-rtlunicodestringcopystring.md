...
## -description
The <b>RtlUnicodeStringCopyString</b> function copies a string into a <a href="kernel.unicode_string">UNICODE_STRING</a> structure.
...
The <i>pszSrc</i> and <i>DestinationString</i> pointers cannot be <b>NULL</b>. If you need to handle <b>NULL</b> pointer values, use the <a href="kernel.rtlunicodestringcopystringex">RtlUnicodeStringCopyStringEx</a> function.
...
<dl>
<dt>
<a href="kernel.rtlunicodestringcopystringex">RtlUnicodeStringCopyStringEx</a>
</dt>
<dt>
