...
## -description
<p>The <b>RtlUnicodeStringCatEx</b> function concatenates two strings that are contained in <a href="..\wudfwdm\ns-wudfwdm--unicode-string.md">UNICODE_STRING</a> structures. </p>
...
<p><b>RtlUnicodeStringCatEx</b> adds to the functionality of the <a href="..\ntstrsafe\nf-ntstrsafe-rtlunicodestringcat.md">RtlUnicodeStringCat</a> function by returning a <a href="..\wudfwdm\ns-wudfwdm--unicode-string.md">UNICODE_STRING</a> structure that identifies the end of the destination string and the number of bytes that are left unused in that string. You can pass flags to <b>RtlUnicodeStringCatEx</b> for additional control.</p>
