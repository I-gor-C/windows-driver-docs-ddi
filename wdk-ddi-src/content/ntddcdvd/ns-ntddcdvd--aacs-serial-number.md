...
ms.date: 11/15/2017
ms.keywords: AACS_SERIAL_NUMBER, AACS_SERIAL_NUMBER, *PAACS_SERIAL_NUMBER
...
## -description
<p>The AACS_SERIAL_NUMBER structure contains an Advanced Access Content System (AACS) serial number and corresponding message authentication code (MAC).</p>
