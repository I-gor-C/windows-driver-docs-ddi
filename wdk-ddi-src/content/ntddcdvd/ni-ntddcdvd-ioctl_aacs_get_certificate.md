...
The buffer at <b>Irp-&gt;AssociatedIrp.SystemBuffer</b> contains the drive certificate with a format of <a href="storage.aacs_certificate">AACS_CERTIFICATE</a>.The buffer at <b>Irp-&gt;AssociatedIrp.SystemBuffer</b>Irp->AssociatedIrp.SystemBuffer contains the drive certificate with a format of <a href="storage.aacs_certificate">AACS_CERTIFICATE</a><b>AACS_CERTIFICATE</b>AACS_CERTIFICATE.
