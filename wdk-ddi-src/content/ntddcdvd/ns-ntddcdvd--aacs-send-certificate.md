...
ms.date: 11/15/2017
ms.keywords: AACS_SEND_CERTIFICATE, AACS_SEND_CERTIFICATE, *PAACS_SEND_CERTIFICATE
...
## -description
<p>The AACS_SEND_CERTIFICATE structure is a wrapper for both an Advanced Access Content System (AACS) certificate and an Authentication Grant Identifier (AGID).</p>
