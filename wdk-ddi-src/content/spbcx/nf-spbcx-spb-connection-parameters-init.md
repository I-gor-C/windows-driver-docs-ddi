...
title: SPB_CONNECTION_PARAMETERS_INIT
...
## -description
<p>The <b>SPB_CONNECTION_PARAMETERS_INIT</b> function initializes an  <a href="https://msdn.microsoft.com/library/windows/hardware/hh406204">SPB_CONNECTION_PARAMETERS</a> structure.</p>
...
<dd>
<p>A pointer to the <b>SPB_CONNECTION_PARAMETERS</b> structure that is to be initialized.</p>
</dd>
</dl>
