...
ms.date: 12/15/2017
ms.keywords: _SetCHAPSharedSecret_IN, SetCHAPSharedSecret_IN, PSetCHAPSharedSecret_IN, *PSetCHAPSharedSecret_IN
...
## -description
The SetCHAPSharedSecret_IN structure holds the input data for the <a href="storage.setchapsharedsecret">SetCHAPSharedSecret</a> method.
...
<dt>
<a href="storage.setchapsharedsecret_out">SetCHAPSharedSecret_OUT</a>
</dt>
</dl>
 
