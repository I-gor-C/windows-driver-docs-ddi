...
ms.date: 12/15/2017
ms.keywords: _SendTargets_IN, SendTargets_IN, *PSendTargets_IN, PSendTargets_IN
...
## -description
The SendTargets_IN structure holds the input data for the <a href="storage.sendtargets">SendTargets</a> method.
...
<dt>
<a href="storage.sendtargets_out">SendTargets_OUT</a>
</dt>
</dl>
 
