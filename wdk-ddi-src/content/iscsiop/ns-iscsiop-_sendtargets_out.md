...
ms.date: 12/15/2017
ms.keywords: _SendTargets_OUT, PSendTargets_OUT, *PSendTargets_OUT, SendTargets_OUT
...
## -description
The SendTargets_OUT structure holds the output data for the <a href="storage.sendtargets">SendTargets</a> method.
...
<dt>
<a href="storage.sendtargets_in">SendTargets_IN</a>
</dt>
</dl>
 
