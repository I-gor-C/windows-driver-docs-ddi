...
ms.date: 12/15/2017
ms.keywords: _DeleteInitiatorNodeName_OUT, PDeleteInitiatorNodeName_OUT, DeleteInitiatorNodeName_OUT, *PDeleteInitiatorNodeName_OUT
...
## -description
The DeleteInitiatorNodeName_OUT structure holds the output data for the <a href="storage.deleteinitiatornodename">DeleteInitiatorNodeName</a> method.
...
The status of the <b>DeleteInitiatorNodeName</b> operation. For a list of status qualifiers, see <a href="storage.iscsi_status_qualifiers">ISCSI_STATUS_QUALIFIERS</a>. 
...
<dt>
<a href="storage.deleteinitiatornodename_in">DeleteInitiatorNodeName_IN</a>
</dt>
<dt>
