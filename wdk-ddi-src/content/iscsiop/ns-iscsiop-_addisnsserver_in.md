...
ms.date: 1/10/2018
ms.keywords: AddiSNSServer_IN, structs-iSCSI_2c317c93-3fea-4749-98ef-fba28c0cc93f.xml, _AddiSNSServer_IN, PAddiSNSServer_IN structure pointer [Storage Devices], AddiSNSServer_IN structure [Storage Devices], iscsiop/PAddiSNSServer_IN, PAddiSNSServer_IN, storage.addisnsserver_in, iscsiop/AddiSNSServer_IN, *PAddiSNSServer_IN
