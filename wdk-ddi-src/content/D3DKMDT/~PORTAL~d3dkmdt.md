# Declarations in the d3dkmdt header
This header D3Dkmdt contains these programming interfaces:
...
| [DXGKMDT_DPCP_PROTECTION_LEVEL enumeration](ne-d3dkmdt--dxgkmdt-dpcp-protection-level.md) | TBD |
...
| [DXGKMDT_OPM_TYPE_ENFORCEMENT_HDCP_PROTECTION_LEVEL enumeration](ne-d3dkmdt--dxgkmdt-opm-type-enforcement-hdcp-protection-level.md) | TBD |
...
| [DXGKMDT_OPM_OUTPUT_HARDWARE_PROTECTION enumeration](ne-d3dkmdt--dxgkmdt-opm-output-hardware-protection.md) | TBD |
...
| [DXGKMDT_OPM_IMAGE_ASPECT_RATIO_EN300294 enumeration](ne-d3dkmdt--dxgkmdt-opm-image-aspect-ratio-en300294.md) | TBD |
...
| Title        | Description    |
| ------------- |:-------------:|
| [DXGK_NODEMETADATA structure](ns-d3dkmdt--dxgk-nodemetadata.md) | TBD |
| [D3DKMDT_FREQUENCY_RANGE structure](ns-d3dkmdt--d3dkmdt-frequency-range.md) | TBD |
...
| [D3DKMDT_GRAPHICS_RENDERING_FORMAT structure](ns-d3dkmdt--d3dkmdt-graphics-rendering-format.md) | TBD |
...
| [D3DKMT_NODEMETADATA structure](ns-d3dkmdt--d3dkmt-nodemetadata.md) | TBD |
...
| [DXGKMDT_OPM_CREATE_VIDEO_OUTPUT_FOR_TARGET_PARAMETERS structure](ns-d3dkmdt--dxgkmdt-opm-create-video-output-for-target-parameters.md) | TBD |
| [D3DKMDT_MONITOR_DESCRIPTOR structure](ns-d3dkmdt--d3dkmdt-monitor-descriptor.md) | TBD |
...
| [D3DKMDT_GAMMA_RAMP structure](ns-d3dkmdt--d3dkmdt-gamma-ramp.md) | TBD |
| [D3DKMT_QUERYCLOCKCALIBRATION structure](ns-d3dkmdt--d3dkmt-queryclockcalibration.md) | TBD |
...
| [D3DKMDT_VIDPN_PRESENT_PATH structure](ns-d3dkmdt--d3dkmdt-vidpn-present-path.md) | TBD |
...
| [D3DKMDT_COLOR_COEFF_DYNAMIC_RANGES structure](ns-d3dkmdt--d3dkmdt-color-coeff-dynamic-ranges.md) | TBD |
| [D3DKMT_DRIVERCAPS_EXT structure](ns-d3dkmdt--d3dkmt-drivercaps-ext.md) | TBD |
...
| [DXGK_MONITORLINKINFO_CAPABILITIES structure](ns-d3dkmdt--dxgk-monitorlinkinfo-capabilities.md) | TBD |
...
| [D3DKMDT_VIDPN_SOURCE_MODE structure](ns-d3dkmdt--d3dkmdt-vidpn-source-mode.md) | TBD |
...
| [D3DKMDT_2DREGION structure](ns-d3dkmdt--d3dkmdt-2dregion.md) | TBD |
| [DXGK_NODEMETADATA_FLAGS structure](ns-d3dkmdt--dxgk-nodemetadata-flags.md) | TBD |
...
| [D3DKMDT_VIDPN_HW_CAPABILITY structure](ns-d3dkmdt--d3dkmdt-vidpn-hw-capability.md) | TBD |
| [D3DKMDT_VIDEO_PRESENT_TARGET structure](ns-d3dkmdt--d3dkmdt-video-present-target.md) | TBD |
| [DXGK_MONITORLINKINFO_USAGEHINTS structure](ns-d3dkmdt--dxgk-monitorlinkinfo-usagehints.md) | TBD |
| [D3DKMDT_WIRE_FORMAT_AND_PREFERENCE structure](ns-d3dkmdt--d3dkmdt-wire-format-and-preference.md) | TBD |
...
| [D3DKMDT_VIDEO_SIGNAL_INFO structure](ns-d3dkmdt--d3dkmdt-video-signal-info.md) | TBD |
| [D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_SUPPORT structure](ns-d3dkmdt--d3dkmdt-vidpn-present-path-copyprotection-support.md) | TBD |
...
| [DXGK_GPUCLOCKDATA structure](ns-d3dkmdt--dxgk-gpuclockdata.md) | TBD |
| [D3DKMDT_MONITOR_FREQUENCY_RANGE structure](ns-d3dkmdt--d3dkmdt-monitor-frequency-range.md) | TBD |
...
| [D3DKMDT_VIDEO_PRESENT_SOURCE structure](ns-d3dkmdt--d3dkmdt-video-present-source.md) | TBD |
...
| [D3DKMDT_VIDPN_TARGET_MODE structure](ns-d3dkmdt--d3dkmdt-vidpn-target-mode.md) | TBD |
...
| [D3DKMDT_VIRTUALGPUSURFACEDATA structure](ns-d3dkmdt--d3dkmdt-virtualgpusurfacedata.md) | TBD |
...
| [D3DKMDT_MONITOR_SOURCE_MODE structure](ns-d3dkmdt--d3dkmdt-monitor-source-mode.md) | TBD |
Function
