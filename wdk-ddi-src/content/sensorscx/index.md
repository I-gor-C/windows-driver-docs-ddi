...
| [EVT_SENSOR_DRIVER_GET_DATA_FIELD_PROPERTIES](nc-sensorscx-evt_sensor_driver_get_data_field_properties.md) | This callback function returns the properties of a given data field associated with a sensor. |
| [EVT_SENSOR_DRIVER_GET_DATA_INTERVAL](nc-sensorscx-evt_sensor_driver_get_data_interval.md) | This callback function returns the data interval for a specified sensor. |
| [EVT_SENSOR_DRIVER_GET_DATA_THRESHOLDS](nc-sensorscx-evt_sensor_driver_get_data_thresholds.md) | This callback function returns the thresholds that are associated with a sensor. |
| [EVT_SENSOR_DRIVER_GET_PROPERTIES](nc-sensorscx-evt_sensor_driver_get_properties.md) | This callback function returns the properties for a given sensor. |
| [EVT_SENSOR_DRIVER_GET_SUPPORTED_DATA_FIELDS](nc-sensorscx-evt_sensor_driver_get_supported_data_fields.md) | This callback function returns a list of data fields supported by the specified sensor. |
| [EVT_SENSOR_DRIVER_SET_BATCH_LATENCY](nc-sensorscx-evt_sensor_driver_set_batch_latency.md) | This callback function sets the batch latency for a specified sensor. |
| [EVT_SENSOR_DRIVER_SET_DATA_INTERVAL](nc-sensorscx-evt_sensor_driver_set_data_interval.md) | This callback function sets the data interval for a specified sensor. |
| [EVT_SENSOR_DRIVER_SET_DATA_THRESHOLDS](nc-sensorscx-evt_sensor_driver_set_data_thresholds.md) | This callback function handles IOCTLs outside of the class extension. |
| [EVT_SENSOR_DRIVER_START_SENSOR](nc-sensorscx-evt_sensor_driver_start_sensor.md) | This callback function starts the sensor based on the default properties specified by the driver, or properties set by the class extension. |
...
| [EVT_SENSOR_DRIVER_STOP_SENSOR](nc-sensorscx-evt_sensor_driver_stop_sensor.md) | This callback function stops the sensor. |
