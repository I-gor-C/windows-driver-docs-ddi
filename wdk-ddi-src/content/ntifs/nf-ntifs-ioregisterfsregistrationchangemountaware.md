...
```
NTKERNELAPI NTSTATUS IoRegisterFsRegistrationChangeMountAware(
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | The IoRegisterFsRegistrationChangeMountAware routine is available in Windows 7 and later versions of Windows.  |
