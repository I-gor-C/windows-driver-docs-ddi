...
ms.date: 1/9/2018
ms.keywords: ifsk.fsrtlfreeextracreateparameterlist, ntifs/FsRtlFreeExtraCreateParameterList, fsrtlref_909d50be-4f8d-47dc-ad00-03d3f9eb4533.xml, FsRtlFreeExtraCreateParameterList routine [Installable File System Drivers], FsRtlFreeExtraCreateParameterList
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | The FsRtlFreeExtraCreateParameterList routine is available starting with Windows Vista. The FsRtlFreeExtraCreateParameterList routine is available starting with Windows Vista. |
