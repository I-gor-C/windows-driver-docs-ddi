...
<p>For information about how to use ECPs to associate additional information with an <a href="ifsk.irp_mj_create">IRP_MJ_CREATE</a> operation on a file, see <a href="ifsk.using_extra_create_parameters_with_an_irp_mj_create_operation">Using Extra Create Parameters with an IRP_MJ_CREATE Operation</a>. </p>
