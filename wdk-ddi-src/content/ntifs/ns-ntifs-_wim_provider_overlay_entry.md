...
ms.date: 2/7/2018
ms.keywords: WIM_PROVIDER_OVERLAY_ENTRY, ifsk.wim_provider_overlay_entry, WIM_PROVIDER_OVERLAY_ENTRY structure [Installable File System Drivers], WIM_PROVIDER_EXTERNAL_FLAG_NOT_ACTIVE, _WIM_PROVIDER_OVERLAY_ENTRY, WIM_PROVIDER_EXTERNAL_FLAG_SUSPENDED, WIM_BOOT_NOT_OS_WIM, ntifs/PWIM_PROVIDER_OVERLAY_ENTRY, PWIM_PROVIDER_OVERLAY_ENTRY structure pointer [Installable File System Drivers], ntifs/WIM_PROVIDER_OVERLAY_ENTRY, WIM_BOOT_OS_WIM, *PWIM_PROVIDER_OVERLAY_ENTRY, PWIM_PROVIDER_OVERLAY_ENTRY
