...
## -remarks
You can use kernel handles only in kernel mode.  A driver can mark a handle as a kernel handle by specifying the OBJ_KERNEL_HANDLE flag in <a href="kernel.object_attributes">OBJECT_ATTRIBUTES</a> when it creates the handle.
