...
ms.date: 2/7/2018
ms.keywords: FsRtlChangeBackingFileObject routine [Installable File System Drivers], ifsk.fsrtlchangebackingfileobject, ntifs/FsRtlChangeBackingFileObject, FsRtlChangeBackingFileObject, fsrtlref_4dd83ba3-8d9b-4c5b-a4ea-d7a0ceaaa9f2.xml
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | The FsRtlChangeBackingFileObject routine is available starting with Windows Vista. The FsRtlChangeBackingFileObject routine is available starting with Windows Vista. |
