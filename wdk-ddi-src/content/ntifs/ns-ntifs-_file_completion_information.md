...
ms.date: 12/14/2017
ms.keywords: _FILE_COMPLETION_INFORMATION, *PFILE_COMPLETION_INFORMATION, PFILE_COMPLETION_INFORMATION, FILE_COMPLETION_INFORMATION
...
<td width="70%">
This structure is available starting with Windows 8.1. 
