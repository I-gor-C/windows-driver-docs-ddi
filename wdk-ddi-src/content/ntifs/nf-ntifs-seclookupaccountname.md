...
ms.date: 2/7/2018
ms.keywords: SecLookupAccountName, ksecddref_1f4959e5-ea3b-440d-af1b-df05782eefce.xml, SecLookupAccountName function [Installable File System Drivers], ifsk.seclookupaccountname, ntifs/SecLookupAccountName
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | The SecLookupAccountName function is only available on Windows XP and later.  |
