...
Minifilters should call <a href="ifsk.fltcurrentoplock">FltCurrentOplock</a> instead of <b>FsRtlCurrentOplock</b>. 
...
<dl>
<dt>
<a href="ifsk.fltcurrentoplock">FltCurrentOplock</a>
</dt>
<dt>
