...
ms.date: 1/9/2018
ms.keywords: ifsk.fsrtlfindextracreateparameter, FsRtlFindExtraCreateParameter routine [Installable File System Drivers], ntifs/FsRtlFindExtraCreateParameter, FsRtlFindExtraCreateParameter, fsrtlref_3536c7a7-2d3c-4aa5-9a91-5579a8108655.xml
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | The FsRtlFindExtraCreateParameter routine is available starting with Windows Vista. The FsRtlFindExtraCreateParameter routine is available starting with Windows Vista. |
