...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | FsRtlRemoveExtraCreateParameter routine is available starting with Windows Vista. FsRtlRemoveExtraCreateParameter routine is available starting with Windows Vista. |
