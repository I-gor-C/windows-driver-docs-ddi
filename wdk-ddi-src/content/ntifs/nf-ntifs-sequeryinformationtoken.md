...
```
NTKERNELAPI NTSTATUS SeQueryInformationToken(
  PACCESS_TOKEN           Token,
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | This routine is available on Microsoft Windows 2000 and later versions of the operating system.  |
