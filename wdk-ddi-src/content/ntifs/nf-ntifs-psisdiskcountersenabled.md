...
## -remarks
A file system driver uses the <b>PsIsDiskCountersEnabled</b> routine to query the system enabled  state of the disk I/O  counters. A file system driver will use this routine prior to accounting for process disk I/O using <a href="ifsk.psupdatediskcounters">PsUpdateDiskCounters</a>.
...
<dl>
<dt>
<a href="ifsk.psupdatediskcounters">PsUpdateDiskCounters</a>
</dt>
</dl>
 
 
