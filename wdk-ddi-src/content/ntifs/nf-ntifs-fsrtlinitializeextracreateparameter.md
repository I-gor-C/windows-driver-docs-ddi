...
```
NTKERNELAPI VOID FsRtlInitializeExtraCreateParameter(
  PECP_HEADER                                    Ecp,
  ULONG                                          EcpFlags,
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | The FsRtlInitializeExtraCreateParameter routine is available starting with Windows 7.  |
