...
title: FILE_PROVIDER_EXTERNAL_INFO_V1
...
ms.date: 11/14/2017
ms.keywords: FILE_PROVIDER_EXTERNAL_INFO_V1, FILE_PROVIDER_EXTERNAL_INFO_V1, *PFILE_PROVIDER_EXTERNAL_INFO_V1
...
## -description
<p>The <b>FILE_PROVIDER_EXTERNAL_INFO_V1</b> structure defines metadata specific to files provided by WOF_PROVIDER_FILE. This provider gives efficient compression for data which will not be modified, such as executable files.  If the file is opened for write access, the file will be transparently decompressed.</p>
...
<dd>
<p>Specifies flags for the operation. Reserved for future use, should be 0.</p>
</dd>
</dl>
