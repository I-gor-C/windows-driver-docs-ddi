...
ms.date: 1/9/2018
ms.keywords: FsRtlAllocateExtraCreateParameterList, ifsk.fsrtlallocateextracreateparameterlist, fsrtlref_2d552d23-4312-4203-91fb-c6cf6fb39681.xml, FsRtlAllocateExtraCreateParameterList routine [Installable File System Drivers], ntifs/FsRtlAllocateExtraCreateParameterList
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | The FsRtlAllocateExtraCreateParameterList routine is available starting with Windows Vista. The FsRtlAllocateExtraCreateParameterList routine is available starting with Windows Vista. |
