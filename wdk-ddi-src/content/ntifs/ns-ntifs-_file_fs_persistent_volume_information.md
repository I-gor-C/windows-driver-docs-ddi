...
ms.date: 1/9/2018
ms.keywords: PERSISTENT_VOLUME_STATE_BACKED_BY_WIM, FILE_FS_PERSISTENT_VOLUME_INFORMATION structure [Installable File System Drivers], _FILE_FS_PERSISTENT_VOLUME_INFORMATION, *PFILE_FS_PERSISTENT_VOLUME_INFORMATION, PERSISTENT_VOLUME_STATE_NO_HEAT_GATHERING, fileinformationstructures_81dcbc8f-6b7e-455e-b1b2-b99e6fd4084d.xml, PERSISTENT_VOLUME_STATE_VOLUME_SCRUB_DISABLED, ntifs/PFILE_FS_PERSISTENT_VOLUME_INFORMATION, ifsk.file_fs_persistent_volume_information, PERSISTENT_VOLUME_STATE_LOCAL_METADATA_NO_SEEK_PENALTY, PFILE_FS_PERSISTENT_VOLUME_INFORMATION, FILE_FS_PERSISTENT_VOLUME_INFORMATION, ntifs/FILE_FS_PERSISTENT_VOLUME_INFORMATION, PERSISTENT_VOLUME_STATE_CONTAINS_BACKING_WIM, PERSISTENT_VOLUME_STATE_GLOBAL_METADATA_NO_SEEK_PENALTY, PFILE_FS_PERSISTENT_VOLUME_INFORMATION structure pointer [Installable File System Drivers], PERSISTENT_VOLUME_STATE_SHORT_NAME_CREATION_DISABLED
