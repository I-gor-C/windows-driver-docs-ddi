...
ms.date: 2/16/2018
ms.keywords: STORAGE_BUS_RESET_REQUEST structure [Storage Devices], storage.storage_bus_reset_request, ntddstor/STORAGE_BUS_RESET_REQUEST, ntddstor/PSTORAGE_BUS_RESET_REQUEST, PSTORAGE_BUS_RESET_REQUEST, STORAGE_BUS_RESET_REQUEST, *PSTORAGE_BUS_RESET_REQUEST, PSTORAGE_BUS_RESET_REQUEST structure pointer [Storage Devices], _STORAGE_BUS_RESET_REQUEST, structs-general_ffea4f36-cf98-4961-be14-d8a4cde94fad.xml
