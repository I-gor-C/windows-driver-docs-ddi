...
ms.date: 1/10/2018
ms.keywords: STORAGE_OFFLOAD_WRITE_OUTPUT structure [Storage Devices], ntddstor/STORAGE_OFFLOAD_WRITE_OUTPUT, PSTORAGE_OFFLOAD_WRITE_OUTPUT, storage.storage_offload_write_output, ntddstor/PSTORAGE_OFFLOAD_WRITE_OUTPUT, PSTORAGE_OFFLOAD_WRITE_OUTPUT structure pointer [Storage Devices], STORAGE_OFFLOAD_WRITE_OUTPUT, STORAGE_OFFLOAD_WRITE_RANGE_TRUNCATED, _STORAGE_OFFLOAD_WRITE_OUTPUT, *PSTORAGE_OFFLOAD_WRITE_OUTPUT, STORAGE_OFFLOAD_TOKEN_INVALID
