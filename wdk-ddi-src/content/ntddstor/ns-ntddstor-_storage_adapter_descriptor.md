...
typedef struct _STORAGE_ADAPTER_DESCRIPTOR {
  ...
  __WRAPPED__ ULONG   MaximumTransferLength;
  __WRAPPED__ ULONG   MaximumPhysicalPages;
  __WRAPPED__ ULONG   AlignmentMask;
  __WRAPPED__ BOOLEAN AdapterUsesPio;
  __WRAPPED__ BOOLEAN AdapterScansDown;
  __WRAPPED__ BOOLEAN CommandQueueing;
  __WRAPPED__ BOOLEAN AcceleratedTransfer;
  BOOLEAN             BusType;
  __WRAPPED__ UCHAR   BusType;
  __WRAPPED__ USHORT  BusMajorVersion;
  __WRAPPED__ USHORT  BusMinorVersion;
  __WRAPPED__ UCHAR   SrbType;
  __WRAPPED__ UCHAR   AddressType;
