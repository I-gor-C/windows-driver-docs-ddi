...
<b>Parameters.DeviceIoControl.OutputBufferLength</b> in the I/O stack location indicates the size, in bytes, of the parameter buffer, which must be &gt;= <b>sizeof</b>(<a href="storage.storage_temperature_threshold">STORAGE_TEMPERATURE_THRESHOLD</a>). 
<b>Parameters.DeviceIoControl.OutputBufferLength</b>Parameters.DeviceIoControl.OutputBufferLength in the I/O stack location indicates the size, in bytes, of the parameter buffer, which must be >= <b>sizeof</b>sizeof(<a href="storage.storage_temperature_threshold">STORAGE_TEMPERATURE_THRESHOLD</a><b>STORAGE_TEMPERATURE_THRESHOLD</b>STORAGE_TEMPERATURE_THRESHOLD). 
...
This IOCTL has no output structure.</p>This IOCTL has no output structure.
