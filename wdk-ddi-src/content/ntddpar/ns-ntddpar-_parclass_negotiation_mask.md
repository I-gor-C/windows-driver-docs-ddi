...
ms.date: 12/14/2017
ms.keywords: PARCLASS_NEGOTIATION_MASK, PPARCLASS_NEGOTIATION_MASK, PARCLASS_NEGOTIATION_MASK structure [Parallel Ports], _PARCLASS_NEGOTIATION_MASK, ntddpar/PARCLASS_NEGOTIATION_MASK, ntddpar/PPARCLASS_NEGOTIATION_MASK, PPARCLASS_NEGOTIATION_MASK structure pointer [Parallel Ports], cisspd_8afca893-6736-49a8-a2bd-efb3d97bb63d.xml, *PPARCLASS_NEGOTIATION_MASK, parports.parclass_negotiation_mask
