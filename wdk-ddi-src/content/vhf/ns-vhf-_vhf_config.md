...
ms.date: 2/15/2018
ms.keywords: PVHF_CONFIG structure pointer [Human Input Devices], vhf/PVHF_CONFIG, VHF_CONFIG, _VHF_CONFIG, VHF_CONFIG structure [Human Input Devices], PVHF_CONFIG, *PVHF_CONFIG, hid.vhf_config, vhf/VHF_CONFIG
