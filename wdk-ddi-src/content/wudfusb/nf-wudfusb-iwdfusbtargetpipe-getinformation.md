...
## -remarks
<p>After a UMDF driver calls the <a href="wdf.iwdfusbinterface_retrieveusbpipeobject">IWDFUsbInterface::RetrieveUsbPipeObject</a> method to retrieve a USB pipe object, the UMDF driver should retrieve information about the USB pipe. Therefore, the <b>GetInformation</b> method does not fail.</p>
