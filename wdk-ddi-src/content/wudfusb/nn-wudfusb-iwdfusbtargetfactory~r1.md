...
The <a href="wdf.iwdfusbtargetfactory_createusbtargetdevice">CreateUsbTargetDevice</a> method creates a USB device object that is also an I/O target.
...
</table>The <a href="wdf.iwdfusbtargetfactory_createusbtargetdevice">CreateUsbTargetDevice</a> method creates a USB device object that is also an I/O target.
