...
## -inheritance
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IUsbTargetPipeContinuousReaderCallbackReadComplete</b> interface inherits from the <a href="com.iunknown" xmlns:loc="http://microsoft.com/wdcml/l10n"><b>IUnknown</b></a> interface. <b>IUsbTargetPipeContinuousReaderCallbackReadComplete</b> also has these types of members:

The <b>IUsbTargetPipeContinuousReaderCallbackReadComplete</b> interface has these methods.

A driver's <a href="wdf.iusbtargetpipecontinuousreadercallbackreadcomplete_onreadercompletion">OnReaderCompletion</a> event callback function informs the driver that a continuous reader has successfully completed a read request.
...
</table>A driver's <a href="wdf.iusbtargetpipecontinuousreadercallbackreadcomplete_onreadercompletion">OnReaderCompletion</a> event callback function informs the driver that a continuous reader has successfully completed a read request.
