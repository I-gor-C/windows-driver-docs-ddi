...
ms.date: 12/15/2017
ms.keywords: IWDFDevice, IWDFDevice::CommitPnpState, CommitPnpState
...
The <b>CommitPnpState</b> method commits the state of the Plug and Play (PnP) property (that is, turns on, turns off, or sets to the default state) that the <a href="wdf.iwdfdevice_setpnpstate">IWDFDevice::SetPnpState</a> method set.
...
## -remarks
The values of the <a href="wdf.wdf_pnp_state">WDF_PNP_STATE</a> enumeration identify the state of PnP for the device.

For a code example of how to use the <b>CommitPnpState</b> method, see <a href="wdf.iwdfdevice_setpnpstate">IWDFDevice::SetPnpState</a>.
...
<dt>
<a href="wdf.wdf_pnp_state">WDF_PNP_STATE</a>
</dt>
</dl>
 
