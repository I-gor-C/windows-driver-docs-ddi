...
A driver registers the <b>IFileCallbackCleanup</b> interface when it calls the <a href="wdf.iwdfdriver_createdevice">IWDFDriver::CreateDevice</a> method to create a device object. 
...
The <a href="wdf.ifilecallbackcleanup_oncleanupfile">OnCleanupFile</a> method cancels all I/O requests that a driver has pending in the framework queue. 
...
</table>The <a href="wdf.ifilecallbackcleanup_oncleanupfile">OnCleanupFile</a> method cancels all I/O requests that a driver has pending in the framework queue. 
