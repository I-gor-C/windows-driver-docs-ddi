...
## -returns
<b>GetEffectiveIoType</b> returns a <a href="wdf.wdf_device_io_type__umdf_">WDF_DEVICE_IO_TYPE</a>-typed value that identifies the buffer access method that UMDF is using for the I/O request's data buffers. 
...
The following code example shows how an <a href="wdf.iqueuecallbackwrite_onwrite">IQueueCallbackWrite::OnWrite</a> callback function can obtain the buffer access method of an I/O request. 
