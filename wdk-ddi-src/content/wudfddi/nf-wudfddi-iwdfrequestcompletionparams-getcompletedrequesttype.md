...
## -returns
<b>GetCompletedRequestType</b> returns a <a href="wdf.wdf_request_type__umdf_">WDF_REQUEST_TYPE</a>-typed value that identifies the request type and why the request was sent to the driver.
