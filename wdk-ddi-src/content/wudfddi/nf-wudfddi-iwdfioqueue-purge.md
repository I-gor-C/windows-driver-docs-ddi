...
For example, if the driver previously called <b>Purge</b>, it should wait for notification from the method of the interface that the <i>pPurgeComplete</i> parameter points to before it calls either <a href="wdf.iwdfioqueue_stop">Stop</a> or <a href="wdf.iwdfioqueue_drain">Drain</a>. Violating this rule results in termination of the host process.
