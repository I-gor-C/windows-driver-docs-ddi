...
## -inheritance
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IWDFUnifiedPropertyStore</b> interface inherits from the <a href="com.iunknown" xmlns:loc="http://microsoft.com/wdcml/l10n"><b>IUnknown</b></a> interface. <b>IWDFUnifiedPropertyStore</b> also has these types of members:

The <b>IWDFUnifiedPropertyStore</b> interface has these methods.

The <a href="wdf.iwdfunifiedpropertystore_getpropertydata">GetPropertyData</a> method retrieves the current setting for a device property.


The <a href="wdf.iwdfunifiedpropertystore_setpropertydata">SetPropertyData</a> method modifies the current setting of a device property.
...
</table>The <a href="wdf.iwdfunifiedpropertystore_getpropertydata">GetPropertyData</a> method retrieves the current setting for a device property.
