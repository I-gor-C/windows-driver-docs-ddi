...
ms.date: 11/28/2017
ms.keywords: IWDFIoQueue, Start, IWDFIoQueue::Start
...
<p>The <b>Start</b> method enables an I/O queue to start receiving new I/O requests and delivering them to a driver.</p>
