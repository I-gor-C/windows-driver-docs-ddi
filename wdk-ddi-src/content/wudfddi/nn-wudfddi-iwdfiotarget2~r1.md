...
</table><p>The <a href="wdf.iwdfiotarget2_formatrequestforflush">FormatRequestForFlush</a> method builds an I/O request for a flush operation but does not send the request to an I/O target.</p>
