...
</table><p>A UMDF-based driver's <a href="wdf.iremoteinterfacecallbackremoval_onremoteinterfaceremoval">OnRemoteInterfaceRemoval</a> event callback function notifies the driver that it cannot use a <a href="wdf.using_device_interfaces_in_umdf_drivers">device interface</a> because the interface has been removed.</p>
