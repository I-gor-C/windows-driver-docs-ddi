...
A UMDF-based driver's <a href="https://msdn.microsoft.com/0dfa2eb8-a7f6-46d9-9599-5e2aaf583f78">OnRemoteInterfaceRemoval</a> event callback function notifies the driver that it cannot use a <a href="wdf.using_device_interfaces_in_umdf_drivers">device interface</a> because the interface has been removed.
...
</table>A UMDF-based driver's <a href="https://msdn.microsoft.com/0dfa2eb8-a7f6-46d9-9599-5e2aaf583f78">OnRemoteInterfaceRemoval</a> event callback function notifies the driver that it cannot use a <a href="wdf.using_device_interfaces_in_umdf_drivers">device interface</a> because the interface has been removed.
