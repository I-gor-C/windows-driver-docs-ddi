...
<p>A driver calls <b>GetHardwareRegisterMappedAddress</b> to get the user-mode mapped address of the memory resource it earlier mapped using <a href="wdf.iwdfdevice3_mapiospace">MapIoSpace</a>.</p>
...
## -returns
<p>User-mode base address of the resources mapped earlier using <a href="wdf.iwdfdevice3_mapiospace">MapIoSpace</a>.</p>
