...
</table><p>The <a href="wdf.ipnpcallbackselfmanagedio_onselfmanagediocleanup">OnSelfManagedIoCleanup</a> method releases memory for a device's self-managed I/O operations, after the device is removed.</p>
