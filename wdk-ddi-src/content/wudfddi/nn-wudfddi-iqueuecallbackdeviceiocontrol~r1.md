---
UID: NN.wudfddi.IQueueCallbackDeviceIoControl~r1
...
</table><p>The <a href="wdf.iqueuecallbackdeviceiocontrol_ondeviceiocontrol">OnDeviceIoControl</a> method is called to handle a device I/O control request when an application performs a specific operation on a device through the Microsoft Win32 <b>OnDeviceIoControl</b> function. </p>
