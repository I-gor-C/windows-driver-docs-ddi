...
<p>A driver registers the <b>IQueueCallbackIoResume</b> interface when the driver calls the <a href="wdf.iwdfdevice_createioqueue">IWDFDevice::CreateIoQueue</a> method to create an I/O queue or to configure the default I/O queue. </p>
...
<p>The <a href="wdf.iqueuecallbackioresume_onioresume">OnIoResume</a> method resumes the processing of the specified I/O request from the specified queue. </p>
...
</table><p>The <a href="wdf.iqueuecallbackioresume_onioresume">OnIoResume</a> method resumes the processing of the specified I/O request from the specified queue. </p>
