---
UID: NN.wudfddi.IObjectCleanup~r1
...
<p>The <a href="wdf.iobjectcleanup_oncleanup">OnCleanup</a> method releases any references to a WDF object to prevent interface leakage.</p>
...
</table><p>The <a href="wdf.iobjectcleanup_oncleanup">OnCleanup</a> method releases any references to a WDF object to prevent interface leakage.</p>
