...
For more information, see <a href="wdf.power_policy_ownership_in_umdf">Power Policy Ownership in UMDF</a>.

For a code example of how to use the <b>SetPowerPolicyOwnership</b> method, see <a href="wdf.iwdfdriver_createdevice">IWDFDriver::CreateDevice</a>.
