...
ms.date: 12/15/2017
ms.keywords: IWDFIoTargetStateManagement, IWDFIoTargetStateManagement::GetState, GetState
...
req.kmdf-ver: 
req.umdf-ver: 1.5
req.alt-api: IWDFIoTargetStateManagement.GetState
...
The <b>GetState</b> method returns the current state of a <a href="wdf.general_i_o_targets_in_umdf">local  I/O target</a>.
...
## -returns
<b>GetState</b> returns a <a href="wdf.wdf_io_target_state">WDF_IO_TARGET_STATE</a>-typed value that identifies the state of the I/O target.
...
## -remarks
For more information about <b>GetState</b>, see <a href="wdf.controlling_a_general_i_o_target_s_state_in_umdf">Controlling a General I/O Target's State</a>. 
