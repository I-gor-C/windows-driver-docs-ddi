...
The following code example shows how to create a device interface instance. In this example, the driver explicitly calls <a href="wdf.iwdfdevice_assigndeviceinterfacestate">IWDFDevice::AssignDeviceInterfaceState</a> to enable the interface.
