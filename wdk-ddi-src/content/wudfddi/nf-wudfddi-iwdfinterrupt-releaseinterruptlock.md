...
ms.date: 11/30/2017
ms.keywords: IWDFInterrupt, ReleaseInterruptLock, IWDFInterrupt::ReleaseInterruptLock
...
<p>The <b>ReleaseInterruptLock</b> method ends a code sequence that executes while holding an interrupt object's lock.</p>
