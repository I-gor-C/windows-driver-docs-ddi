...
ms.date : 12/14/2017
ms.keywords : IKeywordDetectorOemAdapter, GetCapabilities method [Audio Devices], IKeywordDetectorOemAdapter interface, IKeywordDetectorOemAdapter interface [Audio Devices], GetCapabilities method, GetCapabilities, IKeywordDetectorOemAdapter::GetCapabilities, GetCapabilities method [Audio Devices], audio.ikeyworddetectoroemadapter_getcapabilities, keyworddetectoroemadapter/IKeywordDetectorOemAdapter::GetCapabilities
