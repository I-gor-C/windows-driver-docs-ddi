...
title: ScsiPortWritePortBufferUchar
...
## -description
<p>The <b>ScsiPortWritePortBufferUchar</b> routine transfers a given number of unsigned bytes from a buffer to the HBA.</p>
