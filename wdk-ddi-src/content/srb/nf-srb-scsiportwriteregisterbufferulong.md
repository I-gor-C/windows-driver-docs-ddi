...
title: ScsiPortWriteRegisterBufferUlong
...
## -description
<p>The <b>ScsiPortWriteRegisterBufferUlong</b> routine transfers a given number of ULONG values from a buffer to the HBA.</p>
