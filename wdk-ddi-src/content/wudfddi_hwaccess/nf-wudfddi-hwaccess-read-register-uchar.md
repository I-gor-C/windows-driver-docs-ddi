...
<p>The <b>READ_REGISTER_UCHAR</b> function reads a byte from the specified register address.</p>
...
## -returns
<p><b>READ_REGISTER_UCHAR</b> returns the byte that is read from the specified port address.</p>
