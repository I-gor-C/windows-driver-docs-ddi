...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: pfnStateCsShaderCb
...
## -description
<p>The <b>pfnStateCsShaderCb</b> function causes the Microsoft Direct3D 11 runtime to refresh the compute shader.</p>
...
<td width="70%">
<p>pfnStateCsShaderCb is supported beginning with the Windows 7 operating system. </p>
</td>
</tr>
<tr>
<th width="30%">
