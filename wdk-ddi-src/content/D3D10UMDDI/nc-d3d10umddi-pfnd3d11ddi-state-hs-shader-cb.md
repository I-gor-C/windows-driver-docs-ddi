...
## -description
<p>The <b>pfnStateHsShaderCb</b> function causes the Microsoft Direct3D 11 runtime to refresh the hull shader.</p>
...
<td width="70%">
<p>pfnStateHsShaderCb is supported beginning with the Windows 7 operating system. </p>
</td>
</tr>
<tr>
<th width="30%">
