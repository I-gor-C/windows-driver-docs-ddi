...
<div class="alert"><b>Note</b>    The Direct3D runtime can call the driver's <a href="https://msdn.microsoft.com/78ee9813-e23e-4d46-acc4-f2fa88559b03">QueryGetData</a> function at any time to request this statistic data. Therefore, it must be continually calculated accurately.  </div>
<div> </div>
<p>Only the difference between two independent statistic requests will provide meaningful information. The driver should calculate the difference between the statistic data that it receives when a call to its <a href="https://msdn.microsoft.com/2f0a7462-83a6-47df-b5f6-b3706b875349">QueryBegin</a> function occurs and the statistic data that it receives when a call to its <a href="https://msdn.microsoft.com/5a231d7e-7e47-40ad-99d1-82661dec41d0">QueryEnd</a> function occurs. </p>
...
<dd>
<p>Supported in Windows 7 and later versions.</p>
<p>The data that the driver associates with this query type is a <a href="https://msdn.microsoft.com/library/windows/hardware/ff541976">D3D10_DDI_QUERY_DATA_SO_STATISTICS</a> structure. </p>
</dd>
...
### -field <a id="D3D11DDI_QUERY_STREAMOUTPUTSTATS_STREAM2"></a><a id="d3d11ddi_query_streamoutputstats_stream2"></a><b>D3D11DDI_QUERY_STREAMOUTPUTSTATS_STREAM2</b>
...
### -field <a id="D3D11DDI_QUERY_STREAMOVERFLOWPREDICATE_STREAM2"></a><a id="d3d11ddi_query_streamoverflowpredicate_stream2"></a><b>D3D11DDI_QUERY_STREAMOVERFLOWPREDICATE_STREAM2</b>
...
### -field <a id="D3D10DDI_COUNTER_TRISETUP_THROUGHPUT_UTILIZATION"></a><a id="d3d10ddi_counter_trisetup_throughput_utilization"></a><b>D3D10DDI_COUNTER_TRISETUP_THROUGHPUT_UTILIZATION</b>
...
### -field <a id="D3D10DDI_COUNTER_GEOMETRYSHADER_COMPUTATION_LIMITED"></a><a id="d3d10ddi_counter_geometryshader_computation_limited"></a><b>D3D10DDI_COUNTER_GEOMETRYSHADER_COMPUTATION_LIMITED</b>
...
<dt>
<a href="https://msdn.microsoft.com/library/windows/hardware/ff541972">D3D10_DDI_QUERY_DATA_PIPELINE_STATISTICS</a>
</dt>
<dt>
<a href="https://msdn.microsoft.com/library/windows/hardware/ff541976">D3D10_DDI_QUERY_DATA_SO_STATISTICS</a>
</dt>
<dt>
<a href="https://msdn.microsoft.com/library/windows/hardware/ff541984">D3D10_DDI_QUERY_DATA_TIMESTAMP_DISJOINT</a>
</dt>
<dt>
...
<p> </p>
<p> </p>
<p><a href="mailto:wsddocfb@microsoft.com?subject=Documentation%20feedback [display\display]:%20D3D10DDI_QUERY enumeration%20 RELEASE:%20(10/25/2017)&amp;body=%0A%0APRIVACY STATEMENT%0A%0AWe use your feedback to improve the documentation. We don't use your email address for any other purpose, and we'll remove your email address from our system after the issue that you're reporting is fixed. While we're working to fix this issue, we might send you an email message to ask for more info. Later, we might also send you an email message to let you know that we've addressed your feedback.%0A%0AFor more info about Microsoft's privacy policy, see http://privacy.microsoft.com/en-us/default.aspx." title="Send comments about this topic to Microsoft">Send comments about this topic to Microsoft</a></p>
