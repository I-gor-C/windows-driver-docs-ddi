...
## -description
The <b>ScsiPortWmiSetData</b> routine updates the <a href="kernel.wnode_all_data">WNODE_ALL_DATA</a> structure within the request context to specify the position and length of the data for an instance. 
...
<a href="storage.scsiportwmisetinstancename">ScsiPortWmiSetInstanceName</a>
...
## -remarks
The minidriver must call <a href="storage.scsiportwmisetinstancecount">ScsiPortWmiSetInstanceCount</a> before calling <b>ScsiPortWmiSetData</b>.
