...
## -description
<p>The <b>ScsiPortWmiSetData</b> routine updates the <a href="https://msdn.microsoft.com/library/windows/hardware/ff566372">WNODE_ALL_DATA</a> structure within the request context to specify the position and length of the data for an instance. </p>
...
## -remarks
<p>The minidriver must call <a href="https://msdn.microsoft.com/library/windows/hardware/ff564806">ScsiPortWmiSetInstanceCount</a> before calling <b>ScsiPortWmiSetData</b>.</p>
