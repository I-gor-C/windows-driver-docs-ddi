...
When the <b>DeviceloControl</b> function is called with the IOCTL_WRITE_REGISTERS I/O control code, the caller must specify the address of an <a href="image.io_block">IO_BLOCK</a> structure as the function's <i>lpInBuffer</i> parameter.
