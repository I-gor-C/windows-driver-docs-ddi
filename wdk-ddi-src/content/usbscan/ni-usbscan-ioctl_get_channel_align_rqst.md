...
### -output-buffer
Pointer to a <a href="image.channel_info">CHANNEL_INFO</a> structure.
...
When the <b>DeviceloControl</b> function is called with the IOCTL_GET_CHANNEL_ALIGN_RQST I/O control code, the caller must specify the address of a <a href="image.channel_info">CHANNEL_INFO</a> structure as the function's <i>lpOutBuffer</i> parameter. The kernel-mode driver fills in the structure.
