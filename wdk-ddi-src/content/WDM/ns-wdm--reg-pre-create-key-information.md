...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: REG_PRE_OPEN_KEY_INFORMATION
req.alt-loc: Wdm.h
req.ddi-compliance: 
req.unicode-ansi: 
req.idl: 
...
## -description
<p>The <b>REG_PRE_OPEN_KEY_INFORMATION</b> structure contains the name of a registry key that is about to be opened.</p>
