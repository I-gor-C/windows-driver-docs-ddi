...
<p>Drivers can also use the <a href="https://msdn.microsoft.com/library/windows/hardware/ff550495">IoWMISetSingleItem</a> routine to update a single property within the class instance.</p>
