...
ms.date: 2/20/2018
ms.keywords: display.idarg_out_querytargetmodes, iddcx/IDARG_OUT_QUERYTARGETMODES, IDARG_OUT_QUERYTARGETMODES, IDARG_OUT_QUERYTARGETMODES structure [Display Devices]
