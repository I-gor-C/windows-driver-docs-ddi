...
ms.date: 12/29/2017
ms.keywords: IDARG_OUT_QUERYTARGETMODES structure [Display Devices], IDARG_OUT_QUERYTARGETMODES, display.idarg_out_querytargetmodes, iddcx/IDARG_OUT_QUERYTARGETMODES
