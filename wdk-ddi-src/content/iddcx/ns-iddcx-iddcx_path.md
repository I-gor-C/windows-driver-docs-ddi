...
ms.date: 12/29/2017
ms.keywords: display.iddcx_path, iddcx/IDDCX_PATH, IDDCX_PATH structure structure [Display Devices], IDDCX_PATH structure [Display Devices], IDDCX_PATH, IDDCX_PATH structure, IDDCX_PATH structure pointer [Display Devices]
