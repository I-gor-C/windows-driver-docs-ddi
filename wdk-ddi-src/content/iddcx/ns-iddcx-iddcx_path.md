...
ms.date: 12/29/2017
ms.keywords: IDDCX_PATH, IDDCX_PATH structure pointer [Display Devices], IDDCX_PATH structure structure [Display Devices], display.iddcx_path, IDDCX_PATH structure, IDDCX_PATH structure [Display Devices], iddcx/IDDCX_PATH
