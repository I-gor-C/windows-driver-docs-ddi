...
ms.date: 12/29/2017
ms.keywords: IDARG_IN_OPM_GET_CERTIFICATE, display.idarg_in_opm_get_certificate, IDARG_IN_OPM_GET_CERTIFICATE structure [Display Devices], iddcx/IDARG_IN_OPM_GET_CERTIFICATE
