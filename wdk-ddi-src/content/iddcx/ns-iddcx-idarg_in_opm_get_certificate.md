...
ms.date : 12/29/2017
ms.keywords : IDARG_IN_OPM_GET_CERTIFICATE structure [Display Devices], IDARG_IN_OPM_GET_CERTIFICATE, display.idarg_in_opm_get_certificate, iddcx/IDARG_IN_OPM_GET_CERTIFICATE
