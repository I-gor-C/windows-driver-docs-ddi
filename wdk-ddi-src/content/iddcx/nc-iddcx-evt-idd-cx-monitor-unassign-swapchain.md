...
## -description
<p><b>EVT_IDD_CX_MONITOR_UNASSIGN_SWAPCHAIN</b> is called by the OS to inform the driver that a swapchain associated with a monitor is not valid anymore.</p>
...
<p>
                ...
                A handle by the OS to identify the monitor that has an invalid associated swapchain.</p>
</dd>
</dl>
