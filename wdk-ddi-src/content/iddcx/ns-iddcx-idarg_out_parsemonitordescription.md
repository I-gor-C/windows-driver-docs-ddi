...
ms.date: 12/29/2017
ms.keywords: IDARG_OUT_PARSEMONITORDESCRIPTION, IDARG_OUT_PARSEMONITORDESCRIPTION structure [Display Devices], iddcx/IDARG_OUT_PARSEMONITORDESCRIPTION, display.idarg_out_parsemonitordescription
