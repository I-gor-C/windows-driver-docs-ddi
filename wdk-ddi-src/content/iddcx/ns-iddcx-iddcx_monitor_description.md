...
ms.date: 12/29/2017
ms.keywords: IDDCX_MONITOR_DESCRIPTION structure [Display Devices], iddcx/IDDCX_MONITOR_DESCRIPTION, IDDCX_MONITOR_DESCRIPTION, display.iddcx_monitor_description
