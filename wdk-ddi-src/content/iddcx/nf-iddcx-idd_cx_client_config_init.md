...
ms.date: 2/20/2018
ms.keywords: IDD_CX_CLIENT_CONFIG_INIT method [Display Devices], iddcx/IDD_CX_CLIENT_CONFIG_INIT, display.idd_cx_client_config_init, IDD_CX_CLIENT_CONFIG_INIT
