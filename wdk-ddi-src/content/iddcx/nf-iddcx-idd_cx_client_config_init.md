...
ms.date : 12/29/2017
ms.keywords : IDD_CX_CLIENT_CONFIG_INIT method [Display Devices], display.idd_cx_client_config_init, IDD_CX_CLIENT_CONFIG_INIT, iddcx/IDD_CX_CLIENT_CONFIG_INIT
