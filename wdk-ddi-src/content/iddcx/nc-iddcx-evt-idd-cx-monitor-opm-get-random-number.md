...
## -description
<p><b>EVT_IDD_CX_MONITOR_OPM_GET_RANDOM_NUMBER</b> is called by the OS to get an OPM random number.</p>
...
<p>
                ...
                The object for the OPM context that a random number will be gotten from.</p>
</dd>
...
<p>
                ...
                Output arguments returned by <b>EVT_IDD_CX_MONITOR_OPM_GET_RANDOM_NUMBER</b>.</p>
</dd>
</dl>
