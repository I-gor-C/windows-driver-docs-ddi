...
ms.date: 12/29/2017
ms.keywords: IDDCX_METADATA structure, iddcx/IDDCX_METADATA, IDDCX_METADATA structure [Display Devices], IDDCX_METADATA structure pointer [Display Devices], IDDCX_METADATA structure structure [Display Devices], IDDCX_METADATA, display.iddcx_metadata
