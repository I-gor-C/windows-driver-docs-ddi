...
ms.date: 2/20/2018
ms.keywords: IDDCX_OPM_REQUESTED_INFORMATION structure [Display Devices], iddcx/IDDCX_OPM_REQUESTED_INFORMATION, IDDCX_OPM_REQUESTED_INFORMATION, display.iddcx_opm_requested_information
