...
ms.date: 12/29/2017
ms.keywords: IDDCX_OPM_REQUESTED_INFORMATION structure [Display Devices], IDDCX_OPM_REQUESTED_INFORMATION, display.iddcx_opm_requested_information, iddcx/IDDCX_OPM_REQUESTED_INFORMATION
