...
ms.date: 12/29/2017
ms.keywords: iddcx/IDDCX_FRAME_STATUS_UNINITIALIZED, iddcx/IDDCX_FRAME_STATUS_ERROR, display.iddcx_frame_status, iddcx/IDDCX_FRAME_STATUS, IDDCX_FRAME_STATUS enumeration [Display Devices], IDDCX_FRAME_STATUS_UNINITIALIZED, IDDCX_FRAME_STATUS_DROPPED, iddcx/IDDCX_FRAME_STATUS_DROPPED, IDDCX_FRAME_STATUS_ERROR, IDDCX_FRAME_STATUS, IDDCX_FRAME_STATUS_COMPLETED, iddcx/IDDCX_FRAME_STATUS_COMPLETED
