...
ms.date: 12/29/2017
ms.keywords: IDDCX_FRAME_STATUS enumeration [Display Devices], iddcx/IDDCX_FRAME_STATUS_ERROR, IDDCX_FRAME_STATUS_COMPLETED, IDDCX_FRAME_STATUS_UNINITIALIZED, iddcx/IDDCX_FRAME_STATUS_DROPPED, iddcx/IDDCX_FRAME_STATUS_UNINITIALIZED, IDDCX_FRAME_STATUS_ERROR, iddcx/IDDCX_FRAME_STATUS_COMPLETED, display.iddcx_frame_status, IDDCX_FRAME_STATUS_DROPPED, iddcx/IDDCX_FRAME_STATUS, IDDCX_FRAME_STATUS
