...
ms.date: 12/29/2017
ms.keywords: display.idarg_in_opm_create_protected_output, IDARG_IN_OPM_CREATE_PROTECTED_OUTPUT structure [Display Devices], iddcx/IDARG_IN_OPM_CREATE_PROTECTED_OUTPUT, IDARG_IN_OPM_CREATE_PROTECTED_OUTPUT
