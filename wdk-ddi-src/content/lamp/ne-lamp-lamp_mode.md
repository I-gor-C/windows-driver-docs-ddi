...
ms.date: 2/20/2018
ms.keywords: LAMP_MODE_WHITE, lamp/LAMP_MODE, lamp/LAMP_MODE_COLOR, LAMP_MODE_COLOR, stream.lamp_mode, lamp/LAMP_MODE_WHITE, LAMP_MODE enumeration [Streaming Media Devices], LAMP_MODE
