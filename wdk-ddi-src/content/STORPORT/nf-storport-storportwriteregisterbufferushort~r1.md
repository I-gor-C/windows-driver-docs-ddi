...
title: StorPortWriteRegisterBufferUshort
...
## -description
<p>The <b>StorPortWriteRegisterBufferUshort</b> routine transfers a given number of USHORT values from a buffer to the HBA.</p>
