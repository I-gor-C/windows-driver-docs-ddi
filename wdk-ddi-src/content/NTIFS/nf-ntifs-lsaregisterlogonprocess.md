---
UID: NF.ntifs.LsaRegisterLogonProcess
title: LsaRegisterLogonProcess
author: windows-driver-content
description: 
ms.assetid: 3f833980-90f4-44cf-b919-d130e2eaf874
ms.author: windowsdriverdev
ms.date: 
ms.topic: function
ms.prod: windows-hardware
ms.technology: windows-devices
ms.keywords: LsaRegisterLogonProcess
req.iface: 
req.header: ntifs.h
req.include-header:
req.target-type:
