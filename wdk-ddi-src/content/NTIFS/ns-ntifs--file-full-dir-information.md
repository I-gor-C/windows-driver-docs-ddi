...
title: FILE_FULL_DIR_INFORMATION
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: FILE_FULL_DIR_INFORMATION
req.alt-loc: ntifs.h
req.ddi-compliance: 
req.unicode-ansi: 
req.idl: 
...
req.dll: 
req.irql: 
ms.keywords: FILE_FULL_DIR_INFORMATION, FILE_FULL_DIR_INFORMATION, *PFILE_FULL_DIR_INFORMATION
req.iface: 
---
...
## -description
<p>The FILE_FULL_DIR_INFORMATION structure is used to query detailed information for the files in a directory. </p>
...
<dd>
<p>Byte offset of the next FILE_FULL_DIR_INFORMATION entry, if multiple entries are present in a buffer. This member is zero if no other entries follow this one. </p>
</dd>
