---
UID: NF.ntifs.IoGetFsZeroingOffset~r1
title: IoGetFsZeroingOffset
author: windows-driver-content
description: 
ms.assetid: 83a66303-a05d-42d0-a588-5f4eca3edf40
ms.author: windowsdriverdev
ms.date: 
ms.topic: function
ms.prod: windows-hardware
ms.technology: windows-devices
ms.keywords: IoGetFsZeroingOffset
req.iface: 
req.header: ntifs.h
req.include-header:
req.target-type:
