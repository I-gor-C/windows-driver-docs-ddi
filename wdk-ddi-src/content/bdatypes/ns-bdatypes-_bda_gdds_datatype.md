...
ms.date: 2/20/2018
ms.keywords: BDA_GDDS_DATATYPE, bdatypes/P_BDA_GDDS_DATATYPE, bdatypes/BDA_GDDS_DATATYPE, stream.bda_gdds_datatype, BDA_GDDS_DATATYPE structure [Streaming Media Devices], P_BDA_GDDS_DATATYPE, *P_BDA_GDDS_DATATYPE, _BDA_GDDS_DATATYPE, P_BDA_GDDS_DATATYPE structure pointer [Streaming Media Devices]
