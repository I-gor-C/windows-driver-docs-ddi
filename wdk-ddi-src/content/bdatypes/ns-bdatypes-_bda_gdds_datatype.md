...
ms.date: 1/9/2018
ms.keywords: bdatypes/P_BDA_GDDS_DATATYPE, bdatypes/BDA_GDDS_DATATYPE, *P_BDA_GDDS_DATATYPE, BDA_GDDS_DATATYPE structure [Streaming Media Devices], P_BDA_GDDS_DATATYPE, stream.bda_gdds_datatype, P_BDA_GDDS_DATATYPE structure pointer [Streaming Media Devices], _BDA_GDDS_DATATYPE, BDA_GDDS_DATATYPE
