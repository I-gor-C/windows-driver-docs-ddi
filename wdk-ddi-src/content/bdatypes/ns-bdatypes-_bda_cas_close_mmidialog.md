...
ms.date: 1/9/2018
ms.keywords: stream.bda_cas_close_mmidialog, PBDA_CAS_CLOSE_MMIDIALOG structure pointer [Streaming Media Devices], *PBDA_CAS_CLOSE_MMIDIALOG, bdatypes/BDA_CAS_CLOSE_MMIDIALOG, PBDA_CAS_CLOSE_MMIDIALOG, _BDA_CAS_CLOSE_MMIDIALOG, bdatypes/PBDA_CAS_CLOSE_MMIDIALOG, BDA_CAS_CLOSE_MMIDIALOG, BDA_CAS_CLOSE_MMIDIALOG structure [Streaming Media Devices]
