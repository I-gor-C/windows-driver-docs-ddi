...
ms.date: 2/20/2018
ms.keywords: PBDA_RATING_PINRESET structure pointer [Streaming Media Devices], stream.bda_rating_pinreset, bdatypes/PBDA_RATING_PINRESET, bdatypes/BDA_RATING_PINRESET, *PBDA_RATING_PINRESET, PBDA_RATING_PINRESET, BDA_RATING_PINRESET structure [Streaming Media Devices], BDA_RATING_PINRESET, _BDA_RATING_PINRESET
