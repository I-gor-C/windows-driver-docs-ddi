...
ms.date: 1/9/2018
ms.keywords: bdatypes/BDA_ETHERNET_ADDRESS_LIST, _BDA_ETHERNET_ADDRESS_LIST, BDA_ETHERNET_ADDRESS_LIST, BDA_ETHERNET_ADDRESS_LIST structure [Streaming Media Devices], bdatypes/PBDA_ETHERNET_ADDRESS_LIST, stream.bda_ethernet_address_list, PBDA_ETHERNET_ADDRESS_LIST structure pointer [Streaming Media Devices], *PBDA_ETHERNET_ADDRESS_LIST, PBDA_ETHERNET_ADDRESS_LIST
