...
ms.keywords: BDA_TEMPLATE_CONNECTION, BDA_TEMPLATE_CONNECTION, *PBDA_TEMPLATE_CONNECTION
req.iface: 
---

# BDA_TEMPLATE_CONNECTION structure



## -description
<p>The BDA_TEMPLATE_CONNECTION structure describes the template for a BDA connection in terms of where it begins and ends. </p>
