...
ms.date : 12/29/2017
ms.keywords : dxgiddi/DXGI1_2_DDI_BASE_FUNCTIONS, DXGI1_2_DDI_BASE_FUNCTIONS, display.dxgi1_2_ddi_base_functions, DXGI1_2_DDI_BASE_FUNCTIONS structure [Display Devices]
