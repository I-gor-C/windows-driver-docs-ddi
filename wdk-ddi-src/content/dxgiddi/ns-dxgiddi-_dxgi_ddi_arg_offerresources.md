...
ms.date: 12/29/2017
ms.keywords: display.dxgi_ddi_arg_offerresources, DXGI_DDI_ARG_OFFERRESOURCES, _DXGI_DDI_ARG_OFFERRESOURCES, dxgiddi/DXGI_DDI_ARG_OFFERRESOURCES, DXGI_DDI_ARG_OFFERRESOURCES structure [Display Devices]
