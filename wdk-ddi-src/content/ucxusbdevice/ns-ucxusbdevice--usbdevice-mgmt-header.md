...
ms.date: 11/20/2017
ms.keywords: USBDEVICE_MGMT_HEADER, USBDEVICE_MGMT_HEADER, *PUSBDEVICE_MGMT_HEADER
...
# USBDEVICE_MGMT_HEADER structure



## -description
<p>This structure provides a handle  for the Universal Serial Bus (USB) hub or device physically connected to the bus.</p>
