...
ms.date: 11/20/2017
ms.keywords: USBDEVICE_PURGEIO, USBDEVICE_PURGEIO, *PUSBDEVICE_PURGEIO
...
# USBDEVICE_PURGEIO structure



## -description
<p>The <b>USBDEVICE_PURGEIO</b> structure contains the handle for the Universal Serial Bus (USB) hub or device to purge I/O for.</p>
