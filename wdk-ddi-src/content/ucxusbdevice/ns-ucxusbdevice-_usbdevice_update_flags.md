...
ms.date: 2/8/2018
ms.keywords: ucxusbdevice/P_USBDEVICE_UPDATE_FLAGS, P_USBDEVICE_UPDATE_FLAGS, buses._usbdevice_update_flags, _USBDEVICE_UPDATE_FLAGS, P_USBDEVICE_UPDATE_FLAGS structure pointer [Buses], USBDEVICE_UPDATE_FLAGS structure [Buses], ucxusbdevice/_USBDEVICE_UPDATE_FLAGS, USBDEVICE_UPDATE_FLAGS
