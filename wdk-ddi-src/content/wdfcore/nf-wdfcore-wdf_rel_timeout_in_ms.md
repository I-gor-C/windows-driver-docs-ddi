...
The following code example starts a timer. The framework will call the timer's <a href="wdf.evttimerfunc">EvtTimerFunc</a> callback function after ten milliseconds. 
...
<dl>
<dt>
<a href="wdf.wdf_abs_timeout_in_ms">WDF_ABS_TIMEOUT_IN_MS</a>
</dt>
</dl>
 
