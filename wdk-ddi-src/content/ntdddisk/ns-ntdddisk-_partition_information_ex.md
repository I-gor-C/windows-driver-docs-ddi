...
ms.date: 1/10/2018
ms.keywords: PARTITION_INFORMATION_EX, ntdddisk/PPARTITION_INFORMATION_EX, PARTITION_INFORMATION_EX structure [Storage Devices], ntdddisk/PARTITION_INFORMATION_EX, PPARTITION_INFORMATION_EX, _PARTITION_INFORMATION_EX, structs-disk_459428ff-6869-41c6-b72f-94721018f66e.xml, PPARTITION_INFORMATION_EX structure pointer [Storage Devices], storage.partition_information_ex, *PPARTITION_INFORMATION_EX
