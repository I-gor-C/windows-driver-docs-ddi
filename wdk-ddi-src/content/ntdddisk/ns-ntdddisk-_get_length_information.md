...
ms.date: 1/10/2018
ms.keywords: GET_LENGTH_INFORMATION structure [Storage Devices], structs-disk_6efbf7e7-9fc2-44b0-a9f8-b83219b07a64.xml, PGET_LENGTH_INFORMATION, _GET_LENGTH_INFORMATION, ntdddisk/GET_LENGTH_INFORMATION, GET_LENGTH_INFORMATION, PGET_LENGTH_INFORMATION structure pointer [Storage Devices], *PGET_LENGTH_INFORMATION, ntdddisk/PGET_LENGTH_INFORMATION, storage.get_length_information
