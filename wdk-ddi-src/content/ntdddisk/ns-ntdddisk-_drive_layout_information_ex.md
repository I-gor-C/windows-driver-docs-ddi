...
typedef struct _DRIVE_LAYOUT_INFORMATION_EX {
  __WRAPPED__ ULONG                    PartitionStyle;
  __WRAPPED__ ULONG                    PartitionCount;
  union {
    __WRAPPED__ DRIVE_LAYOUT_INFORMATION_GPT Gpt;
    __WRAPPED__ DRIVE_LAYOUT_INFORMATION_MBR Mbr;
  } DUMMYUNIONNAME;
  __WRAPPED__ PARTITION_INFORMATION_EX PartitionEntry[1];
