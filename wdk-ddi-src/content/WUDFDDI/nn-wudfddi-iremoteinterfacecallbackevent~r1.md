...
<p>A UMDF-based driver's <a href="https://msdn.microsoft.com/6cee6662-2eef-4caf-ab70-780748521ba9">OnRemoteInterfaceEvent</a> event callback function handles device events that are associated with a <a href="wdf.using_device_interfaces_in_umdf_drivers">device interface</a>.</p>
...
</table><p>A UMDF-based driver's <a href="https://msdn.microsoft.com/6cee6662-2eef-4caf-ab70-780748521ba9">OnRemoteInterfaceEvent</a> event callback function handles device events that are associated with a <a href="wdf.using_device_interfaces_in_umdf_drivers">device interface</a>.</p>
