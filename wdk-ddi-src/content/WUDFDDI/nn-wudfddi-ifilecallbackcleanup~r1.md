---
UID: NN.wudfddi.IFileCallbackCleanup~r1
...
<p>A driver registers the <b>IFileCallbackCleanup</b> interface when it calls the <a href="https://msdn.microsoft.com/library/windows/hardware/ff558899">IWDFDriver::CreateDevice</a> method to create a device object. </p>
...
<p>The <a href="https://msdn.microsoft.com/e6dd18f4-725f-4611-ad70-029654cf4375">OnCleanupFile</a> method cancels all I/O requests that a driver has pending in the framework queue. </p>
...
</table><p>The <a href="https://msdn.microsoft.com/e6dd18f4-725f-4611-ad70-029654cf4375">OnCleanupFile</a> method cancels all I/O requests that a driver has pending in the framework queue. </p>
