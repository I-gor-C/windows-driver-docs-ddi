...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: Dot11ExtSetUnicastCipherAlgorithm
...
### -param <i>dwUnicastCipherAlgo</i> [in]
...
<p>If the value is within the range of <b>DOT11_CIPHER_ALGO_IHV_START</b> through DOT11_CIPHER_ALGO_IHV_END,
     the IHV Extensions DLL enables a proprietary cipher algorithm supported by the WLAN adapter.</p>
<p>Otherwise, the DLL is responsible for processing a standard cipher algorithm supported by the
