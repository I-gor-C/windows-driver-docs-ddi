...
### -param <i>uDefaultKeyId</i> [in]

<dd>
<p>The index value of the key within the adapter's default or per-station cipher key tables.
     </p>
<p>For standard 802.11 cipher algorithms, such as WEP or TKIP, 
     <i>uDefaultKeyId</i> must be from 0 through 3. For a proprietary cipher algorithm developed by an IHV, 
     <i>uDefaultKeyId</i> can be any value within the range defined by the IHV.</p>
</dd>
</dl>
