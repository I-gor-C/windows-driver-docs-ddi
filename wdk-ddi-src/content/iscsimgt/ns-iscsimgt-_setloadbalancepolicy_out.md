...
ms.date: 12/15/2017
ms.keywords: _SetLoadBalancePolicy_OUT, PSetLoadBalancePolicy_OUT, *PSetLoadBalancePolicy_OUT, SetLoadBalancePolicy_OUT
...
## -remarks
You must implement this class. For a list of possible status qualifiers, see <a href="storage.iscsi_status_qualifiers">ISCSI_STATUS_QUALIFIERS</a>.
