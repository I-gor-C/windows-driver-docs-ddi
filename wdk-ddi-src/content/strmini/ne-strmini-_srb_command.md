...
ms.date: 1/9/2018
ms.keywords: strmini/SRB_GET_DATA_FORMAT, strmini/SRB_STREAM_METHOD, SRB_SET_STREAM_PROPERTY, SRB_SURPRISE_REMOVAL, strmini/SRB_SURPRISE_REMOVAL, strmini/SRB_GET_STREAM_STATE, SRB_UNINITIALIZE_DEVICE, strmini/SRB_GET_STREAM_PROPERTY, SRB_READ_DATA, strmini/SRB_UNINITIALIZE_DEVICE, strmini/SRB_GET_DEVICE_PROPERTY, SRB_CLOSE_DEVICE_INSTANCE, strmini/SRB_UNKNOWN_DEVICE_COMMAND, SRB_PROPOSE_STREAM_RATE, SRB_GET_DEVICE_PROPERTY, SRB_SET_STREAM_STATE, strmini/SRB_INITIALIZE_DEVICE, SRB_PROPOSE_DATA_FORMAT, strmini/SRB_PAGING_OUT_DRIVER, SRB_COMMAND, SRB_COMMAND enumeration [Streaming Media Devices], SRB_SET_DEVICE_PROPERTY, strmini/SRB_OPEN_MASTER_CLOCK, SRB_CHANGE_POWER_STATE, strmini/SRB_DEVICE_METHOD, strmini/SRB_SET_DEVICE_PROPERTY, strmini/SRB_SET_STREAM_STATE, strmini/SRB_UNKNOWN_STREAM_COMMAND, _SRB_COMMAND, strmini/SRB_SET_STREAM_PROPERTY, strmini/SRB_CHANGE_POWER_STATE, strmini/SRB_END_FLUSH, stream.srb_command, strmini/SRB_COMMAND, SRB_SET_STREAM_RATE, SRB_SET_DATA_FORMAT, strmini/SRB_SET_DATA_FORMAT, SRB_GET_DATA_FORMAT, SRB_DEVICE_METHOD, SRB_PAGING_OUT_DRIVER, strmini/SRB_CLOSE_STREAM, SRB_OPEN_DEVICE_INSTANCE, SRB_STREAM_METHOD, strmini/SRB_WRITE_DATA, SRB_INITIALIZE_DEVICE, SRB_UNKNOWN_DEVICE_COMMAND, SRB_GET_STREAM_INFO, strmini/SRB_BEGIN_FLUSH, SRB_CLOSE_STREAM, strmini/SRB_INITIALIZATION_COMPLETE, SRB_GET_DATA_INTERSECTION, strmini/SRB_SET_STREAM_RATE, strmini/SRB_OPEN_DEVICE_INSTANCE, strmini/SRB_CLOSE_MASTER_CLOCK, strmini/SRB_READ_DATA, SRB_GET_STREAM_STATE, SRB_END_FLUSH, SRB_INDICATE_MASTER_CLOCK, strmini/SRB_CLOSE_DEVICE_INSTANCE, SRB_GET_STREAM_PROPERTY, SRB_INITIALIZATION_COMPLETE, strmini/SRB_GET_DATA_INTERSECTION, SRB_NOTIFY_IDLE_STATE, strmini/SRB_NOTIFY_IDLE_STATE, SRB_UNKNOWN_STREAM_COMMAND, strmini/SRB_PROPOSE_DATA_FORMAT, strmini/SRB_OPEN_STREAM, SRB_BEGIN_FLUSH, strmini/SRB_GET_STREAM_INFO, strmini/SRB_PROPOSE_STREAM_RATE, strmini/SRB_INDICATE_MASTER_CLOCK, SRB_OPEN_STREAM, SRB_CLOSE_MASTER_CLOCK, SRB_WRITE_DATA, SRB_OPEN_MASTER_CLOCK
