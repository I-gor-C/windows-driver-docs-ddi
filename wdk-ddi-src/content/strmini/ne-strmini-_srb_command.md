...
ms.date: 1/9/2018
ms.keywords: SRB_UNKNOWN_STREAM_COMMAND, strmini/SRB_PROPOSE_DATA_FORMAT, strmini/SRB_PROPOSE_STREAM_RATE, strmini/SRB_GET_DATA_INTERSECTION, strmini/SRB_SET_STREAM_STATE, SRB_OPEN_MASTER_CLOCK, strmini/SRB_INDICATE_MASTER_CLOCK, SRB_UNKNOWN_DEVICE_COMMAND, strmini/SRB_SURPRISE_REMOVAL, strmini/SRB_CHANGE_POWER_STATE, SRB_CLOSE_MASTER_CLOCK, SRB_GET_STREAM_STATE, strmini/SRB_OPEN_MASTER_CLOCK, strmini/SRB_CLOSE_MASTER_CLOCK, SRB_CLOSE_DEVICE_INSTANCE, SRB_CHANGE_POWER_STATE, SRB_GET_STREAM_INFO, SRB_OPEN_STREAM, SRB_GET_STREAM_PROPERTY, SRB_WRITE_DATA, strmini/SRB_UNKNOWN_DEVICE_COMMAND, strmini/SRB_CLOSE_DEVICE_INSTANCE, strmini/SRB_GET_STREAM_PROPERTY, SRB_GET_DEVICE_PROPERTY, SRB_END_FLUSH, strmini/SRB_UNKNOWN_STREAM_COMMAND, _SRB_COMMAND, SRB_INDICATE_MASTER_CLOCK, strmini/SRB_END_FLUSH, strmini/SRB_COMMAND, SRB_SET_STREAM_PROPERTY, strmini/SRB_BEGIN_FLUSH, strmini/SRB_GET_DEVICE_PROPERTY, SRB_SET_DEVICE_PROPERTY, SRB_UNINITIALIZE_DEVICE, SRB_COMMAND enumeration [Streaming Media Devices], SRB_COMMAND, SRB_PAGING_OUT_DRIVER, SRB_GET_DATA_INTERSECTION, strmini/SRB_SET_DATA_FORMAT, SRB_OPEN_DEVICE_INSTANCE, strmini/SRB_GET_DATA_FORMAT, strmini/SRB_INITIALIZE_DEVICE, strmini/SRB_PAGING_OUT_DRIVER, strmini/SRB_DEVICE_METHOD, SRB_SURPRISE_REMOVAL, SRB_SET_STREAM_RATE, SRB_READ_DATA, SRB_PROPOSE_STREAM_RATE, strmini/SRB_WRITE_DATA, strmini/SRB_SET_DEVICE_PROPERTY, SRB_INITIALIZE_DEVICE, strmini/SRB_SET_STREAM_PROPERTY, strmini/SRB_STREAM_METHOD, SRB_SET_DATA_FORMAT, strmini/SRB_GET_STREAM_STATE, strmini/SRB_SET_STREAM_RATE, strmini/SRB_GET_STREAM_INFO, SRB_INITIALIZATION_COMPLETE, SRB_NOTIFY_IDLE_STATE, SRB_STREAM_METHOD, strmini/SRB_OPEN_DEVICE_INSTANCE, strmini/SRB_CLOSE_STREAM, SRB_DEVICE_METHOD, strmini/SRB_INITIALIZATION_COMPLETE, strmini/SRB_UNINITIALIZE_DEVICE, strmini/SRB_OPEN_STREAM, stream.srb_command, SRB_GET_DATA_FORMAT, SRB_BEGIN_FLUSH, SRB_CLOSE_STREAM, strmini/SRB_READ_DATA, strmini/SRB_NOTIFY_IDLE_STATE, SRB_SET_STREAM_STATE, SRB_PROPOSE_DATA_FORMAT
