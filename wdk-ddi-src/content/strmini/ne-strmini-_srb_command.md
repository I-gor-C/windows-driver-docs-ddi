...
ms.date: 1/9/2018
ms.keywords: SRB_OPEN_STREAM, SRB_SET_DEVICE_PROPERTY, SRB_OPEN_DEVICE_INSTANCE, strmini/SRB_GET_DATA_FORMAT, SRB_GET_STREAM_INFO, strmini/SRB_OPEN_STREAM, strmini/SRB_NOTIFY_IDLE_STATE, strmini/SRB_PROPOSE_DATA_FORMAT, strmini/SRB_INITIALIZE_DEVICE, strmini/SRB_BEGIN_FLUSH, SRB_BEGIN_FLUSH, strmini/SRB_DEVICE_METHOD, SRB_GET_DATA_INTERSECTION, SRB_CLOSE_STREAM, strmini/SRB_SET_DEVICE_PROPERTY, strmini/SRB_GET_STREAM_STATE, SRB_COMMAND, strmini/SRB_COMMAND, strmini/SRB_READ_DATA, SRB_GET_DATA_FORMAT, SRB_PROPOSE_DATA_FORMAT, _SRB_COMMAND, strmini/SRB_WRITE_DATA, strmini/SRB_CLOSE_MASTER_CLOCK, SRB_CLOSE_MASTER_CLOCK, SRB_SET_DATA_FORMAT, SRB_UNINITIALIZE_DEVICE, strmini/SRB_SURPRISE_REMOVAL, SRB_WRITE_DATA, strmini/SRB_GET_STREAM_INFO, SRB_GET_STREAM_PROPERTY, strmini/SRB_CHANGE_POWER_STATE, strmini/SRB_PROPOSE_STREAM_RATE, SRB_OPEN_MASTER_CLOCK, strmini/SRB_UNKNOWN_DEVICE_COMMAND, SRB_NOTIFY_IDLE_STATE, strmini/SRB_SET_STREAM_PROPERTY, SRB_CHANGE_POWER_STATE, SRB_READ_DATA, SRB_INITIALIZATION_COMPLETE, SRB_END_FLUSH, SRB_SET_STREAM_STATE, strmini/SRB_SET_STREAM_STATE, SRB_INDICATE_MASTER_CLOCK, stream.srb_command, strmini/SRB_UNINITIALIZE_DEVICE, strmini/SRB_GET_DATA_INTERSECTION, SRB_SET_STREAM_PROPERTY, strmini/SRB_CLOSE_STREAM, strmini/SRB_PAGING_OUT_DRIVER, strmini/SRB_END_FLUSH, SRB_STREAM_METHOD, SRB_PAGING_OUT_DRIVER, strmini/SRB_GET_STREAM_PROPERTY, SRB_PROPOSE_STREAM_RATE, strmini/SRB_SET_STREAM_RATE, SRB_CLOSE_DEVICE_INSTANCE, strmini/SRB_UNKNOWN_STREAM_COMMAND, SRB_GET_DEVICE_PROPERTY, SRB_SURPRISE_REMOVAL, SRB_INITIALIZE_DEVICE, strmini/SRB_INITIALIZATION_COMPLETE, strmini/SRB_CLOSE_DEVICE_INSTANCE, strmini/SRB_OPEN_MASTER_CLOCK, SRB_UNKNOWN_DEVICE_COMMAND, SRB_COMMAND enumeration [Streaming Media Devices], SRB_GET_STREAM_STATE, strmini/SRB_OPEN_DEVICE_INSTANCE, SRB_SET_STREAM_RATE, strmini/SRB_SET_DATA_FORMAT, strmini/SRB_GET_DEVICE_PROPERTY, SRB_DEVICE_METHOD, strmini/SRB_STREAM_METHOD, SRB_UNKNOWN_STREAM_COMMAND, strmini/SRB_INDICATE_MASTER_CLOCK
