...
ms.date: 2/8/2018
ms.keywords: PSYNTH_REVERB_PARAMS, SYNTH_REVERB_PARAMS, SYNTH_REVERB_PARAMS structure [Audio Devices], dmusprop/SYNTH_REVERB_PARAMS, _SYNTH_REVERB_PARAMS, *PSYNTH_REVERB_PARAMS, PSYNTH_REVERB_PARAMS structure pointer [Audio Devices], dmusprop/PSYNTH_REVERB_PARAMS, audio.synth_reverb_params
