...
ms.date: 12/14/2017
ms.keywords: "_SYNTH_REVERB_PARAMS, dmusprop/SYNTH_REVERB_PARAMS, *PSYNTH_REVERB_PARAMS, PSYNTH_REVERB_PARAMS, SYNTH_REVERB_PARAMS, audio.synth_reverb_params, dmusprop/PSYNTH_REVERB_PARAMS, PSYNTH_REVERB_PARAMS structure pointer [Audio Devices], SYNTH_REVERB_PARAMS structure [Audio Devices]"
