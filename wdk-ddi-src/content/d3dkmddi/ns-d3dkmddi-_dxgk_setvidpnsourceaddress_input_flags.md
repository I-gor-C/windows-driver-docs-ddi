...
ms.date: 12/29/2017
ms.keywords: display.dxgk_setvidpnsourceaddress_input_flags, DXGK_SETVIDPNSOURCEADDRESS_INPUT_FLAGS, _DXGK_SETVIDPNSOURCEADDRESS_INPUT_FLAGS, DXGK_SETVIDPNSOURCEADDRESS_INPUT_FLAGS structure [Display Devices], d3dkmddi/DXGK_SETVIDPNSOURCEADDRESS_INPUT_FLAGS
