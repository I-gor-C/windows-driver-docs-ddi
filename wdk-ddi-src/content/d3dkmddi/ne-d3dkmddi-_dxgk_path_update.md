...
ms.date : 12/29/2017
ms.keywords : d3dkmddi/DXGK_PATH_UPDATE_ADDED, DXGK_PATH_UPDATE enumeration [Display Devices], DXGK_PATH_UPDATE, DXGK_PATH_UPDATE_REMOVED, d3dkmddi/DXGK_PATH_UPDATE_REMOVED, _DXGK_PATH_UPDATE, DXGK_PATH_UPDATE_UNMODIFED, DXGK_PATH_UPDATE_ADDED, d3dkmddi/DXGK_PATH_UPDATE, d3dkmddi/DXGK_PATH_UPDATE_UNMODIFED, display.dxgk_path_update, DXGK_PATH_UPDATE_MODIFIED, d3dkmddi/DXGK_PATH_UPDATE_MODIFIED
