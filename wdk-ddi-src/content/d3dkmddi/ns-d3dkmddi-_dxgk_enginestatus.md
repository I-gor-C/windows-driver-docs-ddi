...
## -description
Indicates the progress of a node within an active physical display adapter (engine) specified by a <a href="display.dxgkarg_queryenginestatus">DXGKARG_QUERYENGINESTATUS</a> structure.
