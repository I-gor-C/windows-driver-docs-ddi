...
ms.date: 12/29/2017
ms.keywords: DXGK_MULTIPLANE_OVERLAY_BLEND structure [Display Devices], d3dkmddi/DXGK_MULTIPLANE_OVERLAY_BLEND, display.dxgk_multiplane_overlay_blend, DXGK_MULTIPLANE_OVERLAY_BLEND, _DXGK_MULTIPLANE_OVERLAY_BLEND
