...
ms.date: 12/29/2017
ms.keywords: DXGK_GLITCH_DURATION_MULTI_FRAME, DXGK_GLITCH_DURATION_INDEFINITE, DXGK_GLITCH_DURATION_SINGLE_FRAME, d3dkmddi/DXGK_GLITCH_DURATION_NONE, _DXGK_GLITCH_DURATION, d3dkmddi/DXGK_GLITCH_DURATION_SINGLE_FRAME, d3dkmddi/DXGK_GLITCH_DURATION_MULTI_FRAME, d3dkmddi/DXGK_GLITCH_DURATION, DXGK_GLITCH_DURATION_MULTI_LINE, d3dkmddi/DXGK_GLITCH_DURATION_MULTI_LINE, DXGK_GLITCH_DURATION enumeration [Display Devices], DXGK_GLITCH_DURATION_NONE, d3dkmddi/DXGK_GLITCH_DURATION_SINGLE_LINE, DXGK_GLITCH_DURATION_SINGLE_LINE, d3dkmddi/DXGK_GLITCH_DURATION_INDEFINITE, DXGK_GLITCH_DURATION, display.dxgk_glitch_duration
