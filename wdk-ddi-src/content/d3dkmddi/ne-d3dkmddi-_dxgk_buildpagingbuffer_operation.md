...
ms.date: 12/29/2017
ms.keywords: DXGK_BUILDPAGINGBUFFER_OPERATION enumeration [Display Devices], DXGK_OPERATION_READ_PHYSICAL, DXGK_OPERATION_FLUSH_TLB, DXGK_OPERATION_MAP_APERTURE_SEGMENT, d3dkmddi/DXGK_OPERATION_UPDATE_PAGE_TABLE, d3dkmddi/DXGK_OPERATION_READ_PHYSICAL, d3dkmddi/DXGK_OPERATION_UPDATE_CONTEXT_ALLOCATION, d3dkmddi/DXGK_OPERATION_FLUSH_TLB, DXGK_OPERATION_VIRTUAL_FILL, d3dkmddi/DXGK_OPERATION_COPY_PAGE_TABLE_ENTRIES, DXGK_OPERATION_NOTIFY_RESIDENCY, d3dkmddi/, d3dkmddi/DXGK_OPERATION_WRITE_PHYSICAL, DXGK_OPERATION_UPDATE_CONTEXT_ALLOCATION, DXGK_OPERATION_UPDATE_PAGE_TABLE, DXGK_OPERATION_SPECIAL_LOCK_TRANSFER, d3dkmddi/DXGK_OPERATION_VIRTUAL_FILL, d3dkmddi/DXGK_OPERATION_NOTIFY_RESIDENCY, DXGK_BUILDPAGINGBUFFER_OPERATION, DXGK_OPERATION_FILL, d3dkmddi/DXGK_OPERATION_INIT_CONTEXT_RESOURCE, DXGK_OPERATION_INIT_CONTEXT_RESOURCE, _DXGK_BUILDPAGINGBUFFER_OPERATION, d3dkmddi/DXGK_OPERATION_FILL, d3dkmddi/DXGK_OPERATION_UNMAP_APERTURE_SEGMENT, DXGK_OPERATION_UNMAP_APERTURE_SEGMENT, d3dkmddi/DXGK_OPERATION_SPECIAL_LOCK_TRANSFER, DXGK_OPERATION_COPY_PAGE_TABLE_ENTRIES, d3dkmddi/DXGK_OPERATION_DISCARD_CONTENT, d3dkmddi/DXGK_OPERATION_MAP_APERTURE_SEGMENT, DXGK_OPERATION_VIRTUAL_TRANSFER, DXGK_OPERATION_DISCARD_CONTENT, DXGK_OPERATION_WRITE_PHYSICAL, DXGK_OPERATION_TRANSFER, display.dxgk_buildpagingbuffer_operation, d3dkmddi/DXGK_OPERATION_VIRTUAL_TRANSFER, d3dkmddi/DXGK_BUILDPAGINGBUFFER_OPERATION, d3dkmddi/DXGK_OPERATION_TRANSFER
