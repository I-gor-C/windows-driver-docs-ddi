...
ms.date : 12/29/2017
ms.keywords : DmStructs_b23578a5-ae81-42c8-95ce-3ba9b4691d57.xml, DXGK_RENDERKM_COMMAND structure [Display Devices], DXGK_RENDERKM_COMMAND, display.dxgk_renderkm_command, d3dkmddi/DXGK_RENDERKM_COMMAND, _DXGK_RENDERKM_COMMAND
