...
A value of type  <a href="display.dxgkarg_querydependentenginegroup">DXGKARG_QUERYDEPENDENTENGINEGROUP</a> that specifies all nodes that are affected by the reset operation.
...
<dt>
<a href="display.dxgkarg_querydependentenginegroup">DXGKARG_QUERYDEPENDENTENGINEGROUP</a>
</dt>
</dl>
 
