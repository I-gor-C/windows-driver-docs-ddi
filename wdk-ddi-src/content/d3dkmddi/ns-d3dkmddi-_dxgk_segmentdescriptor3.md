...
ms.date : 12/29/2017
ms.keywords : DXGK_SEGMENTDESCRIPTOR3, display.dxgk_segmentdescriptor3, d3dkmddi/DXGK_SEGMENTDESCRIPTOR3, _DXGK_SEGMENTDESCRIPTOR3, DXGK_SEGMENTDESCRIPTOR3 structure [Display Devices]
