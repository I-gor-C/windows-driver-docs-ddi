...
## -description
<p>The DXGKARG_RECOMMENDMONITORMODES structure contains arguments for the <a href="display.dxgkddirecommendmonitormodes">DxgkDdiRecommendMonitorModes</a> function. </p>
