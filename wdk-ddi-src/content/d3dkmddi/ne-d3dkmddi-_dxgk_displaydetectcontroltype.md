...
ms.date: 12/29/2017
ms.keywords: "_DXGK_DISPLAYDETECTCONTROLTYPE, DXGK_DISPLAYDETECTCONTROLTYPE, DXGK_DDCT_DISABLEHPD, DXGK_DDCT_UNINITIALIZED, d3dkmddi/DXGK_DISPLAYDETECTCONTROLTYPE, display.dxgk_displaydetectcontroltype, d3dkmddi/DXGK_DDCT_UNINITIALIZED, d3dkmddi/DXGK_DDCT_POLLONE, d3dkmddi/DXGK_DDCT_ENABLEHPD, d3dkmddi/DXGK_DDCT_DISABLEHPD, DXGK_DDCT_POLLALL, d3dkmddi/DXGK_DDCT_POLLALL, DXGK_DDCT_POLLONE, DXGK_DISPLAYDETECTCONTROLTYPE enumeration [Display Devices], DXGK_DDCT_ENABLEHPD"
