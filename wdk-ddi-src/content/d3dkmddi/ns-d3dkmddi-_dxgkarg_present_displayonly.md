...
ms.date: 12/29/2017
ms.keywords: "_DXGKARG_PRESENT_DISPLAYONLY, display.dxgkarg_present_displayonly, d3dkmddi/DXGKARG_PRESENT_DISPLAYONLY, DXGKARG_PRESENT_DISPLAYONLY structure [Display Devices], DXGKARG_PRESENT_DISPLAYONLY"
