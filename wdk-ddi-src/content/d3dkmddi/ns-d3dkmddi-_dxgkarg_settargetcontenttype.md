...
ms.date: 12/29/2017
ms.keywords: "_DXGKARG_SETTARGETCONTENTTYPE, display.dxgkarg_settargetcontenttype, DXGKARG_SETTARGETCONTENTTYPE, DXGKARG_SETTARGETCONTENTTYPE structure [Display Devices], d3dkmddi/PDXGKARG_SETTARGETCONTENTTYPE, PDXGKARG_SETTARGETCONTENTTYPE structure pointer [Display Devices], d3dkmddi/DXGKARG_SETTARGETCONTENTTYPE, PDXGKARG_SETTARGETCONTENTTYPE"
