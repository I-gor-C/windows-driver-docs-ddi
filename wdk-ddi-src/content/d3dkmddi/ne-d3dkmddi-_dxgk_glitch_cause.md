...
ms.date: 2/20/2018
ms.keywords: DXGK_GLITCH_CAUSE_DRIVER_ERROR, DXGK_GLITCH_CAUSE_MODIFIED_WIRE_USAGE, _DXGK_GLITCH_CAUSE, d3dkmddi/DXGK_GLITCH_CAUSE_MEMORY_TIMING, DXGK_GLITCH_CAUSE, d3dkmddi/DXGK_GLITCH_CAUSE_ENCODER_RECONFIG, d3dkmddi/DXGK_GLITCH_CAUSE_TIMING_CHANGE, d3dkmddi/DXGK_GLITCH_CAUSE, d3dkmddi/DXGK_GLITCH_CAUSE_PIPELINE_CHANGE, DXGK_GLITCH_CAUSE_NONE, DXGK_GLITCH_CAUSE_METADATA_CHANGE, d3dkmddi/DXGK_GLITCH_CAUSE_DRIVER_ERROR, DXGK_GLITCH_CAUSE_ENCODER_RECONFIG, d3dkmddi/DXGK_GLITCH_CAUSE_MODIFIED_WIRE_USAGE, display.dxgk_glitch_cause, DXGK_GLITCH_CAUSE_TIMING_CHANGE, DXGK_GLITCH_CAUSE_PIPELINE_CHANGE, d3dkmddi/DXGK_GLITCH_CAUSE_METADATA_CHANGE, d3dkmddi/DXGK_GLITCH_CAUSE_NONE, DXGK_GLITCH_CAUSE_MEMORY_TIMING, DXGK_GLITCH_CAUSE enumeration [Display Devices]
