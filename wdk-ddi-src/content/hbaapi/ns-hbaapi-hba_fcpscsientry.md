...
ms.date: 1/10/2018
ms.keywords: PHBA_FCPSCSIENTRY structure pointer [Storage Devices], structs-Fibre_32b32b55-43e6-484c-a7fb-5c477864b735.xml, hbaapi/PHBA_FCPSCSIENTRY, PHBA_FCPSCSIENTRY, HBA_FCPSCSIENTRY structure [Storage Devices], HBA_FCPSCSIENTRY, storage.hba_fcpscsientry, HBA_FcpScsiEntry, *PHBA_FCPSCSIENTRY, HBA_FcpScsiEntry structure [Storage Devices], hbaapi/HBA_FcpScsiEntry
