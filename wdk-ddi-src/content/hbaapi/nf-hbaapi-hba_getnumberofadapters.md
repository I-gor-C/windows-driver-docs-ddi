...
ms.date: 1/10/2018
ms.keywords: HBA_GetNumberOfAdapters routine [Storage Devices], fibreHBA_rtns_de5ced35-f290-47fb-ada1-df032be61bfd.xml, hbaapi/HBA_GetNumberOfAdapters, HBA_GetNumberOfAdapters, storage.hba_getnumberofadapters
