...
ms.date: 1/10/2018
ms.keywords: hbaapi/HBA_AdapterAttributes, PHBA_ADAPTERATTRIBUTES structure pointer [Storage Devices], HBA_AdapterAttributes structure [Storage Devices], HBA_ADAPTERATTRIBUTES, HBA_AdapterAttributes, hbaapi/PHBA_ADAPTERATTRIBUTES, storage.hba_adapterattributes, PHBA_ADAPTERATTRIBUTES, structs-Fibre_364bd5e8-0276-425b-a1f9-9659aabecd19.xml, *PHBA_ADAPTERATTRIBUTES, HBA_ADAPTERATTRIBUTES structure [Storage Devices]
