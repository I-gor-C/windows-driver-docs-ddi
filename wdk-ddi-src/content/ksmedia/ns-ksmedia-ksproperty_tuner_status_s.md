...
ms.date: 1/9/2018
ms.keywords: PKSPROPERTY_TUNER_STATUS_S, PKSPROPERTY_TUNER_STATUS_S structure pointer [Streaming Media Devices], vidcapstruct_a36247d8-99d7-4dad-8632-5feb685616d6.xml, ksmedia/KSPROPERTY_TUNER_STATUS_S, *PKSPROPERTY_TUNER_STATUS_S, ksmedia/PKSPROPERTY_TUNER_STATUS_S, stream.ksproperty_tuner_status_s, KSPROPERTY_TUNER_STATUS_S structure [Streaming Media Devices], KSPROPERTY_TUNER_STATUS_S
