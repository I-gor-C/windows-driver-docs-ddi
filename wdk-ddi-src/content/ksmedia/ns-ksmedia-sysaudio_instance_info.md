...
ms.date: 2/8/2018
ms.keywords: ksmedia/SYSAUDIO_INSTANCE_INFO, PSYSAUDIO_INSTANCE_INFO structure pointer [Audio Devices], SYSAUDIO_INSTANCE_INFO structure [Audio Devices], aud-prop_dd4269d6-0f6e-476a-a4d3-ea71f3b9a96a.xml, SYSAUDIO_INSTANCE_INFO, ksmedia/PSYSAUDIO_INSTANCE_INFO, audio.sysaudio_instance_info, PSYSAUDIO_INSTANCE_INFO, *PSYSAUDIO_INSTANCE_INFO
