...
ms.date: 12/6/2017
ms.keywords: PKSPROPERTY_CAMERACONTROL_NODE_FOCAL_LENGTH_S, *PKSPROPERTY_CAMERACONTROL_NODE_FOCAL_LENGTH_S, KSPROPERTY_CAMERACONTROL_NODE_FOCAL_LENGTH_S
...
Specifies both the target node and the property to <i>get</i>. This member is an initialized structure of type <a href="audio.ksnodeproperty">KSNODEPROPERTY</a>.
...
<dt>
<a href="stream.ksproperty_cameracontrol_focal_length_s">KSPROPERTY_CAMERACONTROL_FOCAL_LENGTH_S</a>
</dt>
</dl>
 
 
