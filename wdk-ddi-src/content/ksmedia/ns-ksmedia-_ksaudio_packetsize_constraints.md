...
ms.date: 12/14/2017
ms.keywords: FILE_BYTE_ALIGNMENT, FILE_512_BYTE_ALIGNMENT, ksmedia/PKSAUDIO_PACKETSIZE_CONSTRAINTS, PKSAUDIO_PACKETSIZE_CONSTRAINTS, FILE_32_BYTE_ALIGNMENT, FILE_OCTA_ALIGNMENT, FILE_256_BYTE_ALIGNMENT, FILE_64_BYTE_ALIGNMENT, FILE_WORD_ALIGNMENT, FILE_QUAD_ALIGNMENT, FILE_128_BYTE_ALIGNMENT, _KSAUDIO_PACKETSIZE_CONSTRAINTS, KSAUDIO_PACKETSIZE_CONSTRAINTS, ksmedia/KSAUDIO_PACKETSIZE_CONSTRAINTS, FILE_LONG_ALIGNMENT, audio.ksaudio_packetsize_constraints, KSAUDIO_PACKETSIZE_CONSTRAINTS structure [Audio Devices], PKSAUDIO_PACKETSIZE_CONSTRAINTS structure pointer [Audio Devices]
