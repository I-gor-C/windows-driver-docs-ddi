...
ms.date: 12/14/2017
ms.keywords: ksmedia/PKSAUDIOENGINE_VOLUMELEVEL, PKSAUDIOENGINE_VOLUMELEVEL, KSAUDIOENGINE_VOLUMELEVEL structure [Audio Devices], PKSAUDIOENGINE_VOLUMELEVEL structure pointer [Audio Devices], *PKSAUDIOENGINE_VOLUMELEVEL, _tagKSAUDIOENGINE_VOLUMELEVEL, ksmedia/KSAUDIOENGINE_VOLUMELEVEL, audio.ksaudioengine_volumelevel, KSAUDIOENGINE_VOLUMELEVEL
