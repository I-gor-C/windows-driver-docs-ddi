...
ms.date: 12/14/2017
ms.keywords: ksmedia/KSRTAUDIO_HWREGISTER_PROPERTY, ksmedia/PKSRTAUDIO_HWREGISTER_PROPERTY, *PKSRTAUDIO_HWREGISTER_PROPERTY, PKSRTAUDIO_HWREGISTER_PROPERTY structure pointer [Audio Devices], audio.ksrtaudio_hwregister_property, KSRTAUDIO_HWREGISTER_PROPERTY, aud-prop_d554442a-4677-4fc6-a305-ef02d5caffef.xml, PKSRTAUDIO_HWREGISTER_PROPERTY, KSRTAUDIO_HWREGISTER_PROPERTY structure [Audio Devices]
