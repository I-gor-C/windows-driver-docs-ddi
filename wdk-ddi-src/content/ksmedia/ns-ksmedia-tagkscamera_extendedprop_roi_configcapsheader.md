...
ms.date: 1/9/2018
ms.keywords: ksmedia/PKSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER, ksmedia/KSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER, PKSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER structure pointer [Streaming Media Devices], PKSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER, KSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER structure [Streaming Media Devices], stream.kscamera_extendedprop_roi_configcapsheader, KSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER, tagKSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER, *PKSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER
