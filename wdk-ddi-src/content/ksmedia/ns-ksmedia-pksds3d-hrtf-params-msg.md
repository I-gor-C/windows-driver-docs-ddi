---
UID: NS.ksmedia.PKSDS3D_HRTF_PARAMS_MSG
title: PKSDS3D_HRTF_PARAMS_MSG
...
ms.date: 11/21/2017
ms.keywords: PKSDS3D_HRTF_PARAMS_MSG, KSDS3D_HRTF_PARAMS_MSG, *PKSDS3D_HRTF_PARAMS_MSG
...
# PKSDS3D_HRTF_PARAMS_MSG structure



## -description
<p>The KSDS3D_HRTF_PARAMS_MSG structure specifies the parameter settings to apply to a head-relative transfer function (HRTF).</p>
...
## -remarks
<p>This structure is used by the <a href="https://msdn.microsoft.com/library/windows/hardware/ff537357">KSPROPERTY_HRTF3D_PARAMS</a> property.</p>
