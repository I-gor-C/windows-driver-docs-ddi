...
ms.date: 2/8/2018
ms.keywords: PKSRTAUDIO_SETWRITEPACKET_INFO structure pointer [Audio Devices], PKSRTAUDIO_SETWRITEPACKET_INFO, ksmedia/PKSRTAUDIO_SETWRITEPACKET_INFO, KSRTAUDIO_SETWRITEPACKET_INFO, audio.ksrtaudio_setwritepacket_info, KSRTAUDIO_SETWRITEPACKET_INFO structure [Audio Devices], *PKSRTAUDIO_SETWRITEPACKET_INFO, ksmedia/KSRTAUDIO_SETWRITEPACKET_INFO
