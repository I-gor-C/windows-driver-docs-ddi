...
ms.date: 12/6/2017
ms.keywords: PKSDS3D_HRTF_INIT_MSG, *PKSDS3D_HRTF_INIT_MSG, KSDS3D_HRTF_INIT_MSG
...
Specifies the number of samples over which to cross-fade the output channels after a transition across azimuth angle zero. This member is used when cross-fading of the output channels is enabled by the <b>CrossFadeOutput</b> member of <a href="audio.ksds3d_hrtf_params_msg">KSDS3D_HRTF_PARAMS_MSG</a>.
