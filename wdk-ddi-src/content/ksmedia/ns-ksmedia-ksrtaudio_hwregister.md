...
ms.date: 2/21/2018
ms.keywords: ksmedia/PKSRTAUDIO_HWREGISTER, KSRTAUDIO_HWREGISTER, KSRTAUDIO_HWREGISTER structure [Audio Devices], ksmedia/KSRTAUDIO_HWREGISTER, PKSRTAUDIO_HWREGISTER structure pointer [Audio Devices], audio.ksrtaudio_hwregister, PKSRTAUDIO_HWREGISTER, aud-prop_f94f5b72-e081-48ee-96b9-4649201743d5.xml, *PKSRTAUDIO_HWREGISTER
