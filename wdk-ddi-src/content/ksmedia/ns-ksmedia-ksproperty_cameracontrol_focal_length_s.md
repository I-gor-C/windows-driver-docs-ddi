...
ms.date: 1/9/2018
ms.keywords: "*PKSPROPERTY_CAMERACONTROL_FOCAL_LENGTH_S, PKSPROPERTY_CAMERACONTROL_FOCAL_LENGTH_S structure pointer [Streaming Media Devices], PKSPROPERTY_CAMERACONTROL_FOCAL_LENGTH_S, ksmedia/PKSPROPERTY_CAMERACONTROL_FOCAL_LENGTH_S, vidcapstruct_d3d5d26e-e8be-4ce5-9a9a-03b125134bf7.xml, stream.ksproperty_cameracontrol_focal_length_s, KSPROPERTY_CAMERACONTROL_FOCAL_LENGTH_S structure [Streaming Media Devices], KSPROPERTY_CAMERACONTROL_FOCAL_LENGTH_S, ksmedia/KSPROPERTY_CAMERACONTROL_FOCAL_LENGTH_S"
