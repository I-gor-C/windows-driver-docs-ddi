...
<dd>
<p>A range as a <a href="..\d3d12umddi\ns-d3d12umddi-d3d12ddi-range.md">D3D12DDI_RANGE</a> structure. If the resource is a texture with an adapter-dependent layout, the range must be (0, UINT64_MAX), because only the driver knows where a particular subresource resides. When the resource is a buffer or texture with well-specified layout, the range fits within the subresource extent. Empty ranges are never passed.</p>
</dd>
</dl>
...
<dl>
<dt>
<a href="..\d3d12umddi\ns-d3d12umddi-d3d12ddi-range.md">D3D12DDI_RANGE</a>
</dt>
</dl>
<p> </p>
<p> </p>
