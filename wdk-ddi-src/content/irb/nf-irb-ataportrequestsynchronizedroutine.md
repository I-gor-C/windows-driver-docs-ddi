...
title: AtaPortRequestSynchronizedRoutine
...
## -description
<p>The <b>AtaPortRequestSynchronizedRoutine</b> routine is used by the miniport driver to request synchronization with the interrupt service routine (ISR).</p>
