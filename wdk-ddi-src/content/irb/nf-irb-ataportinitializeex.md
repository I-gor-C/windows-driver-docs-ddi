...
When the ATA port driver is processing a channel device start request, the miniport driver routine <a href="storage.atacontrollerchannelenabled">AtaControllerChannelEnabled</a> is called for each channel on the controller to determine whether it is enabled.

After the <a href="storage.atacontrollerchannelenabled">AtaControllerChannelEnabled</a> routine determines which channels are enabled, the ATA port driver calls <a href="storage.atachannelinitroutine">AtaChannelInitRoutine</a> for this channel. 
