...
## -remarks
The miniport driver should call <b>AtaPortReleaseQueueTag</b> to free allocated queue tags by using <a href="storage.ataportallocatequeuetag">AtaPortAllocateQueueTag</a>. 
