...
title: AtaPortWritePortBufferUchar
...
## -description
<p>The <b>AtaPortWritePortBufferUchar</b> routine transfers the indicated number of unsigned bytes from a buffer to the HBA.</p>
...
<dd>
<p>Pointer to the I/O port. The address value that is assigned to this parameter must be within the range of mapped I/O space addresses that are obtained by a call to <a href="https://msdn.microsoft.com/library/windows/hardware/ff550160">AtaPortGetDeviceBase</a>.</p>
</dd>
...
<dd>
<p>Specifies the number of UCHAR values to write to the HBA.</p>
</dd>
</dl>
