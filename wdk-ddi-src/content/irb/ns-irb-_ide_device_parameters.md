...
ms.date: 12/15/2017
ms.keywords: _IDE_DEVICE_PARAMETERS, PIDE_DEVICE_PARAMETERS, *PIDE_DEVICE_PARAMETERS, IDE_DEVICE_PARAMETERS
...
## -remarks
The port driver passes a IDE_DEVICE_PARAMETERS structure to the miniport driver when it calls <a href="storage.idehwinitialize">IdeHwInitialize</a>.
