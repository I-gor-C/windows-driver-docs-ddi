...
ms.date: 1/18/2018
ms.keywords: PWSK_DATA_INDICATION structure pointer [Network Drivers Starting with Windows Vista], PWSK_DATA_INDICATION, _WSK_DATA_INDICATION, *PWSK_DATA_INDICATION, wsk/WSK_DATA_INDICATION, wskref_89ac35f7-4945-4b2d-90d6-177d9bca7361.xml, WSK_DATA_INDICATION structure [Network Drivers Starting with Windows Vista], WSK_DATA_INDICATION, wsk/PWSK_DATA_INDICATION, netvista.wsk_data_indication
