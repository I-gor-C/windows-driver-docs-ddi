...
## -description
<p>The MONITOREX structure is obsolete and supported for compatibility purposes only. New print monitors should implement <a href="..\winsplp\nf-winsplp-initializeprintmonitor2.md">InitializePrintMonitor2</a> and <a href="..\winsplp\ns-winsplp--monitor2.md">MONITOR2</a> so that they can be used with print server clusters.</p>
<p>The MONITOREX structure is used as the return value for a print monitor's <a href="..\winsplp\nf-winsplp-initializeprintmonitor.md">InitializePrintMonitor</a> function.</p>
...
<dl>
<dt>
<a href="..\winsplp\ns-winsplp--monitor.md">MONITOR</a>
</dt>
</dl>
<p> </p>
<p> </p>
