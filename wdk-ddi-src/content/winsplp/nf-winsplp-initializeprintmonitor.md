...
## -description
The <b>InitializePrintMonitor</b> function is obsolete and is supported only for compatibility purposes. New print monitors should implement <a href="print.initializeprintmonitor2">InitializePrintMonitor2</a> so that they can be used with print server clusters.
...
<dl>
<dt>
<a href="print.initializeprintmonitorui">InitializePrintMonitorUI</a>
</dt>
<dt>
<a href="print.monitorex">MONITOREX</a>
</dt>
</dl>
 
