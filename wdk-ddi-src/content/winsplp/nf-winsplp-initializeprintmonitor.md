...
## -description
<p>The <b>InitializePrintMonitor</b> function is obsolete and is supported only for compatibility purposes. New print monitors should implement <a href="..\winsplp\nf-winsplp-initializeprintmonitor2.md">InitializePrintMonitor2</a> so that they can be used with print server clusters.</p>
...
<dt>
<a href="..\winsplp\ns-winsplp--monitorex.md">MONITOREX</a>
</dt>
</dl>
<p> </p>
<p> </p>
