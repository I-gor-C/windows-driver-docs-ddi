...
Calling <code>PartialReplyPrinterChangeNotification</code> does not cause the spooler to notify the application that changes have occurred. If the print provider's <a href="print.findfirstprinterchangenotification">FindFirstPrinterChangeNotification</a> function did not set the PRINTER_NOTIFY_STATUS_POLL flag, the provider must call <a href="print.replyprinterchangenotification">ReplyPrinterChangeNotification</a> to cause the application to be notified.
