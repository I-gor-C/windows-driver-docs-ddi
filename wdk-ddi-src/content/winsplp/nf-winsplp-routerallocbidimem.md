...
## -remarks
When the memory allocated by this function is no longer needed, it can be returned by a call to <a href="print.routerfreebidimem">RouterFreeBidiMem</a>.
...
<dl>
<dt>
<a href="print.routerfreebidimem">RouterFreeBidiMem</a>
</dt>
<dt>
