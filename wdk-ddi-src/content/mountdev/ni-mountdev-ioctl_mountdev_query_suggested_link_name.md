...
### -output-buffer
The client driver must place a variable-length structure of type <a href="storage.mountdev_suggested_link_name">MOUNTDEV_SUGGESTED_LINK_NAME</a>, defined in <i>moundev.h</i>, at the beginning of the buffer at <b>Irp-&gt;AssociatedIrp.SystemBuffer</b>. Starting at the address of the structure member <i>Name</i>, the client driver must insert the suggested persistent name.
...
<dl>
<dt>
<a href="storage.mountdev_suggested_link_name">MOUNTDEV_SUGGESTED_LINK_NAME</a>
</dt>
</dl>
 
