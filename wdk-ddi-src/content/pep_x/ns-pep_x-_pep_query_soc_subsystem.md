...
- Windows
targetos: Windows
req.typenames: PEP_QUERY_SOC_SUBSYSTEM, *PPEP_QUERY_SOC_SUBSYSTEM, PEP_QUERY_SOC_SUBSYSTEM, *PPEP_QUERY_SOC_SUBSYSTEM
---
...
typedef struct _PEP_QUERY_SOC_SUBSYSTEM {
  ...
  ULONG          MetadataCount;
  ULONG          Flags;
} *PPEP_QUERY_SOC_SUBSYSTEM, PEP_QUERY_SOC_SUBSYSTEM;
```
