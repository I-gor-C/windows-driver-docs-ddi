...
ms.date: 2/16/2018
ms.keywords: PPEP_ACPI_PREPARE_DEVICE structure pointer [Kernel-Mode Driver Architecture], *PPEP_ACPI_PREPARE_DEVICE, pepfx/PEP_ACPI_PREPARE_DEVICE, PEP_ACPI_PREPARE_DEVICE, kernel.pep_acpi_prepare_device, PEP_ACPI_PREPARE_DEVICE structure [Kernel-Mode Driver Architecture], _PEP_ACPI_PREPARE_DEVICE, PPEP_ACPI_PREPARE_DEVICE, pepfx/PPEP_ACPI_PREPARE_DEVICE
