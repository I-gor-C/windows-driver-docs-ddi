...
title: PEP_PROCESSOR_IDLE_CONSTRAINTS
...
# PEP_PROCESSOR_IDLE_CONSTRAINTS structure



## -description
<p>The <b>PEP_PROCESSOR_IDLE_CONSTRAINTS</b> structure specifies a set of constraints that the PEP uses to select a processor idle state.</p>
