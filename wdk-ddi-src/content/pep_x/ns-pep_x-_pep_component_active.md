...
ms.date: 1/4/2018
ms.keywords: PPEP_COMPONENT_ACTIVE, PEP_COMPONENT_ACTIVE, kernel.pep_component_active, PEP_COMPONENT_ACTIVE structure [Kernel-Mode Driver Architecture], pep_x/PPEP_COMPONENT_ACTIVE, *PPEP_COMPONENT_ACTIVE, pep_x/PEP_COMPONENT_ACTIVE, PPEP_COMPONENT_ACTIVE structure pointer [Kernel-Mode Driver Architecture], _PEP_COMPONENT_ACTIVE
