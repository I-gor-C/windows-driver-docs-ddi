...
ms.date: 2/16/2018
ms.keywords: pepfx/PEP_WORK_INFORMATION, kernel.pep_work_information, pepfx/PPEP_WORK_INFORMATION, PPEP_WORK_INFORMATION structure pointer [Kernel-Mode Driver Architecture], PEP_WORK_INFORMATION structure [Kernel-Mode Driver Architecture], *PPEP_WORK_INFORMATION, _PEP_WORK_INFORMATION, PPEP_WORK_INFORMATION, PEP_WORK_INFORMATION
