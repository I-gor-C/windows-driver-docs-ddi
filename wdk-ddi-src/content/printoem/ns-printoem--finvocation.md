...
## -description
<p>The FINVOCATION structure is used as input to the <a href="print.iprintoemuni_sendfontcmd">IPrintOemUni::SendFontCmd</a> method. The structure is defined in printoem.h.</p>
