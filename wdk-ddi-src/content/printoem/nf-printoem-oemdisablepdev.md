...
This function is obsolete for Windows XP and later. It is supported only for earlier plug-ins. Use <a href="print.iprintoemps_disablepdev">IPrintOemPS::DisablePDEV</a> (Pscript) or <a href="print.iprintoemuni_disablepdev">IPrintOemUni::DisablePDEV</a> (Unidrv).
