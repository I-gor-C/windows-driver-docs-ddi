...
ms.date: 11/27/2017
ms.keywords: IDebugClient3, RemoveProcessOptions, IDebugClient3::RemoveProcessOptions
...
<dd>
<p>Specifies the process options to remove from those affecting the current process.  For details on these options, see <a href="debugger.debug_process_xxx">DEBUG_PROCESS_XXX</a>.</p>
</dd>
</dl>
