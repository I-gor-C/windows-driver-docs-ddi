...
<dd>
<p>Receives the type of the processor.  For possible values, see the <i>Type</i> parameter in <a href="debugger.getactualprocessortype">GetActualProcessorType</a>.</p>
</dd>
</dl>
