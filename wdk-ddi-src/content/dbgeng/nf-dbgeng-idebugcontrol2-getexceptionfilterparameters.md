...
title: IDebugControl2::GetExceptionFilterParameters method
...
ms.date: 2/15/2018
ms.keywords: IDebugControl3::GetExceptionFilterParameters, debugger.getexceptionfilterparameters, IDebugControl, IDebugControl interface [Windows Debugging], GetExceptionFilterParameters method, IDebugControl2, GetExceptionFilterParameters method [Windows Debugging], IDebugControl_012d902c-ff4c-4ac8-9a35-b6cdcd1e2894.xml, GetExceptionFilterParameters method [Windows Debugging], IDebugControl2 interface, IDebugControl3 interface [Windows Debugging], GetExceptionFilterParameters method, IDebugControl2 interface [Windows Debugging], GetExceptionFilterParameters method, IDebugControl2::GetExceptionFilterParameters, dbgeng/IDebugControl3::GetExceptionFilterParameters, GetExceptionFilterParameters method [Windows Debugging], IDebugControl interface, IDebugControl::GetExceptionFilterParameters, dbgeng/IDebugControl2::GetExceptionFilterParameters, GetExceptionFilterParameters, GetExceptionFilterParameters method [Windows Debugging], IDebugControl3 interface, dbgeng/IDebugControl::GetExceptionFilterParameters
