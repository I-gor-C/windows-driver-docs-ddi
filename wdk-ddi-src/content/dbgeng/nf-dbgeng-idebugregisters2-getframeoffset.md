...
ms.date: 11/30/2017
ms.keywords: IDebugRegisters2, GetFrameOffset, IDebugRegisters2::GetFrameOffset
...
<p>The method <a href="debugger.getframeoffset2">GetFrameOffset2</a> performs the same task as this method but also allows the register source to be specified.</p>
