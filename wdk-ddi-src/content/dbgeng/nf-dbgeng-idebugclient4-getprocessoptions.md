...
title: IDebugClient4::GetProcessOptions
...
ms.date: 11/27/2017
ms.keywords: IDebugClient4, GetProcessOptions, IDebugClient4::GetProcessOptions
...
<dd>
<p>Receives a set of flags representing the process options for the current process.  For details on these options, see <a href="debugger.debug_process_xxx">DEBUG_PROCESS_XXX</a>.</p>
</dd>
</dl>
