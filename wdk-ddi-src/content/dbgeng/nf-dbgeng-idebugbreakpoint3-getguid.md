...
ms.date: 2/15/2018
ms.keywords: GetGuid, IDebugBreakpoint3 interface [Windows Debugging], GetGuid method, IDebugBreakpoint3, debugger.idebugbreakpoint3_getguid, GetGuid method [Windows Debugging], GetGuid method [Windows Debugging], IDebugBreakpoint3 interface, dbgeng/IDebugBreakpoint3::GetGuid, IDebugBreakpoint3::GetGuid
