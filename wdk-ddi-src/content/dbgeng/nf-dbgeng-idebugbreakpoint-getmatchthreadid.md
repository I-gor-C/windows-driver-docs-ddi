...
title: IDebugBreakpoint::GetMatchThreadId method
...
ms.date: 1/19/2018
ms.keywords: GetMatchThreadId method [Windows Debugging], IDebugBreakpoint2 interface, ComOther_6a9afca5-8445-48d9-8e28-8d38e6cf2658.xml, GetMatchThreadId method [Windows Debugging], IDebugBreakpoint interface, GetMatchThreadId, IDebugBreakpoint interface [Windows Debugging], GetMatchThreadId method, GetMatchThreadId method [Windows Debugging], dbgeng/IDebugBreakpoint2::GetMatchThreadId, IDebugBreakpoint, IDebugBreakpoint::GetMatchThreadId, dbgeng/IDebugBreakpoint::GetMatchThreadId, IDebugBreakpoint2 interface [Windows Debugging], GetMatchThreadId method, IDebugBreakpoint2::GetMatchThreadId, debugger.getmatchthreadid
