...
ms.date: 2/15/2018
ms.keywords: AddTypeOptions method [Windows Debugging], IDebugSymbols3 interface, debugger.addtypeoptions, IDebugSymbols3::AddTypeOptions, IDebugSymbols2 interface [Windows Debugging], AddTypeOptions method, AddTypeOptions method [Windows Debugging], AddTypeOptions, AddTypeOptions method [Windows Debugging], IDebugSymbols2 interface, dbgeng/IDebugSymbols2::AddTypeOptions, IDebugSymbols2::AddTypeOptions, IDebugSymbols3, IDebugSymbols_e856a688-7f26-4a00-b911-5b23a0bafa11.xml, IDebugSymbols3 interface [Windows Debugging], AddTypeOptions method, dbgeng/IDebugSymbols3::AddTypeOptions, IDebugSymbols2
