...
ms.date: 11/27/2017
ms.keywords: IDebugControl3, OutputVaList, IDebugControl3::OutputVaList
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: IDebugControl.OutputVaList,IDebugControl2.OutputVaList,IDebugControl3.OutputVaList
...
## -description
<p>The <b>OutputVaList</b>  method formats a string and sends the result to the <a href="debugger.using_input_and_output#output_callbacks#output_callbacks">output callbacks</a> that are registered with the engine's clients.</p>
