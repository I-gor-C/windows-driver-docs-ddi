...
ms.date: 1/19/2018
ms.keywords: debugger.getexceptionfiltersecondcommandwide, dbgeng/IDebugControl4::GetExceptionFilterSecondCommandWide, GetExceptionFilterSecondCommandWide method [Windows Debugging], IDebugControl4 interface, GetExceptionFilterSecondCommandWide, GetExceptionFilterSecondCommandWide method [Windows Debugging], IDebugControl4, IDebugControl4::GetExceptionFilterSecondCommand, IDebugControl4 interface [Windows Debugging], GetExceptionFilterSecondCommandWide method, IDebugControl4::GetExceptionFilterSecondCommandWide, GetExceptionFilterSecondCommand
