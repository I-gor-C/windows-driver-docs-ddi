...
ms.date: 1/19/2018
ms.keywords: IDebugControl4::GetExceptionFilterSecondCommand, IDebugControl4::GetExceptionFilterSecondCommandWide, dbgeng/IDebugControl4::GetExceptionFilterSecondCommandWide, IDebugControl4 interface [Windows Debugging], GetExceptionFilterSecondCommandWide method, debugger.getexceptionfiltersecondcommandwide, GetExceptionFilterSecondCommand, GetExceptionFilterSecondCommandWide, GetExceptionFilterSecondCommandWide method [Windows Debugging], IDebugControl4 interface, IDebugControl4, GetExceptionFilterSecondCommandWide method [Windows Debugging]
