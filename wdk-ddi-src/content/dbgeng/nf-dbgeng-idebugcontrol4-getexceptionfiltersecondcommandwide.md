...
ms.date: 2/15/2018
ms.keywords: IDebugControl4::GetExceptionFilterSecondCommand, dbgeng/IDebugControl4::GetExceptionFilterSecondCommandWide, GetExceptionFilterSecondCommand, GetExceptionFilterSecondCommandWide method [Windows Debugging], IDebugControl4, GetExceptionFilterSecondCommandWide, GetExceptionFilterSecondCommandWide method [Windows Debugging], IDebugControl4 interface, IDebugControl4::GetExceptionFilterSecondCommandWide, debugger.getexceptionfiltersecondcommandwide, IDebugControl4 interface [Windows Debugging], GetExceptionFilterSecondCommandWide method
