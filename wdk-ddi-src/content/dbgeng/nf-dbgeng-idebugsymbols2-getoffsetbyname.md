...
ms.date: 1/19/2018
ms.keywords: GetOffsetByName method [Windows Debugging], debugger.getoffsetbyname, GetOffsetByName method [Windows Debugging], IDebugSymbols2 interface, IDebugSymbols::GetOffsetByName, IDebugSymbols3 interface [Windows Debugging], GetOffsetByName method, dbgeng/IDebugSymbols2::GetOffsetByName, GetOffsetByName method [Windows Debugging], IDebugSymbols3 interface, dbgeng/IDebugSymbols3::GetOffsetByName, IDebugSymbols2 interface [Windows Debugging], GetOffsetByName method, IDebugSymbols2, IDebugSymbols2::GetOffsetByName, IDebugSymbols_ef72e546-d27f-4cdf-9eeb-53151680c2d1.xml, IDebugSymbols, IDebugSymbols3::GetOffsetByName, GetOffsetByName method [Windows Debugging], IDebugSymbols interface, IDebugSymbols interface [Windows Debugging], GetOffsetByName method, GetOffsetByName, dbgeng/IDebugSymbols::GetOffsetByName
