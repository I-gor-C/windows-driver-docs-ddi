...
ms.date: 12/14/2017
ms.keywords: IDebugEventCallbacksWide, IDebugEventCallbacksWide::CreateProcess, CreateProcess
...
## -remarks
This method is only called by the engine if the DEBUG_EVENT_CREATE_PROCESS flag is set in the mask returned by <a href="debugger.idebugeventcallbackswide_getinterestmask">IDebugEventCallbacksWide::GetInterestMask</a>.
