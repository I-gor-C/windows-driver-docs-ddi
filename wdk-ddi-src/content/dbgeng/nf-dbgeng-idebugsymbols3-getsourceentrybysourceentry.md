...
A pointer to a <a href="debugger.debug_symbol_source_entry">DEBUG_SYMBOL_SOURCE_ENTRY</a> as the input entry.
...
A pointer to a <a href="debugger.debug_symbol_source_entry">DEBUG_SYMBOL_SOURCE_ENTRY</a> as the output entry.
