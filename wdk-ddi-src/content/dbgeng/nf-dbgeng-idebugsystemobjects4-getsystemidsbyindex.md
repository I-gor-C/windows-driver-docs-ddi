...
## -remarks
The index of the first target is zero.  The index of the last target is the number of targets returned by <a href="debugger.getnumbersystems">GetNumberSystems</a> minus one.
