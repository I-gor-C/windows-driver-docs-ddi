...
ms.date: 2/15/2018
ms.keywords: IDebugControl4::OutputPromptWide, OutputPromptWide method [Windows Debugging], IDebugControl4 interface, IDebugControl4, debugger.outputpromptwide, dbgeng/IDebugControl4::OutputPromptWide, OutputPromptWide, OutputPromptWide method [Windows Debugging], IDebugControl4 interface [Windows Debugging], OutputPromptWide method
