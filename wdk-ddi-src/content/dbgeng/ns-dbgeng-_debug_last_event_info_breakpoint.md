...
ms.date: 1/19/2018
ms.keywords: PDEBUG_LAST_EVENT_INFO_BREAKPOINT structure pointer [Windows Debugging], debugger.debug_last_event_info_breakpoint, DEBUG_LAST_EVENT_INFO_BREAKPOINT structure [Windows Debugging], dbgeng/PDEBUG_LAST_EVENT_INFO_BREAKPOINT, DEBUG_LAST_EVENT_INFO_BREAKPOINT, dbgeng/DEBUG_LAST_EVENT_INFO_BREAKPOINT, PDEBUG_LAST_EVENT_INFO_BREAKPOINT, *PDEBUG_LAST_EVENT_INFO_BREAKPOINT, _DEBUG_LAST_EVENT_INFO_BREAKPOINT
