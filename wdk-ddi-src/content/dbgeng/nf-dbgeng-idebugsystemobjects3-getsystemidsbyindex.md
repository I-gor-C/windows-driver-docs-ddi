...
ms.date: 11/30/2017
ms.keywords: IDebugSystemObjects3, GetSystemIdsByIndex, IDebugSystemObjects3::GetSystemIdsByIndex
...
## -remarks
<p>The index of the first target is zero.  The index of the last target is the number of targets returned by <a href="debugger.getnumbersystems">GetNumberSystems</a> minus one.</p>
