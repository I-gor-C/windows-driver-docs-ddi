...
ms.date: 11/27/2017
ms.keywords: IDebugControl2, GetNumberTextReplacements, IDebugControl2::GetNumberTextReplacements
...
## -description
<p>The <b>GetNumberTextReplacements</b> method returns the number of currently defined user-named and automatic aliases.  </p>
...
### -param <i>NumRepl</i> [out]

<dd>
<p>Receives the total number of user-named and automatic aliases.</p>
</dd>
</dl>
