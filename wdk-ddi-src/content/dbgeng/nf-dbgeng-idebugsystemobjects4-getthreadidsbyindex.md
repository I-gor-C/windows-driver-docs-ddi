...
## -remarks
The index of the first thread is zero.  The index of the last thread is the number of threads returned by <a href="debugger.getnumberthreads">GetNumberThreads</a> minus one.
