...
ms.date: 1/19/2018
ms.keywords: IDebugControl::GetLogFile, IDebugControl interface [Windows Debugging], GetLogFile method, IDebugControl2 interface [Windows Debugging], GetLogFile method, GetLogFile method [Windows Debugging], IDebugControl2 interface, GetLogFile method [Windows Debugging], IDebugControl3 interface [Windows Debugging], GetLogFile method, IDebugControl2::GetLogFile, GetLogFile, GetLogFile method [Windows Debugging], IDebugControl interface, dbgeng/IDebugControl::GetLogFile, IDebugControl_cad2fa56-b2ca-4a26-822e-193acf602913.xml, dbgeng/IDebugControl2::GetLogFile, GetLogFile method [Windows Debugging], IDebugControl3 interface, dbgeng/IDebugControl3::GetLogFile, IDebugControl2, IDebugControl3::GetLogFile, debugger.getlogfile, IDebugControl
