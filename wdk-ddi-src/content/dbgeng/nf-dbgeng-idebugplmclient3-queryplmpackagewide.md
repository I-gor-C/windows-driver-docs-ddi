...
ms.date: 2/15/2018
ms.keywords: IDebugPlmClient3, IDebugPlmClient3 interface [Windows Debugging], QueryPlmPackageWide method, debugger.idebugplmclient3_queryplmpackagewide, QueryPlmPackageWide method [Windows Debugging], dbgeng/IDebugPlmClient3::QueryPlmPackageWide, QueryPlmPackageWide method [Windows Debugging], IDebugPlmClient3 interface, IDebugPlmClient3::QueryPlmPackageWide, QueryPlmPackageWide
