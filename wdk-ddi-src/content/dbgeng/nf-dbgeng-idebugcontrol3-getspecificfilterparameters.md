...
Receives the parameters for the specific event filters.  <i>Params</i> is an array of elements of type <a href="debugger.debug_specific_filter_parameters">DEBUG_SPECIFIC_FILTER_PARAMETERS</a>.
