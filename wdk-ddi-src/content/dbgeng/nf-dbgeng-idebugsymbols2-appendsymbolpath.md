...
ms.date: 11/27/2017
ms.keywords: IDebugSymbols2, AppendSymbolPath, IDebugSymbols2::AppendSymbolPath
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: IDebugSymbols.AppendSymbolPath,IDebugSymbols2.AppendSymbolPath,IDebugSymbols3.AppendSymbolPath
...
## -description
<p>The <b>AppendSymbolPath</b>  method appends directories to the symbol path.</p>
