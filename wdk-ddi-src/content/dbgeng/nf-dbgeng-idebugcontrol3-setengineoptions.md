...
ms.date: 1/19/2018
ms.keywords: IDebugControl2 interface [Windows Debugging], SetEngineOptions method, SetEngineOptions, IDebugControl3, IDebugControl2::SetEngineOptions, debugger.setengineoptions, dbgeng/IDebugControl::SetEngineOptions, SetEngineOptions method [Windows Debugging], IDebugControl interface [Windows Debugging], SetEngineOptions method, dbgeng/IDebugControl2::SetEngineOptions, dbgeng/IDebugControl3::SetEngineOptions, IDebugControl::SetEngineOptions, IDebugControl3::SetEngineOptions, SetEngineOptions method [Windows Debugging], IDebugControl2 interface, IDebugControl_bcc66264-b955-480d-b610-5080386354c9.xml, IDebugControl2, SetEngineOptions method [Windows Debugging], IDebugControl3 interface, IDebugControl, IDebugControl3 interface [Windows Debugging], SetEngineOptions method, SetEngineOptions method [Windows Debugging], IDebugControl interface
