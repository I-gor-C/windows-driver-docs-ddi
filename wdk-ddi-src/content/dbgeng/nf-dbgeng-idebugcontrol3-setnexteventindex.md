...
ms.date: 1/19/2018
ms.keywords: SetNextEventIndex method [Windows Debugging], IDebugControl3 interface, IDebugControl3 interface [Windows Debugging], SetNextEventIndex method, IDebugControl_9a902b9c-c621-4d71-bae7-d3fd288b1cd8.xml, SetNextEventIndex, dbgeng/IDebugControl3::SetNextEventIndex, debugger.setnexteventindex, IDebugControl3, SetNextEventIndex method [Windows Debugging], IDebugControl3::SetNextEventIndex
