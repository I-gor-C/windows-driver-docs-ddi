...
ms.date: 1/19/2018
ms.keywords: IDebugControl2::GetTextMacro, IDebugControl2, dbgeng/IDebugControl3::GetTextMacro, IDebugControl2 interface [Windows Debugging], GetTextMacro method, debugger.gettextmacro, dbgeng/IDebugControl2::GetTextMacro, GetTextMacro method [Windows Debugging], IDebugControl_b6408c67-fb45-4a11-94b4-24099f406a8a.xml, IDebugControl3::GetTextMacro, dbgeng/IDebugControl::GetTextMacro, IDebugControl3 interface [Windows Debugging], GetTextMacro method, IDebugControl, GetTextMacro method [Windows Debugging], IDebugControl3 interface, GetTextMacro method [Windows Debugging], IDebugControl interface, GetTextMacro, IDebugControl::GetTextMacro, IDebugControl interface [Windows Debugging], GetTextMacro method, GetTextMacro method [Windows Debugging], IDebugControl2 interface
