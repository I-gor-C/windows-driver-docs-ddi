...
ms.date: 2/15/2018
ms.keywords: IDebugSymbols2 interface [Windows Debugging], EndSymbolMatch method, IDebugSymbols_1661cc8a-ad5c-4cd3-83fe-f829bd07e453.xml, dbgeng/IDebugSymbols2::EndSymbolMatch, dbgeng/IDebugSymbols::EndSymbolMatch, dbgeng/IDebugSymbols3::EndSymbolMatch, IDebugSymbols3 interface [Windows Debugging], EndSymbolMatch method, IDebugSymbols3::EndSymbolMatch, EndSymbolMatch method [Windows Debugging], IDebugSymbols interface, IDebugSymbols2::EndSymbolMatch, IDebugSymbols2, EndSymbolMatch, EndSymbolMatch method [Windows Debugging], IDebugSymbols3 interface, IDebugSymbols interface [Windows Debugging], EndSymbolMatch method, debugger.endsymbolmatch, IDebugSymbols, IDebugSymbols::EndSymbolMatch, EndSymbolMatch method [Windows Debugging], IDebugSymbols2 interface, EndSymbolMatch method [Windows Debugging]
