...
| Method | Description |
| ---- |:---- |
| [dbgeng.IDebugSymbols.GetFieldOffset](nf-dbgeng-idebugsymbols-getfieldoffset.md) | The GetFieldOffset function returns the offset of a member from the beginning of a structure. |
