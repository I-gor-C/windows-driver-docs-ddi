...
ms.date: 1/19/2018
ms.keywords: ExitThread method [Windows Debugging], IDebugEventCallbacks interface, ExitThread, dbgeng/IDebugEventCallbacks::ExitThread, ComCallbacks_554f76a8-5f15-4bcc-b3ec-070ecc836ba9.xml, debugger.idebugeventcallbacks_exitthread, IDebugEventCallbacks interface [Windows Debugging], ExitThread method, IDebugEventCallbacks, ExitThread method [Windows Debugging], IDebugEventCallbacks::ExitThread
