...
ms.date: 1/10/2018
ms.keywords: IDebugSymbols3, IDebugSymbols3::GetModuleByModuleName2Wide, GetModuleByModuleName2Wide
...
## -description
The <b>GetModuleByModuleName2Wide</b>  method searches through the process's <a href="debugger.modules#modules#modules">modules</a> for one with the specified name.
