...
ms.date: 1/19/2018
ms.keywords: GetDataParameters method [Windows Debugging], IDebugBreakpoint interface, IDebugBreakpoint2 interface [Windows Debugging], GetDataParameters method, dbgeng/IDebugBreakpoint::GetDataParameters, IDebugBreakpoint2::GetDataParameters, IDebugBreakpoint, IDebugBreakpoint::GetDataParameters, dbgeng/IDebugBreakpoint2::GetDataParameters, GetDataParameters method [Windows Debugging], GetDataParameters method [Windows Debugging], IDebugBreakpoint2 interface, debugger.getdataparameters, ComOther_297fe316-4a1a-476b-a804-056bb56b6e77.xml, IDebugBreakpoint interface [Windows Debugging], GetDataParameters method, GetDataParameters
