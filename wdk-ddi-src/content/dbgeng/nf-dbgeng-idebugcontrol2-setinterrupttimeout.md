...
ms.date: 1/19/2018
ms.keywords: IDebugControl2, IDebugControl interface [Windows Debugging], SetInterruptTimeout method, SetInterruptTimeout, debugger.setinterrupttimeout, dbgeng/IDebugControl::SetInterruptTimeout, IDebugControl::SetInterruptTimeout, SetInterruptTimeout method [Windows Debugging], IDebugControl2::SetInterruptTimeout, IDebugControl, SetInterruptTimeout method [Windows Debugging], IDebugControl interface, IDebugControl2 interface [Windows Debugging], SetInterruptTimeout method, SetInterruptTimeout method [Windows Debugging], IDebugControl3 interface, IDebugControl3::SetInterruptTimeout, dbgeng/IDebugControl2::SetInterruptTimeout, IDebugControl3 interface [Windows Debugging], SetInterruptTimeout method, IDebugControl_c16219f4-97b7-451d-8f04-30aa262667f6.xml, SetInterruptTimeout method [Windows Debugging], IDebugControl2 interface, dbgeng/IDebugControl3::SetInterruptTimeout
