...
title: IDebugDataSpaces2::ReadBusData method
...
ms.date: 2/15/2018
ms.keywords: IDebugDataSpaces4::ReadBusData, ReadBusData, IDebugDataSpaces interface [Windows Debugging], ReadBusData method, IDebugDataSpaces2::ReadBusData, IDebugDataSpaces3 interface [Windows Debugging], ReadBusData method, ReadBusData method [Windows Debugging], IDebugDataSpaces2 interface [Windows Debugging], ReadBusData method, ReadBusData method [Windows Debugging], IDebugDataSpaces2 interface, IDebugDataSpaces4 interface [Windows Debugging], ReadBusData method, dbgeng/IDebugDataSpaces2::ReadBusData, IDebugDataSpaces::ReadBusData, IDebugDataSpaces_59d5bf3f-7eb5-452c-ace2-4aed701d34a6.xml, ReadBusData method [Windows Debugging], IDebugDataSpaces interface, debugger.readbusdata, dbgeng/IDebugDataSpaces::ReadBusData, ReadBusData method [Windows Debugging], IDebugDataSpaces3 interface, IDebugDataSpaces, dbgeng/IDebugDataSpaces4::ReadBusData, dbgeng/IDebugDataSpaces3::ReadBusData, IDebugDataSpaces2, IDebugDataSpaces3::ReadBusData, ReadBusData method [Windows Debugging], IDebugDataSpaces4 interface
