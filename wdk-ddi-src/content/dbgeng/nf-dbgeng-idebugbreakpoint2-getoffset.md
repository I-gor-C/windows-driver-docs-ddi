...
</dl>The breakpoint is deferred and does not currently specify a location in the target's memory address space. To determine the breakpoint location in this case, call <a href="debugger.getoffsetexpression">GetOffsetExpression</a>.
...
## -remarks
The <a href="debugger.getparameters">GetParameters</a> method also returns the location that triggers a breakpoint.
