...
Specifies the module and symbol ID of the desired symbol.  For details on this structure, see <a href="debugger.debug_module_and_id">DEBUG_MODULE_AND_ID</a>.


### -param Info [out]

Receives the symbol entry information for the symbol.  For details on this structure, see <a href="debugger.debug_symbol_entry">DEBUG_SYMBOL_ENTRY</a>.
