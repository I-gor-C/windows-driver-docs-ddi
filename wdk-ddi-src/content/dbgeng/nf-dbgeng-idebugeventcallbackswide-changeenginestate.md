...
ms.date: 1/19/2018
ms.keywords: IDebugEventCallbacksWide::ChangeEngineState, ChangeEngineState, IDebugEventCallbacksWide interface [Windows Debugging], ChangeEngineState method, ChangeEngineState method [Windows Debugging], dbgeng/IDebugEventCallbacksWide::ChangeEngineState, IDebugEventCallbacksWide, ChangeEngineState method [Windows Debugging], IDebugEventCallbacksWide interface, debugger.idebugeventcallbackswide_changeenginestate
