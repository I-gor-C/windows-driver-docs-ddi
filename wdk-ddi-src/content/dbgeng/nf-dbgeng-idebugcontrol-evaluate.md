...
ms.date: 2/15/2018
ms.keywords: IDebugControl, IDebugControl_c985be86-1f8b-4b54-ae35-a7dec5980cec.xml, dbgeng/IDebugControl::Evaluate, dbgeng/IDebugControl3::Evaluate, Evaluate, IDebugControl3::Evaluate, dbgeng/IDebugControl2::Evaluate, IDebugControl interface [Windows Debugging], Evaluate method, Evaluate method [Windows Debugging], debugger.evaluate, Evaluate method [Windows Debugging], IDebugControl2 interface, IDebugControl2 interface [Windows Debugging], Evaluate method, IDebugControl3 interface [Windows Debugging], Evaluate method, Evaluate method [Windows Debugging], IDebugControl interface, Evaluate method [Windows Debugging], IDebugControl3 interface, IDebugControl::Evaluate, IDebugControl2::Evaluate
