...
ms.date: 11/15/2017
ms.keywords: IDebugEventCallbacksWide, CreateThread, IDebugEventCallbacksWide::CreateThread
...
## -remarks
<p>This method is only called by the engine if the DEBUG_EVENT_CREATE_THREAD flag is set in the mask returned by <a href="https://msdn.microsoft.com/library/windows/hardware/ff550625">IDebugEventCallbacksWide::GetInterestMask</a>.</p>
