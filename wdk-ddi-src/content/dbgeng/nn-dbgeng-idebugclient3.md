...
## -inheritance
<p>The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IDebugClient3</b> interface inherits from <a href="..\dbgeng\nn-dbgeng-idebugclient2.md">IDebugClient2</a>. <b>IDebugClient3</b> also has these types of members:</p>
