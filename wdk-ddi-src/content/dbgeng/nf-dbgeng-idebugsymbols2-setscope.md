...
title: IDebugSymbols2::SetScope method
...
ms.date: 2/15/2018
ms.keywords: IDebugSymbols interface [Windows Debugging], SetScope method, debugger.setscope, IDebugSymbols3::SetScope, SetScope method [Windows Debugging], IDebugSymbols3 interface, IDebugSymbols2 interface [Windows Debugging], SetScope method, IDebugSymbols_20e96a86-b9c3-481f-9a26-319bac975e15.xml, SetScope, SetScope method [Windows Debugging], IDebugSymbols interface, IDebugSymbols2::SetScope, IDebugSymbols, IDebugSymbols2, SetScope method [Windows Debugging], dbgeng/IDebugSymbols3::SetScope, SetScope method [Windows Debugging], IDebugSymbols2 interface, dbgeng/IDebugSymbols::SetScope, IDebugSymbols::SetScope, dbgeng/IDebugSymbols2::SetScope, IDebugSymbols3 interface [Windows Debugging], SetScope method
