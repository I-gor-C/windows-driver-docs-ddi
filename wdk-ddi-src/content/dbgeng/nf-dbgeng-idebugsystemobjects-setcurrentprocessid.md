...
ms.date: 1/19/2018
ms.keywords: SetCurrentProcessId, IDebugSystemObjects4 interface [Windows Debugging], SetCurrentProcessId method, IDebugSystemObjects interface [Windows Debugging], SetCurrentProcessId method, dbgeng/IDebugSystemObjects3::SetCurrentProcessId, dbgeng/IDebugSystemObjects::SetCurrentProcessId, SetCurrentProcessId method [Windows Debugging], IDebugSystemObjects4 interface, IDebugSystemObjects4::SetCurrentProcessId, IDebugSystemObjects2 interface [Windows Debugging], SetCurrentProcessId method, dbgeng/IDebugSystemObjects4::SetCurrentProcessId, IDebugSystemObjects2::SetCurrentProcessId, SetCurrentProcessId method [Windows Debugging], IDebugSystemObjects interface, dbgeng/IDebugSystemObjects2::SetCurrentProcessId, IDebugSystemObjects3 interface [Windows Debugging], SetCurrentProcessId method, SetCurrentProcessId method [Windows Debugging], SetCurrentProcessId method [Windows Debugging], IDebugSystemObjects3 interface, SetCurrentProcessId method [Windows Debugging], IDebugSystemObjects2 interface, debugger.setcurrentprocessid, IDebugSystemObjects3::SetCurrentProcessId, IDebugSystemObjects::SetCurrentProcessId, IDebugSystemObjects_e588cabd-e079-4dc0-ab0f-085181414985.xml, IDebugSystemObjects
