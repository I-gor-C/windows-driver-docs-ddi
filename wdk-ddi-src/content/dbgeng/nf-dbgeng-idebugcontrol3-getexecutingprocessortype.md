...
Receives the processor type.  See <a href="debugger.getactualprocessortype">GetActualProcessorType</a> for a list of possible values this parameter can receive.
