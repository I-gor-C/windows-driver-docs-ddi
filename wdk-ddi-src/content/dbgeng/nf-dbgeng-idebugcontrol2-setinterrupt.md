...
title: IDebugControl2::SetInterrupt method
...
ms.date: 2/15/2018
ms.keywords: SetInterrupt method [Windows Debugging], IDebugControl3 interface, IDebugControl_dd73562c-6f15-4101-8ab3-3f432de5a002.xml, IDebugControl, IDebugControl2, debugger.setinterrupt, dbgeng/IDebugControl::SetInterrupt, IDebugControl2 interface [Windows Debugging], SetInterrupt method, SetInterrupt method [Windows Debugging], dbgeng/IDebugControl2::SetInterrupt, SetInterrupt method [Windows Debugging], IDebugControl2 interface, IDebugControl interface [Windows Debugging], SetInterrupt method, SetInterrupt method [Windows Debugging], IDebugControl interface, IDebugControl2::SetInterrupt, dbgeng/IDebugControl3::SetInterrupt, IDebugControl3 interface [Windows Debugging], SetInterrupt method, SetInterrupt, IDebugControl3::SetInterrupt, IDebugControl::SetInterrupt
