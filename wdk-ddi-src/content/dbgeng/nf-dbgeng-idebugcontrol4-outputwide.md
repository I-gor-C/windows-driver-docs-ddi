...
ms.date: 11/27/2017
ms.keywords: IDebugControl4, OutputWide, IDebugControl4::OutputWide
...
## -description
<p>The <b>OutputWide</b>  method formats a string and send the result to <a href="debugger.using_input_and_output#output_callbacks#output_callbacks">output callbacks</a> that have been registered with the engine's clients.</p>
