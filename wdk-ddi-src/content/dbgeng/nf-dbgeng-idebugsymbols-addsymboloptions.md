...
ms.date: 1/19/2018
ms.keywords: IDebugSymbols3::AddSymbolOptions, AddSymbolOptions method [Windows Debugging], IDebugSymbols2 interface, AddSymbolOptions method [Windows Debugging], dbgeng/IDebugSymbols2::AddSymbolOptions, IDebugSymbols interface [Windows Debugging], AddSymbolOptions method, AddSymbolOptions method [Windows Debugging], IDebugSymbols3 interface, IDebugSymbols3 interface [Windows Debugging], AddSymbolOptions method, dbgeng/IDebugSymbols3::AddSymbolOptions, IDebugSymbols_a7ffc5ae-fc9e-4298-a351-95871b8fd12e.xml, AddSymbolOptions, AddSymbolOptions method [Windows Debugging], IDebugSymbols interface, IDebugSymbols2::AddSymbolOptions, IDebugSymbols::AddSymbolOptions, IDebugSymbols, IDebugSymbols2 interface [Windows Debugging], AddSymbolOptions method, debugger.addsymboloptions, dbgeng/IDebugSymbols::AddSymbolOptions
