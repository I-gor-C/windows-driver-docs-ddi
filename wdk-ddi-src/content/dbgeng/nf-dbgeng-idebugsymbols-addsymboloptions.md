...
ms.date: 1/19/2018
ms.keywords: AddSymbolOptions method [Windows Debugging], IDebugSymbols interface, IDebugSymbols3 interface [Windows Debugging], AddSymbolOptions method, AddSymbolOptions, IDebugSymbols2::AddSymbolOptions, AddSymbolOptions method [Windows Debugging], IDebugSymbols3 interface, dbgeng/IDebugSymbols2::AddSymbolOptions, IDebugSymbols3::AddSymbolOptions, AddSymbolOptions method [Windows Debugging], IDebugSymbols2 interface, dbgeng/IDebugSymbols3::AddSymbolOptions, dbgeng/IDebugSymbols::AddSymbolOptions, IDebugSymbols_a7ffc5ae-fc9e-4298-a351-95871b8fd12e.xml, debugger.addsymboloptions, AddSymbolOptions method [Windows Debugging], IDebugSymbols, IDebugSymbols interface [Windows Debugging], AddSymbolOptions method, IDebugSymbols::AddSymbolOptions, IDebugSymbols2 interface [Windows Debugging], AddSymbolOptions method
