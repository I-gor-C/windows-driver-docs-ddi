...
ms.date: 2/15/2018
ms.keywords: OutputRegisters method [Windows Debugging], IDebugRegisters interface [Windows Debugging], OutputRegisters method, IDebugRegisters2, debugger.outputregisters, OutputRegisters method [Windows Debugging], IDebugRegisters interface, dbgeng/IDebugRegisters2::OutputRegisters, OutputRegisters method [Windows Debugging], IDebugRegisters2 interface, IDebugRegisters2::OutputRegisters, IDebugRegisters, OutputRegisters, IDebugRegisters::OutputRegisters, IDebugRegisters2 interface [Windows Debugging], OutputRegisters method, IDebugRegisters_65d62961-afc5-4609-86d2-c55757fe6ce1.xml, dbgeng/IDebugRegisters::OutputRegisters
