...
title: IDebugSymbolGroup::OutputAsType method
...
ms.date: 2/15/2018
ms.keywords: IDebugSymbolGroup, IDebugSymbolGroup2::OutputAsType, IDebugSymbolGroup::OutputAsType, OutputAsType method [Windows Debugging], IDebugSymbolGroup interface, OutputAsType method [Windows Debugging], OutputAsType method [Windows Debugging], IDebugSymbolGroup2 interface, dbgeng/IDebugSymbolGroup2::OutputAsType, dbgeng/IDebugSymbolGroup::OutputAsType, debugger.outputastype, IDebugSymbolGroup2 interface [Windows Debugging], OutputAsType method, ComOther_6805cc12-0d46-4114-a40d-54c7e32b3c7c.xml, OutputAsType, IDebugSymbolGroup interface [Windows Debugging], OutputAsType method
