...
## -remarks
The index of the first process is zero.  The index of the last process is the number of processes returned by <a href="debugger.getnumberprocesses">GetNumberProcesses</a> minus one.
