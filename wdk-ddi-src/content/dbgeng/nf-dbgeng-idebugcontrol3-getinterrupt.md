...
Examples of user interrupts include pressing Ctrl+C or pressing the <b>Stop</b> button in a debugger.  Calling <a href="debugger.setinterrupt">SetInterrupt</a> also causes a user interrupt.
