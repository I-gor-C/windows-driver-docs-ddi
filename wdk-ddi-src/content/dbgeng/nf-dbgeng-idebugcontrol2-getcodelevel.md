...
ms.date: 1/19/2018
ms.keywords: IDebugControl2, GetCodeLevel method [Windows Debugging], IDebugControl interface, GetCodeLevel method [Windows Debugging], IDebugControl2 interface, GetCodeLevel method [Windows Debugging], dbgeng/IDebugControl2::GetCodeLevel, IDebugControl2 interface [Windows Debugging], GetCodeLevel method, debugger.getcodelevel, IDebugControl3 interface [Windows Debugging], GetCodeLevel method, IDebugControl, IDebugControl_8533dd3f-f004-4d89-9f02-b7835fc6169e.xml, GetCodeLevel method [Windows Debugging], IDebugControl3 interface, IDebugControl3::GetCodeLevel, IDebugControl interface [Windows Debugging], GetCodeLevel method, dbgeng/IDebugControl3::GetCodeLevel, GetCodeLevel, IDebugControl2::GetCodeLevel, IDebugControl::GetCodeLevel, dbgeng/IDebugControl::GetCodeLevel
