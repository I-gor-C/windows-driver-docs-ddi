...
ms.date: 2/15/2018
ms.keywords: debugger.gettypename, IDebugSymbols::GetTypeName, GetTypeName method [Windows Debugging], IDebugSymbols3 interface, IDebugSymbols3 interface [Windows Debugging], GetTypeName method, GetTypeName method [Windows Debugging], IDebugSymbols_01f0496a-ce0e-442b-88c9-2a92c15a1237.xml, dbgeng/IDebugSymbols::GetTypeName, GetTypeName method [Windows Debugging], IDebugSymbols2 interface, IDebugSymbols3::GetTypeName, dbgeng/IDebugSymbols2::GetTypeName, IDebugSymbols interface [Windows Debugging], GetTypeName method, dbgeng/IDebugSymbols3::GetTypeName, IDebugSymbols2, IDebugSymbols2 interface [Windows Debugging], GetTypeName method, IDebugSymbols2::GetTypeName, IDebugSymbols, GetTypeName, GetTypeName method [Windows Debugging], IDebugSymbols interface
