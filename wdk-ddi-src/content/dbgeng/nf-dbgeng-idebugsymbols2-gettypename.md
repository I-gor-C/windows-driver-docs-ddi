...
ms.date: 1/19/2018
ms.keywords: GetTypeName method [Windows Debugging], IDebugSymbols3 interface, IDebugSymbols2 interface [Windows Debugging], GetTypeName method, debugger.gettypename, dbgeng/IDebugSymbols::GetTypeName, IDebugSymbols interface [Windows Debugging], GetTypeName method, IDebugSymbols3::GetTypeName, dbgeng/IDebugSymbols3::GetTypeName, IDebugSymbols2::GetTypeName, IDebugSymbols2, IDebugSymbols::GetTypeName, IDebugSymbols3 interface [Windows Debugging], GetTypeName method, GetTypeName method [Windows Debugging], IDebugSymbols interface, GetTypeName method [Windows Debugging], IDebugSymbols2 interface, dbgeng/IDebugSymbols2::GetTypeName, IDebugSymbols, IDebugSymbols_01f0496a-ce0e-442b-88c9-2a92c15a1237.xml, GetTypeName, GetTypeName method [Windows Debugging]
