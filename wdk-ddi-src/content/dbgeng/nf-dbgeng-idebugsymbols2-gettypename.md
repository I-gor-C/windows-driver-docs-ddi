...
ms.date: 1/19/2018
ms.keywords: dbgeng/IDebugSymbols::GetTypeName, IDebugSymbols_01f0496a-ce0e-442b-88c9-2a92c15a1237.xml, dbgeng/IDebugSymbols2::GetTypeName, GetTypeName method [Windows Debugging], IDebugSymbols3 interface, GetTypeName, GetTypeName method [Windows Debugging], IDebugSymbols2 interface, IDebugSymbols::GetTypeName, GetTypeName method [Windows Debugging], IDebugSymbols3::GetTypeName, GetTypeName method [Windows Debugging], IDebugSymbols interface, IDebugSymbols, IDebugSymbols2, IDebugSymbols interface [Windows Debugging], GetTypeName method, dbgeng/IDebugSymbols3::GetTypeName, IDebugSymbols3 interface [Windows Debugging], GetTypeName method, IDebugSymbols2 interface [Windows Debugging], GetTypeName method, debugger.gettypename, IDebugSymbols2::GetTypeName
