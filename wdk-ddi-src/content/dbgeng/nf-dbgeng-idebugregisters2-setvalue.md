...
ms.date: 2/15/2018
ms.keywords: IDebugRegisters2, IDebugRegisters_f704c31f-5062-47d7-9f44-35bc85e0d0aa.xml, IDebugRegisters2::SetValue, debugger.setvalue, IDebugRegisters::SetValue, IDebugRegisters2 interface [Windows Debugging], SetValue method, IDebugRegisters interface [Windows Debugging], SetValue method, SetValue, IDebugRegisters, dbgeng/IDebugRegisters2::SetValue, SetValue method [Windows Debugging], IDebugRegisters interface, dbgeng/IDebugRegisters::SetValue, SetValue method [Windows Debugging], SetValue method [Windows Debugging], IDebugRegisters2 interface
