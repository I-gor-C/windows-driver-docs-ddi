...
ms.date: 1/19/2018
ms.keywords: SetOffsetExpression, SetOffsetExpression method [Windows Debugging], dbgeng/IDebugBreakpoint2::SetOffsetExpression, debugger.setoffsetexpression, ComOther_d34036ae-b160-4b24-86d0-ebd2bd8408ea.xml, IDebugBreakpoint, IDebugBreakpoint interface [Windows Debugging], SetOffsetExpression method, IDebugBreakpoint2 interface [Windows Debugging], SetOffsetExpression method, SetOffsetExpression method [Windows Debugging], IDebugBreakpoint interface, dbgeng/IDebugBreakpoint::SetOffsetExpression, IDebugBreakpoint::SetOffsetExpression, IDebugBreakpoint2, IDebugBreakpoint2::SetOffsetExpression, SetOffsetExpression method [Windows Debugging], IDebugBreakpoint2 interface
