...
Receives the parameters for the exception filters specified by <i>Codes</i> or <i>Start</i>.  <i>Params</i> is an array of elements of type <a href="debugger.debug_exception_filter_parameters">DEBUG_EXCEPTION_FILTER_PARAMETERS</a>.
