...
ms.date: 12/14/2017
ms.keywords: IDebugRegisters2, IDebugRegisters2::GetInstructionOffset, GetInstructionOffset
...
The method <a href="debugger.getinstructionoffset2">GetInstructionOffset2</a> performs the same task as this method but also allows the register source to be specified.
