...
ms.date: 2/15/2018
ms.keywords: SetQuitLockString, IDebugClient5, SetQuitLockString method [Windows Debugging], IDebugClient5::SetQuitLockString, SetQuitLockString method [Windows Debugging], IDebugClient5 interface, debugger.idebugclient5_setquitlockstring, dbgeng/IDebugClient5::SetQuitLockString, IDebugClient5 interface [Windows Debugging], SetQuitLockString method
