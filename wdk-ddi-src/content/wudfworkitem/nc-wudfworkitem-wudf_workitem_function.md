...
## -remarks
To register an <i>OnWorkItem</i> callback function, your driver must place the callback function's address in a <a href="wdf.wudf_workitem_config">WUDF_WORKITEM_CONFIG</a> structure before calling <a href="wdf.iwdfdevice3_createworkitem">IWDFDevice3::CreateWorkItem</a>.
...
The driver must not call <a href="wdf.iwdfobject_deletewdfobject">IWDFObject::DeleteWdfObject</a> from the <i>OnWorkItem</i> callback function.
