---
UID: NF.sdplib.SdpCreateNodeUInt32~r1
title: SdpCreateNodeUInt32
...
<p>The Bluetooth 
  ...
  <a href="..\sdpnode\ns-sdpnode--sdp-node.md">SDP_NODE</a> structure to an unsigned 32-bit integer
  type.</p>
...
<dd>
<p>The unsigned 32-bit integer value that is used to initialize the SDP_NODE structure.</p>
</dd>
