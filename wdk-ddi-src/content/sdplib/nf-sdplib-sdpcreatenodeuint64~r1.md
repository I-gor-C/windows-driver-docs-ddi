...
<p>The Bluetooth 
  ...
  <a href="..\sdpnode\ns-sdpnode--sdp-node.md">SDP_NODE</a> structure to an unsigned 64-bit integer
  type.</p>
...
<dd>
<p>The unsigned 64-bit integer value that is used to initialize the SDP_NODE structure.</p>
</dd>
