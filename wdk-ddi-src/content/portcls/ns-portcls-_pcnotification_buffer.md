...
ms.date: 12/14/2017
ms.keywords: portcls/PPCNOTIFICATION_BUFFER, PPCNOTIFICATION_BUFFER, portcls/PCNOTIFICATION_BUFFER, PPCNOTIFICATION_BUFFER structure pointer [Audio Devices], _PCNOTIFICATION_BUFFER, audio.pcnotification_buffer, *PPCNOTIFICATION_BUFFER, PCNOTIFICATION_BUFFER, PCNOTIFICATION_BUFFER structure [Audio Devices]
