...
ms.date: 2/21/2018
ms.keywords: IPortEvents, audio.iportevents_generateeventlist, GenerateEventList method [Audio Devices], IPortEvents interface, GenerateEventList method [Audio Devices], IPortEvents::GenerateEventList, IPortEvents interface [Audio Devices], GenerateEventList method, GenerateEventList, audmp-routines_cc4243f5-90e9-471f-b8f0-aaf0945bddf5.xml, portcls/IPortEvents::GenerateEventList
