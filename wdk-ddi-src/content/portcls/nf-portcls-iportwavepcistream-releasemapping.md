...
## -description
<p>The <code>ReleaseMapping</code> method releases a mapping that was obtained by a previous call to <a href="audio.iportwavepcistream_getmapping">IPortWavePciStream::GetMapping</a>.</p>
...
## -remarks
<p>Set the <i>Tag</i> parameter to the same tag value that you used to identify the mapping in the call to <a href="audio.iportwavepcistream_getmapping">IPortWavePciStream::GetMapping</a> that originally obtained the mapping.</p>
