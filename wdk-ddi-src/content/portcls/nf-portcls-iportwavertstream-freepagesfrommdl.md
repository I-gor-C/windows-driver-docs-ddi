...
ms.date: 12/14/2017
ms.keywords: IPortWaveRTStream, portcls/IPortWaveRTStream::FreePagesFromMdl, FreePagesFromMdl method [Audio Devices], IPortWaveRTStream interface, FreePagesFromMdl method [Audio Devices], FreePagesFromMdl, IPortWaveRTStream::FreePagesFromMdl, audio.iportwavertstream_freepagesfrommdl, IPortWaveRTStream interface [Audio Devices], FreePagesFromMdl method, audmp-routines_7e3477c5-08b8-4e7c-bfb9-36945bf765c4.xml
