...
Pointer to the manufacturer-supplied name of the value entry. The name string is specified by a structure of type <a href="kernel.unicode_string">UNICODE_STRING</a>.
