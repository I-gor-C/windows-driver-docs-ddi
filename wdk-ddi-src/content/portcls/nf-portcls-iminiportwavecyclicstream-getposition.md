...
ms.date: 12/14/2017
ms.keywords: audmp-routines_016da0e2-bc56-4c06-9755-a13b75d6c5c9.xml, IMiniportWaveCyclicStream, GetPosition method [Audio Devices], GetPosition method [Audio Devices], IMiniportWaveCyclicStream interface, GetPosition, IMiniportWaveCyclicStream::GetPosition, audio.iminiportwavecyclicstream_getposition, portcls/IMiniportWaveCyclicStream::GetPosition, IMiniportWaveCyclicStream interface [Audio Devices], GetPosition method
