...
ms.date: 2/8/2018
ms.keywords: IPinCount interface [Audio Devices], PinCount method, audio.ipincount_pincount, audmp-routines_bded3ce8-936c-4391-901f-df6b2061c7c3.xml, PinCount method [Audio Devices], IPinCount interface, PinCount method [Audio Devices], portcls/IPinCount::PinCount, IPinCount, IPinCount::PinCount, PinCount
