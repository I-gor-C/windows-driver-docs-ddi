...
ms.date: 12/14/2017
ms.keywords: IMiniportTopology::Init, IMiniportTopology interface [Audio Devices], Init method, Init, Init method [Audio Devices], IMiniportTopology, audio.iminiporttopology_init, audmp-routines_c87a11c3-aed3-4516-b3bf-5d32423fa293.xml, Init method [Audio Devices], IMiniportTopology interface, portcls/IMiniportTopology::Init
