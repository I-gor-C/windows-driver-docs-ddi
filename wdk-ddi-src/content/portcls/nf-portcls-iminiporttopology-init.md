...
ms.date: 2/21/2018
ms.keywords: Init method [Audio Devices], Init, audio.iminiporttopology_init, portcls/IMiniportTopology::Init, IMiniportTopology, audmp-routines_c87a11c3-aed3-4516-b3bf-5d32423fa293.xml, IMiniportTopology::Init, IMiniportTopology interface [Audio Devices], Init method, Init method [Audio Devices], IMiniportTopology interface
