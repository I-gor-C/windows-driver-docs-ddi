...
ms.date: 2/8/2018
ms.keywords: IMiniportAudioEngineNode::GetAudioEngineDescriptor, GetAudioEngineDescriptor method [Audio Devices], IMiniportAudioEngineNode interface, GetAudioEngineDescriptor, audio.iminiportaudioenginenode_getaudioenginedescriptor, IMiniportAudioEngineNode, IMiniportAudioEngineNode interface [Audio Devices], GetAudioEngineDescriptor method, GetAudioEngineDescriptor method [Audio Devices], portcls/IMiniportAudioEngineNode::GetAudioEngineDescriptor
