...
## -description
<p><code>IAdapterPnpManagement</code>  is an interface that adapters should implement and
 ...
 <a href="..\portcls\nf-portcls-pcunregisteradapterpnpmanagement.md">PcUnregisterAdapterPnpManagement</a>.</p>
<p>IAdapterPnpManagement is available in Windows 10, version 1511 and later versions of Windows. </p>


## -inheritance
<p>The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IAdapterPnpManagement</b> interface inherits from the <a href="com.iunknown" xmlns:loc="http://microsoft.com/wdcml/l10n"><b>IUnknown</b></a> interface but does not have additional members.</p>
