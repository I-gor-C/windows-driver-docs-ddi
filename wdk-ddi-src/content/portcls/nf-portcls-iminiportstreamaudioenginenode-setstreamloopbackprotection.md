...
ms.date: 2/21/2018
ms.keywords: IMiniportStreamAudioEngineNode, audio.iminiportstreamaudioenginenode_setstreamloopbackprotection, SetStreamLoopbackProtection, portcls/IMiniportStreamAudioEngineNode::SetStreamLoopbackProtection, SetStreamLoopbackProtection method [Audio Devices], IMiniportStreamAudioEngineNode interface, IMiniportStreamAudioEngineNode::SetStreamLoopbackProtection, IMiniportStreamAudioEngineNode interface [Audio Devices], SetStreamLoopbackProtection method, SetStreamLoopbackProtection method [Audio Devices]
