...
A WaveRT miniport driver optionally can use this interface instead of hard-linking with the <a href="audio.pcaddstreamresource">PcAddStreamResource</a> 
and <a href="audio.pcremovestreamresource">PcRemoveStreamResource</a>. 
