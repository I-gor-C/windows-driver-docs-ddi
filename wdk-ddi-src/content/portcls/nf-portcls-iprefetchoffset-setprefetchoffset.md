...
ms.date: 12/14/2017
ms.keywords: portcls/IPreFetchOffset::SetPreFetchOffset, audio.iprefetchoffset_setprefetchoffset, IPreFetchOffset interface [Audio Devices], SetPreFetchOffset method, audmp-routines_7fb7bb20-d9e0-4022-9de4-1c5952bfccf8.xml, SetPreFetchOffset, SetPreFetchOffset method [Audio Devices], SetPreFetchOffset method [Audio Devices], IPreFetchOffset interface, IPreFetchOffset, IPreFetchOffset::SetPreFetchOffset
