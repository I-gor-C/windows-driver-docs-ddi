...
ms.date: 1/19/2018
ms.keywords: ExtRemoteData class [Windows Debugging], GetData method, ExtRemoteData, ExtRemoteData::GetData, GetData method [Windows Debugging], ExtRemoteData class, GetData method [Windows Debugging], GetData, debugger.extremotedata_getdata, EngExtCpp_Ref_a440fb76-5d7c-4e77-9d1e-61c0b7002493.xml
