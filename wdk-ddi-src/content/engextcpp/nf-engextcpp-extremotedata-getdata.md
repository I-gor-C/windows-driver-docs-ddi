...
ms.date : 1/19/2018
ms.keywords : EngExtCpp_Ref_a440fb76-5d7c-4e77-9d1e-61c0b7002493.xml, GetData method [Windows Debugging], ExtRemoteData class, ExtRemoteData::GetData, ExtRemoteData, GetData, GetData method [Windows Debugging], debugger.extremotedata_getdata, ExtRemoteData class [Windows Debugging], GetData method
