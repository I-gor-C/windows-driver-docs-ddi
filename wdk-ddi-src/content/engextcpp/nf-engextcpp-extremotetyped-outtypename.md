...
ms.date: 1/10/2018
ms.keywords: ExtRemoteTyped, ExtRemoteTyped::OutTypeName, OutTypeName
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: ExtRemoteTyped.OutTypeName
...
## -remarks
The type name is sent to the debugger engine's output callbacks.</p>