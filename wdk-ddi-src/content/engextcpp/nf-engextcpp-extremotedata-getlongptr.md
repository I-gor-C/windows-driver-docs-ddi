...
ms.date: 1/19/2018
ms.keywords: ExtRemoteData, GetLongPtr method [Windows Debugging], ExtRemoteData class [Windows Debugging], GetLongPtr method, GetLongPtr, debugger.extremotedata_getlongptr, GetLongPtr method [Windows Debugging], ExtRemoteData class, ExtRemoteData::GetLongPtr, EngExtCpp_Ref_3160f5ef-8983-40b4-a7f8-95a1a40d67ac.xml
