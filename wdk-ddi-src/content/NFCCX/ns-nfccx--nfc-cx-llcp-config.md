...
req.dll: 
req.irql: 
ms.keywords: NFC_CX_LLCP_CONFIG, NFC_CX_LLCP_CONFIG, *PNFC_CX_LLCP_CONFIG
req.iface: 
---
...
## -description
<p>The NFC_CX_LLCP_CONFIG structure is an input parameter to <a href="https://msdn.microsoft.com/8208F61E-DFD9-4AA8-B225-BEB35F80F621">NfcCxSetLlcpConfig.</a>
</p>
