...
ms.date: 12/14/2017
ms.keywords: PCLIENT_CONTROLLER_BASIC_INFORMATION structure pointer [Parallel Ports], gpioclx/PCLIENT_CONTROLLER_BASIC_INFORMATION, gpioclx/CLIENT_CONTROLLER_BASIC_INFORMATION, GPIO.client_controller_basic_information, CLIENT_CONTROLLER_BASIC_INFORMATION, PCLIENT_CONTROLLER_BASIC_INFORMATION, *PCLIENT_CONTROLLER_BASIC_INFORMATION, CLIENT_CONTROLLER_BASIC_INFORMATION structure [Parallel Ports], _CLIENT_CONTROLLER_BASIC_INFORMATION
