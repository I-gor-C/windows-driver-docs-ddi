...
title: GPIO_READ_PINS_MASK_PARAMETERS
...
ms.date: 11/3/2017
ms.keywords: GPIO_READ_PINS_MASK_PARAMETERS, GPIO_READ_PINS_MASK_PARAMETERS, *PGPIO_READ_PINS_MASK_PARAMETERS
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: GPIO_READ_PINS_MASK_PARAMETERS
...
# GPIO_READ_PINS_MASK_PARAMETERS structure



## -description
<p>The <b>GPIO_READ_PINS_MASK_PARAMETERS</b> structure describes a read operation on a bank of general-purpose I/O (GPIO) pins.</p>
...
<dd>
<p>A 64-bit variable to which the GPIO controller driver stores the values that it reads from the GPIO pins in the bank. If N is the number of GPIO pins in this bank, the pins are numbered 0 to N–1. The value from pin number 0 is saved in bit 0 (the least significant bit) of this variable, the value from pin number 1 is saved in bit 1 of this variable, and so on.</p>
</dd>
...
## -remarks
<p>The <i>ReadParameters</i> parameter of the <a href="https://msdn.microsoft.com/library/windows/hardware/hh439406">CLIENT_ReadGpioPinsUsingMask</a> event callback function is a pointer to a caller-allocated <b>GPIO_READ_PINS_MASK_PARAMETERS</b> structure.</p>
