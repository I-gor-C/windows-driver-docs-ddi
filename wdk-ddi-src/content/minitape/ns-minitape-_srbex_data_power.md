...
ms.date: 2/16/2018
ms.keywords: SRBEX_DATA_POWER structure [Storage Devices], SRBEX_DATA_POWER, PSRBEX_DATA_POWER structure pointer [Storage Devices], PSRBEX_DATA_POWER, storport/PSRBEX_DATA_POWER, storage.srbex_data_power, *PSRBEX_DATA_POWER, storport/SRBEX_DATA_POWER, _SRBEX_DATA_POWER
