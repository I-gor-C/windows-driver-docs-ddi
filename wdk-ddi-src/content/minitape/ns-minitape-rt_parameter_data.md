...
ms.date: 2/16/2018
ms.keywords: scsi/PRT_PARAMETER_DATA, scsi/RT_PARAMETER_DATA, RT_PARAMETER_DATA structure [Storage Devices], *PRT_PARAMETER_DATA, PRT_PARAMETER_DATA structure pointer [Storage Devices], storage.rt_parameter_data, PRT_PARAMETER_DATA, RT_PARAMETER_DATA
