...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | CheckDeferredContextHandleSizes is supported beginning with the Windows 7 operating system. CheckDeferredContextHandleSizes is supported beginning with the Windows 7 operating system. |
