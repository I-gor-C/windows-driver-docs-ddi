...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | CreateDeferredContext is supported beginning with the Windows 7 operating system. CreateDeferredContext is supported beginning with the Windows 7 operating system. |
