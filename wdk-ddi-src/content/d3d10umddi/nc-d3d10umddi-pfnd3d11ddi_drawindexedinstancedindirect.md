...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | DrawIndexedInstancedIndirect is supported beginning with the Windows 7 operating system. DrawIndexedInstancedIndirect is supported beginning with the Windows 7 operating system. |
