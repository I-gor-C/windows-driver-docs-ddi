...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | RecycleCreateCommandList is supported beginning with the Windows 7 operating system. RecycleCreateCommandList is supported beginning with the Windows 7 operating system. |
