...
<table>
                ...
                <tr>
                    ...
                    <td>The resource can be bound as a vertex buffer in a call to the driver's <a href="https://msdn.microsoft.com/3d5a7ea1-08c2-4594-93bc-97b985cd16dc">IaSetVertexBuffers</a> function.</td>
                </tr>
            
                <tr>
                    <td>D3D10_DDI_BIND_INDEX_BUFFER</td>
                    <td>The resource can be bound as an index buffer in a call to the driver's <a href="https://msdn.microsoft.com/042ebb72-b794-4cb8-9d81-bd52a785f1e0">IaSetIndexBuffer</a> function.</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>The resource can be bound as a shader resource in a call to the <a href="https://msdn.microsoft.com/b5cd87bb-7a08-444c-9120-d7ab79e512c5">GsSetShaderResources</a>, <a href="https://msdn.microsoft.com/e30aabdd-52b7-40c0-bb92-50cbabdc5e1f">PsSetShaderResources</a>, or <a href="https://msdn.microsoft.com/4d432517-97f0-441f-ac49-0416ac19b319">VsSetShaderResources</a> function.</td>
                </tr>
