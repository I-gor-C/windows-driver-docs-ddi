...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | SetResourceMinLOD is supported beginning with the Windows 7 operating system. SetResourceMinLOD is supported beginning with the Windows 7 operating system. |
