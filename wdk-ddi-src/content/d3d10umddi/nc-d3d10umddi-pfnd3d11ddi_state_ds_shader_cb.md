...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | pfnStateDsShaderCb is supported beginning with the Windows 7 operating system. pfnStateDsShaderCb is supported beginning with the Windows 7 operating system. |
