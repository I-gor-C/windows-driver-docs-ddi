...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | DispatchIndirect is supported beginning with the Windows 7 operating system. DispatchIndirect is supported beginning with the Windows 7 operating system. |
