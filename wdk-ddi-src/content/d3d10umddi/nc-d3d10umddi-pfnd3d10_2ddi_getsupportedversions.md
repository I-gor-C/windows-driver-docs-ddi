...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | GetSupportedVersions is supported beginning with the Windows 7 operating system. GetSupportedVersions is supported beginning with the Windows 7 operating system. |
