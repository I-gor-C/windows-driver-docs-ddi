...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: pfnStatePsSamplerCb
...
## -description
<p>The <b>pfnStatePsSamplerCb</b> function causes the Microsoft Direct3D 10 runtime to refresh the pixel shader stage's bound samplers.</p>
