...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | CreateCommandList is supported beginning with the Windows 7 operating system. CreateCommandList is supported beginning with the Windows 7 operating system. |
