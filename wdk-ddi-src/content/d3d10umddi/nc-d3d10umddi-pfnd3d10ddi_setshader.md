...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | CsSetShader is supported beginning with the Windows 7 operating system. CsSetShader is supported beginning with the Windows 7 operating system. |
