...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | DestroyUnorderedAccessView is supported beginning with the Windows 7 operating system. DestroyUnorderedAccessView is supported beginning with the Windows 7 operating system. |
