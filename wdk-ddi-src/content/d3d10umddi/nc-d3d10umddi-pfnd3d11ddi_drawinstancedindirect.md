...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | DrawInstancedIndirect is supported beginning with the Windows 7 operating system. DrawInstancedIndirect is supported beginning with the Windows 7 operating system. |
