...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | CreateDomainShader is supported beginning with the Windows 7 operating system. CreateDomainShader is supported beginning with the Windows 7 operating system. |
