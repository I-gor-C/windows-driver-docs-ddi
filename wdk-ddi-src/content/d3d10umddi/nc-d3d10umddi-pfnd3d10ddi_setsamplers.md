...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | CsSetSamplers is supported beginning with the Windows 7 operating system. CsSetSamplers is supported beginning with the Windows 7 operating system. |
