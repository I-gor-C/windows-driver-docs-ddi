...
<div> </div>
Only the difference between two independent statistic requests will provide meaningful information. The driver should calculate the difference between the statistic data that it receives when a call to its <a href="https://msdn.microsoft.com/2f0a7462-83a6-47df-b5f6-b3706b875349">QueryBegin</a> function occurs and the statistic data that it receives when a call to its <a href="https://msdn.microsoft.com/5a231d7e-7e47-40ad-99d1-82661dec41d0">QueryEnd</a> function occurs.</td>
                </tr>
...
The data that the driver associates with this query type is a <a href="https://msdn.microsoft.com/library/windows/hardware/ff541976">D3D10_DDI_QUERY_DATA_SO_STATISTICS</a> structure.</td>
                </tr>
