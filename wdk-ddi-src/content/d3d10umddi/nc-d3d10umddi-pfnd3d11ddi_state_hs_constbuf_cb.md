...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | pfnStateHsConstBufCb is supported beginning with the Windows 7 operating system. pfnStateHsConstBufCb is supported beginning with the Windows 7 operating system. |
