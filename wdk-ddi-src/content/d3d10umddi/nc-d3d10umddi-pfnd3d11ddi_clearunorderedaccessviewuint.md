...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | ClearUnorderedAccessViewUINT is supported beginning with the Windows 7 operating system. ClearUnorderedAccessViewUINT is supported beginning with the Windows 7 operating system. |
