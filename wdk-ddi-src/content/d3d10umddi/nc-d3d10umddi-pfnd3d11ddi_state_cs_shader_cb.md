...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | pfnStateCsShaderCb is supported beginning with the Windows 7 operating system. pfnStateCsShaderCb is supported beginning with the Windows 7 operating system. |
