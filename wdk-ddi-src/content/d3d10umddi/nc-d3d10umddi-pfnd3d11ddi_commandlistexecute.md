...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | CommandListExecute is supported beginning with the Windows 7 operating system. CommandListExecute is supported beginning with the Windows 7 operating system. |
