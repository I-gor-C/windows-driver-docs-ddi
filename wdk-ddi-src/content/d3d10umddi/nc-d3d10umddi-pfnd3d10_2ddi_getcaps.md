...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | GetCaps(D3D10_2) is supported beginning with the Windows 7 operating system. GetCaps(D3D10_2) is supported beginning with the Windows 7 operating system. |
