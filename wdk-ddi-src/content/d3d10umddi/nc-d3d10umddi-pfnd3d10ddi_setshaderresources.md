...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | CsSetShaderResources is supported beginning with the Windows 7 operating system. CsSetShaderResources is supported beginning with the Windows 7 operating system. |
