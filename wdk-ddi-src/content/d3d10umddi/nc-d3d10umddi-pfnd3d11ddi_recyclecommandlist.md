...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | RecycleCommandList is supported beginning with the Windows 7 operating system. RecycleCommandList is supported beginning with the Windows 7 operating system. |
