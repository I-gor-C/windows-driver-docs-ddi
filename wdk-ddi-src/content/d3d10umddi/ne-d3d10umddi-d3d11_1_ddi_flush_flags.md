...
ms.date: 12/29/2017
ms.keywords: D3D11_1_DDI_FLUSH_FLAGS, D3D11_1DDI_FLUSH_UNLESS_NO_COMMANDS, d3d10umddi/D3DWDDM1_3DDI_TRIM_MEMORY, D3D11_1_DDI_FLUSH_FLAGS enumeration [Display Devices], display.d3d11_1_ddi_flush_flags, d3d10umddi/D3D11_1_DDI_FLUSH_FLAGS, d3d10umddi/D3D11_1DDI_FLUSH_UNLESS_NO_COMMANDS, D3DWDDM1_3DDI_TRIM_MEMORY
...
<table>
                ...
                <tr>
                    <td>D3D11_1DDI_FLUSH_UNLESS_NO_COMMANDS</td>
                    <td>The driver should not submit command buffers if there have been no new commands since the last time the driver submitted a command buffer.</td>
                </tr>
            
                <tr>
                    <td>D3DWDDM1_3DDI_TRIM_MEMORY</td>
...
Supported starting with Windows 8.1 for WDDM 1.3 and later user-mode display drivers.</td>
                </tr>
</table>
