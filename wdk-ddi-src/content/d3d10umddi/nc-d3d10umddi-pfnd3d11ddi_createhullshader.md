...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | CreateHullShader is supported beginning with the Windows 7 operating system. CreateHullShader is supported beginning with the Windows 7 operating system. |
