...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | AbandonCommandList is supported beginning with the Windows 7 operating system. AbandonCommandList is supported beginning with the Windows 7 operating system. |
