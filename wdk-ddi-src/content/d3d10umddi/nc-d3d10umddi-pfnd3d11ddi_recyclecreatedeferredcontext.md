...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | RecycleCreateDeferredContext is supported beginning with the Windows 7 operating system. RecycleCreateDeferredContext is supported beginning with the Windows 7 operating system. |
