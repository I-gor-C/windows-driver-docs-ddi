...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | pfnStateCsConstBufCb is supported beginning with the Windows 7 operating system. pfnStateCsConstBufCb is supported beginning with the Windows 7 operating system. |
