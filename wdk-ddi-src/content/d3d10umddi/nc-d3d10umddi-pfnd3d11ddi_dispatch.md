...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | Dispatch is supported beginning with the Windows 7 operating system. Dispatch is supported beginning with the Windows 7 operating system. |
