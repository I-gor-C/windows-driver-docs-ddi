...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | CopyStructureCount is supported beginning with the Windows 7 operating system. CopyStructureCount is supported beginning with the Windows 7 operating system. |
