...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | SetRenderTargets(D3D11) is supported beginning with the Windows 7 operating system. SetRenderTargets(D3D11) is supported beginning with the Windows 7 operating system. |
