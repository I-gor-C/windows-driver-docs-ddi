# Declarations in the ucmtcpciportcontrollerrequests header
This header Ucmtcpciportcontrollerrequests contains these programming interfaces:
...
| [UCMTCPCI_PORT_CONTROLLER_CONTROL_TYPE enumeration](ne-ucmtcpciportcontrollerrequests--ucmtcpci-port-controller-control-type.md) | TBD |
Struct
