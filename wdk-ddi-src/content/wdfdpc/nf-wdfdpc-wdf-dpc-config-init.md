...
<p>The <b>WDF_DPC_CONFIG_INIT</b> function initializes a driver's <a href="..\wdfdpc\ns-wdfdpc--wdf-dpc-config.md">WDF_DPC_CONFIG</a> structure.</p>
...
<dd>
<p>A pointer to a driver-allocated <a href="..\wdfdpc\ns-wdfdpc--wdf-dpc-config.md">WDF_DPC_CONFIG</a> structure.</p>
</dd>
...
<p>For a code example that uses the <b>WDF_DPC_CONFIG_INIT</b> function, see <a href="..\wdfdpc\nf-wdfdpc-wdfdpccreate.md">WdfDpcCreate</a>.</p>
