...
title: WdfWmiInstanceGetProvider
...
<p>The <b>WdfWmiInstanceGetProvider</b> method returns a handle to the WMI provider object that is the parent object of a specified WMI instance object.</p>
...
## -returns
<p><b>WdfWmiInstanceGetProvider</b> returns a handle to a WMI provider object.</p>

<p>A bug check occurs if the driver supplies an invalid object handle.

</p>

<p>The following code example obtains a handle to the WMI provider object that is the parent object of a specified WMI instance object.</p>
