...
ms.date: 12/15/2017
ms.keywords: _STORAGE_DEVICE_LAYOUT_SIGNATURE, STORAGE_DEVICE_LAYOUT_SIGNATURE, PSTORAGE_DEVICE_LAYOUT_SIGNATURE, *PSTORAGE_DEVICE_LAYOUT_SIGNATURE
...
## -remarks
The device layout signature contributes to the definition of a device unique identifier (DUID). For more information about DUIDs, see the description of the <a href="storage.storage_device_unique_identifier">STORAGE_DEVICE_UNIQUE_IDENTIFIER</a> structure.
...
<dl>
<dt>
<a href="storage.storage_device_unique_identifier">STORAGE_DEVICE_UNIQUE_IDENTIFIER</a>
</dt>
</dl>
 
