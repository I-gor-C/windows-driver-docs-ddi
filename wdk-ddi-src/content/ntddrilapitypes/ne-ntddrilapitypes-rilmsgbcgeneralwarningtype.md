...
ms.date : 1/18/2018
ms.keywords : ntddrilapitypes/RILMSGBCGENERALWARNINGTYPE, ntddrilapitypes/RIL_WARNINGTYPE_TSUNAMI, netvista.rilmsgbcgeneralwarningtype, ntddrilapitypes/RIL_WARNINGTYPE_TEST, RIL_WARNINGTYPE_TSUNAMI, ntddrilapitypes/RIL_WARNINGTYPE_EARTHQUAKETSUNAMI, RIL_WARNINGTYPE_OTHER, ntddrilapitypes/RIL_WARNINGTYPE_OTHER, RIL_WARNINGTYPE_MAX, ntddrilapitypes/RIL_WARNINGTYPE_MAX, RILMSGBCGENERALWARNINGTYPE enumeration [Network Drivers Starting with Windows Vista], RIL_WARNINGTYPE_RESERVED, ntddrilapitypes/RIL_WARNINGTYPE_RESERVED, RIL_WARNINGTYPE_TEST, RIL_WARNINGTYPE_EARTHQUAKETSUNAMI, RILMSGBCGENERALWARNINGTYPE
