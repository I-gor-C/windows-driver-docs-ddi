...
ms.date: 1/18/2018
ms.keywords: netvista.rilcallmediastate, RILCALLMEDIASTATE, ntddrilapitypes/RILCALLMEDIASTATE, RILCALLMEDIASTATE structure [Network Drivers Starting with Windows Vista], *LPRILCALLMEDIASTATE
