...
ms.date: 1/18/2018
ms.keywords: RILRADIOSTATEGROUPS structure [Network Drivers Starting with Windows Vista], RILRADIOSTATEGROUPS, *LPRILRADIOSTATEGROUPS, ntddrilapitypes/RILRADIOSTATEGROUPS, netvista.rilradiostategroups
