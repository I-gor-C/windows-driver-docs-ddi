...
ms.date: 1/18/2018
ms.keywords: RILRADIOSTATEGROUPS structure [Network Drivers Starting with Windows Vista], *LPRILRADIOSTATEGROUPS, RILRADIOSTATEGROUPS, ntddrilapitypes/RILRADIOSTATEGROUPS, netvista.rilradiostategroups
