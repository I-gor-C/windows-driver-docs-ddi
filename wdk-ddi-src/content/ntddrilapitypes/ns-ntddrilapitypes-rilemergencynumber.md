...
ms.date: 1/18/2018
ms.keywords: RILEMERGENCYNUMBER, RILEMERGENCYNUMBER structure [Network Drivers Starting with Windows Vista], netvista.rilemergencynumber, *LPRILEMERGENCYNUMBER, ntddrilapitypes/RILEMERGENCYNUMBER
