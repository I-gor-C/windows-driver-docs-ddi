...
ms.date: 1/18/2018
ms.keywords: RILMSGCDMAOUTSUBMIT, netvista.rilmsgcdmaoutsubmit, RILMSGCDMAOUTSUBMIT structure [Network Drivers Starting with Windows Vista], *LPRILMSGCDMAOUTSUBMIT, ntddrilapitypes/RILMSGCDMAOUTSUBMIT
