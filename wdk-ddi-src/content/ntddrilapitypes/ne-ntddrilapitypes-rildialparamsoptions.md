...
ms.date : 1/18/2018
ms.keywords : ntddrilapitypes/RIL_DIALOPT_ALL, ntddrilapitypes/RIL_DIALOPT_ANYEXECUTORFOREMERGENCY, RIL_DIALOPT_RESTRICTID, RIL_DIALOPT_ALL, ntddrilapitypes/RIL_DIALOPT_PRESENTID, RILDIALPARAMSOPTIONS enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_DIALOPT_RESTRICTID, RIL_DIALOPT_RTTFULL, RIL_DIALOPT_PRESENTID, RIL_DIALOPT_ANYEXECUTORFOREMERGENCY, ntddrilapitypes/RIL_DIALOPT_RTTFULL, RILDIALPARAMSOPTIONS, ntddrilapitypes/RILDIALPARAMSOPTIONS, netvista.rildialparamsoptions
