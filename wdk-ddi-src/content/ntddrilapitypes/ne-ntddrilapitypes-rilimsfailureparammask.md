...
ms.date : 1/18/2018
ms.keywords : RILIMSFAILUREPARAMMASK, netvista.rilimsfailureparammask, RIL_PARAM_IMSFAILURE_ERRORSTRING, ntddrilapitypes/RIL_PARAM_IMSFAILURE_MESSAGETYPE, ntddrilapitypes/RIL_PARAM_IMSFAILURE_ERRORCODE, RIL_PARAM_IMSFAILURE_MESSAGESUBTYPE, ntddrilapitypes/RILIMSFAILUREPARAMMASK, ntddrilapitypes/RIL_PARAM_IMSFAILURE_MESSAGESUBTYPE, ntddrilapitypes/RIL_PARAM_IMSFAILURE_ERRORSTRING, RIL_PARAM_IMSFAILURE_ALL, ntddrilapitypes/RIL_PARAM_IMSFAILURE_ALL, RIL_PARAM_IMSFAILURE_ERRORCODE, RILIMSFAILUREPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_IMSFAILURE_MESSAGETYPE
