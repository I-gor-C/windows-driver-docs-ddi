...
ms.date: 1/18/2018
ms.keywords: RILSENDDTMFPARAMS structure [Network Drivers Starting with Windows Vista], RILSENDDTMFPARAMS, *LPRILSENDDTMFPARAMS, netvista.rilsenddtmfparams, ntddrilapitypes/RILSENDDTMFPARAMS
