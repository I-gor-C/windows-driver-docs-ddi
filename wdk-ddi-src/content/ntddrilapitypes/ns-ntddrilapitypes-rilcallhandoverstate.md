...
ms.date : 1/18/2018
ms.keywords : RILCALLHANDOVERSTATE structure [Network Drivers Starting with Windows Vista], RILCALLHANDOVERSTATE, ntddrilapitypes/RILCALLHANDOVERSTATE, netvista.rilcallhandoverstate, *LPRILCALLHANDOVERSTATE
