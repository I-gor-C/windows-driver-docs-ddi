...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_CALLCMD_ASSUREDCALLTRANSFER, ntddrilapitypes/RIL_CALLCMD_HOLDACTIVE_ACCEPTHELD, ntddrilapitypes/RIL_CALLCMD_ADDHELDTOCONF, RIL_CALLCMD_ADDHELDTOCONF_DISCONNECT, RIL_CALLCMD_RTT, ntddrilapitypes/RIL_CALLCMD_OFFERMEDIA, RIL_CALLCMD_MAX, RILMANAGECALLPARAMSCOMMAND, ntddrilapitypes/RIL_CALLCMD_RELEASEHELDCONFCALL, ntddrilapitypes/RIL_CALLCMD_RTT, ntddrilapitypes/RIL_CALLCMD_ANSWERMEDIAOFFER, RIL_CALLCMD_RELEASEPROCEEDING, RIL_CALLCMD_ACCEPTINCOMINGCALL, ntddrilapitypes/RIL_CALLCMD_HOLDALLBUTONE, RIL_CALLCMD_OFFERMEDIA, ntddrilapitypes/RIL_CALLCMD_ACCEPTINCOMINGCALL, ntddrilapitypes/RIL_CALLCMD_ADDHELDTOCONF_DISCONNECT, RIL_CALLCMD_ANSWERMEDIAOFFER, ntddrilapitypes/RIL_CALLCMD_RELEASEPROCEEDING, RIL_CALLCMD_ADDHELDTOCONF, ntddrilapitypes/RIL_CALLCMD_RELEASECALL, ntddrilapitypes/RIL_CALLCMD_CONSULTATIVECALLTRANSFER, RIL_CALLCMD_HOLDALLBUTONE, RIL_CALLCMD_ASSUREDCALLTRANSFER, ntddrilapitypes/RIL_CALLCMD_MAX, RIL_CALLCMD_HOLDACTIVE_ACCEPTHELD, RIL_CALLCMD_RELEASEHELDCONFCALL, netvista.rilmanagecallparamscommand, RIL_CALLCMD_CONSULTATIVECALLTRANSFER, ntddrilapitypes/RIL_CALLCMD_BLINDCALLTRANSFER, ntddrilapitypes/RIL_CALLCMD_RELEASEALLCALLS, RIL_CALLCMD_RELEASEALLCALLS, RIL_CALLCMD_BLINDCALLTRANSFER, RILMANAGECALLPARAMSCOMMAND enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILMANAGECALLPARAMSCOMMAND, RIL_CALLCMD_RELEASECALL
