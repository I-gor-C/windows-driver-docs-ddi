...
ms.date : 1/18/2018
ms.keywords : netvista.rildmconfiginfotype, ntddrilapitypes/RIL_DMCV_TYPE_STRING, RIL_DMCV_TYPE_BOOLEAN, RILDMCONFIGINFOTYPE enumeration [Network Drivers Starting with Windows Vista], RILDMCONFIGINFOTYPE, RIL_DMCV_TYPE_MAX, ntddrilapitypes/RIL_DMCV_TYPE_BOOLEAN, RIL_DMCV_TYPE_STRING, ntddrilapitypes/RILDMCONFIGINFOTYPE, ntddrilapitypes/RIL_DMCV_TYPE_MAX, ntddrilapitypes/RIL_DMCV_TYPE_DWORD, RIL_DMCV_TYPE_DWORD
