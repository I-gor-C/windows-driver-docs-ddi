...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_CPS_ADDRESS, ntddrilapitypes/RIL_PARAM_CPS_CALLTRANSFER, ntddrilapitypes/RIL_PARAM_CPS_PARTICIPANTOP, netvista.rilconfparticipantstatusparammask, ntddrilapitypes/RILCONFPARTICIPANTSTATUSPARAMMASK, RIL_PARAM_CPS_PARTICIPANTOP, RIL_PARAM_CPS_ALL, ntddrilapitypes/RIL_PARAM_CPS_ALL, RIL_PARAM_CPS_ADDRESS, RIL_PARAM_CPS_CALLTRANSFER, ntddrilapitypes/RIL_PARAM_CPS_SIPSTATUS, RIL_PARAM_CPS_SIPSTATUS, ntddrilapitypes/RIL_PARAM_CPS_ID, RILCONFPARTICIPANTSTATUSPARAMMASK, RILCONFPARTICIPANTSTATUSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_CPS_ID
