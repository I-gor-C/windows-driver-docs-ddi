...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_CPS_ID, ntddrilapitypes/RIL_PARAM_CPS_PARTICIPANTOP, RILCONFPARTICIPANTSTATUSPARAMMASK, RILCONFPARTICIPANTSTATUSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_CPS_CALLTRANSFER, RIL_PARAM_CPS_SIPSTATUS, ntddrilapitypes/RIL_PARAM_CPS_ADDRESS, ntddrilapitypes/RIL_PARAM_CPS_ALL, RIL_PARAM_CPS_ALL, netvista.rilconfparticipantstatusparammask, ntddrilapitypes/RIL_PARAM_CPS_ID, RIL_PARAM_CPS_PARTICIPANTOP, ntddrilapitypes/RIL_PARAM_CPS_CALLTRANSFER, RIL_PARAM_CPS_ADDRESS, ntddrilapitypes/RILCONFPARTICIPANTSTATUSPARAMMASK, ntddrilapitypes/RIL_PARAM_CPS_SIPSTATUS
