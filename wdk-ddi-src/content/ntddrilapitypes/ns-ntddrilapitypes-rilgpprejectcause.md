...
ms.date : 1/18/2018
ms.keywords : netvista.rilgpprejectcause, *LPRILGPPREJECTCAUSE, RILGPPREJECTCAUSE structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILGPPREJECTCAUSE, RILGPPREJECTCAUSE
