...
ms.date: 1/18/2018
ms.keywords: RILGPPREJECTCAUSE structure [Network Drivers Starting with Windows Vista], *LPRILGPPREJECTCAUSE, netvista.rilgpprejectcause, RILGPPREJECTCAUSE, ntddrilapitypes/RILGPPREJECTCAUSE
