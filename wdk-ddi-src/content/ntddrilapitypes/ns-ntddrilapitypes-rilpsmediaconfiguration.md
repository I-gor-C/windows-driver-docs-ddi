...
ms.date: 1/18/2018
ms.keywords: RILPSMEDIACONFIGURATION structure [Network Drivers Starting with Windows Vista], *LPRILPSMEDIACONFIGURATION, netvista.rilpsmediaconfiguration, ntddrilapitypes/RILPSMEDIACONFIGURATION, RILPSMEDIACONFIGURATION
