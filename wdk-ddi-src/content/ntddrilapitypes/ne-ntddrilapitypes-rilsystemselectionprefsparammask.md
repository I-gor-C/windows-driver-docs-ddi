...
ms.date : 1/18/2018
ms.keywords : ntddrilapitypes/RIL_PARAM_SSP_ACQUISITIONORDERSIZE, ntddrilapitypes/RILSYSTEMSELECTIONPREFSPARAMMASK, netvista.rilsystemselectionprefsparammask, RIL_PARAM_SSP_SYSTEMTYPES, ntddrilapitypes/RIL_PARAM_SSP_ROAMINGMODE, RIL_PARAM_SSP_ACQUISITIONORDER, ntddrilapitypes/RIL_PARAM_SSP_ACQUISITIONORDER, ntddrilapitypes/RIL_PARAM_SSP_MODE, RIL_PARAM_SSP_MODE, RIL_PARAM_SSP_ROAMINGMODE, RIL_PARAM_SSP_ACQUISITIONORDERSIZE, RIL_PARAM_SSP_ALL, ntddrilapitypes/RIL_PARAM_SSP_SYSTEMTYPES, ntddrilapitypes/RIL_PARAM_SSP_ALL, RILSYSTEMSELECTIONPREFSPARAMMASK, RILSYSTEMSELECTIONPREFSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PARAM_SSP_PLMNINFO, RIL_PARAM_SSP_PLMNINFO
