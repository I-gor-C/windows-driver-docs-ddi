...
ms.date: 1/18/2018
ms.keywords: RILMSGOUTSUBMIT, RILMSGOUTSUBMIT structure [Network Drivers Starting with Windows Vista], *LPRILMSGOUTSUBMIT, ntddrilapitypes/RILMSGOUTSUBMIT, netvista.rilmsgoutsubmit
