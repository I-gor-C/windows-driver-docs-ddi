...
ms.date: 1/18/2018
ms.keywords: netvista.riluicccmdparameters, *LPRILUICCCMDPARAMETERS, RILUICCCMDPARAMETERS, RILUICCCMDPARAMETERS structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILUICCCMDPARAMETERS
