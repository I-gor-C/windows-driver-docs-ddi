...
ms.date: 1/18/2018
ms.keywords: RILPHONEBOOKENTRY, netvista.rilphonebookentry, RILPHONEBOOKENTRY structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILPHONEBOOKENTRY, *LPRILPHONEBOOKENTRY
