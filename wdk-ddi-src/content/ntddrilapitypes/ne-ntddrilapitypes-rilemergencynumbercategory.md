...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RIL_ENUM_MOUNTAIN_RESCUE, ntddrilapitypes/RIL_ENUM_FIRE_BRIGADE, RIL_ENUM_AUTO_ECALL, ntddrilapitypes/RIL_ENUM_MANUAL_ECALL, ntddrilapitypes/RIL_ENUM_ALL, ntddrilapitypes/RIL_ENUM_AMBULANCE, RIL_ENUM_MANUAL_ECALL, ntddrilapitypes/RILEMERGENCYNUMBERCATEGORY, netvista.rilemergencynumbercategory, RILEMERGENCYNUMBERCATEGORY enumeration [Network Drivers Starting with Windows Vista], RIL_ENUM_FIRE_BRIGADE, ntddrilapitypes/RIL_ENUM_MARINE_GUARD, RIL_ENUM_ALL, RIL_ENUM_AMBULANCE, RIL_ENUM_MARINE_GUARD, RIL_ENUM_MOUNTAIN_RESCUE, ntddrilapitypes/RIL_ENUM_AUTO_ECALL, RILEMERGENCYNUMBERCATEGORY
