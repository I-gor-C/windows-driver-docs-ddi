...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_CMI_MODIFICATIONTYPE, RILCALLMODIFICATIONINFOPARAMMASK, RIL_PARAM_CMI_ADDRESS, RILCALLMODIFICATIONINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PARAM_CMI_OLDCALLTYPE, ntddrilapitypes/RILCALLMODIFICATIONINFOPARAMMASK, ntddrilapitypes/RIL_PARAM_CMI_ALPHAIDENTIFIER, ntddrilapitypes/RIL_PARAM_CMI_ADDRESS, RIL_PARAM_CMI_OLDCALLTYPE, ntddrilapitypes/RIL_PARAM_CMI_ALL, ntddrilapitypes/RIL_PARAM_CMI_NEWCALLTYPE, RIL_PARAM_CMI_ALL, RIL_PARAM_CMI_ID, RIL_PARAM_CMI_NEWCALLTYPE, RIL_PARAM_CMI_ALPHAIDENTIFIER, RIL_PARAM_CMI_MODIFICATIONTYPE, netvista.rilcallmodificationinfoparammask, ntddrilapitypes/RIL_PARAM_CMI_ID
