...
ms.date: 1/18/2018
ms.keywords: netvista.rilwritemsgparams, RILWRITEMSGPARAMS structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILWRITEMSGPARAMS, RILWRITEMSGPARAMS, *LPRILWRITEMSGPARAMS
