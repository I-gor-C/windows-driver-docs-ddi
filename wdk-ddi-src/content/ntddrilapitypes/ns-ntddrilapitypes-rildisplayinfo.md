...
ms.date: 1/18/2018
ms.keywords: RILDISPLAYINFO structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILDISPLAYINFO, RILDISPLAYINFO, netvista.rildisplayinfo, *LPRILDISPLAYINFO
