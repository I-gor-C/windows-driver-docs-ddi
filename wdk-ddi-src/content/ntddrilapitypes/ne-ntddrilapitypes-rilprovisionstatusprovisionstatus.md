...
ms.date : 1/18/2018
ms.keywords : ntddrilapitypes/RIL_PROVISIONSTAT_FAILURE_END, RILPROVISIONSTATUSPROVISIONSTATUS, RILPROVISIONSTATUSPROVISIONSTATUS enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PROVISIONSTAT_BIP_STARTED, ntddrilapitypes/RIL_PROVISIONSTAT_BIP_SUCCESS, ntddrilapitypes/RIL_PROVISIONSTAT_FAILURE_RETRY, RIL_PROVISIONSTAT_NEEDED, ntddrilapitypes/RILPROVISIONSTATUSPROVISIONSTATUS, RIL_PROVISIONSTAT_SUCCESS, RIL_PROVISIONSTAT_BIP_STARTED, RIL_PROVISIONSTAT_BIP_SUCCESS, RIL_PROVISIONSTAT_FAILURE_END, ntddrilapitypes/RIL_PROVISIONSTAT_MAX, netvista.rilprovisionstatusprovisionstatus, ntddrilapitypes/RIL_PROVISIONSTAT_NEEDED, RIL_PROVISIONSTAT_MAX, RIL_PROVISIONSTAT_FAILURE_RETRY, ntddrilapitypes/RIL_PROVISIONSTAT_SUCCESS
