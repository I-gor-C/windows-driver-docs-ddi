...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_PROVISIONSTAT_FAILURE_END, RILPROVISIONSTATUSPROVISIONSTATUS, RIL_PROVISIONSTAT_NEEDED, RIL_PROVISIONSTAT_FAILURE_END, RIL_PROVISIONSTAT_SUCCESS, netvista.rilprovisionstatusprovisionstatus, RIL_PROVISIONSTAT_BIP_SUCCESS, ntddrilapitypes/RIL_PROVISIONSTAT_BIP_SUCCESS, ntddrilapitypes/RIL_PROVISIONSTAT_MAX, RIL_PROVISIONSTAT_FAILURE_RETRY, ntddrilapitypes/RIL_PROVISIONSTAT_SUCCESS, ntddrilapitypes/RIL_PROVISIONSTAT_NEEDED, RIL_PROVISIONSTAT_BIP_STARTED, RILPROVISIONSTATUSPROVISIONSTATUS enumeration [Network Drivers Starting with Windows Vista], RIL_PROVISIONSTAT_MAX, ntddrilapitypes/RIL_PROVISIONSTAT_FAILURE_RETRY, ntddrilapitypes/RIL_PROVISIONSTAT_BIP_STARTED, ntddrilapitypes/RILPROVISIONSTATUSPROVISIONSTATUS
