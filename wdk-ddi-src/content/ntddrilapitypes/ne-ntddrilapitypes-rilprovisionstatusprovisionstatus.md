...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RIL_PROVISIONSTAT_BIP_SUCCESS, RILPROVISIONSTATUSPROVISIONSTATUS enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PROVISIONSTAT_MAX, ntddrilapitypes/RIL_PROVISIONSTAT_FAILURE_END, RIL_PROVISIONSTAT_SUCCESS, RIL_PROVISIONSTAT_FAILURE_RETRY, RIL_PROVISIONSTAT_NEEDED, RIL_PROVISIONSTAT_BIP_SUCCESS, ntddrilapitypes/RIL_PROVISIONSTAT_NEEDED, ntddrilapitypes/RIL_PROVISIONSTAT_SUCCESS, RIL_PROVISIONSTAT_BIP_STARTED, RIL_PROVISIONSTAT_MAX, netvista.rilprovisionstatusprovisionstatus, ntddrilapitypes/RILPROVISIONSTATUSPROVISIONSTATUS, ntddrilapitypes/RIL_PROVISIONSTAT_BIP_STARTED, RILPROVISIONSTATUSPROVISIONSTATUS, RIL_PROVISIONSTAT_FAILURE_END, ntddrilapitypes/RIL_PROVISIONSTAT_FAILURE_RETRY
