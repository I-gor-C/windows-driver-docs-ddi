...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_SQ_SYSTEMTYPE, RIL_PARAM_SQ_SIGNALSTRENGTH, ntddrilapitypes/RIL_PARAM_SQ_SNR, ntddrilapitypes/RILSIGNALQUALITYPARAMMASK, RIL_PARAM_SQ_NUMSIGNALBARS, RIL_PARAM_SQ_ALL, RIL_PARAM_SQ_SYSTEMTYPE, ntddrilapitypes/RIL_PARAM_SQ_NUMSIGNALBARS, ntddrilapitypes/RIL_PARAM_SQ_ALL, RILSIGNALQUALITYPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RILSIGNALQUALITYPARAMMASK, netvista.rilsignalqualityparammask, ntddrilapitypes/RIL_PARAM_SQ_SIGNALSTRENGTH, RIL_PARAM_SQ_SNR
