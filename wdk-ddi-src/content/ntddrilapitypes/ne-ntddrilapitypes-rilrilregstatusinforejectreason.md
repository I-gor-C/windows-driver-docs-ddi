...
ms.date : 1/18/2018
ms.keywords : ntddrilapitypes/RIL_REGREJECTREASON_MACFAILURE, ntddrilapitypes/RIL_REGREJECTREASON_IMSIUNK_VLR, RIL_REGREJECTREASON_ILLEGAL_MS, RIL_REGREJECTREASON_CSG_NOTAUTHORIZED, ntddrilapitypes/RIL_REGREJECTREASON_SVCOPT_NOTSUPPORTED, ntddrilapitypes/RIL_REGREJECTREASON_IMSI_NOTACCEPTED, RIL_REGREJECTREASON_ILLEGAL_ME, RIL_REGREJECTREASON_IMSIUNK_VLR, RILRILREGSTATUSINFOREJECTREASON, RIL_REGREJECTREASON_PLMN_NOTALLOWED, ntddrilapitypes/RIL_REGREJECTREASON_CSG_NOTAUTHORIZED, ntddrilapitypes/RIL_REGREJECTREASON_NOSUITABLECELL, RIL_REGREJECTREASON_CONGESTION, RIL_REGREJECTREASON_REQSVCOPT_NOTSUBSCRIBED, RIL_REGREJECTREASON_SYNCHFAILURE, ntddrilapitypes/RIL_REGREJECTREASON_REQSVCOPT_NOTSUBSCRIBED, RIL_REGREJECTREASON_MACFAILURE, RIL_REGREJECTREASON_LOCAREA_NOTALLOWED, RIL_REGREJECTREASON_SVCOPT_NOTSUPPORTED, ntddrilapitypes/RIL_REGREJECTREASON_GSMAUTH_NOTACCEPTED, RIL_REGREJECTREASON_NOSUITABLECELL, ntddrilapitypes/RIL_REGREJECTREASON_CONGESTION, ntddrilapitypes/RIL_REGREJECTREASON_SVCOPT_OUTOFORDER, ntddrilapitypes/RIL_REGREJECTREASON_ILLEGAL_MS, ntddrilapitypes/RIL_REGREJECTREASON_ILLEGAL_ME, ntddrilapitypes/RILRILREGSTATUSINFOREJECTREASON, RIL_REGREJECTREASON_GSMAUTH_NOTACCEPTED, ntddrilapitypes/RIL_REGREJECTREASON_ROAMING_NOTALLOWED, RIL_REGREJECTREASON_IMSI_NOTACCEPTED, RIL_REGREJECTREASON_IMSIUNK_HLR, RIL_REGREJECTREASON_NETWORKFAILURE, ntddrilapitypes/RIL_REGREJECTREASON_NETWORKFAILURE, ntddrilapitypes/RIL_REGREJECTREASON_LOCAREA_NOTALLOWED, RIL_REGREJECTREASON_ROAMING_NOTALLOWED, ntddrilapitypes/RIL_REGREJECTREASON_IMSIUNK_HLR, ntddrilapitypes/RIL_REGREJECTREASON_SYNCHFAILURE, RILRILREGSTATUSINFOREJECTREASON enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_REGREJECTREASON_PLMN_NOTALLOWED, RIL_REGREJECTREASON_SVCOPT_OUTOFORDER, netvista.rilrilregstatusinforejectreason
