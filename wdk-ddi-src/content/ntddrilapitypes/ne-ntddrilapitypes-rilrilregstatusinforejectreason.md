...
ms.date: 1/18/2018
ms.keywords: RIL_REGREJECTREASON_ILLEGAL_MS, RIL_REGREJECTREASON_LOCAREA_NOTALLOWED, RIL_REGREJECTREASON_NETWORKFAILURE, ntddrilapitypes/RIL_REGREJECTREASON_REQSVCOPT_NOTSUBSCRIBED, ntddrilapitypes/RIL_REGREJECTREASON_ILLEGAL_MS, ntddrilapitypes/RIL_REGREJECTREASON_LOCAREA_NOTALLOWED, RIL_REGREJECTREASON_MACFAILURE, RIL_REGREJECTREASON_PLMN_NOTALLOWED, ntddrilapitypes/RIL_REGREJECTREASON_ROAMING_NOTALLOWED, RIL_REGREJECTREASON_GSMAUTH_NOTACCEPTED, ntddrilapitypes/RIL_REGREJECTREASON_PLMN_NOTALLOWED, RIL_REGREJECTREASON_SVCOPT_OUTOFORDER, RIL_REGREJECTREASON_ROAMING_NOTALLOWED, RIL_REGREJECTREASON_REQSVCOPT_NOTSUBSCRIBED, ntddrilapitypes/RIL_REGREJECTREASON_GSMAUTH_NOTACCEPTED, ntddrilapitypes/RIL_REGREJECTREASON_IMSI_NOTACCEPTED, RIL_REGREJECTREASON_CONGESTION, RIL_REGREJECTREASON_NOSUITABLECELL, RIL_REGREJECTREASON_SVCOPT_NOTSUPPORTED, RILRILREGSTATUSINFOREJECTREASON, ntddrilapitypes/RIL_REGREJECTREASON_MACFAILURE, RIL_REGREJECTREASON_CSG_NOTAUTHORIZED, netvista.rilrilregstatusinforejectreason, ntddrilapitypes/RIL_REGREJECTREASON_IMSIUNK_VLR, ntddrilapitypes/RIL_REGREJECTREASON_SVCOPT_NOTSUPPORTED, RIL_REGREJECTREASON_IMSIUNK_VLR, RIL_REGREJECTREASON_IMSIUNK_HLR, ntddrilapitypes/RIL_REGREJECTREASON_SVCOPT_OUTOFORDER, ntddrilapitypes/RIL_REGREJECTREASON_SYNCHFAILURE, ntddrilapitypes/RIL_REGREJECTREASON_NOSUITABLECELL, ntddrilapitypes/RIL_REGREJECTREASON_NETWORKFAILURE, ntddrilapitypes/RIL_REGREJECTREASON_ILLEGAL_ME, ntddrilapitypes/RIL_REGREJECTREASON_CSG_NOTAUTHORIZED, ntddrilapitypes/RIL_REGREJECTREASON_IMSIUNK_HLR, RILRILREGSTATUSINFOREJECTREASON enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILRILREGSTATUSINFOREJECTREASON, RIL_REGREJECTREASON_ILLEGAL_ME, ntddrilapitypes/RIL_REGREJECTREASON_CONGESTION, RIL_REGREJECTREASON_IMSI_NOTACCEPTED, RIL_REGREJECTREASON_SYNCHFAILURE
