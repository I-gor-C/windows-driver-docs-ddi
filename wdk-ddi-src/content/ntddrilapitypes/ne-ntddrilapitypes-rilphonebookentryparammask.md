...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_PBE_ADDITIONALNUMSIZE, RIL_PARAM_PBE_EMAILOFFSET, RIL_PARAM_PBE_GROUPIDCOUNT, ntddrilapitypes/RIL_PARAM_PBE_ADDITIONALNUMSIZE, RIL_PARAM_PBE_ADDITIONALNUMCOUNT, ntddrilapitypes/RILPHONEBOOKENTRYPARAMMASK, ntddrilapitypes/RIL_PARAM_PBE_ALL, RIL_PARAM_PBE_ADDRESS, ntddrilapitypes/RIL_PARAM_PBE_GROUPID, ntddrilapitypes/RIL_PARAM_PBE_EMAILCOUNT, RIL_PARAM_PBE_EMAILSIZE, RILPHONEBOOKENTRYPARAMMASK enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PARAM_PBE_EMAILOFFSET, RIL_PARAM_PBE_TEXT, ntddrilapitypes/RIL_PARAM_PBE_ADDITIONALNUMCOUNT, ntddrilapitypes/RIL_PARAM_PBE_ADDITIONALNUMOFFSET, RIL_PARAM_PBE_ALL, ntddrilapitypes/RIL_PARAM_PBE_ADDRESS, RIL_PARAM_PBE_EMAILCOUNT, ntddrilapitypes/RIL_PARAM_PBE_TEXT, RIL_PARAM_PBE_SECONDNAME, ntddrilapitypes/RIL_PARAM_PBE_GROUPIDCOUNT, RIL_PARAM_PBE_GROUPID, RILPHONEBOOKENTRYPARAMMASK, ntddrilapitypes/RIL_PARAM_PBE_SECONDNAME, netvista.rilphonebookentryparammask, ntddrilapitypes/RIL_PARAM_PBE_EMAILSIZE, RIL_PARAM_PBE_ADDITIONALNUMOFFSET
