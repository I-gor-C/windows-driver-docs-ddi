...
ms.date: 1/18/2018
ms.keywords: netvista.rilphoneentrystorelocation, RILPHONEENTRYSTORELOCATION enumeration [Network Drivers Starting with Windows Vista], RIL_PBLOC_UICCFIXDIALING, RIL_PBLOC_OWNNUMBERS, RIL_PBLOC_ALL, RILPHONEENTRYSTORELOCATION, ntddrilapitypes/RIL_PBLOC_UICCFIXDIALING, ntddrilapitypes/RIL_PBLOC_UICCPHONEBOOK, ntddrilapitypes/RIL_PBLOC_UICCSERVICEDIALING, RIL_PBLOC_UICCSERVICEDIALING, RIL_PBLOC_UICCPHONEBOOK, ntddrilapitypes/RIL_PBLOC_OWNNUMBERS, ntddrilapitypes/RIL_PBLOC_ALL, ntddrilapitypes/RILPHONEENTRYSTORELOCATION
