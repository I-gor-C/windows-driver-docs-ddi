...
<dd>
<p>A <a href="..\usbfnbase\ns-usbfnbase--usbfn-class-interface-ex.md">USBFN_CLASS_INTERFACE_EX</a> structure that describes an interface for full speed device.</p>
</dd>

### -field HighSpeedClassInterface

<dd>
<p>A <a href="..\usbfnbase\ns-usbfnbase--usbfn-class-interface-ex.md">USBFN_CLASS_INTERFACE_EX</a> structure that describes an interface for high speed device.</p>
</dd>
