...
| Title | Description |
| ---- |:---- |
| [_USBFN_INTERFACE_ATTACH](ns-usbfnattach-_usbfn_interface_attach.md) | Stores pointers to driver-implemented callback functions for handling attach and detach operations. |
| [_USBFN_ON_ATTACH](ns-usbfnattach-_usbfn_on_attach.md) | Describes the detected port type and attach action. |


## Enumerations
| Title | Description |
| ---- |:---- |
| [_USBFN_ATTACH_ACTION](ne-usbfnattach-_usbfn_attach_action.md) | Defines the actions that the Universal Serial Bus (USB) function stack takes when a device is attached to a USB port. |