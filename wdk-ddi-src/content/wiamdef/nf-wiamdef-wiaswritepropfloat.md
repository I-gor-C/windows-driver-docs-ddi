...
## -description
<p>The <b>wiasWritePropFloat </b>function writes a single floating-point property value to a WIA item.</p>
...
<dd>
<p>A Pointer to a WIA item context.</p>
</dd>
...
<dd>
<p>Specifies the floating-point property value to write to the item.</p>
</dd>
</dl>
