...
## -remarks
The wiasDebugError function is not recommended for Windows XP and later. For Windows XP use the <a href="image.wias_lerror">WIAS_LERROR</a> macro instead. For Windows Vista use the <a href="image.wias_error">WIAS_ERROR</a> macro instead.
