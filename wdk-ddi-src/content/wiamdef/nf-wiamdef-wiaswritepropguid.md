...
## -description
<p>The <b>wiasWritePropGuid </b>function writes a single GUID property value to a WIA item.</p>
...
<dd>
<p>Specifies a GUID property value to write to the item.</p>
</dd>
</dl>
