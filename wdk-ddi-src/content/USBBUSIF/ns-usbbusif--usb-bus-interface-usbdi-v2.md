...
title: USB_BUS_INTERFACE_USBDI_V2
...
req.dll: 
req.irql: 
ms.keywords: USB_BUS_INTERFACE_USBDI_V2, USB_BUS_INTERFACE_USBDI_V2, *PUSB_BUS_INTERFACE_USBDI_V2
req.iface: 
req.product: Windows 10 or later.
---

# USB_BUS_INTERFACE_USBDI_V2 structure



## -description
<p>The <b>USB_BUS_INTERFACE_USBDI_V2</b> structure is provided by the USB hub driver to allow USB clients to make direct calls to the hub driver without allocating IRPs. </p>
