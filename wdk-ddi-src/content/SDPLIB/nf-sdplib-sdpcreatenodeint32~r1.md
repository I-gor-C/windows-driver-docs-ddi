---
UID: NF.sdplib.SdpCreateNodeInt32~r1
title: SdpCreateNodeInt32
...
<p>The Bluetooth 
  ...
  <a href="https://msdn.microsoft.com/library/windows/hardware/ff536848">SDP_NODE</a> structure to a 32-bit integer type.</p>
...
<dd>
<p>It ensures the SDP_NODE structure's data type and data size fields are set appropriately.</p>
</dd>
<dd>
...
</dl><p>It ensures the SDP_NODE structure's data type and data size fields are set appropriately.</p>
