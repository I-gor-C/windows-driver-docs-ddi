...
ms.date: 2/20/2018
ms.keywords: video/VideoPortGetCommonBuffer, VideoPortGetCommonBuffer, VideoPortGetCommonBuffer function [Display Devices], display.videoportgetcommonbuffer, VideoPort_Functions_eead14aa-271b-49a2-8ded-482ffc73741e.xml
