...
The <i>OldIrql</i> value must be specified when the spin lock is released with <a href="display.videoportreleasespinlock">VideoPortReleaseSpinLock</a>.
...
<dl>
<dt>
<a href="display.videoportreleasespinlock">VideoPortReleaseSpinLock</a>
</dt>
<dt>
