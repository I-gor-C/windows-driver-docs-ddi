...
ms.date: 2/15/2018
ms.keywords: debugger.idebugfailureanalysis2_get, Get method [Windows Debugging], IDebugFailureAnalysis2 interface, Get, IDebugFailureAnalysis2 interface [Windows Debugging], Get method, IDebugFailureAnalysis2::Get, Get method [Windows Debugging], extsfns/IDebugFailureAnalysis2::Get, IDebugFailureAnalysis2
