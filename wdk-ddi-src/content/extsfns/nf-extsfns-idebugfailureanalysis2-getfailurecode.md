...
ms.date : 1/19/2018
ms.keywords : IDebugFailureAnalysis2::GetFailureCode, IDebugFailureAnalysis2 interface [Windows Debugging], GetFailureCode method, GetFailureCode method [Windows Debugging], GetFailureCode method [Windows Debugging], IDebugFailureAnalysis2 interface, GetFailureCode, debugger.idebugfailureanalysis2_getfailurecode, extsfns/IDebugFailureAnalysis2::GetFailureCode, IDebugFailureAnalysis2
