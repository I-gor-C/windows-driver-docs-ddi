...
## -returns
If this method succeeds, it returns a pointer to the new <a href="debugger.fa_entry">FA_ENTRY</a> structure. Otherwise, it returns <b>NULL</b>.
