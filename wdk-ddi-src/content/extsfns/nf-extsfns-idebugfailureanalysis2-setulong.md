...
ms.date : 1/19/2018
ms.keywords : IDebugFailureAnalysis2 interface [Windows Debugging], SetUlong method, debugger.idebugfailureanalysis2_setulong, IDebugFailureAnalysis2, IDebugFailureAnalysis2::SetUlong, extsfns/IDebugFailureAnalysis2::SetUlong, debugger.idebugfailureanalysis2_setextensionulong, SetUlong, SetUlong method [Windows Debugging], IDebugFailureAnalysis2 interface, SetUlong method [Windows Debugging]
