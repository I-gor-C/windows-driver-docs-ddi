...
ms.date: 1/19/2018
ms.keywords: SetUlong method [Windows Debugging], IDebugFailureAnalysis2 interface, SetUlong, SetUlong method [Windows Debugging], IDebugFailureAnalysis2::SetUlong, extsfns/IDebugFailureAnalysis2::SetUlong, debugger.idebugfailureanalysis2_setulong, debugger.idebugfailureanalysis2_setextensionulong, IDebugFailureAnalysis2, IDebugFailureAnalysis2 interface [Windows Debugging], SetUlong method
