...
ms.date: 1/19/2018
ms.keywords: GetBuffer, GetBuffer method [Windows Debugging], GetBuffer method [Windows Debugging], IDebugFailureAnalysis2 interface, IDebugFailureAnalysis2::GetBuffer, debugger.idebugfailureanalysis2_getbuffer, IDebugFailureAnalysis2 interface [Windows Debugging], GetBuffer method, IDebugFailureAnalysis2, extsfns/IDebugFailureAnalysis2::GetBuffer
