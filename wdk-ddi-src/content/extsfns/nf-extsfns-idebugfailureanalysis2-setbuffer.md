...
ms.date: 2/15/2018
ms.keywords: SetBuffer method [Windows Debugging], IDebugFailureAnalysis2 interface, IDebugFailureAnalysis2 interface [Windows Debugging], SetBuffer method, IDebugFailureAnalysis2::SetBuffer, SetBuffer, SetBuffer method [Windows Debugging], IDebugFailureAnalysis2, extsfns/IDebugFailureAnalysis2::SetBuffer, debugger.idebugfailureanalysis2_setbuffer
