...
ms.date: 1/19/2018
ms.keywords: IDebugFailureAnalysis2, IDebugFailureAnalysis2 interface [Windows Debugging], NextEntry method, NextEntry, IDebugFailureAnalysis2::NextEntry, debugger.idebugfailureanalysis2_nextentry, extsfns/IDebugFailureAnalysis2::NextEntry, NextEntry method [Windows Debugging], IDebugFailureAnalysis2 interface, NextEntry method [Windows Debugging]
