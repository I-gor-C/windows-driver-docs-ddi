...
ms.date: 2/15/2018
ms.keywords: IDebugFailureAnalysis2 interface [Windows Debugging], GetUlong method, GetUlong method [Windows Debugging], IDebugFailureAnalysis2::GetString, GetUlong method [Windows Debugging], IDebugFailureAnalysis2 interface, debugger.idebugfailureanalysis2_getstring, IDebugFailureAnalysis2::GetUlong, GetString, IDebugFailureAnalysis2, extsfns/IDebugFailureAnalysis2::GetUlong
