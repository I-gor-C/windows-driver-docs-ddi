...
ms.date: 1/19/2018
ms.keywords: debugger.idebugfailureanalysis2_getstring, IDebugFailureAnalysis2 interface [Windows Debugging], GetUlong method, GetUlong method [Windows Debugging], GetString, IDebugFailureAnalysis2::GetString, GetUlong method [Windows Debugging], IDebugFailureAnalysis2 interface, IDebugFailureAnalysis2::GetUlong, extsfns/IDebugFailureAnalysis2::GetUlong, IDebugFailureAnalysis2
