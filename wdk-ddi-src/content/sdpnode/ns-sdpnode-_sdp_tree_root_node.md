...
ms.date: 12/14/2017
ms.keywords: _SDP_TREE_ROOT_NODE, SDP_TREE_ROOT_NODE, *PSDP_TREE_ROOT_NODE, PSDP_TREE_ROOT_NODE
...
An 
     <a href="bltooth.sdp_node">SDP_NODE</a> structure that represents the root node of
...
The 
    <a href="bltooth.sdpaddattributetotree">SdpAddAttributeToTree</a> function adds
...
The 
    <a href="bltooth.sdpcreatenodetree">SdpCreateNodeTree</a> function creates an
...
The 
    <a href="bltooth.sdpfindattributeintree">SdpFindAttributeInTree</a> function
