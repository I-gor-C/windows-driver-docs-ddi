...
## -description
The <b>IStiDeviceControl::Release</b> method closes the instance of the COM object that was created when a minidriver client called <a href="image.istiusd_initialize">IStiUSD::Initialize</a>.
...
A still image minidriver receives an <b>IStiDeviceControl</b> interface pointer as input to its <a href="image.istiusd_initialize">IStiUSD::Initialize</a> method.
