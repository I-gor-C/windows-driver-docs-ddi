...
ms.date: 1/9/2018
ms.keywords: avc/AVC_FUNCTION, avc/AVC_FUNCTION_GET_UNIQUE_ID, avc/AVC_FUNCTION_GET_REQUEST, AVC_FUNCTION_SEND_RESPONSE, avc/AVC_FUNCTION_SET_CONNECTINFO, avc/AVC_FUNCTION_FIND_PEER_DO, stream.avc_function, avc/AVC_FUNCTION_GET_SUBUNIT_INFO, avc/AVC_FUNCTION_PEER_DO_LIST, AVC_FUNCTION_PEER_DO_LIST, AVC_FUNCTION_SET_CONNECTINFO, AVC_FUNCTION_GET_PIN_COUNT, AVC_FUNCTION_GET_PIN_DESCRIPTOR, avc/AVC_FUNCTION_GET_CONNECTINFO, avc/AVC_FUNCTION_SEND_RESPONSE, avc/AVC_FUNCTION_RELEASE, _tagAVC_FUNCTION, AVC_FUNCTION_GET_EXT_PLUG_COUNTS, AVC_FUNCTION_GET_REQUEST, AVC_FUNCTION_COMMAND, avc/AVC_FUNCTION_GET_PIN_DESCRIPTOR, AVC_FUNCTION_GET_UNIQUE_ID, AVC_FUNCTION, avc/AVC_FUNCTION_COMMAND, AVC_FUNCTION_GET_CONNECTINFO, avc/AVC_FUNCTION_GET_PIN_COUNT, avc/AVC_FUNCTION_CLR_CONNECTINFO, AVC_FUNCTION_ACQUIRE, AVC_FUNCTION_RELEASE, avcref_aa8add30-67c7-469c-ab3d-9173e7b4b91e.xml, AVC_FUNCTION enumeration [Streaming Media Devices], AVC_FUNCTION_GET_SUBUNIT_INFO, avc/AVC_FUNCTION_GET_EXT_PLUG_COUNTS, avc/AVC_FUNCTION_ACQUIRE, AVC_FUNCTION_CLR_CONNECTINFO, AVC_FUNCTION_FIND_PEER_DO
