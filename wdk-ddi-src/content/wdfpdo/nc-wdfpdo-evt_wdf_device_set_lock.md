...
## -remarks
Framework-based bus drivers can provide an <i>EvtDeviceSetLock</i> callback function. To register this callback function, bus drivers call <a href="wdf.wdfpdoinitseteventcallbacks">WdfPdoInitSetEventCallbacks</a>.
...
For more information about return values, see <a href="wdf.supporting_ejectable_devices">Supporting Ejectable Devices</a>.
