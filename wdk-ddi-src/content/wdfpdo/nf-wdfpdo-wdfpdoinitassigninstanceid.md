...
<dd>
<p>A pointer to a <a href="..\wudfwdm\ns-wudfwdm--unicode-string.md">UNICODE_STRING</a> structure that contains an <a href="NULL">instance ID</a> string. The driver can allocate the string's buffer from paged pool. </p>
</dd>
</dl>
