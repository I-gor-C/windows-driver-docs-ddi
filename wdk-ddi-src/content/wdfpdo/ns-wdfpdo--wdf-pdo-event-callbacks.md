...
## -remarks
<p>The <b>WDF_PDO_EVENT_CALLBACKS</b> structure is used as input to <a href="..\wdfpdo\nf-wdfpdo-wdfpdoinitseteventcallbacks.md">WdfPdoInitSetEventCallbacks</a>.</p>

<p>Drivers must call <a href="..\wdfpdo\nf-wdfpdo-wdf-pdo-event-callbacks-init.md">WDF_PDO_EVENT_CALLBACKS_INIT</a> to initialize this structure.</p>
...
<dl>
<dt>
<a href="..\wdffdo\ns-wdffdo--wdf-fdo-event-callbacks.md">WDF_FDO_EVENT_CALLBACKS</a>
</dt>
<dt>
