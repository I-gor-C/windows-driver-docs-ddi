...
ms.date: 1/4/2018
ms.keywords: VPCI_WRITE_BLOCK_INPUT structure [Kernel-Mode Driver Architecture], PVPCI_WRITE_BLOCK_INPUT structure pointer [Kernel-Mode Driver Architecture], *PVPCI_WRITE_BLOCK_INPUT, PVPCI_WRITE_BLOCK_INPUT, vpci/VPCI_WRITE_BLOCK_INPUT, kernel.vpci_write_block_input, _VPCI_WRITE_BLOCK_INPUT, vpci/PVPCI_WRITE_BLOCK_INPUT, VPCI_WRITE_BLOCK_INPUT
