...
## -description
Initializes a <a href="buses.udecx_usb_endpoint_callbacks">UDECX_USB_ENDPOINT_CALLBACKS</a> structure before a <a href="buses.udecxusbendpointcreate">UdecxUsbEndpointCreate</a> call.
...
A pointer to a <a href="buses.udecx_usb_endpoint_callbacks">UDECX_USB_ENDPOINT_CALLBACKS</a> to initialize.
