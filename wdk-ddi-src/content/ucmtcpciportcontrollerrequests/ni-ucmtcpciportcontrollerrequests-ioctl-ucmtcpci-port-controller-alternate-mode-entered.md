...
### -input-buffer
<p>A pointer to a <a href="https://msdn.microsoft.com/library/windows/hardware/mt805868">UCMTCPCI_PORT_CONTROLLER_ALTERNATE_MODE_ENTERED_IN_PARAMS</a> structure that contains information about the alternate mode. </p>

<p>A pointer to a <a href="https://msdn.microsoft.com/library/windows/hardware/mt805868">UCMTCPCI_PORT_CONTROLLER_ALTERNATE_MODE_ENTERED_IN_PARAMS</a> structure that contains information about the alternate mode. </p>

### -input-buffer-length
<p>The size of <a href="https://msdn.microsoft.com/library/windows/hardware/mt805868">UCMTCPCI_PORT_CONTROLLER_ALTERNATE_MODE_ENTERED_IN_PARAMS</a>.</p>
