...
### -input-buffer
A pointer to a <a href="buses.ucmtcpci_port_controller_alternate_mode_exited_in_params">UCMTCPCI_PORT_CONTROLLER_ALTERNATE_MODE_EXITED_IN_PARAMS</a> structure that contains information about the alternate mode. 

### -input-buffer-length
The size of <a href="buses.ucmtcpci_port_controller_alternate_mode_exited_in_params">UCMTCPCI_PORT_CONTROLLER_ALTERNATE_MODE_EXITED_IN_PARAMS</a>.
