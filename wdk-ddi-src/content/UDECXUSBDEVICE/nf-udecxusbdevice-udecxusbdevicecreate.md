...
## -description
<p>Creates a USB Device Emulation (UDE) device object.</p>
...
<dd>
<p>A pointer to a caller-allocated <a href="https://msdn.microsoft.com/library/windows/hardware/ff552400">WDF_OBJECT_ATTRIBUTES</a> structure that specifies attributes for the USB device object. </p>
</dd>

### -param <i>UdecxUsbDevice</i> [out]

<dd>
<p>A pointer to a variable that receives a handle to the new UDE device object that represents the virtual USB device.</p>
</dd>
</dl>
