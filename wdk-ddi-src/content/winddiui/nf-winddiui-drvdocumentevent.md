...
ms.date: 2/2/2018
ms.keywords: print.drvdocumentevent, winddiui/DrvDocumentEvent, DrvDocumentEvent, DrvDocumentEvent function [Print Devices], print_interface-graphics_ffc39ed1-d1b8-4e3d-b0a3-515b90cd6c8f.xml
