...
ms.date: 1/18/2018
ms.keywords: FWPS_FIELD_OUTBOUND_TRANSPORT_V4_INTERFACE_TYPE, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_SUB_INTERFACE_INDEX, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_INTERFACE_TYPE, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_LOCAL_ADDRESS_TYPE, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_LOCAL_ADDRESS, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_LOCAL_PORT, FWPS_FIELDS_OUTBOUND_TRANSPORT_V4 enumeration [Network Drivers Starting with Windows Vista], fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_LOCAL_ADDRESS, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_MAX, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_PROFILE_ID, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_REMOTE_ADDRESS, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_INTERFACE_INDEX, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_SUB_INTERFACE_INDEX, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_LOCAL_INTERFACE, FWPS_FIELDS_OUTBOUND_TRANSPORT_V4, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_DESTINATION_ADDRESS_TYPE, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_PROFILE_ID, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_TUNNEL_TYPE, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_REMOTE_PORT, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_REMOTE_PORT, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_MAX, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_LOCAL_PORT, netvista.fwps_fields_outbound_transport_v4, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_TUNNEL_TYPE, wfp_ref_5_const_3_data_fields_0bde34c9-33a9-4fc8-8caf-ed1ec3a0f847.xml, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_FLAGS, fwpsk/FWPS_FIELDS_OUTBOUND_TRANSPORT_V4, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_LOCAL_INTERFACE, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_INTERFACE_INDEX, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_FLAGS, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_PROTOCOL, fwpsk/FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_DESTINATION_ADDRESS_TYPE, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_REMOTE_ADDRESS, FWPS_FIELDS_OUTBOUND_TRANSPORT_V4_, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_LOCAL_ADDRESS_TYPE, FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_PROTOCOL
...
<table>
                ...
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_COMPARTMENT_ID</td>
                    <td></td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_FLAGS</td>
     ...
     <a href="https://msdn.microsoft.com/library/windows/hardware/ff549942">Filtering Condition Flags</a>.</td>
                ...
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_INTERFACE_INDEX</td>
                    <td>The index of the network interface, as enumerated by the network stack.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_INTERFACE_TYPE</td>
     ...
     <a href="http://go.microsoft.com/fwlink/p/?linkid=60066">IANAifType-MIB Definitions</a>.</td>
                ...
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_DESTINATION_ADDRESS_TYPE</td>
     ...
     <a href="https://msdn.microsoft.com/library/windows/hardware/ff568757">NL_ADDRESS_TYPE</a> enumeration.</td>
                ...
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_LOCAL_ADDRESS</td>
                    <td>The local IP address.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_LOCAL_ADDRESS_TYPE</td>
                    <td>The local IP address type. The possible values are defined by the 
     <a href="https://msdn.microsoft.com/library/windows/hardware/ff568757">NL_ADDRESS_TYPE</a> enumeration.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_LOCAL_INTERFACE</td>
                    <td>The locally unique identifier (<a href="..\igpupvdev\ns-igpupvdev-_luid.md">LUID</a>) for the network interface associated with the
     local IP address.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_LOCAL_PORT</td>
                    <td>The local transport protocol port number.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_PROTOCOL</td>
                    <td>The IP protocol number, as specified in RFC 1700.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_REMOTE_ADDRESS</td>
                    <td>The remote IP address.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IP_REMOTE_PORT</td>
                    <td>The remote transport protocol port number.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_IPSEC_SECURITY_REALM_ID</td>
                    <td></td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_MAX</td>
                    <td>The maximum value for this enumeration. This value might change in future versions of the NDIS
     header files and binaries.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_PROFILE_ID</td>
...
<div class="alert"><b>Note</b>  Supported starting with Windows 7.</div><div> </div></td>
                ...
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_SUB_INTERFACE_INDEX</td>
                    <td>The index of the logical network interface, as enumerated by the network stack.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_OUTBOUND_TRANSPORT_V4_TUNNEL_TYPE</td>
