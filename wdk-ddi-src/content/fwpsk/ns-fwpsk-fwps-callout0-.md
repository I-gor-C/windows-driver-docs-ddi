...
<p>A callout driver specifies this flag to indicate that the callout driver's 
       <a href="..\fwpsk\nc-fwpsk-fwps-callout-classify-fn0.md">classifyFn0</a> callout function is unaffected
...
<p>A pointer to the callout driver's 
     <a href="..\fwpsk\nc-fwpsk-fwps-callout-classify-fn0.md">classifyFn0</a> callout function. The filter
...
<dd>
<p>A pointer to the callout driver's 
     <a href="..\fwpsk\nc-fwpsk-fwps-callout-notify-fn0.md">notifyFn0</a> function. The filter engine calls
