...
<p>If the 
     <i>netBufferList</i> parameter describes a <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> chain, 
...
<dt><b>STATUS_SUCCESS</b></dt>
       ...
       <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> structure was allocated
...
<p>A callout driver calls the 
    ...
    <a href="..\fwpsk\nc-fwpsk-fwps-callout-classify-fn0.md">classifyFn</a> callout function to inject new
...
<p>A callout driver can also call the 
    ...
    <a href="..\fwpsk\nc-fwpsk-fwps-callout-classify-fn0.md">classifyFn</a> callout function to inject data into a data stream that is currently deferred. A data
...
<p>In addition, a callout driver can call the 
    <b>FwpsStreamInjectAsync0</b> function from outside of a callout's 
    <a href="..\fwpsk\nc-fwpsk-fwps-callout-classify-fn0.md">classifyFn</a> callout function to inject data into a data stream after a FIN indication has been
    pended.</p>
...
<p>Alternately, a callout driver can call the 
    ...
    <a href="..\fwpsk\nc-fwpsk-fwps-callout-classify-fn0.md">classifyFn</a> callout function if the callout driver clones and blocks all data indicated for
...
<p>A callout can pend a data segment by first cloning it with a call to the 
    ...
    <a href="netvista.fwps_classify_out0">FWPS_CLASSIFY_OUT0</a> structure.</p>
