...
ms.date: 12/14/2017
ms.keywords: FWPS_FIELDS_ALE_RESOURCE_ASSIGNMENT_V6_, FWPS_FIELDS_ALE_RESOURCE_ASSIGNMENT_V6
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: FWPS_FIELDS_ALE_RESOURCE_ASSIGNMENT_V6
req.alt-loc: fwpsk.h
req.ddi-compliance: 
req.unicode-ansi: 
req.idl: 
...
### -field For a description of these raw socket modes, see WSAIoctl in the Windows SDK documentation.
