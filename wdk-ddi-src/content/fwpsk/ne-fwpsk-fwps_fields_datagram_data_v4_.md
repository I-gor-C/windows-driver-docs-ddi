...
ms.date: 1/18/2018
ms.keywords: fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_DIRECTION, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_SUB_INTERFACE_INDEX, FWPS_FIELD_DATAGRAM_DATA_V4_IP_LOCAL_ADDRESS, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_IP_PROTOCOL, wfp_ref_5_const_3_data_fields_cefe4e9c-ec39-4078-9790-453448162e92.xml, FWPS_FIELD_DATAGRAM_DATA_V4_MAX, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_IP_LOCAL_INTERFACE, FWPS_FIELD_DATAGRAM_DATA_V4_IP_REMOTE_ADDRESS, FWPS_FIELD_DATAGRAM_DATA_V4_DIRECTION, FWPS_FIELDS_DATAGRAM_DATA_V4_, FWPS_FIELD_DATAGRAM_DATA_V4_IP_PROTOCOL, FWPS_FIELDS_DATAGRAM_DATA_V4, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_INTERFACE_TYPE, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_IP_REMOTE_ADDRESS, FWPS_FIELD_DATAGRAM_DATA_V4_INTERFACE_TYPE, FWPS_FIELD_DATAGRAM_DATA_V4_FLAGS, FWPS_FIELD_DATAGRAM_DATA_V4_IP_LOCAL_INTERFACE, FWPS_FIELD_DATAGRAM_DATA_V4_SUB_INTERFACE_INDEX, FWPS_FIELDS_DATAGRAM_DATA_V4 enumeration [Network Drivers Starting with Windows Vista], FWPS_FIELD_DATAGRAM_DATA_V4_TUNNEL_TYPE, FWPS_FIELD_DATAGRAM_DATA_V4_INTERFACE_INDEX, fwpsk/FWPS_FIELDS_DATAGRAM_DATA_V4, netvista.fwps_fields_datagram_data_v4, FWPS_FIELD_DATAGRAM_DATA_V4_IP_LOCAL_ADDRESS_TYPE, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_IP_LOCAL_ADDRESS, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_IP_LOCAL_PORT, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_IP_REMOTE_PORT, FWPS_FIELD_DATAGRAM_DATA_V4_IP_LOCAL_PORT, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_IP_LOCAL_ADDRESS_TYPE, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_FLAGS, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_TUNNEL_TYPE, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_MAX, FWPS_FIELD_DATAGRAM_DATA_V4_IP_REMOTE_PORT, fwpsk/FWPS_FIELD_DATAGRAM_DATA_V4_INTERFACE_INDEX
...
<table>
                ...
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_COMPARTMENT_ID</td>
                    <td></td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_DIRECTION</td>
...
#### FWP_DIRECTION_OUTBOUND</td>
                ...
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_FLAGS</td>
     ...
     <a href="https://msdn.microsoft.com/library/windows/hardware/ff549942">Filtering Condition Flags</a>.</td>
                ...
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_INTERFACE_INDEX</td>
                    <td>The index of the network interface, as enumerated by the network stack.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_INTERFACE_TYPE</td>
     ...
     <a href="http://go.microsoft.com/fwlink/p/?linkid=60066">IANAifType-MIB Definitions</a>.</td>
                ...
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_IP_LOCAL_ADDRESS</td>
                    <td>The local IP address.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_IP_LOCAL_ADDRESS_TYPE</td>
     ...
     <a href="https://msdn.microsoft.com/library/windows/hardware/ff568757">NL_ADDRESS_TYPE</a> enumeration.</td>
                ...
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_IP_LOCAL_INTERFACE</td>
                    <td>The locally unique identifier (<a href="..\igpupvdev\ns-igpupvdev-_luid.md">LUID</a>) for the network interface associated with the
     local IP address.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_IP_LOCAL_PORT</td>
                    <td>The local transport protocol port number.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_IP_PROTOCOL</td>
                    <td>The IP protocol number, as specified in RFC 1700.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_IP_REMOTE_ADDRESS</td>
                    <td>The remote IP address.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_IP_REMOTE_PORT</td>
                    <td>The remote transport protocol port number.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_MAX</td>
                    <td>The maximum value for this enumeration. This value might change in future versions of the NDIS
     header files and binaries.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_SUB_INTERFACE_INDEX</td>
                    <td>The index of the logical network interface, as enumerated by the network stack.</td>
                </tr>
            
                <tr>
                    <td>FWPS_FIELD_DATAGRAM_DATA_V4_TUNNEL_TYPE</td>
...
<a href="mailto:wsddocfb@microsoft.com?subject=Documentation%20feedback [netvista\netvista]:%20FWPS_FIELDS_DATAGRAM_DATA_V4 enumeration%20 RELEASE:%20(1/18/2018)&amp;body=%0A%0APRIVACY STATEMENT%0A%0AWe use your feedback to improve the documentation. We don't use your email address for any other purpose, and we'll remove your email address from our system after the issue that you're reporting is fixed. While we're working to fix this issue, we might send you an email message to ask for more info. Later, we might also send you an email message to let you know that we've addressed your feedback.%0A%0AFor more info about Microsoft's privacy policy, see http://privacy.microsoft.com/en-us/default.aspx." title="Send comments about this topic to Microsoft">Send comments about this topic to Microsoft</a>