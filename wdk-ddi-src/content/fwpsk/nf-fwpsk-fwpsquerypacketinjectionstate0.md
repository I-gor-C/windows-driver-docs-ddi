...
<p>The 
     ...
     <a href="netvista.fwps_packet_injection_state">FWPS_PACKET_INJECTION_STATE</a> enumeration.</p>
...
<p>If the return value is <b>FWPS_PACKET_INJECTED_BY_SELF</b> or <b>FWPS_PACKET_PREVIOUSLY_INJECTED_BY_SELF</b>, the
    ...
    <a href="..\fwpsk\nc-fwpsk-fwps-callout-classify-fn0.md">classifyFn</a> function to one of the following
    values.</p>
