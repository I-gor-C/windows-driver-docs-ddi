...
## -description
<p><b>EVT_IDD_CX_MONITOR_ASSIGN_SWAPCHAIN</b> is called by the OS to inform the driver of a mode change for monitors on the adapter.</p>
...
<p>
                ...
                A handle provided by the driver used by the OS to identify the monitor that has been affected by the mode change.</p>
</dd>
...
<p>
                ...
                Input arguments used by <b>EVT_IDD_CX_MONITOR_ASSIGN_SWAPCHAIN</b>.</p>
</dd>
</dl>
