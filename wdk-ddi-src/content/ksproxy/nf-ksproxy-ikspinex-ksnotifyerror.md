...
ms.date: 1/9/2018
ms.keywords: IKsPinEx, IKsPinEx interface [Streaming Media Devices], KsNotifyError method, IKsPinEx::KsNotifyError, stream.ikspinex_ksnotifyerror, ksproxy/IKsPinEx::KsNotifyError, KsNotifyError method [Streaming Media Devices], ksproxy_41c855aa-58a3-4bf6-bb8a-1eb8dfe2a3e1.xml, KsNotifyError, KsNotifyError method [Streaming Media Devices], IKsPinEx interface
