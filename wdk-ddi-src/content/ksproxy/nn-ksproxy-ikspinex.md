...
| Method | Description |
| ---- |:---- |
| [ksproxy.IKsPinEx.KsNotifyError](nf-ksproxy-ikspinex-ksnotifyerror.md) | The KsNotifyError method notifies the filter graph of an error to give the filter graph an opportunity to halt. |
