...
ms.date: 2/20/2018
ms.keywords: KsGetFilterName, stream.ikspinpipe_ksgetfiltername, IKsPinPipe, IKsPinPipe::KsGetFilterName, KsGetFilterName method [Streaming Media Devices], IKsPinPipe interface, IKsPinPipe interface [Streaming Media Devices], KsGetFilterName method, ksproxy/IKsPinPipe::KsGetFilterName, KsGetFilterName method [Streaming Media Devices]
