...
## -inheritance
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IKsNotifyEvent</b> interface inherits from the <a href="com.iunknown" xmlns:loc="http://microsoft.com/wdcml/l10n"><b>IUnknown</b></a> interface. <b>IKsNotifyEvent</b> also has these types of members:
