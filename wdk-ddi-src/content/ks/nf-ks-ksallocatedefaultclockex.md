...
ms.date : 1/9/2018
ms.keywords : ksfunc_bace76db-468b-4d8e-bbc4-5a64f238308f.xml, ks/KsAllocateDefaultClockEx, stream.ksallocatedefaultclockex, KsAllocateDefaultClockEx function [Streaming Media Devices], KsAllocateDefaultClockEx
