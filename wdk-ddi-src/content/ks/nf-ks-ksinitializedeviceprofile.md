...
title: KsInitializeDeviceProfile
...
## -description
<p>The <b>KsInitializeDeviceProfile</b> API must be called by all miniport drivers to initialize the profile store and publish the device profiles.
</p>
