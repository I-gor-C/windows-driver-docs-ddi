...
ms.date: 1/9/2018
ms.keywords: PKSEVENTDATA, ks/PKSEVENTDATA, ks/KSEVENTDATA, ks-struct_e9669775-4fb9-465a-bd2b-fd02f718d7a3.xml, KSEVENTDATA structure [Streaming Media Devices], *PKSEVENTDATA, KSEVENTDATA, PKSEVENTDATA structure pointer [Streaming Media Devices], stream.kseventdata
