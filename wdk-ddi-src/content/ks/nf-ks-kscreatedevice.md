...
A minidriver that calls <b>KsCreateDevice</b> directly should not use <a href="stream.ksinitializedriver">KsInitializeDriver</a>. If the minidriver is not calling <b>KsInitializeDriver</b>, it should instead provide its own <i>AddDevice</i> callback. The minidriver can then call <b>KsCreateDevice</b> from that <i>AddDevice</i> callback. 
