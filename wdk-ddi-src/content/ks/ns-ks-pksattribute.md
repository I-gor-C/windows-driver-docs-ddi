...
## -description
<p>The KSATTRIBUTE structure defines an additional attribute of a data format or data range that is not covered by the <a href="stream.ksdataformat">KSDATAFORMAT</a> and <a href="stream.ksdatarange">KSDATARANGE</a> structures or the extended information based on the format and range specifiers.</p>
