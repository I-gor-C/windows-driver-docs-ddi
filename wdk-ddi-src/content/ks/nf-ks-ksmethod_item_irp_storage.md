...
## -description
This macro accesses a pointer to the relevant <a href="..\ks\ns-ks-ksmethod_item.md">KSMETHOD_ITEM</a>. Note that this pointer is only set when using <a href="stream.ksmethodhandlerwithallocator">KsMethodHandlerWithAllocator</a>.
