...
title: KsRemoveIrpFromCancelableQueue
...
## -returns
<p>The <b>KsRemoveIrpFromCancelableQueue</b> function returns the next noncanceled IRP on the list, or it returns <b>NULL</b> if none is found or if an IRP that has not already been acquired cannot be found.</p>
