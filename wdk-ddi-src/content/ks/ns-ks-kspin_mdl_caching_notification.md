...
ms.date: 1/9/2018
ms.keywords: PKSPIN_MDL_CACHING_NOTIFICATION, ks/KSPIN_MDL_CACHING_NOTIFICATION, *PKSPIN_MDL_CACHING_NOTIFICATION, KSPIN_MDL_CACHING_NOTIFICATION, PKSPIN_MDL_CACHING_NOTIFICATION structure pointer [Streaming Media Devices], ks/PKSPIN_MDL_CACHING_NOTIFICATION, stream.kspin_mdl_caching_notification, KSPIN_MDL_CACHING_NOTIFICATION structure [Streaming Media Devices]
