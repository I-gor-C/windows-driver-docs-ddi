...
ms.date: 1/9/2018
ms.keywords: KSPIN_MDL_CACHING_NOTIFICATION structure [Streaming Media Devices], ks/PKSPIN_MDL_CACHING_NOTIFICATION, stream.kspin_mdl_caching_notification, ks/KSPIN_MDL_CACHING_NOTIFICATION, PKSPIN_MDL_CACHING_NOTIFICATION, PKSPIN_MDL_CACHING_NOTIFICATION structure pointer [Streaming Media Devices], KSPIN_MDL_CACHING_NOTIFICATION, *PKSPIN_MDL_CACHING_NOTIFICATION
