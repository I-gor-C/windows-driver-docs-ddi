...
ms.date: 1/9/2018
ms.keywords: KSPIN_MDL_CACHING_NOTIFY_ADDSAMPLE, ks/KSPIN_MDL_CACHING_EVENT, KSPIN_MDL_CACHING_EVENT, KSPIN_MDL_CACHING_NOTIFY_CLEANALL_NOWAIT, KSPIN_MDL_CACHING_NOTIFY_CLEANUP, ks/KSPIN_MDL_CACHING_NOTIFY_CLEANALL_NOWAIT, ks/KSPIN_MDL_CACHING_NOTIFY_ADDSAMPLE, ks/KSPIN_MDL_CACHING_NOTIFY_CLEANALL_WAIT, KSPIN_MDL_CACHING_EVENT enumeration [Streaming Media Devices], ks/KSPIN_MDL_CACHING_NOTIFY_CLEANUP, stream.kspin_mdl_caching_event, KSPIN_MDL_CACHING_NOTIFY_CLEANALL_WAIT
