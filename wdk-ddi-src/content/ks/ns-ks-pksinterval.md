...
ms.date: 11/28/2017
ms.keywords: PKSINTERVAL, KSINTERVAL, *PKSINTERVAL
...
# PKSINTERVAL structure



## -description
<p>The KSINTERVAL structure specifies a base time and time interval for recurring events.</p>
