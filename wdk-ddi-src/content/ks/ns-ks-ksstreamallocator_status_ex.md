...
ms.date: 1/9/2018
ms.keywords: stream.ksstreamallocator_status_ex, ks-struct_e62b6482-11b5-48be-9263-719809e9e79d.xml, *PKSSTREAMALLOCATOR_STATUS_EX, ks/KSSTREAMALLOCATOR_STATUS_EX, KSSTREAMALLOCATOR_STATUS_EX, PKSSTREAMALLOCATOR_STATUS_EX structure pointer [Streaming Media Devices], ks/PKSSTREAMALLOCATOR_STATUS_EX, PKSSTREAMALLOCATOR_STATUS_EX, KSSTREAMALLOCATOR_STATUS_EX structure [Streaming Media Devices]
