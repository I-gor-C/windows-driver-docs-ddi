...
## -description
This macro accesses the type of method as described in the <a href="stream.ksmethod_item">KSMETHOD_ITEM</a>. If the method will be processed asynchronously using <a href="stream.ksdispatchspecificmethod">KsDispatchSpecificMethod</a>, this storage must be maintained intact.
...
## -remarks
The relevant KSMETHOD_ITEM structure is extracted from <b>Irp-&gt;Tail.Overlay.DriverContext</b>. Parameters in <b>DriverContext</b> are initialized by <a href="stream.ksmethodhandler">KsMethodHandler</a> and <a href="stream.ksmethodhandlerwithallocator">KsMethodHandlerWithAllocator</a>.
