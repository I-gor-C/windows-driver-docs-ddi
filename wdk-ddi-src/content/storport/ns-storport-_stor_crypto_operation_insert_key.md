...
ms.date: 1/10/2018
ms.keywords: storage.stor_crypto_operation_insert_key, _STOR_CRYPTO_OPERATION_INSERT_KEY, storport/PSTOR_CRYPTO_OPERATION_INSERT_KEY, *PSTOR_CRYPTO_OPERATION_INSERT_KEY, STOR_CRYPTO_OPERATION_INSERT_KEY structure [Storage Devices], PSTOR_CRYPTO_OPERATION_INSERT_KEY, storport/STOR_CRYPTO_OPERATION_INSERT_KEY, PSTOR_CRYPTO_OPERATION_INSERT_KEY structure pointer [Storage Devices], STOR_CRYPTO_OPERATION_INSERT_KEY
