...
ms.date: 1/10/2018
ms.keywords: STOR_DEVICE_CAPABILITIES_EX structure [Storage Devices], storage.stor_device_capabilities_ex, *PSTOR_DEVICE_CAPABILITIES_EX, STOR_DEVICE_CAPABILITIES_EX, storport/STOR_DEVICE_CAPABILITIES_EX, PSTOR_DEVICE_CAPABILITIES_EX, PSTOR_DEVICE_CAPABILITIES_EX structure pointer [Storage Devices], _STOR_DEVICE_CAPABILITIES_EX, storport/PSTOR_DEVICE_CAPABILITIES_EX
