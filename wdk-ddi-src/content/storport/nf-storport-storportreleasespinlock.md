...
ms.date: 1/10/2018
ms.keywords: StorPortReleaseSpinLock, storport/StorPortReleaseSpinLock, storage.storportreleasespinlock, storprt_5f3bd7a7-ffdd-4d7b-992b-70c2cea3acec.xml, StorPortReleaseSpinLock routine [Storage Devices]
