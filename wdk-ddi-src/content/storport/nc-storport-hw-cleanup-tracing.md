...
## -description
<p>The <b>HwStorCleanupTracing</b> callback routine allows the Storport virtual miniport driver to stop tracing and to free any related resources.</p>
...
<dd>
<p>A pointer to the driver object.</p>
</dd>
</dl>
