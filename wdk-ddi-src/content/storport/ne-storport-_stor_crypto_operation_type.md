...
ms.date : 1/10/2018
ms.keywords : storport/STOR_CRYPTO_OPERATION_TYPE, storage.stor_crypto_operation_type, PSTOR_CRYPTO_OPERATION_TYPE enumeration pointer [Storage Devices], PSTOR_CRYPTO_OPERATION_TYPE, storport/, storport/PSTOR_CRYPTO_OPERATION_TYPE, STOR_CRYPTO_OPERATION_TYPE, _STOR_CRYPTO_OPERATION_TYPE, STOR_CRYPTO_OPERATION_TYPE enumeration [Storage Devices], *PSTOR_CRYPTO_OPERATION_TYPE
