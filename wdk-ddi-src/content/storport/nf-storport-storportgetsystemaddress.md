...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | This routine is available starting with Windows Server 2003 with SP2. This routine is available starting with Windows Server 2003 with SP2. |
