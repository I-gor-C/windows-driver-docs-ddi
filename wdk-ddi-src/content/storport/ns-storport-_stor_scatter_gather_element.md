...
ms.date: 1/10/2018
ms.keywords: PSTOR_SCATTER_GATHER_ELEMENT, storport/PSTOR_SCATTER_GATHER_ELEMENT, *PSTOR_SCATTER_GATHER_ELEMENT, storage.stor_scatter_gather_element, PSTOR_SCATTER_GATHER_ELEMENT structure pointer [Storage Devices], STOR_SCATTER_GATHER_ELEMENT, STOR_SCATTER_GATHER_ELEMENT structure [Storage Devices], structs-storport_e7e71caf-d421-45ba-b356-c1450eec6e6c.xml, storport/STOR_SCATTER_GATHER_ELEMENT, _STOR_SCATTER_GATHER_ELEMENT
