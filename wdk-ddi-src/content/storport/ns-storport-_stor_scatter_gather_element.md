...
ms.date: 1/10/2018
ms.keywords: STOR_SCATTER_GATHER_ELEMENT, PSTOR_SCATTER_GATHER_ELEMENT structure pointer [Storage Devices], storage.stor_scatter_gather_element, STOR_SCATTER_GATHER_ELEMENT structure [Storage Devices], storport/PSTOR_SCATTER_GATHER_ELEMENT, *PSTOR_SCATTER_GATHER_ELEMENT, _STOR_SCATTER_GATHER_ELEMENT, storport/STOR_SCATTER_GATHER_ELEMENT, structs-storport_e7e71caf-d421-45ba-b356-c1450eec6e6c.xml, PSTOR_SCATTER_GATHER_ELEMENT
