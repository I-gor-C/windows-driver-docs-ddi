...
ms.date : 1/10/2018
ms.keywords : STOR_ADDRESS, storage.stor_address, STOR_ADDRESS structure [Storage Devices], PSTOR_ADDRESS, PSTOR_ADDRESS structure pointer [Storage Devices], *PSTOR_ADDRESS, storport/STOR_ADDRESS, STOR_ADDRESS_TYPE_BTL8, STOR_ADDRESS_TYPE_UNKNOWN, storport/PSTOR_ADDRESS, _STOR_ADDRESS
