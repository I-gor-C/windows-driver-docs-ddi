...
ms.date: 1/10/2018
ms.keywords: SCSI_WMI_REQUEST_BLOCK structure [Storage Devices], PSCSI_WMI_REQUEST_BLOCK structure pointer [Storage Devices], srb/PSCSI_WMI_REQUEST_BLOCK, PSCSI_WMI_REQUEST_BLOCK, SCSI_WMI_REQUEST_BLOCK, srb/SCSI_WMI_REQUEST_BLOCK, storage.scsi_wmi_request_block, *PSCSI_WMI_REQUEST_BLOCK, _SCSI_WMI_REQUEST_BLOCK, structs-scsibus_6188bca6-990b-4471-b8ea-2cd5b2b27d51.xml
