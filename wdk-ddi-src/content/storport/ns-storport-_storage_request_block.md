...
ms.date: 1/10/2018
ms.keywords: SRB_STATUS_AUTOSENSE_VALID, SRB_FLAGS_DATA_OUT, SRB_STATUS_MESSAGE_REJECTED, SRB_FLAGS_DISABLE_AUTOSENSE, SRB_FUNCTION_RESET_BUS, SRB_FLAGS_ADAPTER_CACHE_ENABLE, SRB_STATUS_LINK_DOWN, SRB_FUNCTION_RECEIVE_EVENT, SRB_STATUS_SUCCESS, SRB_FUNCTION_QUIESCE_DEVICE, storport/STORAGE_REQUEST_BLOCK, SRB_STATUS_NO_DEVICE, storage.storage_request_block, SRB_STATUS_INVALID_REQUEST, SRB_FUNCTION_CRYPTO_OPERATION, SRB_STATUS_INVALID_PATH_ID, SRB_STATUS_DATA_OVERRUN, SRB_STATUS_BAD_SRB_BLOCK_LENGTH, PSTORAGE_REQUEST_BLOCK structure pointer [Storage Devices], SRB_FUNCTION_TERMINATE_IO, SRB_FLAGS_DISABLE_DISCONNECT, SRB_STATUS_REQUEST_SENSE_FAILED, SRB_FLAGS_IS_ACTIVE, SRB_STATUS_PHASE_SEQUENCE_FAILURE, SRB_STATUS_ABORTED, SRB_FLAGS_FREE_SENSE_BUFFER, SRB_FUNCTION_ABORT_COMMAND, SRB_FUNCTION_FREE_DUMP_POINTERS, SRB_FLAGS_D3_PROCESSING, SRB_FUNCTION_PNP, SRB_STATUS_INVALID_LUN, SRB_FUNCTION_SHUTDOWN, SRB_FUNCTION_FLUSH, SRB_STATUS_PARITY_ERROR, SRB_FLAGS_NO_KEEP_AWAKE, SRB_STATUS_BUSY, SRB_STATUS_SELECTION_TIMEOUT, SRB_STATUS_QUEUE_FROZEN, SRB_FLAGS_NO_DATA_TRANSFER, SRB_STATUS_ABORT_FAILED, SRB_FUNCTION_RESET_DEVICE, SRB_FUNCTION_EXECUTE_SCSI, SRB_STATUS_TIMEOUT, SRB_FUNCTION_UNLOCK_QUEUE, SRB_FLAGS_ALLOCATED_FROM_ZONE, SRB_STATUS_NOT_POWERED, SRB_FUNCTION_RELEASE_RECOVERY, SRB_FUNCTION_LOCK_QUEUE, SRB_FUNCTION_POWER, PSTORAGE_REQUEST_BLOCK, SRB_STATUS_COMMAND_TIMEOUT, SRB_FLAGS_BYPASS_FROZEN_QUEUE, SRB_STATUS_INTERNAL_ERROR, SRB_STATUS_NO_HBA, SRB_STATUS_BAD_FUNCTION, SRB_FLAGS_NO_QUEUE_FREEZE, SRB_STATUS_ERROR_RECOVERY, SRB_FLAGS_BYPASS_LOCKED_QUEUE, STORAGE_REQUEST_BLOCK structure [Storage Devices], SRB_STATUS_PENDING, SRB_STATUS_ERROR, SRB_FLAGS_DISABLE_SYNCH_TRANSFER, SRB_STATUS_INVALID_TARGET_ID, storport/PSTORAGE_REQUEST_BLOCK, SRB_FUNCTION_DUMP_POINTERS, SRB_STATUS_REQUEST_FLUSHED, SRB_FLAGS_DATA_IN, SRB_FLAGS_UNSPECIFIED_DIRECTION, SRB_STATUS_UNEXPECTED_BUS_FREE, SRB_FLAGS_SGLIST_FROM_POOL, SRB_FUNCTION_RESET_LOGICAL_UNIT, SRB_STATUS_BUS_RESET, SRB_FLAGS_QUEUE_ACTION_ENABLE, SRB_FUNCTION_WMI, _STORAGE_REQUEST_BLOCK, SRB_FUNCTION_IO_CONTROL, STORAGE_REQUEST_BLOCK
