...
## -description
<p>The <b>StorPortCompleteServiceIrp</b> routine is called by a Storport virtual miniport driver when it needs to complete a request that it received in its <a href="storage.hwstorprocessservicerequest">HwStorProcessServiceRequest</a> callback routine.</p>
