...
A pointer to the entry to be freed. The caller obtained this pointer from a preceding call to <a href="kernel.exallocatefromnpagedlookasidelist">ExAllocateFromNPagedLookasideList</a>. 
