...
typedef struct _DEVICE_CAPABILITIES {
  ...
  ULONG  : 1         DeviceD1;
  ULONG  : 1         DeviceD2;
  ULONG  : 1         LockSupported;
  ULONG  : 1         EjectSupported;
  ULONG  : 1         Removable;
  ULONG  : 1         DockDevice;
  ULONG  : 1         UniqueID;
  ULONG  : 1         SilentInstall;
  ULONG  : 1         RawDeviceOK;
  ULONG  : 1         SurpriseRemovalOK;
  ULONG  : 1         WakeFromD0;
  ULONG  : 1         WakeFromD1;
  ULONG  : 1         WakeFromD2;
  ULONG  : 1         WakeFromD3;
  ULONG  : 1         HardwareDisabled;
  ULONG  : 1         NonDynamic;
  ULONG  : 1         WarmEjectSupported;
  ULONG  : 1         NoDisplayInUI;
  ULONG  : 1         Reserved1;
  ULONG  : 1         WakeFromInterrupt;
  ULONG  : 1         SecureDevice;
  ULONG  : 11        Reserved;
  ULONG              Address;
  ULONG              UINumber;
