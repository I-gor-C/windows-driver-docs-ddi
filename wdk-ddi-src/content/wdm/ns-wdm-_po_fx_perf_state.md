...
ms.date: 1/4/2018
ms.keywords: kernel.po_fx_perf_state, PPO_FX_PERF_STATE structure pointer [Kernel-Mode Driver Architecture], *PPO_FX_PERF_STATE, wdm/PPO_FX_PERF_STATE, PPO_FX_PERF_STATE, PO_FX_PERF_STATE structure [Kernel-Mode Driver Architecture], _PO_FX_PERF_STATE, PO_FX_PERF_STATE, wdm/PO_FX_PERF_STATE
