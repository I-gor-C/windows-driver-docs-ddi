...
ms.date: 12/6/2017
ms.keywords: _DMA_ADAPTER_INFO, *PDMA_ADAPTER_INFO, DMA_ADAPTER_INFO
...
The version number of the <b>DMA_ADAPTER_INFO_</b><i>XXX</i> structure that follows this member. For a <a href="kernel.dma_adapter_info_v1">DMA_ADAPTER_INFO_V1</a> structure, set this member to DMA_ADAPTER_INFO_VERSION1 before calling the <a href="kernel.getdmaadapterinfo">GetDmaAdapterInfo</a> routine.

### -field V1

The capabilities of the bus-master DMA device or the system DMA controller. For more information, see <a href="kernel.dma_adapter_info_v1">DMA_ADAPTER_INFO_V1</a>.

## -remarks
A device driver calls the <a href="kernel.getdmaadapterinfo">GetDmaAdapterInfo</a> routine to obtain a <b>DMA_ADAPTER_INFO</b> structure that describes the capabilities of a DMA controller.
