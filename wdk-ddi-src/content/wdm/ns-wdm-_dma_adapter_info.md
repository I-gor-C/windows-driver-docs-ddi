...
ms.date: 12/15/2017
ms.keywords: _DMA_ADAPTER_INFO, *PDMA_ADAPTER_INFO, DMA_ADAPTER_INFO, PDMA_ADAPTER_INFO
...
The version number of the <b>DMA_ADAPTER_INFO_</b><i>XXX</i> structure that follows this member. For a <a href="kernel.dma_adapter_info_v1">DMA_ADAPTER_INFO_V1</a> structure, set this member to DMA_ADAPTER_INFO_VERSION1 before calling the <a href="..\wdm\nc-wdm-pget_dma_adapter_info.md">GetDmaAdapterInfo</a> routine.
