...
<td width="70%">
Available in Windows 2000 and later versions of Windows. Use <b>KeSetSystemAffinityThread</b> only on systems before Windows Vista. In Windows Vista and later versions of the Windows operating system, use <a href="..\wdm\nf-wdm-kesetsystemaffinitythreadex.md">KeSetSystemAffinityThreadEx</a> instead.
