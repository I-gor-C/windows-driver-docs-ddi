...
```
NTKERNELAPI NTSTATUS IoWMIQueryAllData(
...
To query for multiple WMI classes, use <a href="https://msdn.microsoft.com/library/windows/hardware/ff550467">IoWMIQueryAllDataMultiple</a>.
