...
ms.date : 1/4/2018
ms.keywords : PoFxActivateComponent, PO_FX_FLAG_BLOCKING, wdm/PoFxActivateComponent, PoFxActivateComponent routine [Kernel-Mode Driver Architecture], PO_FX_FLAG_ASYNC_ONLY, kernel.pofxactivatecomponent
