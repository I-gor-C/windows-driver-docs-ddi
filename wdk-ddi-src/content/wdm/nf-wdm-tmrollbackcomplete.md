...
## -description
<p>The <b>TmRollbackComplete</b> routine notifies KTM that the calling resource manager has finished rolling back a transaction's data.</p>
...
## -returns
<p><b>TmRollbackComplete</b> returns STATUS_SUCCESS if the operation succeeds. Otherwise, this routine might return the following value:</p><dl>
...
## -remarks
<p>The <b>TmRollbackComplete</b> routine is a pointer-based version of the <a href="https://msdn.microsoft.com/library/windows/hardware/ff567081">ZwRollbackComplete</a> routine.</p>
