...
ms.date: 1/4/2018
ms.keywords: PO_FX_PERF_STATE_CHANGE, kernel.po_fx_perf_state_change, PO_FX_PERF_STATE_CHANGE structure [Kernel-Mode Driver Architecture], PPO_FX_PERF_STATE_CHANGE structure pointer [Kernel-Mode Driver Architecture], PPO_FX_PERF_STATE_CHANGE, _PO_FX_PERF_STATE_CHANGE, wdm/PPO_FX_PERF_STATE_CHANGE, *PPO_FX_PERF_STATE_CHANGE, wdm/PO_FX_PERF_STATE_CHANGE
