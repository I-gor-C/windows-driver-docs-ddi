...
Requests the bus type, such as PCIBus or PCMCIABus. <i>PropertyBuffer</i> points to an <a href="..\miniport\ne-miniport-_interface_type.md">INTERFACE_TYPE</a> enumeration value.
