...
To reverse the ordering of bytes in a USHORT value, use the <a href="kernel.rtlushortbyteswap">RtlUshortByteSwap</a> routine. To reverse ordering of bytes in a ULONGLONG value, use the <a href="kernel.rtlulonglongbyteswap">RtlUlonglongByteSwap</a> routine.
