...
```
NTKERNELAPI BOOLEAN ExAcquireResourceExclusiveLite(
  _Requires_lock_not_held_(*_Curr_)PERESOURCE Resource,
  BOOLEAN                                     Wait
);
```
...
| **DLL** | NtosKrnl.exe |
| **IRQL** | "<= APC_LEVEL" |
| **DDI compliance rules** | ExclusiveResourceAccess, IrqlExApcLte3, WithinCriticalRegion, HwStorPortProhibitedDDIs, WithinCriticalRegion(storport) |
