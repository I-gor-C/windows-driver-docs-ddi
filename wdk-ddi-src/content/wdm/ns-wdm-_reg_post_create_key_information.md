...
ms.date: 1/4/2018
ms.keywords: PREG_POST_CREATE_KEY_INFORMATION structure pointer [Kernel-Mode Driver Architecture], wdm/REG_POST_CREATE_KEY_INFORMATION, _REG_POST_CREATE_KEY_INFORMATION, REG_POST_OPEN_KEY_INFORMATION structure [Kernel-Mode Driver Architecture], *PREG_POST_OPEN_KEY_INFORMATION, PREG_POST_CREATE_KEY_INFORMATION, kernel.reg_post_create_key_information, *PREG_POST_CREATE_KEY_INFORMATION, kstruct_d_31e99ef7-d3dc-425d-9cc4-2735c50dd7dc.xml, REG_POST_CREATE_KEY_INFORMATION structure [Kernel-Mode Driver Architecture], wdm/REG_POST_OPEN_KEY_INFORMATION, REG_POST_OPEN_KEY_INFORMATION, REG_POST_CREATE_KEY_INFORMATION, wdm/PREG_POST_CREATE_KEY_INFORMATION
...
product: Windows
targetos: Windows
req.typenames: REG_POST_CREATE_KEY_INFORMATION, *PREG_POST_OPEN_KEY_INFORMATION, REG_POST_OPEN_KEY_INFORMATION, *PREG_POST_CREATE_KEY_INFORMATION
