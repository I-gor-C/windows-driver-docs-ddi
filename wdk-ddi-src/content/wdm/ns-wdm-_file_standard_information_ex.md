...
ms.date: 1/4/2018
ms.keywords: FILE_STANDARD_INFORMATION_EX structure [Kernel-Mode Driver Architecture], wdm/PFILE_STANDARD_INFORMATION_EX, kernel.file_standard_information_ex, PFILE_STANDARD_INFORMATION_EX, *PFILE_STANDARD_INFORMATION_EX, wdm/FILE_STANDARD_INFORMATION_EX, _FILE_STANDARD_INFORMATION_EX, PFILE_STANDARD_INFORMATION_EX structure pointer [Kernel-Mode Driver Architecture], FILE_STANDARD_INFORMATION_EX
