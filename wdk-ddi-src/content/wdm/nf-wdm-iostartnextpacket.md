...
```
NTKERNELAPI VOID IoStartNextPacket(
...
| **DDI compliance rules** | IrqlDispatch, SpinLockSafe, StartIoRecursion, HwStorPortProhibitedDDIs, IrqlDispatch(storport), SpinLockSafe(storport) |
