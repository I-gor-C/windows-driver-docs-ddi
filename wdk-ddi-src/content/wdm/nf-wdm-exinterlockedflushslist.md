...
## -returns
<p>If there were entries on the specified list, <b>ExInterlockedFlushSList</b> returns a pointer to the first <a href="kernel.slist_entry">SLIST_ENTRY</a> structure that was entry on the list; otherwise, it returns <b>NULL</b>.</p>

## -remarks
<p><b>ExInterlockedFlushSList</b> does not delete the <a href="kernel.slist_entry">SLIST_ENTRY</a> structures that made up the list; it only sets the internal pointer of <i>ListHead</i> to the beginning of the list to <b>NULL</b>. The driver must free the entries explicitly.</p>
