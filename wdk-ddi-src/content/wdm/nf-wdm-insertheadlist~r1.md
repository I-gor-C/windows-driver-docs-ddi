...
## -description
<p>The <b>InsertHeadList</b> routine inserts an entry at the head of a doubly linked list of <a href="kernel.list_entry">LIST_ENTRY</a> structures.</p>
...
<dd>
<p>Pointer to a <a href="kernel.list_entry">LIST_ENTRY</a> structure that represents the entry to be inserted into the list. </p>
</dd>
</dl>
