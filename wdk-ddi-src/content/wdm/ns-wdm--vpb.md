...
<td width="60%">
<p>This bit is set by the I/O manager to indicate that the file system has mounted the logical volume.</p>
</td>
</tr>
<tr>
...
<td width="60%">
<p>This bit can be set or cleared by file system drivers. If set, the I/O manager will not delete the VPB structure even if <b>ReferenceCount</b> is zero.</p>
</td>
</tr>
<tr>
...
<td width="60%">
<p>Set by the Plug and Play (PnP) manager to indicate that the underlying device is being removed.</p>
</td>
</tr>
<tr>
...
<td width="60%">
<p>Indicates that only the RAW file system can be mounted on the device.</p>
</td>
</tr>
<tr>
...
<p><code>#define MAXIMUM_VOLUME_LABEL_LENGTH  (32 * sizeof(WCHAR));</code></p>
</dd>
</dl>
