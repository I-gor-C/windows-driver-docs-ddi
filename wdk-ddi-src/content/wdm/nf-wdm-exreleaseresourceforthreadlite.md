...
ms.date : 1/4/2018
ms.keywords : ExReleaseResourceForThreadLite routine [Kernel-Mode Driver Architecture], ExReleaseResourceForThreadLite, kernel.exreleaseresourceforthreadlite, k102_799a8ff7-3996-470d-97b2-e1c18bbcb486.xml, wdm/ExReleaseResourceForThreadLite
...
| **Library** |  |
| **IRQL** | "<= DISPATCH_LEVEL" |
| **DDI compliance rules** | ExclusiveResourceAccess, WithinCriticalRegion, HwStorPortProhibitedDDIs, WithinCriticalRegion(storport) |
