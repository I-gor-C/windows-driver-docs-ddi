...
<dd>
<p>Supplies the value that was passed to the <a href="https://msdn.microsoft.com/library/windows/hardware/ff552198">KeIpiGenericCall</a> routine that called <i>IpiGenericCall</i>.</p>
</dd>
</dl>
