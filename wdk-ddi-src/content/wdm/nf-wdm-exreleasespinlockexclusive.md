...
ms.date: 1/4/2018
ms.keywords: wdm/ExReleaseSpinLockExclusive, ExReleaseSpinLockExclusive routine [Kernel-Mode Driver Architecture], ExReleaseSpinLockExclusive, kernel.exreleasespinlockexclusive_
