...
ms.date: 1/4/2018
ms.keywords: _PCI_MSIX_TABLE_CONFIG_INTERFACE, *PPCI_MSIX_TABLE_CONFIG_INTERFACE, PCI_MSIX_TABLE_CONFIG_INTERFACE
...
## -description
The <b>PCI_MSIX_TABLE_CONFIG_INTERFACE</b> structure enables device drivers to modify their MSI-X interrupt settings. This structure  describes the <a href="https://msdn.microsoft.com/library/windows/hardware/ff546563">GUID_MSIX_TABLE_CONFIG_INTERFACE</a> interface.
