...
Pointer to the storage for the original (unraised) IRQL value to be used in a subsequent call to <a href="kernel.kelowerirql">KeLowerIrql</a>.
...
Callers of this routine can be running at any IRQL. Any caller should restore the original IRQL with <a href="kernel.kelowerirql">KeLowerIrql</a> as soon as possible.
