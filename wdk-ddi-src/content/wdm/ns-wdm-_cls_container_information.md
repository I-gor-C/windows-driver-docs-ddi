...
ms.date : 1/4/2018
ms.keywords : CLS_CONTAINER_INFORMATION structure [Kernel-Mode Driver Architecture], kernel.clfs_container_information, CLFS_CONTAINER_INFORMATION, _CLS_CONTAINER_INFORMATION, PCLFS_CONTAINER_INFORMATION, wdm/CLFS_CONTAINER_INFORMATION, CLS_CONTAINER_INFORMATION, PCLS_CONTAINER_INFORMATION structure pointer [Kernel-Mode Driver Architecture], wdm/PCLS_CONTAINER_INFORMATION, *PCLFS_CONTAINER_INFORMATION, CLFS_CONTAINER_INFORMATION structure [Kernel-Mode Driver Architecture], PCLFS_CONTAINER_INFORMATION structure pointer [Kernel-Mode Driver Architecture], *PCLS_CONTAINER_INFORMATION, wdm/CLS_CONTAINER_INFORMATION, wdm/PCLFS_CONTAINER_INFORMATION, PCLS_CONTAINER_INFORMATION, PPCLS_CONTAINER_INFORMATION structure pointer [Kernel-Mode Driver Architecture], kstruct_a_757d7a17-feb2-4b99-8b6f-f83288858851.xml, wdm/PPCLFS_CONTAINER_INFORMATION, PPCLFS_CONTAINER_INFORMATION, PPCLFS_CONTAINER_INFORMATION structure pointer [Kernel-Mode Driver Architecture], wdm/PPCLS_CONTAINER_INFORMATION, PPCLS_CONTAINER_INFORMATION
