...
## -description
<p>The <b>KeInitializeDpc</b> routine initializes a DPC object, and registers a <a href="kernel.customdpc">CustomDpc</a> routine for that object.</p>
...
<dd>
<p>Pointer to the <a href="kernel.customdpc">CustomDpc</a> routine to associate with the DPC.</p>
</dd>

### -param DeferredContext [in, optional]

<dd>
<p>Specifies the value to pass as the <i>DeferredContext</i> parameter to <a href="kernel.customdpc">CustomDpc</a>. </p>
</dd>
</dl>
