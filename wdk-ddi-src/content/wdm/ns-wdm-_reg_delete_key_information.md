...
ms.date: 1/4/2018
ms.keywords: wdm/PREG_DELETE_KEY_INFORMATION, *PREG_FLUSH_KEY_INFORMATION, kstruct_d_9069d571-f056-490e-b263-7849fd26b041.xml, wdm/REG_DELETE_KEY_INFORMATION, *PREG_DELETE_KEY_INFORMATION, REG_DELETE_KEY_INFORMATION, PREG_DELETE_KEY_INFORMATION structure pointer [Kernel-Mode Driver Architecture], _REG_DELETE_KEY_INFORMATION, REG_FLUSH_KEY_INFORMATION, PREG_DELETE_KEY_INFORMATION, kernel.reg_delete_key_information, REG_DELETE_KEY_INFORMATION structure [Kernel-Mode Driver Architecture]
...
product: Windows
targetos: Windows
req.typenames: REG_FLUSH_KEY_INFORMATION, *PREG_DELETE_KEY_INFORMATION, REG_DELETE_KEY_INFORMATION, *PREG_FLUSH_KEY_INFORMATION
