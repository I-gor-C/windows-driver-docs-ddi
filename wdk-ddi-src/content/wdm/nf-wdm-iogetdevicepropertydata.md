...
Drivers can use the <a href="kernel.iosetdevicepropertydata">IoSetDevicePropertyData</a> routine to modify a device property.
...
<dt>
<a href="kernel.iosetdevicepropertydata">IoSetDevicePropertyData</a>
</dt>
</dl>
 
