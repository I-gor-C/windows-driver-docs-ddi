...
## -description
<p>The <b>RemoveTailList</b> routine removes an entry from the end of a doubly linked list of <a href="kernel.list_entry">LIST_ENTRY</a> structures.</p>
