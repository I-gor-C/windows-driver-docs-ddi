...
ms.date : 1/4/2018
ms.keywords : PREG_DELETE_VALUE_KEY_INFORMATION, REG_DELETE_VALUE_KEY_INFORMATION structure [Kernel-Mode Driver Architecture], kstruct_d_a95a729a-53de-4acc-a935-c2f60d7f9f18.xml, PREG_DELETE_VALUE_KEY_INFORMATION structure pointer [Kernel-Mode Driver Architecture], *PREG_DELETE_VALUE_KEY_INFORMATION, wdm/PREG_DELETE_VALUE_KEY_INFORMATION, kernel.reg_delete_value_key_information, _REG_DELETE_VALUE_KEY_INFORMATION, REG_DELETE_VALUE_KEY_INFORMATION, wdm/REG_DELETE_VALUE_KEY_INFORMATION
