...
## -description
<p>A <b>PLUGPLAY_NOTIFICATION_HEADER</b> structure is included at the beginning of each PnP notification structure, such as a <a href="..\wdm\ns-wdm--device-interface-change-notification.md">DEVICE_INTERFACE_CHANGE_NOTIFICATION</a> structure.</p>
