...
ms.date : 1/4/2018
ms.keywords : "_PO_FX_DEVICE_V2, _PO_FX_DEVICE_V1, *PPO_FX_DEVICE_V1, PPO_FX_DEVICE_V1 structure pointer [Kernel-Mode Driver Architecture], wdm/PPO_FX_DEVICE_V1, kernel.po_fx_device, PO_FX_DEVICE, PO_FX_DEVICE_V1 structure [Kernel-Mode Driver Architecture], *PPO_FX_DEVICE_V2, wdm/PO_FX_DEVICE_V1, *PPO_FX_DEVICE, PO_FX_DEVICE_V2, PO_FX_DEVICE_V1, wdm/PO_FX_DEVICE, PO_FX_DEVICE structure [Kernel-Mode Driver Architecture], PPO_FX_DEVICE_V1"
