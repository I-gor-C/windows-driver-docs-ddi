...
### -field <b>ConnectionProperties</b>
...
<p>For a code example that uses the <b>RH_QUERY_CONNECTION_PROPERTIES_OUTPUT_BUFFER</b> structure, see <a href="NULL">How to Get the Connection Settings for a Device</a>.</p>
