...
## -description
<p>The <b>D3DKMTReleaseKeyedMutex</b> function releases a keyed mutex object.</p>
...
## -returns
<p><b>D3DKMTReleaseKeyedMutex</b> returns one of the following values:</p><dl>
...
<td width="70%">
<p><b>D3DKMTReleaseKeyedMutex</b> is supported beginning with the Windows 7 operating system. </p>
</td>
</tr>
<tr>
<th width="30%">
