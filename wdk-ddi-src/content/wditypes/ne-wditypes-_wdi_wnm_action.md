...
ms.date: 2/16/2018
ms.keywords: wditypes/WDI_WNM_ACTION, WDI_WNM_ACTION, WDI_WNM_ACTION enumeration [Network Drivers Starting with Windows Vista], WDI_WNM_ACTION_BSS_TRANSITION_MANAGEMENT_REQUEST, WDI_WNM_ACTION_BSS_TRANSITION_MANAGEMENT_RESPONSE, netvista.wdi_wnm_action, wditypes/WDI_WNM_ACTION_BSS_TRANSITION_MANAGEMENT_QUERY, WDI_WNM_ACTION_BSS_TRANSITION_MANAGEMENT_QUERY, _WDI_WNM_ACTION, wditypes/WDI_WNM_ACTION_BSS_TRANSITION_MANAGEMENT_RESPONSE, wditypes/WDI_WNM_ACTION_BSS_TRANSITION_MANAGEMENT_REQUEST
