...
ms.date: 1/18/2018
ms.keywords: WDI_WNM_ACTION, WDI_WNM_ACTION_BSS_TRANSITION_MANAGEMENT_REQUEST, wditypes/WDI_WNM_ACTION_BSS_TRANSITION_MANAGEMENT_QUERY, wditypes/WDI_WNM_ACTION_BSS_TRANSITION_MANAGEMENT_RESPONSE, WDI_WNM_ACTION enumeration [Network Drivers Starting with Windows Vista], wditypes/WDI_WNM_ACTION, wditypes/WDI_WNM_ACTION_BSS_TRANSITION_MANAGEMENT_REQUEST, _WDI_WNM_ACTION, netvista.wdi_wnm_action, WDI_WNM_ACTION_BSS_TRANSITION_MANAGEMENT_RESPONSE, WDI_WNM_ACTION_BSS_TRANSITION_MANAGEMENT_QUERY
