...
ms.date: 1/18/2018
ms.keywords: WDI_BSS_SELECTION_HOST_PREFERRED, wditypes/WDI_BSS_SELECTION_FLAGS, _WDI_BSS_SELECTION_FLAGS, WDI_BSS_SELECTION_FLAGS_AP_REQUESTED_TRANSITION, wditypes/WDI_BSS_SELECTION_HOST_PREFERRED, wditypes/WDI_BSS_SELECTION_RECENT_ASSOCIATION_ERROR, netvista.wdi_bss_selection_flags, WDI_BSS_SELECTION_FLAGS enumeration [Network Drivers Starting with Windows Vista], WDI_BSS_SELECTION_RECENT_ASSOCIATION_ERROR, wditypes/WDI_BSS_SELECTION_FLAGS_AP_REQUESTED_TRANSITION, WDI_BSS_SELECTION_FLAGS
