...
ms.date: 1/18/2018
ms.keywords: wditypes/WDI_STOP_AP_REASON_FREQUENCY_NOT_AVAILABLE, WDI_STOP_AP_REASON, wditypes/WDI_STOP_AP_REASON_IHV_END, WDI_STOP_AP_REASON enumeration [Network Drivers Starting with Windows Vista], _WDI_STOP_AP_REASON, netvista.wdi_stop_ap_reason, WDI_STOP_AP_REASON_AP_ACTIVE, wditypes/WDI_STOP_AP_REASON_IHV_START, wditypes/WDI_STOP_AP_REASON_CHANNEL_NOT_AVAILABLE, WDI_STOP_AP_REASON_CHANNEL_NOT_AVAILABLE, WDI_STOP_AP_REASON_IHV_START, WDI_STOP_AP_REASON_IHV_END, WDI_STOP_AP_REASON_FREQUENCY_NOT_AVAILABLE, wditypes/WDI_STOP_AP_REASON, wditypes/WDI_STOP_AP_REASON_AP_ACTIVE
