...
ms.date: 1/18/2018
ms.keywords: wditypes/WDI_CONNECTION_QUALITY_LOW_LATENCY, WDI_CONNECTION_QUALITY_HIGH_CHANNEL_AVAILABILITY, WDI_CONNECTION_QUALITY_HINT enumeration [Device and Driver Installation], wditypes/WDI_CONNECTION_QUALITY_HIGH_CHANNEL_AVAILABILITY, WDI_CONNECTION_QUALITY_HIGH_THROUGHPUT, WDI_CONNECTION_QUALITY_LOW_LATENCY, netvista.wdi_connection_quality_hint, wditypes/WDI_CONNECTION_QUALITY_HINT, WDI_CONNECTION_QUALITY_AUTO_POWER_SAVE, WDI_CONNECTION_QUALITY_HINT, wditypes/WDI_CONNECTION_QUALITY_AUTO_POWER_SAVE, devinst.wfi_connection_quality_hint, _WDI_CONNECTION_QUALITY_HINT, wditypes/WDI_CONNECTION_QUALITY_HIGH_THROUGHPUT
