...
ms.date: 2/16/2018
ms.keywords: wditypes/WDI_CONNECTION_QUALITY_HIGH_CHANNEL_AVAILABILITY, WDI_CONNECTION_QUALITY_AUTO_POWER_SAVE, netvista.wdi_connection_quality_hint, wditypes/WDI_CONNECTION_QUALITY_AUTO_POWER_SAVE, WDI_CONNECTION_QUALITY_HIGH_THROUGHPUT, wditypes/WDI_CONNECTION_QUALITY_LOW_LATENCY, wditypes/WDI_CONNECTION_QUALITY_HIGH_THROUGHPUT, devinst.wfi_connection_quality_hint, WDI_CONNECTION_QUALITY_HIGH_CHANNEL_AVAILABILITY, WDI_CONNECTION_QUALITY_LOW_LATENCY, WDI_CONNECTION_QUALITY_HINT enumeration [Device and Driver Installation], wditypes/WDI_CONNECTION_QUALITY_HINT, _WDI_CONNECTION_QUALITY_HINT, WDI_CONNECTION_QUALITY_HINT
