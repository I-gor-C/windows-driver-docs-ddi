...
ms.date: 1/18/2018
ms.keywords: WDI_CONNECTION_QUALITY_HINT enumeration [Device and Driver Installation], netvista.wdi_connection_quality_hint, wditypes/WDI_CONNECTION_QUALITY_HIGH_CHANNEL_AVAILABILITY, WDI_CONNECTION_QUALITY_AUTO_POWER_SAVE, WDI_CONNECTION_QUALITY_HIGH_THROUGHPUT, devinst.wfi_connection_quality_hint, WDI_CONNECTION_QUALITY_HINT, wditypes/WDI_CONNECTION_QUALITY_HINT, WDI_CONNECTION_QUALITY_HIGH_CHANNEL_AVAILABILITY, wditypes/WDI_CONNECTION_QUALITY_AUTO_POWER_SAVE, wditypes/WDI_CONNECTION_QUALITY_HIGH_THROUGHPUT, WDI_CONNECTION_QUALITY_LOW_LATENCY, wditypes/WDI_CONNECTION_QUALITY_LOW_LATENCY, _WDI_CONNECTION_QUALITY_HINT
