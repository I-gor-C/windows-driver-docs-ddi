...
ms.date: 1/18/2018
ms.keywords: WDI_ETHERTYPE_ENCAPSULATION_ENTRY structure [Device and Driver Installation], netvista.wifi_ethertype_encapsulation_entry, wditypes/WDI_ETHERTYPE_ENCAPSULATION_ENTRY, *PWDI_ETHERTYPE_ENCAPSULATION_ENTRY, WDI_ETHERTYPE_ENCAPSULATION_ENTRY, PWDI_ETHERTYPE_ENCAPSULATION_ENTRY, _WDI_ETHERTYPE_ENCAPSULATION_ENTRY, netvista.wdi_ethertype_encapsulation_entry, PWDI_ETHERTYPE_ENCAPSULATION_ENTRY structure pointer [Device and Driver Installation], wditypes/PWDI_ETHERTYPE_ENCAPSULATION_ENTRY
