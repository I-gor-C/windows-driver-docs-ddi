...
## -description
The D3DKMT_CREATEDEVICEFLAGS structure identifies the type of device context to be created in a call to the <a href="display.d3dkmtcreatedevice">D3DKMTCreateDevice</a> function.
