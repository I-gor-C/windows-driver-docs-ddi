...
```
PFND3DKMT_CONFIGURESHAREDRESOURCE Pfnd3dkmtConfiguresharedresource;

NTSTATUS Pfnd3dkmtConfiguresharedresource(
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | D3DKMTConfigureSharedResource is supported beginning with the Windows 7 operating system.  |
