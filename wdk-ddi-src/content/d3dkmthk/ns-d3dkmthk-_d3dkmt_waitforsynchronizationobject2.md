...
## -description
The D3DKMT_WAITFORSYNCHRONIZATIONOBJECT2 structure contains information about the synchronization events that the <a href="display.d3dkmtwaitforsynchronizationobject2">D3DKMTWaitForSynchronizationObject2</a> function waits for to occur. 
