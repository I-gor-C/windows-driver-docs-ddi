...
```
NTSTATUS D3DKMTWaitForSynchronizationObject2(
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | D3DKMTWaitForSynchronizationObject2 is supported beginning with the Windows 7 operating system.  |
