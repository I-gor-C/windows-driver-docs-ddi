...
ms.date: 12/29/2017
ms.keywords: display.d3dkmt-setdevicelostsupport, D3DKMT_SETDEVICELOSTSUPPORT structure [Display Devices], d3dkmthk/D3DKMT_SETDEVICELOSTSUPPORT, D3DKMT_SETDEVICELOSTSUPPORT, _D3DKMT_SETDEVICELOSTSUPPORT
