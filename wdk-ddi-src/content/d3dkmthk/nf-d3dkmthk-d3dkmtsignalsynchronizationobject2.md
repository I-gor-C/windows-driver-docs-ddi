...
A pointer to a <a href="display.d3dkmt_signalsynchronizationobject2">D3DKMT_SIGNALSYNCHRONIZATIONOBJECT2</a> structure that describes the synchronization objects and context stream that signaling is set up for.
...
<td width="70%">
<b>D3DKMTSignalSynchronizationObject2</b> is supported beginning with the Windows 7 operating system. 
...
<dl>
<dt>
<a href="display.d3dkmt_signalsynchronizationobject2">D3DKMT_SIGNALSYNCHRONIZATIONOBJECT2</a>
</dt>
</dl>
 
