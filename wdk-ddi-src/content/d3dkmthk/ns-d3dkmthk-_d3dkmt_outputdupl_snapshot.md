...
ms.date: 12/29/2017
ms.keywords: d3dkmthk/D3DKMT_OUTPUTDUPL_SNAPSHOT, D3DKMT_OUTPUTDUPL_SNAPSHOT structure [Display Devices], display.d3dkmt_outputdupl_snapshot, D3DKMT_OUTPUTDUPL_SNAPSHOT, _D3DKMT_OUTPUTDUPL_SNAPSHOT
