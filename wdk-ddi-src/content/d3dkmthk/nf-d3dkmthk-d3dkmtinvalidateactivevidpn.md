...
</dl>The display mode that is requested by the OpenGL installable client driver (ICD) in the buffer pointed to by the <b>pPrivateDriverData</b> member of <a href="..\d3dkmthk\ns-d3dkmthk-_d3dkmt_invalidateactivevidpn.md">D3DKMT_INVALIDATEACTIVEVIDPN</a> is not supported by the display miniport driver.
