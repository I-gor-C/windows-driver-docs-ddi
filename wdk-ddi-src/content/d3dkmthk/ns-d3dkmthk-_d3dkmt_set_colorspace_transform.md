...
ms.date: 12/29/2017
ms.keywords: D3DKMT_SET_COLORSPACE_TRANSFORM structure [Display Devices], D3DKMT_SET_COLORSPACE_TRANSFORM, display.d3dkmt-set-colorspace-transform, d3dkmthk/D3DKMT_SET_COLORSPACE_TRANSFORM, _D3DKMT_SET_COLORSPACE_TRANSFORM
