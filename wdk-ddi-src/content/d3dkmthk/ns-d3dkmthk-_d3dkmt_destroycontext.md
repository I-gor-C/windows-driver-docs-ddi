...
[in] A handle to the device context that the Microsoft DirectX graphics kernel subsystem (<i>Dxgkrnl.sys</i>) supplied and that is returned from the call to the <a href="display.d3dkmtcreatecontext">D3DKMTCreateContext</a> function.
...
<dt>
<a href="display.d3dkmtdestroycontext">D3DKMTDestroyContext</a>
</dt>
</dl>
 
