...
### -param pData [in]
 ...
 A pointer to a <a href="display.d3dkmt_checksharedresourceaccess">D3DKMT_CHECKSHAREDRESOURCEACCESS</a> structure that specifies parameters to determine if a process can access a shared resource. 
...
<td width="70%">
<b>D3DKMTCheckSharedResourceAccess</b> is supported beginning with the Windows 7 operating system. 
...
<dl>
<dt>
<a href="display.d3dkmt_checksharedresourceaccess">D3DKMT_CHECKSHAREDRESOURCEACCESS</a>
</dt>
</dl>
 
