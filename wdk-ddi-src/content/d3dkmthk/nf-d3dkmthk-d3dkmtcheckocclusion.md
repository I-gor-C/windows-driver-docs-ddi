...
A pointer to a <a href="display.d3dkmt_checkocclusion">D3DKMT_CHECKOCCLUSION</a> structure that describes parameters for checking occlusion.
...
<dl>
<dt>
<a href="display.d3dkmt_checkocclusion">D3DKMT_CHECKOCCLUSION</a>
</dt>
</dl>
 
 
