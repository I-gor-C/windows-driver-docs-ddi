...
ms.date: 12/29/2017
ms.keywords: d3dkmthk/D3DKMT_CREATECONTEXT, OpenGL_Structs_5a3cc128-be06-4189-a389-95813c2d3e28.xml, D3DKMT_CREATECONTEXT structure [Display Devices], display.d3dkmt_createcontext, _D3DKMT_CREATECONTEXT, D3DKMT_CREATECONTEXT
