...
## -description
The D3DKMT_GETOVERLAYSTATE structure describes parameters that the <a href="display.d3dkmtgetoverlaystate">D3DKMTGetOverlayState</a> function uses to retrieve status about an overlay. 
...
<td width="70%">
D3DKMT_GETOVERLAYSTATE is supported beginning with the Windows 7 operating system. 
</td>
</tr>
<tr>
<th width="30%">
...
<dl>
<dt>
<a href="display.d3dkmtgetoverlaystate">D3DKMTGetOverlayState</a>
</dt>
</dl>
 
 
