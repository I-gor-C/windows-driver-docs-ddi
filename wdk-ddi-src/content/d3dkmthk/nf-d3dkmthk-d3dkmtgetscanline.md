...
## -description
<p>The <b>D3DKMTGetScanLine</b> function determines whether the given video present source of a video present network (VidPN) is in vertical blanking mode and retrieves the current scan line.</p>
...
## -returns
<p><b>D3DKMTGetScanLine</b> returns one of the following values:</p><dl>
<dt><b>STATUS_SUCCESS</b></dt>
</dl><p>The vertical blanking status and scan line were successfully retrieved.</p><dl>
