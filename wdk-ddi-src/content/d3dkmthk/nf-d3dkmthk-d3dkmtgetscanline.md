...
A pointer to a <a href="display.d3dkmt_getscanline">D3DKMT_GETSCANLINE</a> structure that contains the vertical blanking status of a video present source.
...
<dl>
<dt>
<a href="display.d3dkmt_getscanline">D3DKMT_GETSCANLINE</a>
</dt>
</dl>
 
 
