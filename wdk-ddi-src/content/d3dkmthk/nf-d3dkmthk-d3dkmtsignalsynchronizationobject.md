...
A pointer to a <a href="display.d3dkmt_signalsynchronizationobject">D3DKMT_SIGNALSYNCHRONIZATIONOBJECT</a> structure that describes the synchronization objects and context stream that signaling is set up for.
...
<dl>
<dt>
<a href="display.d3dkmt_signalsynchronizationobject">D3DKMT_SIGNALSYNCHRONIZATIONOBJECT</a>
</dt>
</dl>
 
