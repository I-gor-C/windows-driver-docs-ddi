...
A pointer to a <a href="display.d3dkmt_queryadapterinfo">D3DKMT_QUERYADAPTERINFO</a> structure that is filled with specified information about the graphics hardware. 
...
<a href="display.d3dkmtqueryadapterinfo">D3DKMTQueryAdapterInfo</a> could not complete because of insufficient memory.
