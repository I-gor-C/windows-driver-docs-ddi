...
Supplies a pointer to a <a href="display.d3dkmt_getpresenthistory">D3DKMT_GETPRESENTHISTORY</a> structure that describes the copying history.
...
<dl>
<dt>
<a href="display.d3dkmt_getpresenthistory">D3DKMT_GETPRESENTHISTORY</a>
</dt>
</dl>
 
