...
title: D3DKMTOpenAdapterFromHdc
...
## -description
<p>The <b>D3DKMTOpenAdapterFromHdc</b> function maps a device context handle (HDC) to a graphics adapter handle and, if the adapter contains multiple monitor outputs, to one of those outputs.</p>
...
## -returns
<p><b>D3DKMTOpenAdapterFromHdc</b> returns one of the following values:</p><dl>
<dt><b>STATUS_SUCCESS</b></dt>
</dl><p>The mapping was performed successfully.</p><dl>
<dt><b>STATUS_NO_MEMORY</b></dt>
</dl><p>The kernel ran out of the resources that would enable it to open another handle.</p><dl>
