...
A pointer to a <a href="display.d3dkmt_createcontextvirtual">D3DKMT_CREATECONTEXTVIRTUAL</a> structure that describes the kernel-mode device context.
...
<dl>
<dt>
<a href="display.d3dkmt_createcontextvirtual">D3DKMT_CREATECONTEXTVIRTUAL</a>
</dt>
</dl>
 
 
