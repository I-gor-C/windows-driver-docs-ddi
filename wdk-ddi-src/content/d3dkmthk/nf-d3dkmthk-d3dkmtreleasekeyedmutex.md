...
ms.date: 12/29/2017
ms.keywords: d3dkmthk/D3DKMTReleaseKeyedMutex, OpenGL_Functions_16fd3037-2615-49c0-8500-7c93bcda3c9f.xml, D3DKMTReleaseKeyedMutex function [Display Devices], D3DKMTReleaseKeyedMutex, display.d3dkmtreleasekeyedmutex
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | D3DKMTReleaseKeyedMutex is supported beginning with the Windows 7 operating system.  |
