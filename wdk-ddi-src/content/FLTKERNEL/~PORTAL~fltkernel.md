# Declarations in the fltkernel header
This header Fltkernel contains these programming interfaces:
...
| [FLT_IS_IRP_OPERATION function](nf-fltkernel-flt-is-irp-operation.md) | TBD |
| [Add2Ptr function](nf-fltkernel-add2ptr.md) | TBD |
...
| [FLT_IS_FS_FILTER_OPERATION function](nf-fltkernel-flt-is-fs-filter-operation.md) | TBD |
| [FltGetFsZeroingOffset function](nf-fltkernel-fltgetfszeroingoffset.md) | TBD |
...
| [FltQueryInformationByName function](nf-fltkernel-fltqueryinformationbyname.md) | TBD |
...
| [FltPropagateIrpExtension function](nf-fltkernel-fltpropagateirpextension.md) | TBD |
| [FLT_IS_CALLBACK_DATA_DIRTY function](nf-fltkernel-flt-is-callback-data-dirty.md) | TBD |
...
| [FltCbdqEnable function](nf-fltkernel-fltcbdqenable.md) | TBD |
| [FltCbdqInsertIo function](nf-fltkernel-fltcbdqinsertio.md) | TBD |
...
| [FltSetFsZeroingOffset function](nf-fltkernel-fltsetfszeroingoffset.md) | TBD |
...
| [FltCbdqRemoveNextIo function](nf-fltkernel-fltcbdqremovenextio.md) | TBD |
...
| [IS_ALIGNED function](nf-fltkernel-is-aligned.md) | TBD |
...
| [FLT_IS_REISSUED_IO function](nf-fltkernel-flt-is-reissued-io.md) | TBD |
...
| [FltGetFileNameFormat function](nf-fltkernel-fltgetfilenameformat.md) | TBD |
...
| [PtrOffset function](nf-fltkernel-ptroffset.md) | TBD |
...
| [FltFastIoPrepareMdlWrite function](nf-fltkernel-fltfastiopreparemdlwrite.md) | TBD |
| [FLT_IS_SYSTEM_BUFFER function](nf-fltkernel-flt-is-system-buffer.md) | TBD |
...
| [FLT_CLEAR_CALLBACK_DATA_DIRTY function](nf-fltkernel-flt-clear-callback-data-dirty.md) | TBD |
...
| [FLT_IS_FASTIO_OPERATION function](nf-fltkernel-flt-is-fastio-operation.md) | TBD |
| [FltFastIoMdlReadComplete function](nf-fltkernel-fltfastiomdlreadcomplete.md) | TBD |
| [ROUND_TO_SIZE function](nf-fltkernel-round-to-size.md) | TBD |
...
| [FltQueryDirectoryFileEx function](nf-fltkernel-fltquerydirectoryfileex.md) | TBD |
...
| [FltGetIoAttributionHandleFromCallbackData function](nf-fltkernel-fltgetioattributionhandlefromcallbackdata.md) | TBD |
...
| [FltAcquirePushLockSharedEx function](nf-fltkernel-fltacquirepushlocksharedex.md) | TBD |
...
| [FltFastIoMdlWriteComplete function](nf-fltkernel-fltfastiomdlwritecomplete.md) | TBD |
...
| [FltpTraceRedirectedFileIo function](nf-fltkernel-fltptraceredirectedfileio.md) | TBD |
| [FLT_SET_CALLBACK_DATA_DIRTY function](nf-fltkernel-flt-set-callback-data-dirty.md) | TBD |
...
| [FLT_ASSERTMSG function](nf-fltkernel-flt-assertmsg.md) | TBD |
...
| [FltGetFileNameQueryMethod function](nf-fltkernel-fltgetfilenamequerymethod.md) | TBD |
...
| [FltAcquirePushLockExclusiveEx function](nf-fltkernel-fltacquirepushlockexclusiveex.md) | TBD |
...
| [FLT_ASSERT function](nf-fltkernel-flt-assert.md) | TBD |
...
| [FltCheckOplock function](nf-fltkernel-fltcheckoplock.md) | TBD |
...
| [FltReleasePushLockEx function](nf-fltkernel-fltreleasepushlockex.md) | TBD |
...
| [FltFastIoMdlRead function](nf-fltkernel-fltfastiomdlread.md) | TBD |
| [FltCbdqDisable function](nf-fltkernel-fltcbdqdisable.md) | TBD |
...
| [FltCbdqInitialize function](nf-fltkernel-fltcbdqinitialize.md) | TBD |
...
| [FltSetFsZeroingOffsetRequired function](nf-fltkernel-fltsetfszeroingoffsetrequired.md) | TBD |
...
| [FltCbdqRemoveIo function](nf-fltkernel-fltcbdqremoveio.md) | TBD |
...
| [PFLT_CALLBACK_DATA_QUEUE_RELEASE callback function](nc-fltkernel-pflt-callback-data-queue-release.md) | TBD |
...
| [PFLT_CALLBACK_DATA_QUEUE_ACQUIRE callback function](nc-fltkernel-pflt-callback-data-queue-acquire.md) | TBD |
| [PFLT_CALLBACK_DATA_QUEUE_COMPLETE_CANCELED_IO callback function](nc-fltkernel-pflt-callback-data-queue-complete-canceled-io.md) | TBD |
...
| [PFLT_GENERIC_WORKITEM_ROUTINE callback function](nc-fltkernel-pflt-generic-workitem-routine.md) | TBD |
...
| [PFLT_MESSAGE_NOTIFY callback function](nc-fltkernel-pflt-message-notify.md) | TBD |
| [PFLT_CONNECT_NOTIFY callback function](nc-fltkernel-pflt-connect-notify.md) | TBD |
...
| [PFLT_CALLBACK_DATA_QUEUE_PEEK_NEXT_IO callback function](nc-fltkernel-pflt-callback-data-queue-peek-next-io.md) | TBD |
| [PFLT_DISCONNECT_NOTIFY callback function](nc-fltkernel-pflt-disconnect-notify.md) | TBD |
...
| [PFLT_CALLBACK_DATA_QUEUE_REMOVE_IO callback function](nc-fltkernel-pflt-callback-data-queue-remove-io.md) | TBD |
| [PFLT_COMPLETE_CANCELED_CALLBACK callback function](nc-fltkernel-pflt-complete-canceled-callback.md) | TBD |
...
| [PFLTOPLOCK_PREPOST_CALLBACKDATA_ROUTINE callback function](nc-fltkernel-pfltoplock-prepost-callbackdata-routine.md) | TBD |
| [PFLTOPLOCK_WAIT_COMPLETE_ROUTINE callback function](nc-fltkernel-pfltoplock-wait-complete-routine.md) | TBD |
| [PFLT_DEFERRED_IO_WORKITEM_ROUTINE callback function](nc-fltkernel-pflt-deferred-io-workitem-routine.md) | TBD |
| [PFLT_CALLBACK_DATA_QUEUE_INSERT_IO callback function](nc-fltkernel-pflt-callback-data-queue-insert-io.md) | TBD |
...
| Title        | Description    |
| ------------- |:-------------:|
| [FLT_PREOP_CALLBACK_STATUS enumeration](ne-fltkernel--flt-preop-callback-status.md) | TBD |
| [FLT_SET_CONTEXT_OPERATION enumeration](ne-fltkernel--flt-set-context-operation.md) | TBD |
| [FLT_CALLBACK_DATA_QUEUE_FLAGS enumeration](ne-fltkernel--flt-callback-data-queue-flags.md) | TBD |
| [FLT_POSTOP_CALLBACK_STATUS enumeration](ne-fltkernel--flt-postop-callback-status.md) | TBD |
Struct

| Title        | Description    |
| ------------- |:-------------:|
| [KTRANSACTION structure](ns-fltkernel--ktransaction.md) | TBD |
...
| [FLT_PORT structure](ns-fltkernel--flt-port.md) | TBD |
| [FLT_INSTANCE structure](ns-fltkernel--flt-instance.md) | TBD |
| [FLT_DEFERRED_IO_WORKITEM structure](ns-fltkernel--flt-deferred-io-workitem.md) | TBD |
| [FLT_CALLBACK_DATA_QUEUE structure](ns-fltkernel--flt-callback-data-queue.md) | TBD |
...
| [FLT_GENERIC_WORKITEM structure](ns-fltkernel--flt-generic-workitem.md) | TBD |
...
| [FLT_VOLUME structure](ns-fltkernel--flt-volume.md) | TBD |
| [FLT_RELATED_OBJECTS structure](ns-fltkernel--flt-related-objects~r1.md) | TBD |
...
| [FLT_CALLBACK_DATA_QUEUE structure](ns-fltkernel--flt-callback-data-queue~r1.md) | TBD |
...
| [FLT_FILTER structure](ns-fltkernel--flt-filter.md) | TBD |
