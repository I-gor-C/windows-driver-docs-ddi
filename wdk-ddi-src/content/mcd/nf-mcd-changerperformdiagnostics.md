...
Pointer to the buffer of type <a href="storage.wmi_changer_problem_device_error">WMI_CHANGER_PROBLEM_DEVICE_ERROR</a> in which the minidriver returns the diagnostic information.
