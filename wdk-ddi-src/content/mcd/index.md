...
| [ChangerClassCreate](nf-mcd-changerclasscreate.md) | The ChangerClassCreate routine is called by a changer minidriver to allow the class driver perform device-independent operations needed to create or close a device. |
