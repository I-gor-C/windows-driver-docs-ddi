...
<p>The <b>IDrmAudioStream</b> interface has these methods.</p>

| Method | Description |
| ---- |:---- |
| [drmk.IDrmAudioStream.SetContentId](nf-drmk-idrmaudiostream-setcontentid.md) | The SetContentId method sets the DRM content ID and its assigned DRM content rights on a KS audio stream. |
