...
A <a href="netvista.wdi_rx_throttle_level">WDI_RX_THROTTLE_LEVEL</a> enumeration value that specifies the throttle level.
...
<dt>
<a href="netvista.wdi_rx_throttle_level">WDI_RX_THROTTLE_LEVEL</a>
</dt>
<dt>
