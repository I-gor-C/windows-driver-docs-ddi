...
ms.date: 1/18/2018
ms.keywords: PWDI_MESSAGE_HEADER structure pointer [Network Drivers Starting with Windows Vista], WDI_MESSAGE_HEADER, *PWDI_MESSAGE_HEADER, _WDI_MESSAGE_HEADER, netvista.wdi_message_header, dot11wdi/WDI_MESSAGE_HEADER, PWDI_MESSAGE_HEADER, WDI_MESSAGE_HEADER structure [Network Drivers Starting with Windows Vista], dot11wdi/PWDI_MESSAGE_HEADER
