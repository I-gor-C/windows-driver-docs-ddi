...
TX pause reason bitmask, specified as <a href="netvista.wdi_tx_pause_reason">WDI_TX_PAUSE_REASON</a> value(s). See <i>Remarks</i> section for more information.
