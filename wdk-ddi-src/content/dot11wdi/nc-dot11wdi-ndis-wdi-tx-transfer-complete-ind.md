...
<p>If the TX status is a failure code, an <a href="..\dot11wdi\nc-dot11wdi-ndis-wdi-tx-send-complete-ind.md">NdisWdiTxSendCompleteIndication</a> is not indicated for any of the frames in the <a href="..\ndis\ns-ndis--net-buffer-list.md">NET_BUFFER_LIST</a> (NBL) chain.</p>
