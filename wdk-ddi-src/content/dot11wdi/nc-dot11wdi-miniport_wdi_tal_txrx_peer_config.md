...
Pointer to a <a href="netvista.wdi_txrx_peer_cfg">WDI_TXRX_PEER_CFG</a> structure that contains negotiated QoS settings.
...
<dt>
<a href="netvista.wdi_txrx_peer_cfg">WDI_TXRX_PEER_CFG</a>
</dt>
<dt>
