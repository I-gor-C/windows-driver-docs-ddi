...
If the TX status is a failure code, an <a href="..\dot11wdi\nc-dot11wdi-ndis_wdi_tx_send_complete_ind.md">NdisWdiTxSendCompleteIndication</a> is not indicated for any of the frames in the <a href="netvista.net_buffer_list">NET_BUFFER_LIST</a> (NBL) chain.
