...
ms.date: 1/18/2018
ms.keywords: dot11wdi/WDI_TXRX_PEER_CFG, netvista.wifi_txrx_peer_cfg, *PWDI_TXRX_PEER_CFG, PWDI_TXRX_PEER_CFG structure pointer [Network Drivers Starting with Windows Vista], netvista.wdi_txrx_peer_cfg, dot11wdi/PWDI_TXRX_PEER_CFG, _WDI_TXRX_PEER_CFG, WDI_TXRX_PEER_CFG, PWDI_TXRX_PEER_CFG, WDI_TXRX_PEER_CFG structure [Network Drivers Starting with Windows Vista]
