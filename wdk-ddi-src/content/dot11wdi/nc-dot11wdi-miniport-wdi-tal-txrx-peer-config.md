...
### -param <i>pPeerCfg</i> [in]

<dd>
<p>Pointer to a <a href="https://msdn.microsoft.com/library/windows/hardware/dn898190">WDI_TXRX_PEER_CFG</a> structure that contains negotiated QoS settings.</p>
</dd>
</dl>
