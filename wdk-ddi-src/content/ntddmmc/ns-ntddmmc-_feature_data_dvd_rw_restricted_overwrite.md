...
ms.date: 2/16/2018
ms.keywords: storage.feature_data_dvd_rw_restricted_overwrite, ntddmmc/FEATURE_DATA_DVD_RW_RESTRICTED_OVERWRITE, ntddmmc/PFEATURE_DATA_DVD_RW_RESTRICTED_OVERWRITE, FEATURE_DATA_DVD_RW_RESTRICTED_OVERWRITE structure [Storage Devices], _FEATURE_DATA_DVD_RW_RESTRICTED_OVERWRITE, FEATURE_DATA_DVD_RW_RESTRICTED_OVERWRITE, structs-CD-ROM_b6d53c83-8d7d-4fc1-9e42-b173219961a4.xml, PFEATURE_DATA_DVD_RW_RESTRICTED_OVERWRITE, PFEATURE_DATA_DVD_RW_RESTRICTED_OVERWRITE structure pointer [Storage Devices], *PFEATURE_DATA_DVD_RW_RESTRICTED_OVERWRITE
