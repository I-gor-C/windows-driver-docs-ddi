...
ms.date : 1/10/2018
ms.keywords : structs-CD-ROM_313fa292-b1c4-408d-94e9-491cb3d0aa0f.xml, ntddmmc/FEATURE_DATA_DISC_CONTROL_BLOCKS, PFEATURE_DATA_DISC_CONTROL_BLOCKS structure pointer [Storage Devices], PFEATURE_DATA_DISC_CONTROL_BLOCKS, storage.feature_data_disc_control_blocks, _FEATURE_DATA_DISC_CONTROL_BLOCKS, FEATURE_DATA_DISC_CONTROL_BLOCKS, *PFEATURE_DATA_DISC_CONTROL_BLOCKS, FEATURE_DATA_DISC_CONTROL_BLOCKS structure [Storage Devices], ntddmmc/PFEATURE_DATA_DISC_CONTROL_BLOCKS
