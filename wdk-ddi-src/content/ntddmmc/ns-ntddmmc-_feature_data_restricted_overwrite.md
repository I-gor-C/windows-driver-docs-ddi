...
ms.date: 1/10/2018
ms.keywords: FEATURE_DATA_RESTRICTED_OVERWRITE, PFEATURE_DATA_RESTRICTED_OVERWRITE, *PFEATURE_DATA_RESTRICTED_OVERWRITE, ntddmmc/FEATURE_DATA_RESTRICTED_OVERWRITE, PFEATURE_DATA_RESTRICTED_OVERWRITE structure pointer [Storage Devices], _FEATURE_DATA_RESTRICTED_OVERWRITE, structs-CD-ROM_d2d9725b-16c9-4361-a2fc-90bdc2d7905c.xml, storage.feature_data_restricted_overwrite, FEATURE_DATA_RESTRICTED_OVERWRITE structure [Storage Devices], ntddmmc/PFEATURE_DATA_RESTRICTED_OVERWRITE
