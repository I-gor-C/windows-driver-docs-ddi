...
ms.date: 11/15/2017
ms.keywords: FEATURE_DATA_CORE, FEATURE_DATA_CORE, *PFEATURE_DATA_CORE
...
## -description
<p>The FEATURE_DATA_CORE structure holds data for the Core feature descriptor.</p>
