...
ms.date: 2/16/2018
ms.keywords: PPEP_WORK_COMPLETE_IDLE_STATE structure pointer [Kernel-Mode Driver Architecture], pepfx/PPEP_WORK_COMPLETE_IDLE_STATE, _PEP_WORK_COMPLETE_IDLE_STATE, *PPEP_WORK_COMPLETE_IDLE_STATE, pepfx/PEP_WORK_COMPLETE_IDLE_STATE, PPEP_WORK_COMPLETE_IDLE_STATE, PEP_WORK_COMPLETE_IDLE_STATE, kernel.pep_work_complete_idle_state, PEP_WORK_COMPLETE_IDLE_STATE structure [Kernel-Mode Driver Architecture]
