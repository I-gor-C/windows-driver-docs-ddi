...
ms.date: 2/16/2018
ms.keywords: pepfx/PPO_FX_CORE_DEVICE, pepfx/PO_FX_CORE_DEVICE, PO_FX_CORE_DEVICE structure [Kernel-Mode Driver Architecture], PPO_FX_CORE_DEVICE structure pointer [Kernel-Mode Driver Architecture], _PO_FX_CORE_DEVICE, PPO_FX_CORE_DEVICE, PO_FX_CORE_DEVICE, kernel.po_fx_core_device, *PPO_FX_CORE_DEVICE
