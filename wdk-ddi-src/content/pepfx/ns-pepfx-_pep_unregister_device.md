...
ms.date: 1/4/2018
ms.keywords: "*PPEP_UNREGISTER_DEVICE, pepfx/PEP_UNREGISTER_DEVICE, PPEP_UNREGISTER_DEVICE structure pointer [Kernel-Mode Driver Architecture], kernel.pep_unregister_device, PPEP_UNREGISTER_DEVICE, PEP_UNREGISTER_DEVICE, PEP_UNREGISTER_DEVICE structure [Kernel-Mode Driver Architecture], pepfx/PPEP_UNREGISTER_DEVICE, _PEP_UNREGISTER_DEVICE"
