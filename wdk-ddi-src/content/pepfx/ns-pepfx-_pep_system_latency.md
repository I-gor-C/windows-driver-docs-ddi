...
ms.date: 1/4/2018
ms.keywords: PPEP_SYSTEM_LATENCY, *PPEP_SYSTEM_LATENCY, PEP_SYSTEM_LATENCY structure [Kernel-Mode Driver Architecture], kernel.pep_system_latency, PPEP_SYSTEM_LATENCY structure pointer [Kernel-Mode Driver Architecture], _PEP_SYSTEM_LATENCY, pepfx/PPEP_SYSTEM_LATENCY, pepfx/PEP_SYSTEM_LATENCY, PEP_SYSTEM_LATENCY
