...
ms.date: 1/4/2018
ms.keywords: PEP_SYSTEM_LATENCY, PEP_SYSTEM_LATENCY structure [Kernel-Mode Driver Architecture], PPEP_SYSTEM_LATENCY structure pointer [Kernel-Mode Driver Architecture], _PEP_SYSTEM_LATENCY, *PPEP_SYSTEM_LATENCY, pepfx/PPEP_SYSTEM_LATENCY, PPEP_SYSTEM_LATENCY, pepfx/PEP_SYSTEM_LATENCY, kernel.pep_system_latency
