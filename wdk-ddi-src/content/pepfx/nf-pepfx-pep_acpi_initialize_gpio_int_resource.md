...
## -description
The <b>PEP_ACPI_INITIALIZE_GPIO_INT_RESOURCE</b> function initializes a platform extension plug-in's (PEP) <a href="kernel.pep_acpi_gpio_resource">PEP_ACPI_GPIO_RESOURCE</a> structure.
