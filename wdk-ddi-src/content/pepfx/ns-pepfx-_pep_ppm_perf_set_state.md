...
ms.date: 1/4/2018
ms.keywords: PEP_PPM_PERF_SET_STATE structure [Kernel-Mode Driver Architecture], kernel.pep_ppm_perf_set_state, PEP_PPM_PERF_SET_STATE, _PEP_PPM_PERF_SET_STATE, *PPEP_PPM_PERF_SET_STATE, PPEP_PPM_PERF_SET_STATE structure pointer [Kernel-Mode Driver Architecture], PPEP_PPM_PERF_SET_STATE, pepfx/PEP_PPM_PERF_SET_STATE, pepfx/PPEP_PPM_PERF_SET_STATE
