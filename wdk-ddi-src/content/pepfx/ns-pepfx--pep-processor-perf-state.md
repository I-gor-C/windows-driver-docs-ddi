...
<dd>
<p>On output, the performance level (on the scale returned by the <a href="https://msdn.microsoft.com/library/windows/hardware/mt186839">PEP_QUERY_COMPONENT_PERF_CAPABILITIES</a> notification) of this performance state.</p>
</dd>
