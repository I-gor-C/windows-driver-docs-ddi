...
ms.date: 1/4/2018
ms.keywords: kernel.pep_query_soc_subsystem, pepfx/PPEP_QUERY_SOC_SUBSYSTEM, PEP_QUERY_SOC_SUBSYSTEM structure [Kernel-Mode Driver Architecture], PPEP_QUERY_SOC_SUBSYSTEM structure pointer [Kernel-Mode Driver Architecture], PEP_QUERY_SOC_SUBSYSTEM, PPEP_QUERY_SOC_SUBSYSTEM, *PPEP_QUERY_SOC_SUBSYSTEM, pepfx/PEP_QUERY_SOC_SUBSYSTEM, _PEP_QUERY_SOC_SUBSYSTEM
