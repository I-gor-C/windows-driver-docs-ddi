...
title: PEP_PPM_IDLE_COMPLETE_V2
...
# PEP_PPM_IDLE_COMPLETE_V2 structure



## -description
<p>The <b>PEP_PPM_IDLE_COMPLETE_V2</b> structure describe the idle states from which the processor and hardware platform are waking.</p>
