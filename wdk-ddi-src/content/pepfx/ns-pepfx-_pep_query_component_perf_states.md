...
ms.date : 1/4/2018
ms.keywords : pepfx/PPEP_QUERY_COMPONENT_PERF_STATES, pepfx/PEP_QUERY_COMPONENT_PERF_STATES, PEP_QUERY_COMPONENT_PERF_STATES, PPEP_QUERY_COMPONENT_PERF_STATES structure pointer [Kernel-Mode Driver Architecture], PEP_QUERY_COMPONENT_PERF_STATES structure [Kernel-Mode Driver Architecture], PPEP_QUERY_COMPONENT_PERF_STATES, kernel.pep_query_component_perf_states, *PPEP_QUERY_COMPONENT_PERF_STATES, _PEP_QUERY_COMPONENT_PERF_STATES
