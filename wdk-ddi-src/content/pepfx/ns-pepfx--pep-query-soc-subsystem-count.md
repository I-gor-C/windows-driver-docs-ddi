...
title: PEP_QUERY_SOC_SUBSYSTEM_COUNT
...
ms.date: 11/20/2017
ms.keywords: PEP_QUERY_SOC_SUBSYSTEM_COUNT, PEP_QUERY_SOC_SUBSYSTEM_COUNT, *PPEP_QUERY_SOC_SUBSYSTEM_COUNT
...
# PEP_QUERY_SOC_SUBSYSTEM_COUNT structure



## -description
<p>The <b>PEP_QUERY_SOC_SUBSYSTEM_COUNT</b> structure is used to tell the OS whether the PEP supports system on a chip (SoC) subsystem accounting for a given platform idle state. </p>
