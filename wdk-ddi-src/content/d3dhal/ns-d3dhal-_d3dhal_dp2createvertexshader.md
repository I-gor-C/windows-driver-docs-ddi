...
ms.date: 12/15/2017
ms.keywords: _D3DHAL_DP2CREATEVERTEXSHADER, D3DHAL_DP2CREATEVERTEXSHADER
...
See <a href="display.direct3d_driver_shader_codes">Direct3D Driver Shader Codes</a> for information about the format of an individual shader code and the tokens that comprise each shader code. 
