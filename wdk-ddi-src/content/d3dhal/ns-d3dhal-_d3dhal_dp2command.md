...
ms.date: 12/15/2017
ms.keywords: _D3DHAL_DP2COMMAND, LPD3DHAL_DP2COMMAND, D3DHAL_DP2COMMAND, *LPD3DHAL_DP2COMMAND
...
Specifies a primitive to draw or a state change to process. This member can be one of the <a href="display.d3dhal_dp2operation">D3DHAL_DP2OPERATION</a> enumerated values. 
