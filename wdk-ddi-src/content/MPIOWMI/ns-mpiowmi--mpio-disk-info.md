...
req.dll: 
req.irql: 
ms.keywords: MPIO_DISK_INFO, MPIO_DISK_INFO, *PMPIO_DISK_INFO
req.iface: 
---

# MPIO_DISK_INFO structure



## -description
<p>The MPIO_DISK_INFO structure allows applications to query the system for the top level view of its disk topology. The request must be directed to the MPIO control object by using its WMI instance name.</p>
