...
## -description
Defines the video memory allocations that the driver offers for reuse. Used with the  <a href="display.pfnofferallocationscb">pfnOfferAllocationsCb</a> function.
...
[in] The priority, of type  <a href="display.d3dddi_offer_priority">D3DDDI_OFFER_PRIORITY</a>, with which to offer the allocations for reuse.
