...
ms.date: 11/14/2017
ms.keywords: D3DDDICB_RENDERFLAGS, D3DDDICB_RENDERFLAGS
...
# D3DDDICB_RENDERFLAGS structure



## -description
<p>The D3DDDICB_RENDERFLAGS structure identifies information about a command buffer to be rendered.</p>
...
<dd>
<p>A member in the union that is contained in D3DDDICB_RENDERFLAGS that can hold one 32-bit value that identifies information about a command buffer to be rendered.</p>
</dd>
</dl>
