...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | DXVAHDDDI_STREAM_DATA is supported beginning with the Windows 7 operating system. DXVAHDDDI_STREAM_DATA is supported beginning with the Windows 7 operating system. |
