...
ms.date : 12/29/2017
ms.keywords : d3dumddi/DXVAHDDDI_BLT_STATE_CONSTRICTION, d3dumddi/DXVAHDDDI_BLT_STATE_PRIVATE, d3dumddi/DXVAHDDDI_BLT_STATE, DXVAHDDDI_BLT_STATE, DXVAHDDDI_BLT_STATE_CONSTRICTION, d3dumddi/DXVAHDDDI_BLT_STATE_BACKGROUND_COLOR, DXVAHDDDI_BLT_STATE_PRIVATE, DXVAHDDDI_BLT_STATE_OUTPUT_COLOR_SPACE, d3dumddi/DXVAHDDDI_BLT_STATE_TARGET_RECT, DXVAHDDDI_BLT_STATE_TARGET_RECT, d3dumddi/DXVAHDDDI_BLT_STATE_OUTPUT_COLOR_SPACE, DXVAHDDDI_BLT_STATE enumeration [Display Devices], DXVAHDDDI_BLT_STATE_ALPHA_FILL, d3dumddi/DXVAHDDDI_BLT_STATE_ALPHA_FILL, _DXVAHDDDI_BLT_STATE, DXVA2_Structs_2d8a894a-25be-49c1-bebe-82c7403007db.xml, display.dxvahdddi_blt_state, DXVAHDDDI_BLT_STATE_BACKGROUND_COLOR
