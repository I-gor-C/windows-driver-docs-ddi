...
### -param pData [in, out]
 ...
 A pointer to a <a href="display.d3dddiarg_dxvahd_getvideoprocessstreamstateprivate">D3DDDIARG_DXVAHD_GETVIDEOPROCESSSTREAMSTATEPRIVATE</a> structure that describes the private stream-state data to retrieve. 
...
<td width="70%">
<i>GetVideoProcessStreamStatePrivate</i> is supported beginning with the Windows 7 operating system.
</td>
</tr>
<tr>
<th width="30%">
...
<dl>
<dt>
<a href="display.d3dddiarg_dxvahd_getvideoprocessstreamstateprivate">D3DDDIARG_DXVAHD_GETVIDEOPROCESSSTREAMSTATEPRIVATE</a>
</dt>
</dl>
 
 
