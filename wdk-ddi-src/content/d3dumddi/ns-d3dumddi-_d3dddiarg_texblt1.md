...
A <a href="display.point">POINT</a> structure that describes the destination point where the source texture is copied.


### -field SrcRect

A <a href="display.rect">RECT</a> structure that describes the source texture to copy to the destination point.
