...
## -description
<p>Used in a call to the <a href="display.pfncheckmultiplaneoverlaysupport__d3d_">pfnCheckMultiPlaneOverlaySupport (D3D)</a> function to check details on hardware support for multiplane overlays.</p>
