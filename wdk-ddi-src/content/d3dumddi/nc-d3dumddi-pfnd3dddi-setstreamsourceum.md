...
## -description
<p>The <i>SetStreamSourceUM</i> function binds a vertex stream source to a user memory buffer. </p>
...
## -returns
<p><i>SetStreamSourceUM</i> returns S_OK or an appropriate error result if the vertex stream source is not successfully bound.</p>
