...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | StartSessionKeyRefresh is supported beginning with the Windows 7 operating system. StartSessionKeyRefresh is supported beginning with the Windows 7 operating system. |
