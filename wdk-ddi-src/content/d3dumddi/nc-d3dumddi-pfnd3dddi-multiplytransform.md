...
## -description
<p>The <i>MultiplyTransform</i> function modifies the current transform.</p>
...
## -returns
<p><i>MultiplyTransform</i> returns S_OK or an appropriate error result if the transform is not successfully modified.</p>
