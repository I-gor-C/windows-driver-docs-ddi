...
ms.date : 12/29/2017
ms.keywords : FORMATOP_NOALPHABLEND (0x00200000L), FORMATOP_PLANAR (0x02000000L), FORMATOP_PIXELSIZE (0x00001000L), FORMATOP_SAME_FORMAT_UP_TO_ALPHA_RENDERTARGET (0x00000100L), FORMATOP_OFFSCREENPLAIN (0x00004000L), display.formatop, FORMATOP_TEXTURE (0x00000001L), FORMATOP_ZSTENCIL (0x00000040L), FORMATOP_VERTEXTEXTURE (0x00800000L), FORMATOP_MEMBEROFGROUP_ARGB (0x00080000L), FORMATOP_3DACCELERATION (0x00000800L), FORMATOP structure [Display Devices], FORMATOP, FORMATOP_DISPLAYMODE (0x00000400L), FORMATOP_OFFSCREEN_RENDERTARGET (0x00000008L), FORMATOP_CONVERT_TO_ARGB (0x00002000L), FORMATOP_DMAP (0x00020000L), FORMATOP_SRGBWRITE (0x00100000L), FORMATOP_SAME_FORMAT_RENDERTARGET (0x00000010L), FORMATOP_VOLUMETEXTURE (0x00000002L), _FORMATOP, FORMATOP_BUMPMAP (0x00010000L), FORMATOP_CUBETEXTURE (0x00000004L), FORMATOP_NOFILTER (0x00040000L), FORMATOP_CAPTURE (0x08000000L), FORMATOP_SRGBREAD (0x00008000L), D3D_other_Structs_c60ed644-61b9-4700-8944-131765951138.xml, FORMATOP_ZSTENCIL_WITH_ARBITRARY_COLOR_DEPTH (0x00000080L), FORMATOP_VIDEO_ENCODER (0x10000000L), d3dumddi/FORMATOP, FORMATOP_NOTEXCOORDWRAPNORMIP (0x01000000L), FORMATOP_AUTOGENMIPMAP (0x00400000L), FORMATOP_MULTIPLANE_OVERLAY (0x20000000L), FORMATOP_OVERLAY (0x04000000L)
