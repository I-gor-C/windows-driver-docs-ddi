...
### -param pData [in]
 ...
 A pointer to a <a href="display.d3dddiarg_updateoverlay">D3DDDIARG_UPDATEOVERLAY</a> structure that describes how to reconfigure the overlay.
...
<dl>
<dt>
<a href="display.d3dddiarg_updateoverlay">D3DDDIARG_UPDATEOVERLAY</a>
</dt>
<dt>
