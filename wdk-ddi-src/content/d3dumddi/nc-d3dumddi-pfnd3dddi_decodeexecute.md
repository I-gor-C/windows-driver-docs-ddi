...
### -param pData [in]
 ...
 A pointer to a <a href="display.d3dddiarg_decodeexecute">D3DDDIARG_DECODEEXECUTE</a> structure that describes the DirectX VA decode operation to perform.
