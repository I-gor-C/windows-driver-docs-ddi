...
A pointer to a <a href="display.d3dddicb_flipoverlay">D3DDDICB_FLIPOVERLAY</a> structure that describes how to change the display on the overlay.
...
<dt>
<a href="display.d3dddicb_flipoverlay">D3DDDICB_FLIPOVERLAY</a>
</dt>
</dl>
 
 
