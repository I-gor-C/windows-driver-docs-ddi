...
### -param pData [in, out]
 ...
 A pointer to a <a href="display.d3dddiarg_validatetexturestagestate">D3DDDIARG_VALIDATETEXTURESTAGESTATE</a> structure that receives the number of passes in which the hardware can perform the blending operations.
...
<dl>
<dt>
<a href="display.d3dddiarg_validatetexturestagestate">D3DDDIARG_VALIDATETEXTURESTAGESTATE</a>
</dt>
<dt>
