...
### -param pData [in]
 ...
 A pointer to a <a href="display.d3dddiarg_capturetosysmem">D3DDDIARG_CAPTURETOSYSMEM</a> structure that describes the parameters of the bit-block transfer (bitblt).
...
<dl>
<dt>
<a href="display.d3dddiarg_capturetosysmem">D3DDDIARG_CAPTURETOSYSMEM</a>
</dt>
<dt>
