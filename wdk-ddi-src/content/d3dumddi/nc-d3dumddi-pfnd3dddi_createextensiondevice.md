...
### -param pData [in, out]
 ...
 A pointer to a <a href="display.d3dddiarg_createextensiondevice">D3DDDIARG_CREATEEXTENSIONDEVICE</a> structure. On input, this structure contains information that the driver can use. On output, the driver specifies information in the structure that the Microsoft Direct3D runtime can use.
...
<dl>
<dt>
<a href="display.d3dddiarg_createextensiondevice">D3DDDIARG_CREATEEXTENSIONDEVICE</a>
</dt>
<dt>
