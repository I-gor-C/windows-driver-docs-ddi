...
## -description
<p>The D3DDDIARG_QUERYRESOURCERESIDENCY structure describes a list of resources on which residency is verified through the <a href="..\d3dumddi\nc-d3dumddi-pfnd3dddi-queryresourceresidency.md">QueryResourceResidency</a> function. </p>
