...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | DestroyCryptoSession is supported beginning with the Windows 7 operating system. DestroyCryptoSession is supported beginning with the Windows 7 operating system. |
