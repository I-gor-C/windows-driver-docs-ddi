...
### -param pData [in, out]
 ...
 A pointer to a <a href="display.d3dddiarg_dxvahd_getvideoprocessbltstateprivate">D3DDDIARG_DXVAHD_GETVIDEOPROCESSBLTSTATEPRIVATE</a> structure that describes the private bitblt state data to retrieve. 
...
<td width="70%">
<i>GetVideoProcessBltStatePrivate</i> is supported beginning with the Windows 7 operating system.
</td>
</tr>
<tr>
<th width="30%">
...
<dl>
<dt>
<a href="display.d3dddiarg_dxvahd_getvideoprocessbltstateprivate">D3DDDIARG_DXVAHD_GETVIDEOPROCESSBLTSTATEPRIVATE</a>
</dt>
</dl>
 
 
