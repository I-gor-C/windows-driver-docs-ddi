...
ms.date: 12/29/2017
ms.keywords: D3DDDICB_DESTROYHWQUEUE, display.d3dddicb_destroyhwqueue, d3dumddi/D3DDDICB_DESTROYHWQUEUE, D3DDDICB_DESTROYHWQUEUE structure [Display Devices], _D3DDDICB_DESTROYHWQUEUE
