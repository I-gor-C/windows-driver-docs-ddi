...
<dd>
<p>A pointer to a <a href="..\d3dumddi\ns-d3dumddi--d3dddicb-setpriority.md">D3DDDICB_SETPRIORITY</a> structure that describes the priority level to set a resource or list of allocations to.</p>
</dd>
</dl>
...
<dl>
<dt>
<a href="..\d3dumddi\ns-d3dumddi--d3dddicb-setpriority.md">D3DDDICB_SETPRIORITY</a>
</dt>
<dt>
