# Declarations in the pcivirt header
This header Pcivirt contains these programming interfaces:
...
| [SRIOV_GET_MMIO_REQUIREMENTS callback function](nc-pcivirt-sriov-get-mmio-requirements.md) | TBD |
...
| Title        | Description    |
| ------------- |:-------------:|
| [SRIOV_IOCTL function](nf-pcivirt-sriov-ioctl.md) | TBD |
Enum
