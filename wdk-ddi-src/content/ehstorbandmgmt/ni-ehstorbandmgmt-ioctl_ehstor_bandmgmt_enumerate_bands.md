...
### -input-buffer
The buffer at <i>Irp-&gt;AssociatedIrp.SystemBuffer</i> must contain an <a href="storage.enumerate_bands_parameters">ENUMERATE_BANDS_PARAMETERS</a> structure. 
...
### -output-buffer
The buffer at <i>Irp-&gt;AssociatedIrp.SystemBuffer</i> contains a <a href="storage.enumerate_bands_parameters">BAND_TABLE</a> structure followed by <b>BandTableEntryCount</b> band entries.


### -output-buffer-length
The length of a <a href="storage.enumerate_bands_parameters">BAND_TABLE</a> structure followed by <b>BandTableEntryCount</b> band entries.
...
<dl>
<dt>
<a href="storage.enumerate_bands_parameters">BAND_TABLE</a>
</dt>
