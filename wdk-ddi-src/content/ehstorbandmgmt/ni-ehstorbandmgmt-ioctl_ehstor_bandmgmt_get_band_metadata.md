...
### -input-buffer
The input buffer at <i>Irp-&gt;AssociatedIrp.SystemBuffer</i> must contain a <a href="storage.get_band_metadata_parameters"> GET_BAND_METADATA_PARAMETERS</a> structure. 
...
### -output-buffer
The output buffer at <i>Irp-&gt;AssociatedIrp.SystemBuffer</i> contains a byte array of band metadata specified by <a href="storage.get_band_metadata_parameters">GET_BAND_METADATA_PARAMETERS</a>.


### -output-buffer-length
The length of a <a href="storage.get_band_metadata_parameters">GET_BAND_METADATA_PARAMETERS</a> structure.
