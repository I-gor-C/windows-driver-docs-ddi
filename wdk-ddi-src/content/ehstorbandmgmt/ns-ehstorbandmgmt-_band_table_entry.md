...
ms.date : 1/10/2018
ms.keywords : ehstorbandmgmt/PBAND_TABLE_ENTRY, *PBAND_TABLE_ENTRY, BAND_TABLE_ENTRY structure [Storage Devices], BAND_TABLE_ENTRY, storage.band_table_entry, PBAND_TABLE_ENTRY structure pointer [Storage Devices], _BAND_TABLE_ENTRY, PBAND_TABLE_ENTRY, ehstorbandmgmt/BAND_TABLE_ENTRY
