...
ms.date: 1/10/2018
ms.keywords: ehstorbandmgmt/PENUMERATE_BANDS_PARAMETERS, ENUMBANDS_ENUM_ALL_BANDS, PENUMERATE_BANDS_PARAMETERS, storage.enumerate_bands_parameters, ENUMBANDS_REPORT_CRYPTO_ALGO, _ENUMERATE_BANDS_PARAMETERS, ENUMERATE_BANDS_PARAMETERS structure [Storage Devices], ENUMERATE_BANDS_PARAMETERS, *PENUMERATE_BANDS_PARAMETERS, PENUMERATE_BANDS_PARAMETERS structure pointer [Storage Devices], ehstorbandmgmt/ENUMERATE_BANDS_PARAMETERS
