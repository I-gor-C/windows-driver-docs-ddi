...
## -description
<p>The <b>ERASE_BAND_PARAMETERS</b> structure contains the selection criteria for a band to erase. Additionally, a new authentication key can be set. This structure is input for an <a href="https://msdn.microsoft.com/E7DE8E55-B753-42AF-B25F-F806EE37DCF1"> IOCTL_EHSTOR_BANDMGMT_ERASE_BAND</a> request.</p>
