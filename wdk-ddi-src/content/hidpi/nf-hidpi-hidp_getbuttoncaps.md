...
<i>ButtonCapsLength</i> should be set to the value of the <b>Number</b><i>Xxx</i><b>ButtonCaps</b> member of the <a href="hid.hidp_caps">HIDP_CAPS</a> structure returned by <a href="hid.hidp_getcaps">HidP_GetCaps</a>, where <i>Xxx</i> specifies the report type.

To obtain a subset of button capabilities, selected by <a href="https://msdn.microsoft.com/84fed314-3554-4291-b51c-734d874a4bab">usage</a>, <a href="hid.hid_usages#usage_page#usage_page">usage page</a>, or <a href="https://msdn.microsoft.com/3f934661-c33c-4c08-82ac-ee2e0f519c8e">link collection</a>, use <a href="hid.hidp_getspecificbuttoncaps">HidP_GetSpecificButtonCaps</a>.
