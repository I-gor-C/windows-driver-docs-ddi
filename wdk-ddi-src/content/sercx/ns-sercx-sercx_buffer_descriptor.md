...
ms.date: 12/14/2017
ms.keywords: 1/SERCX_BUFFER_DESCRIPTOR, *PSERCX_BUFFER_DESCRIPTOR, SERCX_BUFFER_DESCRIPTOR, 1/PSERCX_BUFFER_DESCRIPTOR, PSERCX_BUFFER_DESCRIPTOR structure pointer [Serial Ports], PSERCX_BUFFER_DESCRIPTOR, serports.sercx_buffer_descriptor, SERCX_BUFFER_DESCRIPTOR structure [Serial Ports]
