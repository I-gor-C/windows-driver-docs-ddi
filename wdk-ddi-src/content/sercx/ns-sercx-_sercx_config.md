...
ms.date: 12/14/2017
ms.keywords: SERCX_CONFIG structure [Serial Ports], *PSERCX_CONFIG, serports.sercx_config, PSERCX_CONFIG structure pointer [Serial Ports], 1/SERCX_CONFIG, SERCX_CONFIG, PSERCX_CONFIG, 1/PSERCX_CONFIG, _SERCX_CONFIG
