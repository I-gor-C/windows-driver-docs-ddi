...
ms.date : 12/14/2017
ms.keywords : SERCX2_CUSTOM_TRANSMIT_CONFIG_INIT, 2/SERCX2_CUSTOM_TRANSMIT_CONFIG_INIT, serports.sercx2_custom_transmit_config_init, SERCX2_CUSTOM_TRANSMIT_CONFIG_INIT function [Serial Ports]
