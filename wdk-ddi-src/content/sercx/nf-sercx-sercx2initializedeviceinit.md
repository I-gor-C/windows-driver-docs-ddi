...
ms.date: 12/14/2017
ms.keywords: SerCx2InitializeDeviceInit method [Serial Ports], SerCx2InitializeDeviceInit, 2/SerCx2InitializeDeviceInit, serports.sercx2initializedeviceinit
