...
## -description
<p>
Implemented by the client driver to start the hardware notification component. It is invoked as a result of a call to <a href="https://msdn.microsoft.com/library/windows/hardware/ff540848">EVT_WDF_DEVICE_D0_ENTRY</a>. </p>
