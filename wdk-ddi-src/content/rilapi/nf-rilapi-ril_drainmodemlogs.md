...
ms.date : 1/18/2018
ms.keywords : RIL_DrainModemLogs method [Network Drivers Starting with Windows Vista], netvista.ril_drainmodemlogs, RIL_DrainModemLogs, rilapi/RIL_DrainModemLogs
