...
ms.date : 1/18/2018
ms.keywords : rilapi/RIL_SetCallWaitingStatus, RIL_SetCallWaitingStatus method [Network Drivers Starting with Windows Vista], netvista.ril_setcallwaitingstatus, RIL_SetCallWaitingStatus
