...
ms.date: 1/18/2018
ms.keywords: netvista.ril_getuiccrecordstatus, RIL_GetUiccRecordStatus method [Network Drivers Starting with Windows Vista], RIL_GetUiccRecordStatus, rilapi/RIL_GetUiccRecordStatus
