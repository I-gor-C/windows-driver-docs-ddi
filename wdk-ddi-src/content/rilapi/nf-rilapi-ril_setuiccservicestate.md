...
ms.date: 2/16/2018
ms.keywords: rilapi/RIL_SetUiccServiceState, RIL_SetUiccServiceState, RIL_SetUiccServiceState method [Network Drivers Starting with Windows Vista], netvista.ril_setuiccservicestate
