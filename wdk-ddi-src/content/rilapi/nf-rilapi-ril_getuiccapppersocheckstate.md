...
ms.date: 1/18/2018
ms.keywords: RIL_GetUiccAppPersoCheckState, RIL_GetUiccAppPersoCheckState method [Network Drivers Starting with Windows Vista], rilapi/RIL_GetUiccAppPersoCheckState, netvista.ril_getuiccapppersocheckstate
