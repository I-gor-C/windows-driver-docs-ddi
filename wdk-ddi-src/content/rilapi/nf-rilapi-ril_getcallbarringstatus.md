...
ms.date: 2/16/2018
ms.keywords: RIL_GetCallBarringStatus, netvista.ril_getcallbarringstatus, RIL_GetCallBarringStatus method [Network Drivers Starting with Windows Vista], rilapi/RIL_GetCallBarringStatus
