...
ms.date: 1/18/2018
ms.keywords: rilapi/RIL_GetCallBarringStatus, RIL_GetCallBarringStatus method [Network Drivers Starting with Windows Vista], RIL_GetCallBarringStatus, netvista.ril_getcallbarringstatus
