...
ms.date: 2/16/2018
ms.keywords: RIL_GetDMProfileConfigInfo method [Network Drivers Starting with Windows Vista], RIL_GetDMProfileConfigInfo, rilapi/RIL_GetDMProfileConfigInfo, netvista.ril_getdmprofileconfiginfo
