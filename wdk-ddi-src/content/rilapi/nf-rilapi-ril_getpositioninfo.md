...
ms.date: 1/18/2018
ms.keywords: netvista.ril_getpositioninfo, RIL_GetPositionInfo method [Network Drivers Starting with Windows Vista], rilapi/RIL_GetPositionInfo, RIL_GetPositionInfo
