...
ms.date: 2/16/2018
ms.keywords: netvista.ril_setpsmediaconfiguration, RIL_SetPSMediaConfiguration, RIL_SetPSMediaConfiguration method [Network Drivers Starting with Windows Vista], rilapi/RIL_SetPSMediaConfiguration
