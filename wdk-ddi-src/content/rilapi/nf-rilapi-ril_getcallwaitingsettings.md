...
ms.date: 2/16/2018
ms.keywords: RIL_GetCallWaitingSettings method [Network Drivers Starting with Windows Vista], netvista.ril_getcallwaitingsettings, RIL_GetCallWaitingSettings, rilapi/RIL_GetCallWaitingSettings
