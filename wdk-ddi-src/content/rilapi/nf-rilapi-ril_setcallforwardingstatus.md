...
ms.date: 1/18/2018
ms.keywords: rilapi/RIL_SetCallForwardingStatus, RIL_SetCallForwardingStatus method [Network Drivers Starting with Windows Vista], RIL_SetCallForwardingStatus, netvista.ril_setcallforwardingstatus
