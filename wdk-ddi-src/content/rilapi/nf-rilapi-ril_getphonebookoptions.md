...
ms.date: 2/16/2018
ms.keywords: rilapi/RIL_GetPhonebookOptions, netvista.ril_getphonebookoptions, RIL_GetPhonebookOptions method [Network Drivers Starting with Windows Vista], RIL_GetPhonebookOptions
