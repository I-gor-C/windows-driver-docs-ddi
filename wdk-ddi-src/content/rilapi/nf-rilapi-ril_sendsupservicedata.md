...
ms.date : 1/18/2018
ms.keywords : RIL_SendSupServiceData method [Network Drivers Starting with Windows Vista], rilapi/RIL_SendSupServiceData, RIL_SendSupServiceData, netvista.ril_sendsupservicedata
