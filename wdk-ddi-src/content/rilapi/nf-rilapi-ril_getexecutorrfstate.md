...
ms.date : 1/18/2018
ms.keywords : rilapi/RIL_GetExecutorRFState, RIL_GetExecutorRFState, RIL_GetExecutorRFState method [Network Drivers Starting with Windows Vista], netvista.ril_getexecutorrfstate
