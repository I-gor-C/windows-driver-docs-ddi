...
ms.date: 2/16/2018
ms.keywords: netvista.ril_getuiccservicelock, rilapi/RIL_GetUiccServiceLock, RIL_GetUiccServiceLock method [Network Drivers Starting with Windows Vista], RIL_GetUiccServiceLock
