...
ms.date: 1/18/2018
ms.keywords: netvista.ril_getuiccservicelock, RIL_GetUiccServiceLock method [Network Drivers Starting with Windows Vista], RIL_GetUiccServiceLock, rilapi/RIL_GetUiccServiceLock
