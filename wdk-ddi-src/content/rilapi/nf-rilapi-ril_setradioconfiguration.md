...
ms.date: 2/16/2018
ms.keywords: RIL_SetRadioConfiguration, RIL_SetRadioConfiguration method [Network Drivers Starting with Windows Vista], rilapi/RIL_SetRadioConfiguration, netvista.ril_setradioconfiguration
