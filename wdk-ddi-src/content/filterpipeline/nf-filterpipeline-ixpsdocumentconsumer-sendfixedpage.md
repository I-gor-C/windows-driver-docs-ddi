...
ms.date: 2/21/2018
ms.keywords: SendFixedPage method [Print Devices], IXpsDocumentConsumer interface, SendFixedPage, filterpipeline_fbf758b4-801f-4c68-879c-2820736e459e.xml, filterpipeline/IXpsDocumentConsumer::SendFixedPage, SendFixedPage method [Print Devices], print.ixpsdocumentconsumer_sendfixedpage, IXpsDocumentConsumer::SendFixedPage, IXpsDocumentConsumer interface [Print Devices], SendFixedPage method, IXpsDocumentConsumer
