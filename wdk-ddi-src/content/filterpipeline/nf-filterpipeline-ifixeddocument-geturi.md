...
ms.date: 2/2/2018
ms.keywords: GetUri method [Print Devices], IFixedDocument interface, print.ifixeddocument_geturi, filterpipeline/IFixedDocument::GetUri, filterpipeline_278b5027-10e2-4564-a404-143f84e0123c.xml, IFixedDocument interface [Print Devices], GetUri method, IFixedDocument::GetUri, GetUri, GetUri method [Print Devices], IFixedDocument
