...
req.dll: 
req.irql: 
ms.keywords: IPrintPipelineFilter, ShutdownOperation, IPrintPipelineFilter::ShutdownOperation
...
## -description
<p>The Pipeline Manager uses the <code>ShutdownOperation</code> method to shut down a filter if the print job is canceled or an error occurs.</p>
