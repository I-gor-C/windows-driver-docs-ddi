...
ms.date: 2/21/2018
ms.keywords: GetProperty method [Print Devices], filterpipeline_6a2e804b-b8dd-4e20-a71a-7817181b825c.xml, IPrintPipelinePropertyBag, print.iprintpipelinepropertybag_getproperty, IPrintPipelinePropertyBag interface [Print Devices], GetProperty method, GetProperty, GetProperty method [Print Devices], IPrintPipelinePropertyBag interface, filterpipeline/IPrintPipelinePropertyBag::GetProperty, IPrintPipelinePropertyBag::GetProperty
