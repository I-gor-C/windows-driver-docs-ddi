...
## -description
<p>UCX invokes this callback function to set the priority on an endpoint.</p>
...
<dd>
<p>A pointer to a <a href="https://msdn.microsoft.com/4785D94B-271C-4F8E-B95B-87401E32CE42">UCX_ENDPOINT_CHARACTERISTIC</a> structure that contains endpoint characteristics.</p>
</dd>
</dl>
