...
ms.date: 1/18/2018
ms.keywords: ntddndis/PNDIS_OBJECT_HEADER, NDIS_OBJECT_HEADER structure [Network Drivers Starting with Windows Vista], _NDIS_OBJECT_HEADER, ntddndis/NDIS_OBJECT_HEADER, netvista.ndis_object_header, PNDIS_OBJECT_HEADER structure pointer [Network Drivers Starting with Windows Vista], PNDIS_OBJECT_HEADER, *PNDIS_OBJECT_HEADER, ndis_object_ref_c4593f06-bd96-4bbe-8e94-d8b7b1cf413b.xml, NDIS_OBJECT_HEADER
