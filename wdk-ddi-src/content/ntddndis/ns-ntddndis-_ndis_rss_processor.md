...
ms.date: 1/18/2018
ms.keywords: ndis_processor_group_ref_cbab90a4-91cf-4df3-a9dc-94f3cacf2039.xml, PNDIS_RSS_PROCESSOR structure pointer [Network Drivers Starting with Windows Vista], NDIS_RSS_PROCESSOR structure [Network Drivers Starting with Windows Vista], PNDIS_RSS_PROCESSOR, *PNDIS_RSS_PROCESSOR, NDIS_RSS_PROCESSOR, ntddndis/NDIS_RSS_PROCESSOR, _NDIS_RSS_PROCESSOR, ntddndis/PNDIS_RSS_PROCESSOR, netvista.ndis_rss_processor
