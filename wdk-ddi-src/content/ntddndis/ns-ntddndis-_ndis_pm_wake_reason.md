...
ms.date : 1/18/2018
ms.keywords : PNDIS_PM_WAKE_REASON structure pointer [Network Drivers Starting with Windows Vista], PNDIS_PM_WAKE_REASON, netvista.ndis_pm_wake_reason, ntddndis/PNDIS_PM_WAKE_REASON, _NDIS_PM_WAKE_REASON, NDIS_PM_WAKE_REASON, NDIS_PM_WAKE_REASON structure [Network Drivers Starting with Windows Vista], ntddndis/NDIS_PM_WAKE_REASON, *PNDIS_PM_WAKE_REASON
