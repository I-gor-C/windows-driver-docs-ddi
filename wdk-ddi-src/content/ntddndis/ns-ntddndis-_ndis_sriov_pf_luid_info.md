...
ms.date: 12/14/2017
ms.keywords: _NDIS_SRIOV_PF_LUID_INFO, PNDIS_SRIOV_PF_LUID_INFO, *PNDIS_SRIOV_PF_LUID_INFO, NDIS_SRIOV_PF_LUID_INFO
...
The type, revision, and size of the <b>NDIS_SRIOV_PF_LUID_INFO</b> structure. This member is formatted as an <a href="netvista.ndis_object_header">NDIS_OBJECT_HEADER</a> structure.
...
An <a href="netvista.luid">LUID</a> value that is associated with the PF network adapter. For more information, see the Remarks section.
