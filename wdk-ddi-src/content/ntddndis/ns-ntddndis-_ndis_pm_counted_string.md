...
ms.date: 12/14/2017
ms.keywords: _NDIS_PM_COUNTED_STRING, *PNDIS_PM_COUNTED_STRING, PNDIS_PM_COUNTED_STRING, NDIS_PM_COUNTED_STRING
...
The NDIS_PM_COUNTED_STRING structure specifies a limited size string that is used in the 
    <a href="netvista.ndis_pm_protocol_offload">NDIS_PM_PROTOCOL_OFFLOAD</a> and 
    <a href="netvista.ndis_pm_wol_pattern">NDIS_PM_WOL_PATTERN</a> power management
