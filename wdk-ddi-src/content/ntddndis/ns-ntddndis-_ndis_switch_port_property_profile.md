...
typedef struct _NDIS_SWITCH_PORT_PROPERTY_PROFILE {
  ...
  struct {
    UINT32  : 8  PciBusNumber;
    UINT32  : 5  PciDeviceNumber;
    UINT32  : 3  PciFunctionNumber;
    UINT32  : 16 PciSegmentNumber;
  } PciLocation;
  UINT32                                      CdnLabelId;
  NDIS_SWITCH_PORT_PROPERTY_PROFILE_CDN_LABEL CdnLabel;
} *PNDIS_SWITCH_PORT_PROPERTY_PROFILE, NDIS_SWITCH_PORT_PROPERTY_PROFILE;
```
