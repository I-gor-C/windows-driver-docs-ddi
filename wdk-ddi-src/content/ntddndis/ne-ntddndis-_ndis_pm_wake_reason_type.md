...
ms.date: 1/18/2018
ms.keywords: ntddndis/NdisWakeReasonWwanUSSDReceive, NDIS_PM_WAKE_REASON_TYPE enumeration [Network Drivers Starting with Windows Vista], ntddndis/NdisWakeReasonWwanSMSReceive, NdisWakeReasonMediaDisconnect, ntddndis/NDIS_PM_WAKE_REASON_TYPE, NdisWakeReasonWwanRegisterState, ntddndis/NdisWakeReasonWlanGTKHandshakeError, ntddndis/NdisWakeReasonWlanAPAssociationLost, NdisWakeReasonWlanGTKHandshakeError, ntddndis/NdisWakeReasonMediaConnect, *PNDIS_PM_WAKE_REASON_TYPE, ntddndis/NdisWakeReasonUnspecified, ntddndis/NdisWakeReasonMediaDisconnect, ntddndis/NdisWakeReasonPacket, ntddndis/NdisWakeReasonWlan4WayHandshakeRequest, PNDIS_PM_WAKE_REASON_TYPE, NdisWakeReasonWlan4WayHandshakeRequest, NdisWakeReasonMediaConnect, NdisWakeReasonUnspecified, ntddndis/NdisWakeReasonWwanRegisterState, NdisWakeReasonWwanSMSReceive, _NDIS_PM_WAKE_REASON_TYPE, NdisWakeReasonWlanAPAssociationLost, NdisWakeReasonWlanNLODiscovery, NDIS_PM_WAKE_REASON_TYPE, NdisWakeReasonWwanUSSDReceive, PNDIS_PM_WAKE_REASON_TYPE enumeration pointer [Network Drivers Starting with Windows Vista], ntddndis/NdisWakeReasonWlanNLODiscovery, netvista.ndis_pm_wake_reason_type, ntddndis/PNDIS_PM_WAKE_REASON_TYPE, NdisWakeReasonPacket
