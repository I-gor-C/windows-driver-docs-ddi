...
ms.date: 1/18/2018
ms.keywords: ntddndis/NDIS_PORT_STATE, netvista.ndis_port_state, ntddndis/PNDIS_PORT_STATE, _NDIS_PORT_STATE, NDIS_PORT_STATE structure [Network Drivers Starting with Windows Vista], NDIS_PORT_STATE, PNDIS_PORT_STATE, *PNDIS_PORT_STATE, PNDIS_PORT_STATE structure pointer [Network Drivers Starting with Windows Vista], ndis_ports_ref_dbfd8cd5-9c0c-4ea9-8329-d9fbf15b14df.xml
