...
title: NDIS_RECEIVE_QUEUE_ALLOCATION_COMPLETE_PARAMETERS
...
ms.date: 11/28/2017
ms.keywords: NDIS_RECEIVE_QUEUE_ALLOCATION_COMPLETE_PARAMETERS, NDIS_RECEIVE_QUEUE_ALLOCATION_COMPLETE_PARAMETERS, *PNDIS_RECEIVE_QUEUE_ALLOCATION_COMPLETE_PARAMETERS
...
# NDIS_RECEIVE_QUEUE_ALLOCATION_COMPLETE_PARAMETERS structure



## -description
<p>The <b>NDIS_RECEIVE_QUEUE_ALLOCATION_COMPLETE_PARAMETERS</b> structure contains information about the
  allocation status of a receive queue.</p>
...
<p>The 
     ...
     <b>Size</b> member to <b>NDIS_SIZEOF_RECEIVE_QUEUE_ALLOCATION_COMPLETE_PARAMETERS_REVISION_1</b>.</p>
</dd>
...
<dd>
<p>An <b>NDIS_STATUS</b> value that contains an NDIS_STATUS_<i>Xxx</i> completion status code. The miniport driver
     ...
     error status, for example, <b>NDIS_STATUS_RESOURCES</b>.</p>
</dd>
</dl>

## -remarks
<p>The <b>NDIS_RECEIVE_QUEUE_ALLOCATION_COMPLETE_PARAMETERS</b> structure is used with the 
