...
ms.date : 1/18/2018
ms.keywords : PNDIS_SWITCH_PORT_PARAMETERS structure pointer [Network Drivers Starting with Windows Vista], ntddndis/PNDIS_SWITCH_PORT_PARAMETERS, NDIS_SWITCH_PORT_PARAMETERS, PNDIS_SWITCH_PORT_PARAMETERS, NDIS_SWITCH_PORT_PARAMETERS structure [Network Drivers Starting with Windows Vista], _NDIS_SWITCH_PORT_PARAMETERS, ntddndis/NDIS_SWITCH_PORT_PARAMETERS, netvista.ndis_switch_port_parameters, *PNDIS_SWITCH_PORT_PARAMETERS
