...
An 
     <mshelp:link keywords="netvista.ndis_hypervisor_partition_type" tabindex="0"><b>
     NDIS_HYPERVISOR_PARTITION_TYPE</b></mshelp:link> enumeration value that specifies the partition type that is running
     on the hypervisor.
