...
ms.date: 12/14/2017
ms.keywords: _NDIS_HYPERVISOR_INFO, PNDIS_HYPERVISOR_INFO, *PNDIS_HYPERVISOR_INFO, NDIS_HYPERVISOR_INFO
...
The type, revision, and size of the <b>NDIS_HYPERVISOR_INFO</b> structure. This member is formatted as an <a href="netvista.ndis_object_header">NDIS_OBJECT_HEADER</a> structure.
...
An 
     <a href="netvista.ndis_hypervisor_partition_type">
...
The <b>NDIS_HYPERVISOR_INFO</b> structure specifies the hypervisor information that is returned by the 
    <a href="netvista.ndisgethypervisorinfo">NdisGetHypervisorInfo</a> function.
...
<dl>
<dt>
<a href="netvista.ndis_hypervisor_partition_type">NDIS_HYPERVISOR_PARTITION_TYPE</a>
</dt>
<dt>
<a href="netvista.ndis_object_header">NDIS_OBJECT_HEADER</a>
</dt>
<dt>
<a href="netvista.ndisgethypervisorinfo">NdisGetHypervisorInfo Function</a>
</dt>
</dl>
 
