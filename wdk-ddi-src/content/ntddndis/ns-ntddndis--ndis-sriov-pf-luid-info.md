...
<dd>
<p>The type, revision, and size of the <b>NDIS_SRIOV_PF_LUID_INFO</b> structure. This member is formatted as an <a href="..\ntddndis\ns-ntddndis--ndis-object-header.md">NDIS_OBJECT_HEADER</a> structure.</p>
...
<dd>
<p>An <a href="netvista.luid">LUID</a> value that is associated with the PF network adapter. For more information, see the Remarks section.</p>
</dd>
</dl>

## -remarks
<p>NDIS generates an LUID for the PF  before NDIS calls the <a href="..\ndis\nc-ndis-miniport-initialize.md">MiniportInitializeEx</a>
