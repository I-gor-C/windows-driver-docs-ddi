...
A structure of type <a href="buses._roothub_info">ROOTHUB_INFO</a>.
...
The <a href="buses._roothub_info">_ROOTHUB_INFO</a> structure contains the number of USB 2.0 and USB 3.0 ports supported by the root hub.
