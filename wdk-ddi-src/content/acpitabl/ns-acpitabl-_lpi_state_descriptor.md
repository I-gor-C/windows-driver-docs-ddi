...
ms.date: 12/31/2017
ms.keywords: acpitabl/LPI_STATE_DESCRIPTOR, PLPI_STATE_DESCRIPTOR, _LPI_STATE_DESCRIPTOR, LPI_STATE_DESCRIPTOR structure [ACPI Devices], PLPI_STATE_DESCRIPTOR structure pointer [ACPI Devices], LPI_STATE_DESCRIPTOR, acpi.lpi_state_descriptor, acpitabl/PLPI_STATE_DESCRIPTOR, *PLPI_STATE_DESCRIPTOR
