...
## -description
<p>Sets the procotol the driver communicates to the smart card with after the card is detected.</p>


## -ioctlparameters

### -input-buffer
<p>(DWORD) mask of protocols below:<ul>
...
### -output-buffer
<p>(DWORD) contains the selected protocol (for example, SCARD_PROTOCOL_T1).</p>
