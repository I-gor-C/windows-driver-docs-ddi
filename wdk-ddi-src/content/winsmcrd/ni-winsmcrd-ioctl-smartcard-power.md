...
## -description
<p>Windows may require a driver to have this IOCTL to be NOP and return success.</p>
<p>The <b>IOCTL_SMARTCARD_POWER</b> 
   control code  puts the smart card into one of the following power modes:</p>
<p> </p>
...
### -input-buffer
<p>(DWORD) that contains the power state to set.</p>
...
## -remarks
<p>Virtual power is set to TRUE for COLD_RESET and WARM_RESET; otherwise, virtual power is set to FALSE.</p>
