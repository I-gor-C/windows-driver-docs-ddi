...
<dd>
<p>The version of the NDK provider interface (<a href="netvista.ndk_version">NDK_VERSION</a>) that is to be used. </p>
...
## -remarks
<p>To open an NDK adapter, NDIS calls the <a href="..\ndisndk\nc-ndisndk-open-ndk-adapter-handler.md">OPEN_NDK_ADAPTER_HANDLER</a> function and passes it a  pointer to an <b>NDIS_OPEN_NDK_ADAPTER_PARAMETERS</b> structure that defines the NDK adapter open parameters.</p>
