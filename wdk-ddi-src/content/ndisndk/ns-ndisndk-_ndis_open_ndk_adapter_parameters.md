...
ms.date: 12/14/2017
ms.keywords: _NDIS_OPEN_NDK_ADAPTER_PARAMETERS, *PNDIS_OPEN_NDK_ADAPTER_PARAMETERS, NDIS_OPEN_NDK_ADAPTER_PARAMETERS, PNDIS_OPEN_NDK_ADAPTER_PARAMETERS
...
The version of the NDK provider interface (<a href="netvista.ndk_version">NDK_VERSION</a>) that is to be used. 
