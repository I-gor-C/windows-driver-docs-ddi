...
| **IRQL** | "<=PASSIVE_LEVEL" |
| **DDI compliance rules** | DeferredRequestCompleted, DriverCreate, InternalIoctlReqs, IoctlReqs, KmdfIrql, KmdfIrql2, ReadReqs, RequestCompleted, RequestCompletedLocal, SyncReqSend |
