...
<table>
                ...
                <tr>
                    ...
                    <td>The framework attempts to cancel all of the I/O requests in the target's queue, and waits until all delivered requests are completed or canceled, before <a href="https://msdn.microsoft.com/library/windows/hardware/hh439338">WdfIoTargetPurge</a> returns. If the framework receives additional requests for the queue, it completes them with a completion status value of STATUS_INVALID_DEVICE_STATE.</td>
                </tr>
            
                <tr>
                    <td>WdfIoTargetPurgeIo</td>
                    <td>The framework attempts to cancel all of the target queue's I/O requests, before <a href="https://msdn.microsoft.com/library/windows/hardware/hh439338">WdfIoTargetPurge</a> returns.</td>
                </tr>
</table>
