...
After calling <b>RxDriverEntry</b> to initialize the copy of the RDBSS library near the start of its <a href="..\wdm\nc-wdm-driver_initialize.md">DriverEntry</a> routine, the network mini-redirector driver would usually call <a href="ifsk.rxregisterminirdr">RxRegisterMinirdr</a> later in its <i>DriverEntry</i> routine to register with RDBSS. 
