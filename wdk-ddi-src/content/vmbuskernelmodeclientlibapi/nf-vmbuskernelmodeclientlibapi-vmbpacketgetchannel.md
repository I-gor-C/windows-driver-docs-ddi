...
ms.date: 1/18/2018
ms.keywords: VmbPacketGetChannel function [Network Drivers Starting with Windows Vista], VmbPacketGetChannel, netvista.vmbpacketgetchannel, vmbuskernelmodeclientlibapi/VmbPacketGetChannel
