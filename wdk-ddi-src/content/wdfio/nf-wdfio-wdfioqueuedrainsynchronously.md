...
The driver should not call another method that changes queue state, such as <a href="wdf.wdfioqueuepurge">WdfIoQueuePurge</a> or <a href="wdf.wdfioqueuestart">WdfIoQueueStart</a>, before the call to <b>WdfIoQueueDrainSynchronously</b> has returned.

As a best practice, you should only call <b>WdfIoQueueDrainSynchronously</b> when you are certain that the queue's pending I/O requests will complete in a timely fashion. Otherwise, use <a href="wdf.wdfioqueuepurgesynchronously">WdfIoQueuePurgeSynchronously</a>.  For more information, see <a href="wdf.managing_i_o_queues#purging_or_draining_an_i_o_queue#purging_or_draining_an_i_o_queue">Managing I/O Queues</a>.
