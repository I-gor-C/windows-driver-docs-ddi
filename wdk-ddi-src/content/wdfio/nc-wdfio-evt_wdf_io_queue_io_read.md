...
title: EVT_WDF_IO_QUEUE_IO_READ function
...
ms.date: 1/11/2018
ms.keywords: EVT_WDF_IO_QUEUE_IO_READ
...
# EVT_WDF_IO_QUEUE_IO_READ function
...
If a driver has registered an <i>EvtIoRead</i> callback function for a device's I/O queue, the callback function receives every read request from the queue. For more information, see <a href="https://msdn.microsoft.com/bfc543bf-18a8-4e2c-ba7a-d0a21cefb038">Request Handlers</a>.
