...
title: EVT_WDF_IO_ALLOCATE_RESOURCES_FOR_RESERVED_REQUEST function
...
ms.date: 1/11/2018
ms.keywords: EVT_WDF_IO_ALLOCATE_RESOURCES_FOR_RESERVED_REQUEST
...
The driver's <a href="https://msdn.microsoft.com/bfc543bf-18a8-4e2c-ba7a-d0a21cefb038">request handlers</a> can call <a href="..\wdfrequest\nf-wdfrequest-wdfrequestisreserved.md">WdfRequestIsReserved</a> to determine if reserved request objects are being used.

For more information about how to use object context space, see <a href="https://msdn.microsoft.com/21a46e04-2330-4a3d-ba72-c04295bfbb3c">Framework Object Context Space</a>.
...
For more information about the <i>EvtIoAllocateResourcesForReservedRequest</i> callback function, see <a href="https://msdn.microsoft.com/e230eb3b-54ac-43b1-ac2b-8fa137cee43e">Guaranteeing Forward Progress of I/O Operations</a>.
