...
ms.date: 2/16/2018
ms.keywords: PNDK_ADAPTER_DISPATCH, ndkpi/NDK_ADAPTER_DISPATCH, ndkpi/PNDK_ADAPTER_DISPATCH, NDK_ADAPTER_DISPATCH, PNDK_ADAPTER_DISPATCH structure pointer [Network Drivers Starting with Windows Vista], netvista.ndk_adapter_dispatch, NDK_ADAPTER_DISPATCH structure [Network Drivers Starting with Windows Vista], _NDK_ADAPTER_DISPATCH
