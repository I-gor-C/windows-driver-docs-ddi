...
<dd>
<p>The entry point for the object's <a href="..\ndkpi\nc-ndkpi-ndk-fn-get-shared-endpoint-local-address.md">NDK_FN_GET_SHARED_ENDPOINT_LOCAL_ADDRESS</a> dispatch function.</p>
</dd>
</dl>

## -remarks
<p>The <b>NDK_SHARED_ENDPOINT_DISPATCH</b> structure is used in the <a href="..\ndkpi\ns-ndkpi--ndk-shared-endpoint.md">NDK_SHARED_ENDPOINT</a> structure.</p>
...
<dt>
<a href="..\ndkpi\nc-ndkpi-ndk-fn-get-shared-endpoint-local-address.md">NDK_FN_GET_SHARED_ENDPOINT_LOCAL_ADDRESS</a>
</dt>
<dt>
