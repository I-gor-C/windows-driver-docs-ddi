...
ms.date: 1/18/2018
ms.keywords: netvista.ndk_pd_dispatch, NDK_PD_DISPATCH, _NDK_PD_DISPATCH, ndkpi/NDK_PD_DISPATCH, NDK_PD_DISPATCH structure [Network Drivers Starting with Windows Vista]
