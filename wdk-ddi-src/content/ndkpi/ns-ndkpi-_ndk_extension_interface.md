...
ms.date: 2/16/2018
ms.keywords: NDK_EXTENSION_INTERFACE structure [Network Drivers Starting with Windows Vista], PNDK_EXTENSION_INTERFACE structure pointer [Network Drivers Starting with Windows Vista], _NDK_EXTENSION_INTERFACE, ndkpi/PNDK_EXTENSION_INTERFACE, netvista.ndk_extension_interface, NDK_EXTENSION_INTERFACE, ndkpi/NDK_EXTENSION_INTERFACE, PNDK_EXTENSION_INTERFACE
