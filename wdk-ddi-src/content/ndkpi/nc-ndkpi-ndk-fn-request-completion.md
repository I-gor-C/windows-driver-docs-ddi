...
<dd>
<p>The asynchronous completion status for the request. See the asynchronous request  functions (for example, <a href="..\ndkpi\nc-ndkpi-ndk-fn-accept.md">NDK_FN_ACCEPT</a>) for completion status codes that can be returned for each type of request.</p>
</dd>
</dl>
