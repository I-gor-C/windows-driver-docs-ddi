...
ms.date : 1/18/2018
ms.keywords : netvista.ndk_qp_dispatch, _NDK_QP_DISPATCH, ndkpi/NDK_QP_DISPATCH, NDK_QP_DISPATCH structure [Network Drivers Starting with Windows Vista], NDK_QP_DISPATCH
