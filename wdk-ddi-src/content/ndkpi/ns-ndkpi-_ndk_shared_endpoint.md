...
ms.date: 2/16/2018
ms.keywords: ndkpi/NDK_SHARED_ENDPOINT, netvista.ndk_shared_endpoint, _NDK_SHARED_ENDPOINT, PNDK_SHARED_ENDPOINT, PNDK_SHARED_ENDPOINT structure pointer [Network Drivers Starting with Windows Vista], NDK_SHARED_ENDPOINT, NDK_SHARED_ENDPOINT structure [Network Drivers Starting with Windows Vista], ndkpi/PNDK_SHARED_ENDPOINT
