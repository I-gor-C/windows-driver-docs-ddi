...
ms.date: 1/18/2018
ms.keywords: NDK_SHARED_ENDPOINT, netvista.ndk_shared_endpoint, ndkpi/NDK_SHARED_ENDPOINT, PNDK_SHARED_ENDPOINT, PNDK_SHARED_ENDPOINT structure pointer [Network Drivers Starting with Windows Vista], NDK_SHARED_ENDPOINT structure [Network Drivers Starting with Windows Vista], _NDK_SHARED_ENDPOINT, ndkpi/PNDK_SHARED_ENDPOINT
