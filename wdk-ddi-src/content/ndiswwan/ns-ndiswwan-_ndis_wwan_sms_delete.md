...
ms.date: 12/14/2017
ms.keywords: _NDIS_WWAN_SMS_DELETE, *PNDIS_WWAN_SMS_DELETE, NDIS_WWAN_SMS_DELETE, PNDIS_WWAN_SMS_DELETE
...
A formatted 
     <a href="netvista.wwan_sms_filter">WWAN_SMS_FILTER</a> object that represents the
