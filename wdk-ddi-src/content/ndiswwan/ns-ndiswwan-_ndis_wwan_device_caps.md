...
ms.date: 12/14/2017
ms.keywords: _NDIS_WWAN_DEVICE_CAPS, NDIS_WWAN_DEVICE_CAPS, *PNDIS_WWAN_DEVICE_CAPS, PNDIS_WWAN_DEVICE_CAPS
...
<div class="alert"><b>Note</b>  You must specify NDIS_WWAN_DEVICE_CAPS_REVISION_2 in <b>Revision</b> to use the Windows 8 members of <a href="netvista.wwan_device_caps">WWAN_DEVICE_CAPS</a>.</div>
<div> </div>
...
A formatted 
     <a href="netvista.wwan_device_caps">WWAN_DEVICE_CAPS</a> object that represents
