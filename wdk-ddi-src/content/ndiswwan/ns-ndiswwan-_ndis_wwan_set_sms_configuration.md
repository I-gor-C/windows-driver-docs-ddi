...
ms.date: 12/14/2017
ms.keywords: _NDIS_WWAN_SET_SMS_CONFIGURATION, NDIS_WWAN_SET_SMS_CONFIGURATION, PNDIS_WWAN_SET_SMS_CONFIGURATION, *PNDIS_WWAN_SET_SMS_CONFIGURATION
...
A formatted 
     <a href="netvista.wwan_set_sms_configuration">
