...
ms.date: 12/14/2017
ms.keywords: _NDIS_WWAN_USSD_REQUEST, NDIS_WWAN_USSD_REQUEST, PNDIS_WWAN_USSD_REQUEST, *PNDIS_WWAN_USSD_REQUEST
...
A formatted 
     <a href="netvista.wwan_ussd_request">WWAN_USSD_REQUEST</a> object that represents a USSD request.
