...
ms.date: 12/14/2017
ms.keywords: _NDIS_WWAN_SIGNAL_STATE, *PNDIS_WWAN_SIGNAL_STATE, PNDIS_WWAN_SIGNAL_STATE, NDIS_WWAN_SIGNAL_STATE
...
A formatted 
     <a href="netvista.wwan_signal_state">WWAN_SIGNAL_STATE</a> object that represents
