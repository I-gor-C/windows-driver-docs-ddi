...
ms.date: 11/28/2017
ms.keywords: NDIS_WWAN_READY_INFO, NDIS_WWAN_READY_INFO, *PNDIS_WWAN_READY_INFO
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: NDIS_WWAN_READY_INFO
...
# NDIS_WWAN_READY_INFO structure



## -description
<p>The NDIS_WWAN_READY_INFO structure represents the ready-state of the MB device and Subscriber
  Identity Module (SIM card).</p>
...
<dd>
<p>The header with type, revision, and size information about the NDIS_WWAN_READY_INFO structure. The
...
<td>
<p>NDIS_WWAN_READY_INFO_REVISION_1</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>sizeof(NDIS_WWAN_READY_INFO)</p>
</td>
</tr>
</table>
<p> </p>
...
<dd>
<p>A formatted 
     <a href="..\wwan\ns-wwan--wwan-ready-info.md">WWAN_READY_INFO</a> object that represents the
     device ready-state.</p>
</dd>
</dl>
