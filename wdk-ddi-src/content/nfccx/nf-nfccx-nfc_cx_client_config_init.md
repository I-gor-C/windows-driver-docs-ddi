...
ms.date: 12/18/2017
ms.keywords: nfpdrivers.nfc_cx_client_config_init, NFC_CX_CLIENT_CONFIG_INIT function [Near-Field Proximity Drivers], nfccx/NFC_CX_CLIENT_CONFIG_INIT, NFC_CX_CLIENT_CONFIG_INIT
