...
ms.date : 12/18/2017
ms.keywords : nfccx/PNFC_CX_DRIVER_FLAGS, nfccx/NFC_CX_DRIVER_DISABLE_RECOVERY_MODE, NFC_CX_DRIVER_HCI_NETWORK_PER_NFCEE, nfccx/NFC_CX_DRIVER_HCI_NETWORK_PER_NFCEE, nfccx/NFC_CX_DRIVER_DISABLE_WTD_TIMER, nfccx/NFC_CX_DRIVER_DISABLE_NFCEE_DISCOVERY, nfccx/_NFC_CX_DRIVER_FLAGS, NFC_CX_DRIVER_DISABLE_RECOVERY_MODE, NFC_CX_DRIVER_FLAGS, NFC_CX_DRIVER_DISABLE_NFCEE_DISCOVERY, nfccx/NFC_CX_DRIVER_RF_ROUTING_POWER_SUB_STATES_SUPPORTED, PNFC_CX_DRIVER_FLAGS, _NFC_CX_DRIVER_FLAGS, PNFC_CX_DRIVER_FLAGS enumeration pointer [Near-Field Proximity Drivers], NFC_CX_DRIVER_DISABLE_HOST_CARD_EMULATION, NFC_CX_DRIVER_DISABLE_NFCEE_ACTION_NTF, NFC_CX_DRIVER_ENABLE_EEPROM_WRITE_PROTECTION, _NFC_CX_DRIVER_FLAGS enumeration [Near-Field Proximity Drivers], NFC_CX_DRIVER_ISODEP_RNAK_PRESENCE_CHK_SUPPORTED, *PNFC_CX_DRIVER_FLAGS, NFC_CX_DRIVER_DISABLE_WTD_TIMER, nfccx/NFC_CX_DRIVER_ENABLE_EEPROM_WRITE_PROTECTION, NFC_CX_DRIVER_RF_ROUTING_POWER_SUB_STATES_SUPPORTED, nfpdrivers.nfc_cx_driver_flags, nfccx/NFC_CX_DRIVER_DISABLE_NFCEE_ACTION_NTF, nfccx/NFC_CX_DRIVER_ISODEP_RNAK_PRESENCE_CHK_SUPPORTED, nfccx/NFC_CX_DRIVER_DISABLE_HOST_CARD_EMULATION
