...
ms.date: 1/10/2018
ms.keywords: storage.scsi_pass_through_ex, ntddscsi/PSCSI_PASS_THROUGH_EX, _SCSI_PASS_THROUGH_EX, SCSI_PASS_THROUGH_EX structure [Storage Devices], SCSI_PASS_THROUGH_EX, PSCSI_PASS_THROUGH_EX, ntddscsi/SCSI_PASS_THROUGH_EX, *PSCSI_PASS_THROUGH_EX, PSCSI_PASS_THROUGH_EX structure pointer [Storage Devices]
