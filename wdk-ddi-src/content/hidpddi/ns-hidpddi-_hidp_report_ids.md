...
ms.date: 12/21/2017
ms.keywords: hidpddi/PHIDP_REPORT_IDS, HIDP_REPORT_IDS structure [Human Input Devices], hid.hidp_report_ids, PHIDP_REPORT_IDS, *PHIDP_REPORT_IDS, PHIDP_REPORT_IDS structure pointer [Human Input Devices], _HIDP_REPORT_IDS, HIDP_REPORT_IDS, hidpddi/HIDP_REPORT_IDS
