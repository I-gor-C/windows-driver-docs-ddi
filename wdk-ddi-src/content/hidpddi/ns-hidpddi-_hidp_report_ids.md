...
ms.date: 12/21/2017
ms.keywords: HIDP_REPORT_IDS structure [Human Input Devices], hidpddi/PHIDP_REPORT_IDS, *PHIDP_REPORT_IDS, PHIDP_REPORT_IDS structure pointer [Human Input Devices], HIDP_REPORT_IDS, PHIDP_REPORT_IDS, hidpddi/HIDP_REPORT_IDS, _HIDP_REPORT_IDS, hid.hidp_report_ids
