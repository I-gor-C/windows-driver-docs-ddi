...
ms.date : 1/4/2018
ms.keywords : RtlULongLongToUIntPtr function [Kernel-Mode Driver Architecture], ntintsafe/RtlULongLongToUIntPtr, kernel.rtlulonglongtouintptr, RtlULongLongToUIntPtr
