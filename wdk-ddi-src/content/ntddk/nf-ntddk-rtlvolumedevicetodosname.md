...
## -description
<p>The <b>RtlVolumeDeviceToDosName</b> routine is <u>obsolete</u> for Windows XP and later versions of Windows. Use <a href="..\ntddk\nf-ntddk-iovolumedevicetodosname.md">IoVolumeDeviceToDosName</a> instead.</p>
...
## -remarks
<p>The behavior of this routine is identical to that of <a href="..\ntddk\nf-ntddk-iovolumedevicetodosname.md">IoVolumeDeviceToDosName</a>. For more information about how to use this routine, see <b>IoVolumeDeviceToDosName</b>.</p>
...
<td width="70%">
<p>Obsolete for Microsoft Windows XP and later versions of Windows. Use <a href="..\ntddk\nf-ntddk-iovolumedevicetodosname.md">IoVolumeDeviceToDosName</a> instead.</p>
</td>
</tr>
<tr>
<th width="30%">
