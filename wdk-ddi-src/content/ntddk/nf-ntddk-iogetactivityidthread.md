...
## -description
<p>The IoGetActivityIdThread routine returns the activity ID associated with the current thread.</p>
...
## -returns
<p>The activity ID associated with the current thread.</p>
