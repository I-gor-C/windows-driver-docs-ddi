...
ms.date: 12/14/2017
ms.keywords: SOC_SUBSYS_VENDOR_DEFINED, SOC_SUBSYSTEM_TYPE enumeration [WHEA Drivers and Applications], *PSOC_SUBSYSTEM_TYPE, _SOC_SUBSYSTEM_TYPE, ntddk/SOC_SUBSYS_WIRELSS_CONNECTIVITY, SOC_SUBSYS_AUDIO_DSP, SOC_SUBSYSTEM_TYPE, whea.soc_sybsystem_type, ntddk/SOC_SUBSYS_AUDIO_DSP, ntddk/SOC_SUBSYS_SENSORS, ntddk/SOC_SUBSYS_VENDOR_DEFINED, SOC_SUBSYSTEM_WIRELESS_MODEM, ntddk/SOC_SUBSYSTEM_WIRELESS_MODEM, SOC_SUBSYS_WIRELSS_CONNECTIVITY, ntddk/SOC_SUBSYSTEM_TYPE, SOC_SUBSYS_SENSORS
