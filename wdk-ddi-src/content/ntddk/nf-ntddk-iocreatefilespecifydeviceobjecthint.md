...
```
NTKERNELAPI NTSTATUS IoCreateFileSpecifyDeviceObjectHint(
  PHANDLE            FileHandle,
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | The IoCreateFileSpecifyDeviceObjectHint routine is available starting with Windows XP.  |
