...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | The IoCreateFileSpecifyDeviceObjectHint routine is available starting with Windows XP. The IoCreateFileSpecifyDeviceObjectHint routine is available starting with Windows XP. |
