...
} *PSUBSYSTEM_INFORMATION_TYPE, SUBSYSTEM_INFORMATION_TYPE;
```
...
<table>
                ...
                <tr>
                    ...
                    <td>The subsystem type for the process or thread is Windows Subsystem for Linux (WSL). For this process, these members of  the <a href="https://msdn.microsoft.com/library/windows/hardware/ff559960">PS_CREATE_NOTIFY_INFO</a> structure are set as follows:
