...
<td width="70%">
Available starting with Windows XP. Drivers that must work in earlier versions of Windows NT-based operating systems can use <a href="..\ntddk\nf-ntddk-rtlvolumedevicetodosname.md">RtlVolumeDeviceToDosName</a>, which behaves identically.
