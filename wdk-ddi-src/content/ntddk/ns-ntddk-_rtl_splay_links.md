...
ms.date: 2/7/2018
ms.keywords: RTL_SPLAY_LINKS structure [Installable File System Drivers], PRTL_SPLAY_LINKS structure pointer [Installable File System Drivers], RTL_SPLAY_LINKS, *PRTL_SPLAY_LINKS, ifsk.rtl_splay_links, _RTL_SPLAY_LINKS, ntddk/PRTL_SPLAY_LINKS, PRTL_SPLAY_LINKS, othersystemstructures_3a91f0e3-8f7c-4f45-8707-2392d2637cf4.xml, ntddk/RTL_SPLAY_LINKS
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | Available in all supported versions of Windows. Available in all supported versions of Windows. |
