...
ms.date: 2/16/2018
ms.keywords: DISK_SIGNATURE, DISK_SIGNATURE structure [Storage Devices], PDISK_SIGNATURE structure pointer [Storage Devices], storage.disk_signature, structs-disk_6ea56db7-c886-43f2-b9ed-24b0f7e1cb6e.xml, PDISK_SIGNATURE, ntddk/DISK_SIGNATURE, ntddk/PDISK_SIGNATURE, *PDISK_SIGNATURE, _DISK_SIGNATURE
