...
ms.date: 1/4/2018
ms.keywords: PIMAGE_INFO_EX, kernel.image_info_ex, PIMAGE_INFO_EX structure pointer [Kernel-Mode Driver Architecture], ntddk/PIMAGE_INFO_EX, ntddk/IMAGE_INFO_EX, IMAGE_INFO_EX structure [Kernel-Mode Driver Architecture], IMAGE_INFO_EX, _IMAGE_INFO_EX, *PIMAGE_INFO_EX
