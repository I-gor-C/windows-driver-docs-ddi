...
Pointer to a <a href="storage.disk_signature">DISK_SIGNATURE</a> structure the routine uses to return the disk signature information.
...
<dl>
<dt>
<a href="storage.disk_signature">DISK_SIGNATURE</a>
</dt>
<dt>
