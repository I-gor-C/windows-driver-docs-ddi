...
This header is used by Windows Hardware Error Architecture (WHEA), Windows kernel, PCI, Storage, Installable file system, Driver test tools. For more information, see
