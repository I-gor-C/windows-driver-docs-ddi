...
## -description
<p>This structure is used to set the radio state. The driver, in the case of airplane mode, has to persist the radio state and restore it when airplane mode is disabled.</p>
...
### -field <b>SystemStateUpdate</b>

<dd>
<p>The <b>SystemStateUpdate</b>. If true, indicates that IOCTL_NFCRM_SET_RADIO_STATE is triggered by airplane mode.</p>
</dd>

### -field <b>MediaRadioOn</b>

<dd>
<p>The <b>MediaRadioOn</b> flag either enables the system trigger (airplane mode if  <b>SystemStateUpdate</b> is true) or disables it.</p>
</dd>
</dl>

## -remarks
<p>Airplane mode status is ON if  <b>SystemStateUpdate</b> is true and <b>MediaRadioOn</b> is false.</p>
...
<p>NFC status is ON if <b>SystemStateUpdate</b> is false and <b>MediaRadioOn</b> is true.</p>
