...
NTSTATUS UfxEndpointCreate(
  ...
  PWDF_IO_QUEUE_CONFIG   TransferQueueConfig,
  PWDF_OBJECT_ATTRIBUTES TransferQueueAttributes,
  PWDF_IO_QUEUE_CONFIG   CommandQueueConfig,
  PWDF_OBJECT_ATTRIBUTES CommandQueueAttributes,
