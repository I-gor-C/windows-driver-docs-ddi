...
ms.date : 12/29/2017
ms.keywords : PCI.sriov_invalidate_block, *PSRIOV_INVALIDATE_BLOCK, pcivirt/SRIOV_INVALIDATE_BLOCK, SRIOV_INVALIDATE_BLOCK structure [Buses], SRIOV_INVALIDATE_BLOCK, _SRIOV_INVALIDATE_BLOCK
