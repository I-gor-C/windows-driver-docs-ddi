...
ms.date : 12/29/2017
ms.keywords : DXGK_DT_INVALID, d3dkmdt/DXGK_DISPLAY_TECHNOLOGY, DXGK_DISPLAY_TECHNOLOGY enumeration [Display Devices], DXGK_DT_OTHER, d3dkmdt/DXGK_DT_LCD, DXGK_DT_OLED, d3dkmdt/DXGK_DT_OLED, DXGK_DT_LCD, DXGK_DISPLAY_TECHNOLOGY, PDXGK_DISPLAY_TECHNOLOGY, display.dxgk_display_technology, PDXGK_DISPLAY_TECHNOLOGY enumeration pointer [Display Devices], d3dkmdt/DXGK_DT_INVALID, *PDXGK_DISPLAY_TECHNOLOGY, d3dkmdt/DXGK_DT_OTHER, d3dkmdt/PDXGK_DISPLAY_TECHNOLOGY, _DXGK_DISPLAY_TECHNOLOGY
