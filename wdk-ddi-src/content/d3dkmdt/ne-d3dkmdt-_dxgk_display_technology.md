...
ms.date: 12/29/2017
ms.keywords: d3dkmdt/PDXGK_DISPLAY_TECHNOLOGY, DXGK_DT_LCD, DXGK_DT_INVALID, DXGK_DT_OLED, *PDXGK_DISPLAY_TECHNOLOGY, d3dkmdt/DXGK_DT_LCD, d3dkmdt/DXGK_DT_OLED, PDXGK_DISPLAY_TECHNOLOGY enumeration pointer [Display Devices], DXGK_DT_OTHER, DXGK_DISPLAY_TECHNOLOGY, display.dxgk_display_technology, PDXGK_DISPLAY_TECHNOLOGY, _DXGK_DISPLAY_TECHNOLOGY, d3dkmdt/DXGK_DISPLAY_TECHNOLOGY, d3dkmdt/DXGK_DT_INVALID, d3dkmdt/DXGK_DT_OTHER, DXGK_DISPLAY_TECHNOLOGY enumeration [Display Devices]
