...
## Syntax
```
typedef struct _DXGK_MONITORLINKINFO_CAPABILITIES {
  struct {
    UINT  : 1  DedicatedTimingGeneration;
    UINT  : 1  DynamicBitsPerColorChannel;
    UINT  : 1  DynamicColorEncodingFormat;
    UINT  : 1  DynamicColorSpace;
    UINT  : 1  HighColorSpace;
    UINT  : 29 Reserved;
    UINT  : 1  Stereo;
    UINT  : 1  WideColorSpace;
  };
  UINT   Value;
