...
ms.date : 12/29/2017
ms.keywords : d3dkmdt/DXGK_BACKLIGHT_INFO, _DXGK_BACKLIGHT_INFO, display.dxgk_backlight_info, DXGK_BACKLIGHT_INFO structure [Display Devices], DXGK_BACKLIGHT_INFO
