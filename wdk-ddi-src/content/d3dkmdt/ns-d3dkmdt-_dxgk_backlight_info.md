...
ms.date: 2/20/2018
ms.keywords: d3dkmdt/DXGK_BACKLIGHT_INFO, display.dxgk_backlight_info, DXGK_BACKLIGHT_INFO, _DXGK_BACKLIGHT_INFO, DXGK_BACKLIGHT_INFO structure [Display Devices]
