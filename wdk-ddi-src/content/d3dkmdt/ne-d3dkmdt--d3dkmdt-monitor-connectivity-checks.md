...
## -description
<p>The D3DKMDT_MONITOR_CONNECTIVITY_CHECKS enumerated type indicates whether the <a href="display.dxgkddicommitvidpn">DxgkDdiCommitVidPn</a> function should verify that certain video outputs have connected monitors.</p>
