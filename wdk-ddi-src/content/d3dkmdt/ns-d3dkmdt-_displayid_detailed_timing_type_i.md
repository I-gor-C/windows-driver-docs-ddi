...
typedef struct _DISPLAYID_DETAILED_TIMING_TYPE_I {
  struct {
    ULONG  : 3  AspectRatio;
    ULONG  : 24 PixelClock;
    ULONG  : 1  PreferredTiming;
    ULONG  : 1  Reserved;
    ULONG  : 1  ScanningType;
    ULONG  : 2  StereoMode;
  };
  USHORT HorizontalActivePixels;
  USHORT HorizontalBlankPixels;
  struct {
    USHORT  : 15 HorizontalFrontPorch;
    USHORT  : 1  HorizontalSyncPolarity;
  };
  USHORT HorizontalSyncWidth;
  USHORT VerticalActiveLines;
  USHORT VerticalBlankLines;
  struct {
    USHORT  : 15 VerticalFrontPorch;
    USHORT  : 1  VerticalSyncPolarity;
  };
