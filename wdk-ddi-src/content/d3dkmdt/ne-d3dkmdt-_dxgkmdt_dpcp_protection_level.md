...
<table>
                ...
                <tr>
                    <td>DXGKMDT_OPM_DPCP_FORCE_ULONG</td>
                ...
                <tr>
                    <td>DXGKMDT_OPM_DPCP_OFF</td>
                    <td>Indicates that DPCP does not protect the output's signal.</td>
                </tr>
            
                <tr>
                    <td>DXGKMDT_OPM_DPCP_ON</td>
                    <td>Indicates that DPCP protects the output's signal.</td>
                </tr>
</table>
