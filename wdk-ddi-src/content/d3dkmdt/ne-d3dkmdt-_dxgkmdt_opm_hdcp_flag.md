...
<table>
                ...
                <tr>
                    <td>DXGKMDT_OPM_HDCP_FLAG_NONE</td>
                    <td>Indicates that no HDCP flags are set. Therefore, the protected output's physical connector is not connected to an HDCP repeater.</td>
                </tr>
            
                <tr>
                    <td>DXGKMDT_OPM_HDCP_FLAG_REPEATER</td>
                    <td>Indicates that the protected output's physical connector is connected to an HDCP repeater.</td>
                </tr>
</table>
