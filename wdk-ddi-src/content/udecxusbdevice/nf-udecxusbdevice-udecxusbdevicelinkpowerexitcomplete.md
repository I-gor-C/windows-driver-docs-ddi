...
title: UdecxUsbDeviceLinkPowerExitComplete
...
ms.date: 11/20/2017
ms.keywords: UdecxUsbDeviceLinkPowerExitComplete
...
req.kmdf-ver: 1.15
req.umdf-ver: 
req.alt-api: UdecxUsbDeviceLinkPowerExitComplete
...
## -description
<p>Completes an asynchronous request for sending the device to a low power state.  </p>
...
## -remarks
<p>When the USB device emulation class extension (UdeCx) gets a request to send the device to a low power state, it invokes the client driver's implementation of the <a href="https://msdn.microsoft.com/library/windows/hardware/mt595911">EVT_UDECX_USB_DEVICE_D0_EXIT</a> callback function. </p>
