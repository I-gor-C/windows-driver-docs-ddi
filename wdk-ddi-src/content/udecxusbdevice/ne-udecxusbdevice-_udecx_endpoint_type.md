...
} *PUDECX_ENDPOINT_TYPE, UDECX_ENDPOINT_TYPE;
```
...
<table>
                ...
                <tr>
                    ...
                    <td>The endpoint is dynamically created in the client driver's implementation of the <a href="https://msdn.microsoft.com/library/windows/hardware/mt595913">EVT_UDECX_USB_DEVICE_ENDPOINTS_CONFIGURE</a> callback.</td>
                </tr>
</table>
