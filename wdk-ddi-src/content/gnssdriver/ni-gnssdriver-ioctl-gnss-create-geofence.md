...
### -input-buffer
<p>A pointer to a <a href="sensors.gnss_geofence_create_param">GNSS_GEOFENCE_CREATE_PARAM</a> structure that defines the geofence to be created.
...
### -output-buffer
<p>A pointer to a <a href="sensors.gnss_geofence_create_response">GNSS_GEOFENCE_CREATE_RESPONSE</a> structure.</p>
