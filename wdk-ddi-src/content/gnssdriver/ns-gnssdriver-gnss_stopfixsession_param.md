...
ms.date: 2/15/2018
ms.keywords: gnssdriver/GNSS_STOPFIXSESSION_PARAM, PGNSS_STOPFIXSESSION_PARAM structure pointer [Sensor Devices], GNSS_STOPFIXSESSION_PARAM, PGNSS_STOPFIXSESSION_PARAM, GNSS_STOPFIXSESSION_PARAM structure [Sensor Devices], *PGNSS_STOPFIXSESSION_PARAM, gnssdriver/PGNSS_STOPFIXSESSION_PARAM, sensors.gnss_stopfixsession_param
