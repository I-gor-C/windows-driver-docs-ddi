...
ms.date: 12/14/2017
ms.keywords: PGNSS_STOPFIXSESSION_PARAM structure pointer [Sensor Devices], gnssdriver/PGNSS_STOPFIXSESSION_PARAM, GNSS_STOPFIXSESSION_PARAM structure [Sensor Devices], PGNSS_STOPFIXSESSION_PARAM, sensors.gnss_stopfixsession_param, gnssdriver/GNSS_STOPFIXSESSION_PARAM, *PGNSS_STOPFIXSESSION_PARAM, GNSS_STOPFIXSESSION_PARAM
