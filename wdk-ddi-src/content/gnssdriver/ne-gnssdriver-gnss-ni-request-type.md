...
## -description
<p>This enumeration indicates the network initiated (NI) request type represented by the <a href="sensors.gnss_ni_request_param">GNSS_NI_REQUEST_PARAM</a> structure.</p>
