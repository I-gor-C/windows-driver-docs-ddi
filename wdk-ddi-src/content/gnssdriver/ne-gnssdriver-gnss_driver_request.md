...
ms.date: 2/15/2018
ms.keywords: sensors.gnss_driver_request, gnssdriver/SUPL_CONFIG_DATA, SUPL_CONFIG_DATA, gnssdriver/GNSS_DRIVER_REQUEST, GNSS_DRIVER_REQUEST enumeration [Sensor Devices], GNSS_DRIVER_REQUEST
