...
ms.date: 12/14/2017
ms.keywords: CMP_CONNECT_TYPE, CMP_CONNECT_TYPE enumeration [Buses], CMP_Broadcast, IEEE.cmp_connect_type, CMP_PointToPoint, 61883/CMP_CONNECT_TYPE, 61883/CMP_PointToPoint, 61883/CMP_Broadcast
