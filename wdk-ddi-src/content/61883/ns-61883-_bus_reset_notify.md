...
ms.date: 12/14/2017
ms.keywords: BUS_RESET_NOTIFY, IEEE.bus_reset_notify, 61883/BUS_RESET_NOTIFY, *PBUS_RESET_NOTIFY, BUS_RESET_NOTIFY structure [Buses], PBUS_RESET_NOTIFY, PBUS_RESET_NOTIFY structure pointer [Buses], 61883/PBUS_RESET_NOTIFY, _BUS_RESET_NOTIFY
