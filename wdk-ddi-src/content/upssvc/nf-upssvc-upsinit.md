...
<p>If the <b>UPSInit</b> function returns a value other than UPS_INITOK, the UPS service immediately calls the <a href="https://msdn.microsoft.com/library/windows/hardware/ff536314">UPSStop</a> function.</p>
