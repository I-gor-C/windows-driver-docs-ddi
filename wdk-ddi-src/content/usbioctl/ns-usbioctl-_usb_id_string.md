...
ms.date: 2/15/2018
ms.keywords: buses.usb_id_string, usbioctl/PUSB_ID_STRING, USB_ID_STRING structure [Buses], PUSB_ID_STRING structure pointer [Buses], *PUSB_ID_STRING, PUSB_ID_STRING, _USB_ID_STRING, USB_ID_STRING, usbioctl/USB_ID_STRING
