...
ms.date: 1/4/2018
ms.keywords: PUSB_TOPOLOGY_ADDRESS, _USB_TOPOLOGY_ADDRESS, *PUSB_TOPOLOGY_ADDRESS, PUSB_TOPOLOGY_ADDRESS structure pointer [Buses], usbioctl/PUSB_TOPOLOGY_ADDRESS, usbioctl/USB_TOPOLOGY_ADDRESS, USB_TOPOLOGY_ADDRESS structure [Buses], buses.usb_topology_address, USB_TOPOLOGY_ADDRESS
