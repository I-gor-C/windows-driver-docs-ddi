...
ms.date: 2/15/2018
ms.keywords: usbioctl/PUSB_PROTOCOLS, usbioctl/USB_PROTOCOLS, PUSB_PROTOCOLS union pointer [Buses], USB_PROTOCOLS, USB_PROTOCOLS union [Buses], PUSB_PROTOCOLS, _USB_PROTOCOLS, *PUSB_PROTOCOLS, buses.usb_protocols
