...
ms.date: 1/4/2018
ms.keywords: PUSB_TRANSPORT_CHARACTERISTICS_CHANGE_REGISTRATION structure pointer [Buses], usbioctl/PUSB_TRANSPORT_CHARACTERISTICS_CHANGE_REGISTRATION, *PUSB_TRANSPORT_CHARACTERISTICS_CHANGE_REGISTRATION, buses.usb_transport_characteristics_change_registration, USB_TRANSPORT_CHARACTERISTICS_CHANGE_REGISTRATION structure [Buses], PUSB_TRANSPORT_CHARACTERISTICS_CHANGE_REGISTRATION, USB_TRANSPORT_CHARACTERISTICS_CHANGE_REGISTRATION, usbioctl/USB_TRANSPORT_CHARACTERISTICS_CHANGE_REGISTRATION, _USB_TRANSPORT_CHARACTERISTICS_CHANGE_REGISTRATION
