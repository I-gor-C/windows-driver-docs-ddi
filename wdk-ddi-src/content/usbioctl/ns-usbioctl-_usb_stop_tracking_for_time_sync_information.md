...
ms.date: 1/4/2018
ms.keywords: USB_STOP_TRACKING_FOR_TIME_SYNC_INFORMATION structure [Buses], usbioctl/USB_STOP_TRACKING_FOR_TIME_SYNC_INFORMATION, *PUSB_STOP_TRACKING_FOR_TIME_SYNC_INFORMATION, buses.usb_stop_tracking_for_time_sync_information, PUSB_STOP_TRACKING_FOR_TIME_SYNC_INFORMATION, usbioctl/PUSB_STOP_TRACKING_FOR_TIME_SYNC_INFORMATION, _USB_STOP_TRACKING_FOR_TIME_SYNC_INFORMATION, USB_STOP_TRACKING_FOR_TIME_SYNC_INFORMATION, PUSB_STOP_TRACKING_FOR_TIME_SYNC_INFORMATION structure pointer [Buses]
