...
ms.date: 2/16/2018
ms.keywords: storage.lba_filter_table, LBA_FILTER_TABLE structure [Storage Devices], *PLBA_FILTER_TABLE, PLBA_FILTER_TABLE structure pointer [Storage Devices], _LBA_FILTER_TABLE, ehstorioctl/LBA_FILTER_TABLE, ehstorioctl/PLBA_FILTER_TABLE, PLBA_FILTER_TABLE, LBA_FILTER_TABLE
