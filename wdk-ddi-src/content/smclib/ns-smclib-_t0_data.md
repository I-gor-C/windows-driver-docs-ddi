...
ms.date: 12/14/2017
ms.keywords: "*PT0_DATA, PT0_DATA structure pointer [Smart Card Reader Devices], PT0_DATA, T0_DATA structure [Smart Card Reader Devices], smclib/T0_DATA, smartcrd.t0_data, T0_DATA, _T0_DATA, smclib/PT0_DATA"
