...
ms.date: 12/14/2017
ms.keywords: smartcrd.clock_rate_conversion, _CLOCK_RATE_CONVERSION, PCLOCK_RATE_CONVERSION structure pointer [Smart Card Reader Devices], CLOCK_RATE_CONVERSION, *PCLOCK_RATE_CONVERSION, CLOCK_RATE_CONVERSION structure [Smart Card Reader Devices], PCLOCK_RATE_CONVERSION, smclib/CLOCK_RATE_CONVERSION, smclib/PCLOCK_RATE_CONVERSION, scstruct_260d5a02-28d8-4ef4-ac2a-e81d3ac2814a.xml
