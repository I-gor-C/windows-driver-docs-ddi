...
ms.date: 12/14/2017
ms.keywords: smclib/SCARD_READER_CAPABILITIES, *PSCARD_READER_CAPABILITIES, _SCARD_READER_CAPABILITIES, SCARD_READER_CAPABILITIES structure [Smart Card Reader Devices], SCARD_READER_CAPABILITIES, smclib/*PSCARD_READER_CAPABILITIES, *PSCARD_READER_CAPABILITIES structure [Smart Card Reader Devices], smartcrd.scard_reader_capabilities, scstruct_bf7b8868-e647-42c5-8e1d-18681db95b08.xml
