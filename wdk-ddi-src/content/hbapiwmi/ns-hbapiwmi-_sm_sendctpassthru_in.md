...
ms.date: 1/10/2018
ms.keywords: _SM_SendCTPassThru_IN, *PSM_SendCTPassThru_IN, SM_SendCTPassThru_IN
...
## -remarks
The WMI tool suite generates a declaration of the SM_SendCTPassThru_IN structure in <i>Hbapiwmi.h</i> when it compiles the MS_SM_FabricAndDomainManagementMethod WMI class.</p>