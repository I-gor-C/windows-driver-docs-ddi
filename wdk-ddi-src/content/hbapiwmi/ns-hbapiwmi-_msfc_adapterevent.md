...
ms.date: 12/15/2017
ms.keywords: _MSFC_AdapterEvent, PMSFC_AdapterEvent, *PMSFC_AdapterEvent, MSFC_AdapterEvent
...
## -remarks
The WMI tool suite generates a declaration for this structure in <i>Hbapiwm.h </i>after compiling the <a href="storage.msfc_adapterevent_wmi_class">MSFC_AdapterEvent WMI Class</a>.
