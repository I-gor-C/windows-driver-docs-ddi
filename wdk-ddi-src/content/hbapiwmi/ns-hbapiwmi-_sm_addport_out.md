...
ms.date : 1/10/2018
ms.keywords : PSM_AddPort_OUT structure pointer [Storage Devices], _SM_AddPort_OUT, storage.sm_addport_out, SM_AddPort_OUT structure [Storage Devices], hbapiwmi/SM_AddPort_OUT, PSM_AddPort_OUT, SM_AddPort_OUT, *PSM_AddPort_OUT, structs-Fibre_fb9ac678-11bb-4392-ab1e-6a10c5e92de9.xml, hbapiwmi/PSM_AddPort_OUT
