...
ms.date: 12/15/2017
ms.keywords: _GetFcpTargetMapping_IN, *PGetFcpTargetMapping_IN, PGetFcpTargetMapping_IN, GetFcpTargetMapping_IN
...
## -description
The GetFcpTargetMapping_IN structure is used to report the output parameter data of the <a href="storage.getfcptargetmapping">GetFcpTargetMapping</a> WMI method to the WMI client.
...
## -remarks
The <a href="storage.getfcptargetmapping">GetFcpTargetMapping</a> WMI method queries a WMI provider for mappings between the information that uniquely identifies a set of logical units for the operating system and the fibre channel protocol (FCP) identifiers for the logical units.

The WMI tool suite generates a declaration of the GetFcpTargetMapping_IN structure in <i>Hbapiwmi.h </i>when it compiles the <a href="storage.msfc_hbafcpinfo_wmi_class">MSFC_HBAFCPInfo WMI Class</a>.
