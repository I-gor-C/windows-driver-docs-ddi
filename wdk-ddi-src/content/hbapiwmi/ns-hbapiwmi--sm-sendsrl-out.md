...
ms.date: 11/15/2017
ms.keywords: SM_SendSRL_OUT, SM_SendSRL_OUT, *PSM_SendSRL_OUT
...
# SM_SendSRL_OUT structure



## -description
<p>The SM_SendSRL_OUT structure is used to receive output parameters from the SM_SendSRL method.</p>
...
## -remarks
<p>The WMI tool suite generates a declaration of the SM_SendSRL_OUT structure in <i>Hbapiwmi.h</i> when it compiles the MS_SM_FabricAndDomainManagementMethod WMI class.</p>
