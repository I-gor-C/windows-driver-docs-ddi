...
ms.date: 11/15/2017
ms.keywords: SM_SendRPL_OUT, SM_SendRPL_OUT, *PSM_SendRPL_OUT
...
# SM_SendRPL_OUT structure



## -description
<p>The SM_SendRPL_OUT structure is used to receive output parameters from the SM_SendRPL method.</p>
...
## -remarks
<p>The WMI tool suite generates a declaration of the SM_SendRPL_OUT structure in <i>Hbapiwmi.h</i> when it compiles the MS_SM_FabricAndDomainManagementMethod WMI class.</p>
