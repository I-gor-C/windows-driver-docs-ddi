...
ms.date: 1/10/2018
ms.keywords: hbapiwmi/PSM_SendECHO_IN, PSM_SendECHO_IN structure pointer [Storage Devices], structs-Fibre_b5bcd1e0-9847-4425-8091-6b6dcf7581a0.xml, hbapiwmi/SM_SendECHO_IN, storage.sm_sendecho_in, *PSM_SendECHO_IN, SM_SendECHO_IN structure [Storage Devices], SM_SendECHO_IN, PSM_SendECHO_IN, _SM_SendECHO_IN
