...
## -description
<p>The ScsiInquiry_OUT structure is used to report the output data of the <a href="storage.scsiinquiry">ScsiInquiry</a> WMI method to the WMI client.</p>
...
## -remarks
<p>The WMI tool suite generates a declaration of the ScsiInquiry_OUT structure in <i>Hbapiwmi.h </i>when it compiles the <a href="storage.msfc_hbaadaptermethods_wmi_class">MSFC_HBAAdapterMethods WMI Class</a>.</p>
