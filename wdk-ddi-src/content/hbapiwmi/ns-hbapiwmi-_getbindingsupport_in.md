...
ms.date: 2/16/2018
ms.keywords: PGetBindingSupport_IN structure pointer [Storage Devices], GetBindingSupport_IN, GetBindingSupport_IN structure [Storage Devices], storage.getbindingsupport_in, PGetBindingSupport_IN, structs-Fibre_858abc05-6d3e-4630-a9f9-4b9aa742ea8e.xml, hbapiwmi/PGetBindingSupport_IN, *PGetBindingSupport_IN, _GetBindingSupport_IN, hbapiwmi/GetBindingSupport_IN
