...
ms.date : 1/10/2018
ms.keywords : hbapiwmi/PMS_SMHBA_PORTATTRIBUTES, MS_SMHBA_PORTATTRIBUTES, hbapiwmi/MS_SMHBA_PORTATTRIBUTES, structs-Fibre_66af1ae7-5db4-4dd3-bacc-0665dd757660.xml, PMS_SMHBA_PORTATTRIBUTES structure pointer [Storage Devices], *PMS_SMHBA_PORTATTRIBUTES, _MS_SMHBA_PORTATTRIBUTES, storage.ms_smhba_portattributes, PMS_SMHBA_PORTATTRIBUTES, MS_SMHBA_PORTATTRIBUTES structure [Storage Devices]
