...
ms.date : 1/10/2018
ms.keywords : PSM_SendTEST_OUT structure pointer [Storage Devices], hbapiwmi/SM_SendTEST_OUT, PSM_SendTEST_OUT, *PSM_SendTEST_OUT, storage.sm_sendtest_out, _SM_SendTEST_OUT, SM_SendTEST_OUT structure [Storage Devices], structs-Fibre_901c8256-fe8d-4194-aaec-8a0557287687.xml, hbapiwmi/PSM_SendTEST_OUT, SM_SendTEST_OUT
