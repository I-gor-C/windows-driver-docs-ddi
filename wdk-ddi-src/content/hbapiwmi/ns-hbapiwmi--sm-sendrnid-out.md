...
ms.date: 11/15/2017
ms.keywords: SM_SendRNID_OUT, SM_SendRNID_OUT, *PSM_SendRNID_OUT
...
# SM_SendRNID_OUT structure



## -description
<p>The SM_SendRNID_OUT structure is used to receive output parameters from the SM_SendRNID method.</p>
