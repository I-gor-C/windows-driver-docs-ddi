...
ms.date: 12/14/2017
ms.keywords: battery.cad_power_source_info, _CAD_POWER_SOURCE_INFO, CAD_POWER_SOURCE_INFO, charging/BATTERY_INFORMATION, CAD_POWER_SOURCE_INFO structure [Battery Devices], *PCAD_POWER_SOURCE_INFO
