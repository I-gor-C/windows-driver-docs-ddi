...
ms.date : 12/14/2017
ms.keywords : CAD_POWER_SOURCE_INFO structure [Battery Devices], battery.cad_power_source_info, *PCAD_POWER_SOURCE_INFO, CAD_POWER_SOURCE_INFO, charging/BATTERY_INFORMATION, _CAD_POWER_SOURCE_INFO
