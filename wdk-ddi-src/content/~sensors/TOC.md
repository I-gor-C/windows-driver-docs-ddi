...
### [IOCTL_GNSS_CONFIG_SUPL_CERT IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-config-supl-cert.md)
### [IOCTL_GNSS_CREATE_GEOFENCE IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-create-geofence.md)
### [IOCTL_GNSS_DELETE_GEOFENCE IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-delete-geofence.md)
### [IOCTL_GNSS_EXECUTE_CWTEST IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-execute-cwtest.md)
### [IOCTL_GNSS_EXECUTE_SELFTEST IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-execute-selftest.md)
### [IOCTL_GNSS_GET_CHIPSETINFO IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-get-chipsetinfo.md)
### [IOCTL_GNSS_GET_DEVICE_CAPABILITY IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-get-device-capability.md)
### [IOCTL_GNSS_GET_FIXDATA IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-get-fixdata.md)
### [IOCTL_GNSS_INJECT_AGNSS IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-inject-agnss.md)
### [IOCTL_GNSS_LISTEN_AGNSS IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-listen-agnss.md)
### [IOCTL_GNSS_LISTEN_BREADCRUMBING_ALERT IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-listen-breadcrumbing-alert.md)
### [IOCTL_GNSS_LISTEN_DRIVER_REQUEST IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-listen-driver-request.md)
### [IOCTL_GNSS_LISTEN_ERROR IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-listen-error.md)
### [IOCTL_GNSS_LISTEN_GEOFENCE_ALERT IOCTL](content\gnssdriver\ni-gnssdriver-ioctl-gnss-listen-geofence-alert.md)
...
### [ISensorClassExtension interface](content\sensorsclassextension\nn-sensorsclassextension-isensorclassextension.md)
### [ISensorClassExtension interface](content\sensorsclassextension\nn-sensorsclassextension-isensorclassextension~r1.md)
### [ISensorClassExtension::CleanupFile method](content\sensorsclassextension\nf-sensorsclassextension-isensorclassextension-cleanupfile.md)
### [ISensorClassExtension::Initialize method](content\sensorsclassextension\nf-sensorsclassextension-isensorclassextension-initialize.md)
### [ISensorClassExtension::PostEvent method](content\sensorsclassextension\nf-sensorsclassextension-isensorclassextension-postevent.md)
### [ISensorClassExtension::PostStateChange method](content\sensorsclassextension\nf-sensorsclassextension-isensorclassextension-poststatechange.md)
### [ISensorClassExtension::ProcessIoControl method](content\sensorsclassextension\nf-sensorsclassextension-isensorclassextension-processiocontrol.md)
### [ISensorClassExtension::Uninitialize method](content\sensorsclassextension\nf-sensorsclassextension-isensorclassextension-uninitialize.md)
### [ISensorDriver interface](content\sensorsclassextension\nn-sensorsclassextension-isensordriver.md)
### [ISensorDriver interface](content\sensorsclassextension\nn-sensorsclassextension-isensordriver~r1.md)
### [ISensorDriver::OnClientConnect method](content\sensorsclassextension\nf-sensorsclassextension-isensordriver-onclientconnect.md)
### [ISensorDriver::OnClientDisconnect method](content\sensorsclassextension\nf-sensorsclassextension-isensordriver-onclientdisconnect.md)
### [ISensorDriver::OnClientSubscribeToEvents method](content\sensorsclassextension\nf-sensorsclassextension-isensordriver-onclientsubscribetoevents.md)
### [ISensorDriver::OnClientUnsubscribeFromEvents method](content\sensorsclassextension\nf-sensorsclassextension-isensordriver-onclientunsubscribefromevents.md)
### [ISensorDriver::OnGetDataFields method](content\sensorsclassextension\nf-sensorsclassextension-isensordriver-ongetdatafields.md)
### [ISensorDriver::OnGetProperties method](content\sensorsclassextension\nf-sensorsclassextension-isensordriver-ongetproperties.md)
### [ISensorDriver::OnGetSupportedDataFields method](content\sensorsclassextension\nf-sensorsclassextension-isensordriver-ongetsupporteddatafields.md)
### [ISensorDriver::OnGetSupportedEvents method](content\sensorsclassextension\nf-sensorsclassextension-isensordriver-ongetsupportedevents.md)
### [ISensorDriver::OnGetSupportedProperties method](content\sensorsclassextension\nf-sensorsclassextension-isensordriver-ongetsupportedproperties.md)
### [ISensorDriver::OnGetSupportedSensorObjects method](content\sensorsclassextension\nf-sensorsclassextension-isensordriver-ongetsupportedsensorobjects.md)
### [ISensorDriver::OnProcessWpdMessage method](content\sensorsclassextension\nf-sensorsclassextension-isensordriver-onprocesswpdmessage.md)
### [ISensorDriver::OnSetProperties method](content\sensorsclassextension\nf-sensorsclassextension-isensordriver-onsetproperties.md)
...
### [SensorsCxDeviceGetSensorList function](content\sensorscx\nf-sensorscx-sensorscxdevicegetsensorlist.md)
### [SensorsCxDeviceInitConfig function](content\sensorscx\nf-sensorscx-sensorscxdeviceinitconfig.md)
### [SensorsCxDeviceInitialize function](content\sensorscx\nf-sensorscx-sensorscxdeviceinitialize.md)
### [SensorsCxSensorCreate function](content\sensorscx\nf-sensorscx-sensorscxsensorcreate.md)
### [SensorsCxSensorDataReady function](content\sensorscx\nf-sensorscx-sensorscxsensordataready.md)
### [SensorsCxSensorInitialize function](content\sensorscx\nf-sensorscx-sensorscxsensorinitialize.md)
### [SensorsCxStateChange function](content\sensorscx\nf-sensorscx-sensorscxstatechange.md)
## Sensorsdef.h
### [ACTIVITY_STATE enumeration](content\sensorsdef\ne-sensorsdef-activity-state.md)
### [MAGNETOMETER_ACCURACY enumeration](content\sensorsdef\ne-sensorsdef-magnetometer-accuracy.md)
### [PEDOMETER_STEP_TYPE enumeration](content\sensorsdef\ne-sensorsdef-pedometer-step-type.md)
### [PEDOMETER_STEP_TYPE_COUNT enumeration](content\sensorsdef\ne-sensorsdef-pedometer-step-type-count.md)
