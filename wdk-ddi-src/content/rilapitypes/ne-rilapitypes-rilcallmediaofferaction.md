...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_CALLMEDIAOFFERACTION_REJECT, RIL_CALLMEDIAOFFERACTION_ACCEPT, RILCALLMEDIAOFFERACTION enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_CALLMEDIAOFFERACTION_ACCEPT, RIL_CALLMEDIAOFFERACTION_ASK, rilapitypes/RIL_CALLMEDIAOFFERACTION_MAX, RIL_CALLMEDIAOFFERACTION_CANCEL, netvista.rilcallmediaofferaction_2, rilapitypes/RIL_CALLMEDIAOFFERACTION_ASK, rilapitypes/RIL_CALLMEDIAOFFERACTION_CANCEL, rilapitypes/RIL_CALLMEDIAOFFERACTION_ERROR, RIL_CALLMEDIAOFFERACTION_MAX, RILCALLMEDIAOFFERACTION, RIL_CALLMEDIAOFFERACTION_REJECT, rilapitypes/RILCALLMEDIAOFFERACTION, RIL_CALLMEDIAOFFERACTION_ERROR
