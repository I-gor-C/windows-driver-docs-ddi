...
ms.date: 1/18/2018
ms.keywords: RILVERSIONPARAMS structure [Network Drivers Starting with Windows Vista], netvista.rilversionparams_2, RILVERSIONPARAMS, *LPRILVERSIONPARAMS, rilapitypes/RILVERSIONPARAMS
