...
ms.date: 2/16/2018
ms.keywords: RILMSGDCSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_MDCS_MSGCLASS, RIL_PARAM_MDCS_ALPHABET, rilapitypes/RIL_PARAM_MDCS_LANGUAGE, RIL_PARAM_MDCS_ALL, rilapitypes/RIL_PARAM_MDCS_ALL, RIL_PARAM_MDCS_LANGUAGE, rilapitypes/RILMSGDCSPARAMMASK, netvista.rilmsgdcsparammask_2, rilapitypes/RIL_PARAM_MDCS_FLAGS, rilapitypes/RIL_PARAM_MDCS_MSGCLASS, RILMSGDCSPARAMMASK, RIL_PARAM_MDCS_INDICATION, rilapitypes/RIL_PARAM_MDCS_INDICATION, RIL_PARAM_MDCS_FLAGS, rilapitypes/RIL_PARAM_MDCS_ALPHABET
