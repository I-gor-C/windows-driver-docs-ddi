...
ms.date: 1/18/2018
ms.keywords: RILNOTIFICATIONPARAMS structure [Network Drivers Starting with Windows Vista], rilapitypes/RILNOTIFICATIONPARAMS, netvista.rilnotificationparams_2, *LPRILNOTIFICATIONPARAMS, RILNOTIFICATIONPARAMS
