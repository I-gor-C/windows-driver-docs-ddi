...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_CALLMEDIAOFFERANSWERTYPE_PEER_OFFER, RILCALLMEDIAOFFERANSWERTYPE, rilapitypes/RILCALLMEDIAOFFERANSWERTYPE, rilapitypes/RIL_CALLMEDIAOFFERANSWERTYPE_CURRENT, RIL_CALLMEDIAOFFERANSWERTYPE_ANSWER, rilapitypes/RIL_CALLMEDIAOFFERANSWERTYPE_OFFER, RIL_CALLMEDIAOFFERANSWERTYPE_CURRENT, RIL_CALLMEDIAOFFERANSWERTYPE_PEER_ANSWER, rilapitypes/RIL_CALLMEDIAOFFERANSWERTYPE_MAX, RIL_CALLMEDIAOFFERANSWERTYPE_MAX, rilapitypes/RIL_CALLMEDIAOFFERANSWERTYPE_ANSWER, netvista.rilcallmediaofferanswertype_2, RILCALLMEDIAOFFERANSWERTYPE enumeration [Network Drivers Starting with Windows Vista], RIL_CALLMEDIAOFFERANSWERTYPE_OFFER, rilapitypes/RIL_CALLMEDIAOFFERANSWERTYPE_PEER_ANSWER, RIL_CALLMEDIAOFFERANSWERTYPE_PEER_OFFER
