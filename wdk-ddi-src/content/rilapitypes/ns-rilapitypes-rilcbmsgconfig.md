...
ms.date: 1/18/2018
ms.keywords: netvista.rilcbmsgconfig_2, *LPRILCBMSGCONFIG, RILCBMSGCONFIG structure [Network Drivers Starting with Windows Vista], RILCBMSGCONFIG, rilapitypes/RILCBMSGCONFIG
