...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_PARAM_UAPCS_ALL, rilapitypes/RILUICCAPPPERSOCHECKSTATUSPARAMMASK, RILUICCAPPPERSOCHECKSTATUSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RILUICCAPPPERSOCHECKSTATUSPARAMMASK, netvista.riluiccapppersocheckstatusparammask_2, rilapitypes/RIL_PARAM_UAPCS_PERSOFEATURE, rilapitypes/RIL_PARAM_UAPCS_PERSOCHECKSTATE, RIL_PARAM_UAPCS_PERSOCHECKSTATE, RIL_PARAM_UAPCS_ALL, RIL_PARAM_UAPCS_PERSOFEATURE
