...
ms.date: 1/18/2018
ms.keywords: netvista.rilexecutorrfstate_2, *LPRILEXECUTORRFSTATE, rilapitypes/RILEXECUTORRFSTATE, RILEXECUTORRFSTATE structure [Network Drivers Starting with Windows Vista], RILEXECUTORRFSTATE
