...
ms.date: 1/18/2018
ms.keywords: netvista.rilmsgcdmaindeliver_2, RILMSGCDMAINDELIVER structure [Network Drivers Starting with Windows Vista], *LPRILMSGCDMAINDELIVER, RILMSGCDMAINDELIVER, rilapitypes/RILMSGCDMAINDELIVER
