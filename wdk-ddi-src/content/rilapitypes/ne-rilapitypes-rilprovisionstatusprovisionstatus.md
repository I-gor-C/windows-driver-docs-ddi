...
ms.date: 1/18/2018
ms.keywords: RILPROVISIONSTATUSPROVISIONSTATUS, netvista.rilprovisionstatusprovisionstatus_2, rilapitypes/RIL_PROVISIONSTAT_FAILURE_END, rilapitypes/RIL_PROVISIONSTAT_MAX, RIL_PROVISIONSTAT_NEEDED, RIL_PROVISIONSTAT_FAILURE_END, RIL_PROVISIONSTAT_SUCCESS, RIL_PROVISIONSTAT_BIP_SUCCESS, rilapitypes/RIL_PROVISIONSTAT_BIP_SUCCESS, rilapitypes/RILPROVISIONSTATUSPROVISIONSTATUS, rilapitypes/RIL_PROVISIONSTAT_FAILURE_RETRY, RIL_PROVISIONSTAT_FAILURE_RETRY, RIL_PROVISIONSTAT_BIP_STARTED, RILPROVISIONSTATUSPROVISIONSTATUS enumeration [Network Drivers Starting with Windows Vista], RIL_PROVISIONSTAT_MAX, rilapitypes/RIL_PROVISIONSTAT_BIP_STARTED, rilapitypes/RIL_PROVISIONSTAT_SUCCESS, rilapitypes/RIL_PROVISIONSTAT_NEEDED
