...
ms.date: 1/18/2018
ms.keywords: RILPROVISIONSTATUSPROVISIONSTATUS, RILPROVISIONSTATUSPROVISIONSTATUS enumeration [Network Drivers Starting with Windows Vista], RIL_PROVISIONSTAT_NEEDED, RIL_PROVISIONSTAT_FAILURE_RETRY, rilapitypes/RIL_PROVISIONSTAT_NEEDED, netvista.rilprovisionstatusprovisionstatus_2, RIL_PROVISIONSTAT_BIP_SUCCESS, RIL_PROVISIONSTAT_MAX, rilapitypes/RIL_PROVISIONSTAT_FAILURE_END, rilapitypes/RIL_PROVISIONSTAT_BIP_STARTED, RIL_PROVISIONSTAT_SUCCESS, rilapitypes/RIL_PROVISIONSTAT_SUCCESS, rilapitypes/RIL_PROVISIONSTAT_FAILURE_RETRY, rilapitypes/RILPROVISIONSTATUSPROVISIONSTATUS, rilapitypes/RIL_PROVISIONSTAT_MAX, RIL_PROVISIONSTAT_BIP_STARTED, rilapitypes/RIL_PROVISIONSTAT_BIP_SUCCESS, RIL_PROVISIONSTAT_FAILURE_END
