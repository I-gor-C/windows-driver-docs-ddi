...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_PARAM_CMI_MODIFICATIONTYPE, RILCALLMODIFICATIONINFOPARAMMASK, RIL_PARAM_CMI_ADDRESS, RILCALLMODIFICATIONINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_CMI_ALL, rilapitypes/RIL_PARAM_CMI_NEWCALLTYPE, rilapitypes/RIL_PARAM_CMI_ALPHAIDENTIFIER, netvista.rilcallmodificationinfoparammask_2, rilapitypes/RIL_PARAM_CMI_OLDCALLTYPE, RIL_PARAM_CMI_OLDCALLTYPE, RIL_PARAM_CMI_ALL, rilapitypes/RILCALLMODIFICATIONINFOPARAMMASK, RIL_PARAM_CMI_ID, rilapitypes/RIL_PARAM_CMI_ID, RIL_PARAM_CMI_NEWCALLTYPE, rilapitypes/RIL_PARAM_CMI_ADDRESS, RIL_PARAM_CMI_ALPHAIDENTIFIER, RIL_PARAM_CMI_MODIFICATIONTYPE
