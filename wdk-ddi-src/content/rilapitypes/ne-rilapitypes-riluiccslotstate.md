...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_UICCSLOT_OFF, rilapitypes/RIL_UICCSLOT_NOT_READY, RIL_UICCSLOT_NOT_READY, RILUICCSLOTSTATE enumeration [Network Drivers Starting with Windows Vista], RIL_UICCSLOT_EMPTY, RIL_UICCSLOT_ERROR, netvista.riluiccslotstate, RIL_UICCSLOT_ACTIVE, RIL_UICCSLOT_OFF_EMPTY, rilapitypes/RIL_UICCSLOT_EMPTY, rilapitypes/RIL_UICCSLOT_ERROR, rilapitypes/RILUICCSLOTSTATE, rilapitypes/RIL_UICCSLOT_OFF_EMPTY, rilapitypes/RIL_UICCSLOT_ACTIVE, RILUICCSLOTSTATE, RIL_UICCSLOT_OFF
