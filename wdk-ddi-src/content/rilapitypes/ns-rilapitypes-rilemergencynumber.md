...
ms.date: 1/18/2018
ms.keywords: RILEMERGENCYNUMBER, netvista.rilemergencynumber_2, RILEMERGENCYNUMBER structure [Network Drivers Starting with Windows Vista], rilapitypes/RILEMERGENCYNUMBER, *LPRILEMERGENCYNUMBER
