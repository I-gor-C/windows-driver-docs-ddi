...
ms.date : 1/18/2018
ms.keywords : rilapitypes/RILPHONEBOOKINFOPARAMMASK, RIL_PARAM_PBI_MAXEMAILLENGTH, RILPHONEBOOKINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_PBI_MAXANR, RIL_PARAM_PBI_MAXGROUPS, rilapitypes/RIL_PARAM_PBI_MAXGASLENGTH, rilapitypes/RIL_PARAM_PBI_TOTALAAS, RIL_PARAM_PBI_TOTAL, RIL_PARAM_PBI_MAXEMAILS, rilapitypes/RIL_PARAM_PBI_MAXSNELENGTH, RIL_PARAM_PBI_ALL, rilapitypes/RIL_PARAM_PBI_ALL, RIL_PARAM_PBI_TOTALAAS, rilapitypes/RIL_PARAM_PBI_TOTAL, RIL_PARAM_PBI_MAXSNELENGTH, rilapitypes/RIL_PARAM_PBI_MAXEMAILS, RIL_PARAM_PBI_MAXGASLENGTH, RIL_PARAM_PBI_MAXAASTEXTLENGTH, rilapitypes/RIL_PARAM_PBI_ADDRESSLENGTH, RIL_PARAM_PBI_USEDGAS, rilapitypes/RIL_PARAM_PBI_MAXANRLENGTH, RIL_PARAM_PBI_MAXANRLENGTH, rilapitypes/RIL_PARAM_PBI_TEXTLENGTH, RIL_PARAM_PBI_MAXANR, rilapitypes/RIL_PARAM_PBI_USEDAAS, rilapitypes/RIL_PARAM_PBI_USEDGAS, RIL_PARAM_PBI_USEDAAS, rilapitypes/RIL_PARAM_PBI_MAXAASTEXTLENGTH, rilapitypes/RIL_PARAM_PBI_MAXEMAILLENGTH, rilapitypes/RIL_PARAM_PBI_TOTALGAS, RIL_PARAM_PBI_TEXTLENGTH, RIL_PARAM_PBI_ADDRESSLENGTH, rilapitypes/RIL_PARAM_PBI_MAXGROUPS, RILPHONEBOOKINFOPARAMMASK, RIL_PARAM_PBI_TOTALGAS, netvista.rilphonebookinfoparammask_2
