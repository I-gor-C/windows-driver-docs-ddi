...
ms.date: 1/18/2018
ms.keywords: RILUICCTOOLKITPROFILE, rilapitypes/RILUICCTOOLKITPROFILE, *LPRILUICCTOOLKITPROFILE, RILUICCTOOLKITPROFILE structure [Network Drivers Starting with Windows Vista], netvista.riluicctoolkitprofile_2
