...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RILUICCFILELOCKSTATUSPARAMMASK, RIL_PARAM_UFLS_ALL, RILUICCFILELOCKSTATUSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_UFLS_ACCESSCONDITION, RIL_PARAM_UFLS_ACCESSCONDITION, rilapitypes/RIL_PARAM_UFLS_PINREFERENCE, netvista.riluiccfilelockstatusparammask, RIL_PARAM_UFLS_PINREFERENCE, rilapitypes/RIL_PARAM_UFLS_ALL, RILUICCFILELOCKSTATUSPARAMMASK
