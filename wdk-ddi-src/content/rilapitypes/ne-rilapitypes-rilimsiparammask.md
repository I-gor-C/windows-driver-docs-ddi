...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_PARAM_IMSI_IMSI, RIL_PARAM_IMSI_MCC, rilapitypes/RILIMSIPARAMMASK, rilapitypes/RIL_PARAM_IMSI_MNC, RILIMSIPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RILIMSIPARAMMASK, rilapitypes/RIL_PARAM_IMSI_MCC, netvista.rilimsiparammask, rilapitypes/RIL_PARAM_IMSI_ALL, RIL_PARAM_IMSI_IMSI, RIL_PARAM_IMSI_ALL, RIL_PARAM_IMSI_MNC
