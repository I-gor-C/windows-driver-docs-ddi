...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_NOTIFY_FORWARDSTOPDTMF, rilapitypes/RIL_NOTIFY_ADDITIONALNUMBERSTRINGUPDATED, RIL_NOTIFY_EMERGENCYMODEEXITED, rilapitypes/RIL_NOTIFY_RADIOPRESENCECHANGED, RIL_NOTIFY_SIGNALQUALITY, rilapitypes/RIL_NOTIFY_EMERGENCYMODEEXITED, RIL_NOTIFY_COUNT, RIL_NOTIFY_EMERGENCYNUMBERLISTCHANGED, netvista.rilnotifications, rilapitypes/RIL_NOTIFY_CLEARIDLEMODETEXT, rilapitypes/RIL_NOTIFY_OEM_MAX, rilapitypes/ RIL_NOTIFY_NITZ, RIL_NOTIFY_CARDAPPREMOVED, RIL_NOTIFY_UICCTOOLKITCMD, rilapitypes/RIL_NOTIFY_UICCLOCKSTATUS, rilapitypes/RIL_NOTIFY_UICCAPP_DATACHANGE, RIL_NOTIFY_MESSAGE_STORAGE_FULL, rilapitypes/RIL_NOTIFY_PROVISION_STATUS, rilapitypes/RIL_NOTIFY_FORWARDSTARTDTMF, rilapitypes/RIL_NOTIFY_REGSTATUSCHANGED, RIL_NOTIFY_FORWARDSTARTDTMF, RIL_NOTIFY_OEM_MAX, rilapitypes/RIL_NOTIFY_SUPSERVICEDATATERMINATED, RIL_NOTIFY_CALLMODIFICATIONINFO, rilapitypes/RIL_NOTIFY_DIALEDID, RIL_NOTIFY_FORWARDSTOPDTMF, rilapitypes/RIL_NOTIFY_PHONEBOOKENTRYDELETED, rilapitypes/RIL_NOTIFY_MESSAGE_STORAGE_FULL, RIL_NOTIFY_RADIOPRESENCECHANGED, RIL_NOTIFY_REGSTATUSCHANGED, rilapitypes/RIL_NOTIFY_NETWORKCODECHANGED, RIL_NOTIFY_FORWARDBURSTDTMF, RIL_NOTIFY_UICCLOCKSTATUS, RIL_NOTIFY_SYSTEMPREFSCHANGED, RIL_NOTIFY_LINECONTROL, RIL_NOTIFY_NETWORKCODECHANGED, rilapitypes/RIL_NOTIFY_MANAGED_ROAMING, rilapitypes/RIL_NOTIFY_SUPSERVICEDATA, RIL_NOTIFY_UICCAPPPERSOCHECKSTATUS, RIL_NOTIFY_IMSSTATUS, RIL_NOTIFY_CALLWAITING, RIL_NOTIFY_PHONEBOOKENTRYDELETED, RIL_NOTIFY_PROVISION_STATUS, RIL_NOTIFY_RADIOEQUIPMENTSTATECHANGED, rilapitypes/RIL_NOTIFY_SUPSVCINFO, rilapitypes/RILNOTIFICATIONS, rilapitypes/RIL_NOTIFY_MESSAGE, RIL_NOTIFY_SLOTINFOCHANGED, rilapitypes/RIL_NOTIFY_DISPLAY, rilapitypes/RIL_NOTIFY_MESSAGE_IN_UICC, rilapitypes/RIL_NOTIFY_CALLPROGRESSINFO, rilapitypes/RIL_NOTIFY_EXECUTORSTATE, rilapitypes/RIL_NOTIFY_UICCFILE_DATACHANGE, rilapitypes/RIL_NOTIFY_RADIOEQUIPMENTSTATECHANGED, rilapitypes/RIL_NOTIFY_SIGNALQUALITY, rilapitypes/RIL_NOTIFY_UICCAPPPERSOCHECKSTATUS, RIL_NOTIFY_SUPSERVICEDATA, rilapitypes/RIL_NOTIFY_SYSTEMPREFSCHANGED, RIL_NOTIFY_MESSAGE_IN_UICC, rilapitypes/RIL_NOTIFY_COUNT, rilapitypes/RIL_NOTIFY_PHONEBOOKENTRYSTORED, RILNOTIFICATIONS, RIL_NOTIFY_TONESIGNAL, rilapitypes/RIL_NOTIFY_UNSOLICITEDSS, RIL_NOTIFY_UICCAPP_DATACHANGE, RIL_NOTIFY_PHONEBOOKREADYSTATE, rilapitypes/RIL_NOTIFY_CARDAPPREMOVED, RIL_NOTIFY_ADDITIONALNUMBERSTRINGUPDATED, RIL_NOTIFY_SUPSERVICEDATATERMINATED, RIL_NOTIFY_CARDAPPADDED, rilapitypes/RIL_NOTIFY_EMERGENCYNUMBERLISTCHANGED, RIL_NOTIFY_CLEARIDLEMODETEXT, rilapitypes/RIL_NOTIFY_IMSSTATUS, rilapitypes/RIL_NOTIFY_CARDAPPADDED, RIL_NOTIFY_NITZ, rilapitypes/RIL_NOTIFY_TONESIGNAL, RIL_NOTIFY_EMERGENCYMODEENTERED, RIL_NOTIFY_UICCFILE_DATACHANGE, RIL_NOTIFY_UNSOLICITEDSS, rilapitypes/RIL_NOTIFY_EMERGENCYMODEENTERED, RIL_NOTIFY_DIALEDID, RIL_NOTIFY_MESSAGE, rilapitypes/RIL_NOTIFY_LOCATIONUPDATE, rilapitypes/RIL_NOTIFY_LINECONTROL, RIL_NOTIFY_LOCATIONUPDATE, RIL_NOTIFY_PHONEBOOKENTRYSTORED, RIL_NOTIFY_SUPSVCINFO, rilapitypes/RIL_NOTIFY_SLOTINFOCHANGED, RIL_NOTIFY_MANAGED_ROAMING, RIL_NOTIFY_DISPLAY, rilapitypes/RIL_NOTIFY_UICCTOOLKITCMD, rilapitypes/RIL_NOTIFY_CALLWAITING, RIL_NOTIFY_CALLPROGRESSINFO, RIL_NOTIFY_EXECUTORSTATE, rilapitypes/RIL_NOTIFY_PHONEBOOKREADYSTATE, RILNOTIFICATIONS enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_NOTIFY_CALLMODIFICATIONINFO, rilapitypes/RIL_NOTIFY_FORWARDBURSTDTMF
