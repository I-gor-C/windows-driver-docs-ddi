...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_CI_DISCONNECTREASON, rilapitypes/RIL_PARAM_CI_CALLMODIFICATIONCAUSE, RILCALLINFOPARAMMASK, RIL_PARAM_CI_DISCONNECTDETAILS, rilapitypes/RIL_PARAM_CI_DISCONNECTINITIATOR, rilapitypes/RIL_PARAM_CI_ALL, rilapitypes/RIL_PARAM_CI_RTTMODETYPE, RIL_PARAM_CI_TYPE, RIL_PARAM_CI_NAME_PRES_IND, netvista.rilcallinfoparammask_2, RIL_PARAM_CI_SUBADDRESS, RIL_PARAM_CI_DISCONNECTINITIATOR, RIL_PARAM_CI_CALLMODIFICATIONCAUSE, RIL_PARAM_CI_RTTCAPINFO, rilapitypes/RILCALLINFOPARAMMASK, rilapitypes/RIL_PARAM_CI_OFFERANSWER, rilapitypes/RIL_PARAM_CI_ID, rilapitypes/RIL_PARAM_CI_RTTACTION, rilapitypes/RIL_PARAM_CI_NUM_PRES_IND, RIL_PARAM_CI_ADDRESS, RIL_PARAM_CI_STATUS, rilapitypes/RIL_PARAM_CI_DISCONNECTREASON, rilapitypes/RIL_PARAM_CI_MULTIPARTY, RIL_PARAM_CI_MULTIPARTY, rilapitypes/RIL_PARAM_CI_NAME_PRES_IND, rilapitypes/RIL_PARAM_CI_FLAGS, RIL_PARAM_CI_DIRECTION, RIL_PARAM_CI_ALL, RIL_PARAM_CI_RTTACTION, RIL_PARAM_CI_DESCRIPTION, rilapitypes/RIL_PARAM_CI_RTTCAPINFO, RIL_PARAM_CI_HANDOVERSTATE, RIL_PARAM_CI_FLAGS, RIL_PARAM_CI_ID, RIL_PARAM_CI_NUM_PRES_IND, rilapitypes/RIL_PARAM_CI_TYPE, RIL_PARAM_CI_RTTMODETYPE, rilapitypes/RIL_PARAM_CI_HANDOVERSTATE, rilapitypes/RIL_PARAM_CI_SUBADDRESS, RIL_PARAM_CI_OFFERANSWER, rilapitypes/RIL_PARAM_CI_DISCONNECTDETAILS, rilapitypes/RIL_PARAM_CI_DESCRIPTION, rilapitypes/RIL_PARAM_CI_ADDRESS, rilapitypes/RIL_PARAM_CI_STATUS, RILCALLINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_CI_DIRECTION
