...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_CI_HANDOVERSTATE, RIL_PARAM_CI_DESCRIPTION, RIL_PARAM_CI_RTTCAPINFO, rilapitypes/RIL_PARAM_CI_SUBADDRESS, RIL_PARAM_CI_NAME_PRES_IND, RIL_PARAM_CI_SUBADDRESS, rilapitypes/RIL_PARAM_CI_CALLMODIFICATIONCAUSE, RIL_PARAM_CI_ALL, rilapitypes/RIL_PARAM_CI_NUM_PRES_IND, RIL_PARAM_CI_FLAGS, rilapitypes/RIL_PARAM_CI_DIRECTION, RIL_PARAM_CI_DISCONNECTREASON, rilapitypes/RIL_PARAM_CI_FLAGS, rilapitypes/RILCALLINFOPARAMMASK, rilapitypes/RIL_PARAM_CI_DESCRIPTION, rilapitypes/RIL_PARAM_CI_ADDRESS, RIL_PARAM_CI_DISCONNECTINITIATOR, rilapitypes/RIL_PARAM_CI_DISCONNECTDETAILS, RIL_PARAM_CI_ID, rilapitypes/RIL_PARAM_CI_ID, netvista.rilcallinfoparammask_2, RIL_PARAM_CI_DISCONNECTDETAILS, rilapitypes/RIL_PARAM_CI_NAME_PRES_IND, RIL_PARAM_CI_RTTMODETYPE, rilapitypes/RIL_PARAM_CI_MULTIPARTY, rilapitypes/RIL_PARAM_CI_OFFERANSWER, RIL_PARAM_CI_RTTACTION, rilapitypes/RIL_PARAM_CI_TYPE, RIL_PARAM_CI_MULTIPARTY, rilapitypes/RIL_PARAM_CI_STATUS, rilapitypes/RIL_PARAM_CI_HANDOVERSTATE, RIL_PARAM_CI_CALLMODIFICATIONCAUSE, RIL_PARAM_CI_STATUS, rilapitypes/RIL_PARAM_CI_DISCONNECTINITIATOR, RILCALLINFOPARAMMASK, rilapitypes/RIL_PARAM_CI_RTTACTION, rilapitypes/RIL_PARAM_CI_ALL, RIL_PARAM_CI_ADDRESS, rilapitypes/RIL_PARAM_CI_RTTMODETYPE, rilapitypes/RIL_PARAM_CI_RTTCAPINFO, RILCALLINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_CI_NUM_PRES_IND, rilapitypes/RIL_PARAM_CI_DISCONNECTREASON, RIL_PARAM_CI_OFFERANSWER, RIL_PARAM_CI_TYPE, RIL_PARAM_CI_DIRECTION
