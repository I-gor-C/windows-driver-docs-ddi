...
ms.date: 2/16/2018
ms.keywords: RIL_PARAM_CI_ADDRESS, RIL_PARAM_CI_ID, netvista.rilcallinfoparammask_2, rilapitypes/RIL_PARAM_CI_MULTIPARTY, rilapitypes/RIL_PARAM_CI_SUBADDRESS, rilapitypes/RIL_PARAM_CI_FLAGS, rilapitypes/RIL_PARAM_CI_TYPE, RIL_PARAM_CI_MULTIPARTY, RIL_PARAM_CI_CALLMODIFICATIONCAUSE, rilapitypes/RIL_PARAM_CI_RTTACTION, RIL_PARAM_CI_OFFERANSWER, RIL_PARAM_CI_DISCONNECTDETAILS, RIL_PARAM_CI_ALL, rilapitypes/RILCALLINFOPARAMMASK, RIL_PARAM_CI_TYPE, rilapitypes/RIL_PARAM_CI_DIRECTION, rilapitypes/RIL_PARAM_CI_DESCRIPTION, RIL_PARAM_CI_RTTMODETYPE, RIL_PARAM_CI_DIRECTION, rilapitypes/RIL_PARAM_CI_CALLMODIFICATIONCAUSE, rilapitypes/RIL_PARAM_CI_DISCONNECTDETAILS, rilapitypes/RIL_PARAM_CI_ID, RIL_PARAM_CI_NUM_PRES_IND, RIL_PARAM_CI_NAME_PRES_IND, rilapitypes/RIL_PARAM_CI_ALL, RIL_PARAM_CI_DISCONNECTREASON, rilapitypes/RIL_PARAM_CI_STATUS, RIL_PARAM_CI_DESCRIPTION, rilapitypes/RIL_PARAM_CI_OFFERANSWER, RILCALLINFOPARAMMASK, rilapitypes/RIL_PARAM_CI_ADDRESS, RIL_PARAM_CI_DISCONNECTINITIATOR, RIL_PARAM_CI_SUBADDRESS, rilapitypes/RIL_PARAM_CI_HANDOVERSTATE, rilapitypes/RIL_PARAM_CI_NUM_PRES_IND, RIL_PARAM_CI_RTTCAPINFO, RILCALLINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_CI_DISCONNECTINITIATOR, rilapitypes/RIL_PARAM_CI_DISCONNECTREASON, rilapitypes/RIL_PARAM_CI_RTTMODETYPE, RIL_PARAM_CI_RTTACTION, rilapitypes/RIL_PARAM_CI_RTTCAPINFO, RIL_PARAM_CI_FLAGS, RIL_PARAM_CI_HANDOVERSTATE, rilapitypes/RIL_PARAM_CI_NAME_PRES_IND, RIL_PARAM_CI_STATUS
