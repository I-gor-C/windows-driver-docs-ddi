...
ms.date: 1/18/2018
ms.keywords: RILEXECUTORCONFIG, rilapitypes/RILEXECUTORCONFIG, RILEXECUTORCONFIG structure [Network Drivers Starting with Windows Vista], netvista.rilexecutorconfig_2, *LPRILEXECUTORCONFIG
