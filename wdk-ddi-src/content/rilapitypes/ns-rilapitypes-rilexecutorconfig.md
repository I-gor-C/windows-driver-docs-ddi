...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RILEXECUTORCONFIG, netvista.rilexecutorconfig_2, RILEXECUTORCONFIG structure [Network Drivers Starting with Windows Vista], *LPRILEXECUTORCONFIG, RILEXECUTORCONFIG
