...
ms.date: 2/16/2018
ms.keywords: netvista.rilcallrttcap_2, RILCALLRTTCAP structure [Network Drivers Starting with Windows Vista], rilapitypes/RILCALLRTTCAP, *LPRILCALLRTTCAP, RILCALLRTTCAP
