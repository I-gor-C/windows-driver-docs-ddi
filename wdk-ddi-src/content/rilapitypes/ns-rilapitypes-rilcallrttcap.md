...
ms.date: 1/18/2018
ms.keywords: "*LPRILCALLRTTCAP, rilapitypes/RILCALLRTTCAP, netvista.rilcallrttcap_2, RILCALLRTTCAP, RILCALLRTTCAP structure [Network Drivers Starting with Windows Vista]"
