...
ms.date: 1/18/2018
ms.keywords: RILPHONEENTRYSTORELOCATION enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PBLOC_OWNNUMBERS, RIL_PBLOC_UICCFIXDIALING, RIL_PBLOC_OWNNUMBERS, RIL_PBLOC_ALL, RILPHONEENTRYSTORELOCATION, rilapitypes/RIL_PBLOC_UICCSERVICEDIALING, rilapitypes/RIL_PBLOC_UICCFIXDIALING, RIL_PBLOC_UICCSERVICEDIALING, rilapitypes/RIL_PBLOC_ALL, RIL_PBLOC_UICCPHONEBOOK, rilapitypes/RIL_PBLOC_UICCPHONEBOOK, rilapitypes/RILPHONEENTRYSTORELOCATION, netvista.rilphoneentrystorelocation_2
