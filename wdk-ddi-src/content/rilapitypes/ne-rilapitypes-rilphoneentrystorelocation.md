...
ms.date: 1/18/2018
ms.keywords: RIL_PBLOC_UICCFIXDIALING, RIL_PBLOC_UICCPHONEBOOK, rilapitypes/RIL_PBLOC_UICCFIXDIALING, netvista.rilphoneentrystorelocation_2, rilapitypes/RIL_PBLOC_UICCPHONEBOOK, RILPHONEENTRYSTORELOCATION enumeration [Network Drivers Starting with Windows Vista], RIL_PBLOC_ALL, RILPHONEENTRYSTORELOCATION, rilapitypes/RILPHONEENTRYSTORELOCATION, rilapitypes/RIL_PBLOC_ALL, rilapitypes/RIL_PBLOC_OWNNUMBERS, RIL_PBLOC_UICCSERVICEDIALING, rilapitypes/RIL_PBLOC_UICCSERVICEDIALING, RIL_PBLOC_OWNNUMBERS
