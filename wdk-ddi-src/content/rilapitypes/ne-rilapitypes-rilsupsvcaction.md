...
ms.date: 1/18/2018
ms.keywords: RIL_SUPSVCACTION_INTERROGATE, rilapitypes/RIL_SUPSVCACTION_USSD, rilapitypes/RIL_SUPSVCACTION_ERASE, RIL_SUPSVCACTION_REGISTER, RIL_SUPSVCACTION_MAX, RILSUPSVCACTION, rilapitypes/RIL_SUPSVCACTION_REGISTER_PW, RIL_SUPSVCACTION_USSD, rilapitypes/RIL_SUPSVCACTION_MAX, RIL_SUPSVCACTION_DEACTIVATE, RILSUPSVCACTION enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_SUPSVCACTION_DEACTIVATE, rilapitypes/RIL_SUPSVCACTION_REGISTER, rilapitypes/RIL_SUPSVCACTION_INTERROGATE, netvista.rilsupsvcaction_2, rilapitypes/RILSUPSVCACTION, RIL_SUPSVCACTION_ERASE, RIL_SUPSVCACTION_REGISTER_PW
