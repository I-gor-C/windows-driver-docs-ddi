...
ms.date : 1/18/2018
ms.keywords : RIL_SUPSVCACTION_INTERROGATE, RIL_SUPSVCACTION_REGISTER, rilapitypes/RIL_SUPSVCACTION_INTERROGATE, rilapitypes/RIL_SUPSVCACTION_USSD, RIL_SUPSVCACTION_MAX, rilapitypes/RILSUPSVCACTION, rilapitypes/RIL_SUPSVCACTION_DEACTIVATE, RIL_SUPSVCACTION_REGISTER_PW, rilapitypes/RIL_SUPSVCACTION_REGISTER, RIL_SUPSVCACTION_USSD, RIL_SUPSVCACTION_DEACTIVATE, rilapitypes/RIL_SUPSVCACTION_MAX, RIL_SUPSVCACTION_ERASE, rilapitypes/RIL_SUPSVCACTION_REGISTER_PW, netvista.rilsupsvcaction_2, RILSUPSVCACTION, RILSUPSVCACTION enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_SUPSVCACTION_ERASE
