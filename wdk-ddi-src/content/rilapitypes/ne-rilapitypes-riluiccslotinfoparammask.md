...
ms.date : 1/18/2018
ms.keywords : RIL_PARAM_SLOTINFO_ALL, rilapitypes/RILUICCSLOTINFOPARAMMASK, netvista.riluiccslotinfoparammask_2, rilapitypes/RIL_PARAM_SLOTINFO_ALL, RILUICCSLOTINFOPARAMMASK, RILUICCSLOTINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_SLOTINFO_SLOTSTATE, RIL_PARAM_SLOTINFO_SLOTSTATE
