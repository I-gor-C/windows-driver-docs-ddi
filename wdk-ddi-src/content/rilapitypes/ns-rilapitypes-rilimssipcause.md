...
ms.date: 1/18/2018
ms.keywords: RILIMSSIPCAUSE structure [Network Drivers Starting with Windows Vista], *LPRILIMSSIPCAUSE, RILIMSSIPCAUSE, netvista.rilimssipcause_2, rilapitypes/RILIMSSIPCAUSE
