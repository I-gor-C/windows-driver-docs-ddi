...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_FWDREASON_ALLCONDITIONAL, rilapitypes/RILCALLFORWARDINGSETTINGSREASON, rilapitypes/RIL_FWDREASON_NOREPLY, RIL_FWDREASON_ALLFORWARDING, rilapitypes/RIL_FWDREASON_ALLFORWARDING, RIL_FWDREASON_UNREACHABLE, rilapitypes/RIL_FWDREASON_MOBILEBUSY, RIL_FWDREASON_ALLCONDITIONAL, RILCALLFORWARDINGSETTINGSREASON, RIL_FWDREASON_NOREPLY, netvista.rilcallforwardingsettingsreason_2, rilapitypes/RIL_FWDREASON_UNREACHABLE, RILCALLFORWARDINGSETTINGSREASON enumeration [Network Drivers Starting with Windows Vista], RIL_FWDREASON_MOBILEBUSY, rilapitypes/RIL_FWDREASON_MAX, RIL_FWDREASON_MAX
