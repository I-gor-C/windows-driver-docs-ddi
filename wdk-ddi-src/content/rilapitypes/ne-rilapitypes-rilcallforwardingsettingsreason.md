...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_FWDREASON_MAX, rilapitypes/RIL_FWDREASON_NOREPLY, rilapitypes/RIL_FWDREASON_UNREACHABLE, RILCALLFORWARDINGSETTINGSREASON, rilapitypes/RIL_FWDREASON_ALLFORWARDING, rilapitypes/RILCALLFORWARDINGSETTINGSREASON, RIL_FWDREASON_MOBILEBUSY, RIL_FWDREASON_UNREACHABLE, RIL_FWDREASON_NOREPLY, rilapitypes/RIL_FWDREASON_ALLCONDITIONAL, RIL_FWDREASON_ALLFORWARDING, RIL_FWDREASON_ALLCONDITIONAL, RIL_FWDREASON_MAX, RILCALLFORWARDINGSETTINGSREASON enumeration [Network Drivers Starting with Windows Vista], netvista.rilcallforwardingsettingsreason_2, rilapitypes/RIL_FWDREASON_MOBILEBUSY
