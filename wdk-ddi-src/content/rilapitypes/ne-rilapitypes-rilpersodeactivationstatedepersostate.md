...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_DEPERSOSTATE_PUK_BLOCKED, rilapitypes/RIL_DEPERSOSTATE_MAX, RIL_DEPERSOSTATE_PUK_BLOCKED, RIL_DEPERSOSTATE_CK_REQUIRED, rilapitypes/RILPERSODEACTIVATIONSTATEDEPERSOSTATE, netvista.rilpersodeactivationstatedepersostate_2, RILPERSODEACTIVATIONSTATEDEPERSOSTATE, rilapitypes/RIL_DEPERSOSTATE_PUK_REQUIRED, RIL_DEPERSOSTATE_MAX, RIL_DEPERSOSTATE_PUK_REQUIRED, RILPERSODEACTIVATIONSTATEDEPERSOSTATE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_DEPERSOSTATE_CK_REQUIRED
