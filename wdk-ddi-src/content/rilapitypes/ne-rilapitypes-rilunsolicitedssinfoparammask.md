...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_PARAM_UNSSS_CUGINDEX, rilapitypes/RIL_PARAM_UNSSS_ADDRESS, RIL_PARAM_UNSSS_SUBADDR, RIL_PARAM_UNSSS_ALL, RIL_PARAM_UNSSS_HISTINFO, RILUNSOLICITEDSSINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RILUNSOLICITEDSSINFOPARAMMASK, RIL_PARAM_UNSSS_HISTLENGTH, RIL_PARAM_UNSSS_ID, rilapitypes/RIL_PARAM_UNSSS_ID, rilapitypes/RILUNSOLICITEDSSINFOPARAMMASK, RIL_PARAM_UNSSS_NOTIFICATIONCODE, rilapitypes/RIL_PARAM_UNSSS_NOTIFICATIONCODE, rilapitypes/RIL_PARAM_UNSSS_HISTLENGTH, RIL_PARAM_UNSSS_ADDRESS, rilapitypes/RIL_PARAM_UNSSS_SUBADDR, rilapitypes/RIL_PARAM_UNSSS_HISTINFO, RIL_PARAM_UNSSS_CUGINDEX, netvista.rilunsolicitedssinfoparammask_2, rilapitypes/RIL_PARAM_UNSSS_ALL
