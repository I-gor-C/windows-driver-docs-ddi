...
ms.date: 1/18/2018
ms.keywords: RIL_CAPS_CALLSUPPORT_MSP, rilapitypes/RIL_CAPS_CALLSUPPORT_USSD_PHASE2, RIL_CAPS_CALLSUPPORT_CNAP, RILCALLSUPPORTCAPS enumeration [Network Drivers Starting with Windows Vista], RIL_CAPS_CALLSUPPORT_USSD_PHASE2, rilapitypes/RIL_CAPS_CALLSUPPORT_USS, rilapitypes/RIL_CAPS_CALLSUPPORT_CD, RIL_CAPS_CALLSUPPORT_CUG, netvista.rilcallsupportcaps_2, rilapitypes/RIL_CAPS_CALLSUPPORT_CUG, rilapitypes/RIL_CAPS_CALLSUPPORT_MSP, RILCALLSUPPORTCAPS, rilapitypes/RIL_CAPS_CALLSUPPORT_ALL, RIL_CAPS_CALLSUPPORT_USS, RIL_CAPS_CALLSUPPORT_EMLPP, rilapitypes/RIL_CAPS_CALLSUPPORT_FM, RIL_CAPS_CALLSUPPORT_FM, RIL_CAPS_CALLSUPPORT_CD, rilapitypes/RIL_CAPS_CALLSUPPORT_CNAP, rilapitypes/RILCALLSUPPORTCAPS, rilapitypes/RIL_CAPS_CALLSUPPORT_EMLPP, RIL_CAPS_CALLSUPPORT_ALL
