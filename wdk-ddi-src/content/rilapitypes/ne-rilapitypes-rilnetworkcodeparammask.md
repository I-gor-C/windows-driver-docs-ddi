...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_PARAM_NETWORKCODE_RI, RILNETWORKCODEPARAMMASK, rilapitypes/RIL_PARAM_NETWORKCODE_NID, RIL_PARAM_NETWORKCODE_MNC, rilapitypes/RILNETWORKCODEPARAMMASK, RIL_PARAM_NETWORKCODE_SID, RIL_PARAM_NETWORKCODE_ALL, rilapitypes/RIL_PARAM_NETWORKCODE_SID, RIL_PARAM_NETWORKCODE_EXECUTOR, RIL_PARAM_NETWORKCODE_MCC, rilapitypes/RIL_PARAM_NETWORKCODE_ALL, netvista.rilnetworkcodeparammask, rilapitypes/RIL_PARAM_NETWORKCODE_MNC, RILNETWORKCODEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_NETWORKCODE_NID, rilapitypes/RIL_PARAM_NETWORKCODE_EXECUTOR, rilapitypes/RIL_PARAM_NETWORKCODE_MCC, RIL_PARAM_NETWORKCODE_RI
