...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_NETWORKCODE_MCC, RIL_PARAM_NETWORKCODE_EXECUTOR, RIL_PARAM_NETWORKCODE_SID, rilapitypes/RILNETWORKCODEPARAMMASK, RIL_PARAM_NETWORKCODE_MNC, rilapitypes/RIL_PARAM_NETWORKCODE_NID, RIL_PARAM_NETWORKCODE_NID, netvista.rilnetworkcodeparammask, rilapitypes/RIL_PARAM_NETWORKCODE_MNC, rilapitypes/RIL_PARAM_NETWORKCODE_SID, rilapitypes/RIL_PARAM_NETWORKCODE_ALL, RILNETWORKCODEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_NETWORKCODE_ALL, rilapitypes/RIL_PARAM_NETWORKCODE_EXECUTOR, rilapitypes/RIL_PARAM_NETWORKCODE_RI, rilapitypes/RIL_PARAM_NETWORKCODE_MCC, RILNETWORKCODEPARAMMASK, RIL_PARAM_NETWORKCODE_RI
