...
ms.date: 1/18/2018
ms.keywords: netvista.rilcallforwardingsettingsparammask_2, RILCALLFORWARDINGSETTINGSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_CFS_ADDRESS, RIL_PARAM_CFS_ALL, rilapitypes/RIL_PARAM_CFS_ADDRESS, RIL_PARAM_CFS_SUBADDRESS, RIL_PARAM_CFS_INFOCLASSES, RIL_PARAM_CFS_DELAYTIME, rilapitypes/RIL_PARAM_CFS_INFOCLASSES, rilapitypes/RIL_PARAM_CFS_ALL, rilapitypes/RILCALLFORWARDINGSETTINGSPARAMMASK, rilapitypes/RIL_PARAM_CFS_DELAYTIME, RILCALLFORWARDINGSETTINGSPARAMMASK, rilapitypes/RIL_PARAM_CFS_SUBADDRESS
