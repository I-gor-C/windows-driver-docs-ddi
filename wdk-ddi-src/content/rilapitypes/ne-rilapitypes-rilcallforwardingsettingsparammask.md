...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_CFS_ALL, RIL_PARAM_CFS_ADDRESS, rilapitypes/RILCALLFORWARDINGSETTINGSPARAMMASK, RIL_PARAM_CFS_SUBADDRESS, netvista.rilcallforwardingsettingsparammask_2, RIL_PARAM_CFS_INFOCLASSES, rilapitypes/RIL_PARAM_CFS_ADDRESS, rilapitypes/RIL_PARAM_CFS_SUBADDRESS, rilapitypes/RIL_PARAM_CFS_DELAYTIME, RILCALLFORWARDINGSETTINGSPARAMMASK, RILCALLFORWARDINGSETTINGSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_CFS_DELAYTIME, rilapitypes/RIL_PARAM_CFS_ALL, rilapitypes/RIL_PARAM_CFS_INFOCLASSES
