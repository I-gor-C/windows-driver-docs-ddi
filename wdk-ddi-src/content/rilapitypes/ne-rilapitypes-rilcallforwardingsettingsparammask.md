...
ms.date: 2/16/2018
ms.keywords: RILCALLFORWARDINGSETTINGSPARAMMASK, RIL_PARAM_CFS_ALL, RIL_PARAM_CFS_INFOCLASSES, rilapitypes/RIL_PARAM_CFS_ALL, rilapitypes/RIL_PARAM_CFS_INFOCLASSES, rilapitypes/RIL_PARAM_CFS_SUBADDRESS, rilapitypes/RIL_PARAM_CFS_DELAYTIME, netvista.rilcallforwardingsettingsparammask_2, rilapitypes/RILCALLFORWARDINGSETTINGSPARAMMASK, rilapitypes/RIL_PARAM_CFS_ADDRESS, RIL_PARAM_CFS_DELAYTIME, RIL_PARAM_CFS_SUBADDRESS, RILCALLFORWARDINGSETTINGSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_CFS_ADDRESS
