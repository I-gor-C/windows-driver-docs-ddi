...
ms.date: 1/18/2018
ms.keywords: RILDEVICEINFORMATION enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_DEVICEINFO_REVISION, rilapitypes/RIL_DEVICEINFO_ARG_LARGEST, netvista.rildeviceinformation, RIL_DEVICEINFO_MODEL, RILDEVICEINFORMATION, rilapitypes/RIL_DEVICEINFO_SERIALNUMBER_GW, RIL_DEVICEINFO_ARG_SMALLEST, RIL_DEVICEINFO_MANUFACTURER, rilapitypes/RIL_DEVICEINFO_MANUFACTURER, RIL_DEVICEINFO_REVISION, rilapitypes/RIL_DEVICEINFO_ARG_SMALLEST, rilapitypes/RILDEVICEINFORMATION, rilapitypes/RIL_DEVICEINFO_SERIALNUMBER_CDMA, rilapitypes/RIL_DEVICEINFO_MODEL, RIL_DEVICEINFO_ARG_LARGEST, RIL_DEVICEINFO_SERIALNUMBER_GW, RIL_DEVICEINFO_SERIALNUMBER_CDMA
