...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RILDEACTIVATEPERSOPARAMS, *LPRILDEACTIVATEPERSOPARAMS, netvista.rildeactivatepersoparams_2, RILDEACTIVATEPERSOPARAMS structure [Network Drivers Starting with Windows Vista], RILDEACTIVATEPERSOPARAMS
