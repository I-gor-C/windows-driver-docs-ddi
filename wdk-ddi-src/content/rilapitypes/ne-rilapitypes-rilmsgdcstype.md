...
ms.date : 1/18/2018
ms.keywords : RIL_DCSTYPE_MSGWAIT, rilapitypes/RIL_DCSTYPE_MAX, rilapitypes/RILMSGDCSTYPE, RIL_DCSTYPE_LANGUAGE, rilapitypes/RIL_DCSTYPE_LANGUAGE, RILMSGDCSTYPE enumeration [Network Drivers Starting with Windows Vista], RIL_DCSTYPE_MAX, rilapitypes/RIL_DCSTYPE_MSGCLASS, rilapitypes/RIL_DCSTYPE_MSGWAIT, RILMSGDCSTYPE, RIL_DCSTYPE_MSGCLASS, netvista.rilmsgdcstype_2
