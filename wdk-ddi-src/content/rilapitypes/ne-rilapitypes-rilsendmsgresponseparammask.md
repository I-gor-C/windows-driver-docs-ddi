...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_PARAM_MSGRES_GWLRELAYCODE, RIL_PARAM_MSGRES_CDMAERRORCLASS, RIL_PARAM_MSGRES_GWLRELAYCODE, RIL_PARAM_MSGRES_CDMACAUSECODE, rilapitypes/RIL_PARAM_MSGRES_ALL, RIL_PARAM_MSGRES_MSGID, rilapitypes/RILSENDMSGRESPONSEPARAMMASK, rilapitypes/RIL_PARAM_MSGRES_CDMACAUSECODE, rilapitypes/RIL_PARAM_MSGRES_MSGID, RILSENDMSGRESPONSEPARAMMASK, RIL_PARAM_MSGRES_GWLTRANSPORTCODE, RILSENDMSGRESPONSEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_MSGRES_GWLTRANSPORTCODE, rilapitypes/RIL_PARAM_MSGRES_CDMAERRORCLASS, RIL_PARAM_MSGRES_ALL, netvista.rilsendmsgresponseparammask_2
