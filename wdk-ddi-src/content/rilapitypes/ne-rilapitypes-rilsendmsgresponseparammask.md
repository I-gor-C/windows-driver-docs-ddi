...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_PARAM_MSGRES_GWLRELAYCODE, rilapitypes/RIL_PARAM_MSGRES_CDMAERRORCLASS, rilapitypes/RILSENDMSGRESPONSEPARAMMASK, RIL_PARAM_MSGRES_CDMAERRORCLASS, RIL_PARAM_MSGRES_GWLRELAYCODE, RILSENDMSGRESPONSEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_MSGRES_ALL, rilapitypes/RIL_PARAM_MSGRES_ALL, RILSENDMSGRESPONSEPARAMMASK, RIL_PARAM_MSGRES_CDMACAUSECODE, RIL_PARAM_MSGRES_GWLTRANSPORTCODE, rilapitypes/RIL_PARAM_MSGRES_GWLTRANSPORTCODE, rilapitypes/RIL_PARAM_MSGRES_CDMACAUSECODE, rilapitypes/RIL_PARAM_MSGRES_MSGID, netvista.rilsendmsgresponseparammask_2, RIL_PARAM_MSGRES_MSGID
