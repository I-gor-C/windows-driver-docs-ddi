...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_PARAM_MSGRES_ALL, RIL_PARAM_MSGRES_CDMACAUSECODE, RILSENDMSGRESPONSEPARAMMASK, rilapitypes/RIL_PARAM_MSGRES_MSGID, RIL_PARAM_MSGRES_GWLTRANSPORTCODE, rilapitypes/RIL_PARAM_MSGRES_GWLTRANSPORTCODE, rilapitypes/RIL_PARAM_MSGRES_GWLRELAYCODE, RIL_PARAM_MSGRES_ALL, RILSENDMSGRESPONSEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_MSGRES_CDMACAUSECODE, netvista.rilsendmsgresponseparammask_2, rilapitypes/RIL_PARAM_MSGRES_CDMAERRORCLASS, RIL_PARAM_MSGRES_MSGID, RIL_PARAM_MSGRES_GWLRELAYCODE, rilapitypes/RILSENDMSGRESPONSEPARAMMASK, RIL_PARAM_MSGRES_CDMAERRORCLASS
