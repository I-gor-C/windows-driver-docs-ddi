...
NTSTATUS FLTAPI FltCbdqInitialize(
  ...
  PFLT_CALLBACK_DATA_QUEUE_INSERT_IO            CbdqInsertIo,
  PFLT_CALLBACK_DATA_QUEUE_REMOVE_IO            CbdqRemoveIo,
  PFLT_CALLBACK_DATA_QUEUE_PEEK_NEXT_IO         CbdqPeekNextIo,
  PFLT_CALLBACK_DATA_QUEUE_ACQUIRE              CbdqAcquire,
  PFLT_CALLBACK_DATA_QUEUE_RELEASE              CbdqRelease,
  PFLT_CALLBACK_DATA_QUEUE_COMPLETE_CANCELED_IO CbdqCompleteCanceledIo
);
```
