...
## -returns
<p>
<a href="..\wdm\nf-wdm-zwsetinformationfile.md">FltSetInstanceContext</a> returns STATUS_SUCCESS or an appropriate NTSTATUS value such as one of the following: </p><dl>
