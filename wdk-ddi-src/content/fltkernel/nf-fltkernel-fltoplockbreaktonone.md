...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | The FltOplockBreakToNone routine is available starting with Windows 7. The FltOplockBreakToNone routine is available starting with Windows 7. |
