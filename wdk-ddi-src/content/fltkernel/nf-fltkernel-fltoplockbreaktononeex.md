...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | The FltOplockBreakToNoneEx routine is available starting with Windows 7. The FltOplockBreakToNoneEx routine is available starting with Windows 7. |
