...
## -remarks
<p>A minifilter driver calls <b>FltGetContextsEx</b> to retrieve pointers to the minifilter driver's contexts for the objects in an <a href="..\fltkernel\ns-fltkernel--flt-related-objects.md">FLT_RELATED_OBJECTS</a> structure. </p>
...
<p><b>FltGetContextsEx</b> increments the reference count on each of the contexts returned in the <a href="..\fltkernel\ns-fltkernel--flt-related-contexts-ex.md">FLT_RELATED_CONTEXTS_EX</a> structure that the <i>Contexts </i>parameter points to. Thus for every successful call to <b>FltGetContextsEx</b>, the caller must either: </p>

<p>Call <a href="..\fltkernel\nf-fltkernel-fltreleasecontextsex.md">FltReleaseContextsEx</a> for the entire structure that the <i>Contexts</i> parameter points to.</p>
