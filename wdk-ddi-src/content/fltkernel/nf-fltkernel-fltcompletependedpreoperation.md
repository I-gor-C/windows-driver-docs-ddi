...
title: FltCompletePendedPreOperation
...
<dd>
<p>The minifilter driver is returning control of the I/O operation to the Filter Manager. The Filter Manager does not call the corresponding postoperation callback, if one exists, during I/O completion. </p>
</dd>

### -param <a id="FLT_PREOP_SUCCESS_WITH_CALLBACK"></a><a id="flt_preop_success_with_callback"></a><p><a id="FLT_PREOP_SUCCESS_WITH_CALLBACK"></a><a id="flt_preop_success_with_callback"></a><b>FLT_PREOP_SUCCESS_WITH_CALLBACK</b></p>


<dd>
<p>The minifilter driver is returning control of the I/O operation to the Filter Manager. The Filter Manager calls the corresponding postoperation callback during I/O completion. </p>
</dd>
</dl>
</dd>
...
<dd>
<p>If FLT_PREOP_SUCCESS_WITH_CALLBACK is specified for <i>CallbackStatus</i>, this parameter is an optional context pointer to be passed to the corresponding postoperation callback routine. If FLT_PREOP_COMPLETE or FLT_PREOP_SUCCESS_NO_CALLBACK is specified for <i>CallbackStatus</i>, this parameter must be <b>NULL</b>. </p>
</dd>
</dl>
