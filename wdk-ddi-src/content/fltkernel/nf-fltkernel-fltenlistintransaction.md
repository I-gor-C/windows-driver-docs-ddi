...
ms.date: 2/7/2018
ms.keywords: FltEnlistInTransaction routine [Installable File System Drivers], FltEnlistInTransaction, FltApiRef_e_to_o_85856df2-46c0-457b-bc10-2e6a8d32f5bb.xml, ifsk.fltenlistintransaction, fltkernel/FltEnlistInTransaction
...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | This routine is available on Windows Vista and later versions of Windows. This routine is available on Windows Vista and later versions of Windows. |
