...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | The PFLT_CONTEXT_ALLOCATE_CALLBACK callback routine is available on Windows 8 and later. The PFLT_CONTEXT_ALLOCATE_CALLBACK callback routine is available on Windows 8 and later. |
