...
| &nbsp; | &nbsp; |
| ---- |:---- |
| **Windows version** | Available and supported in Windows Vista and later operating systems. Available and supported in Windows Vista and later operating systems. |
