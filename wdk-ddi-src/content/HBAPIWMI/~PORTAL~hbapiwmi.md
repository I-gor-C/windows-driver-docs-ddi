# Declarations in the hbapiwmi header
This header Hbapiwmi contains these programming interfaces:
...
| [SM_GetSASPhyAttributes_IN structure](ns-hbapiwmi--sm-getsasphyattributes-in.md) | TBD |
| [SM_SendSRL_IN structure](ns-hbapiwmi--sm-sendsrl-in.md) | TBD |
...
| [SM_ScsiInquiry_OUT structure](ns-hbapiwmi--sm-scsiinquiry-out.md) | TBD |
...
| [MS_SM_TargetEvent structure](ns-hbapiwmi--ms-sm-targetevent.md) | TBD |
| [SM_GetPortAttributesByWWN_IN structure](ns-hbapiwmi--sm-getportattributesbywwn-in.md) | TBD |
...
| [SM_SendECHO_OUT structure](ns-hbapiwmi--sm-sendecho-out.md) | The SM_SendECHO_OUT structure is used to receive output parameters from the SM_SendECHO method. |
