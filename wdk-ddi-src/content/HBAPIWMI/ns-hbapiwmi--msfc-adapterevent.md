...
req.dll: 
req.irql: 
ms.keywords: MSFC_AdapterEvent, MSFC_AdapterEvent, *PMSFC_AdapterEvent
req.iface: 
---

# MSFC_AdapterEvent structure



## -description
<p>The MSFC_AdapterEvent structure is used by HBA miniport drivers that support the T11 committee's <i>Fibre Channel HBA API</i> specification to report adapter events to WMI clients that have registered to be notified of these events. </p>
...
<dd>
<p>Contains the worldwide name of the port that generated the event. </p>
</dd>
</dl>
