...
| Method | Description |
| ---- |:---- |
| [IWiaLog::hResult](nf-wia_lh-iwialog-hresult.md) | Note that the IWiaLog interface is obsolete for Microsoft Windows XP and later, and is no longer supported. |
