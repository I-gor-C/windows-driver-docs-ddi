...
ms.date: 12/14/2017
ms.keywords: _WWAN_DEVICE_SERVICE_RESPONSE, WWAN_DEVICE_SERVICE_RESPONSE, *PWWAN_DEVICE_SERVICE_RESPONSE, PWWAN_DEVICE_SERVICE_RESPONSE
...
The size, in bytes, of the device service response data that follows the structure instance in memory. This value should not exceed the value of the <b>uMaxCommandDataSize</b> member of the <a href="netvista.wwan_supported_device_services">WWAN_SUPPORTED_DEVICE_SERVICES</a> structure.
