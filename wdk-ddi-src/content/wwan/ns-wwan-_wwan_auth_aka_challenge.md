...
ms.date: 1/18/2018
ms.keywords: wwan/WWAN_AUTH_AKA_CHALLENGE, wwan/PWWAN_AUTH_AKA_CHALLENGE, WWAN_AUTH_AKA_CHALLENGE structure [Network Drivers Starting with Windows Vista], *PWWAN_AUTH_AKA_CHALLENGE, WWAN_AUTH_AKA_CHALLENGE, PWWAN_AUTH_AKA_CHALLENGE, netvista.wwan_auth_aka_challenge, _WWAN_AUTH_AKA_CHALLENGE, PWWAN_AUTH_AKA_CHALLENGE structure pointer [Network Drivers Starting with Windows Vista]
