...
ms.date: 2/16/2018
ms.keywords: WWAN_TDSCDMA_MRL, wwan/WWAN_TDSCDMA_MRL, netvista.wwan_tdscdma_mrl, PWWAN_TDSCDMA_MRL structure pointer [Network Drivers Starting with Windows Vista], PWWAN_TDSCDMA_MRL, wwan/PWWAN_TDSCDMA_MRL, _WWAN_TDSCDMA_MRL, *PWWAN_TDSCDMA_MRL, WWAN_TDSCDMA_MRL structure [Network Drivers Starting with Windows Vista]
