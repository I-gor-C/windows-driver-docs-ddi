...
ms.date : 1/18/2018
ms.keywords : PWWAN_LTE_MRL, *PWWAN_LTE_MRL, WWAN_LTE_MRL, netvista.wwan_lte_mrl, PWWAN_LTE_MRL structure pointer [Network Drivers Starting with Windows Vista], _WWAN_LTE_MRL, wwan/WWAN_LTE_MRL, WWAN_LTE_MRL structure [Network Drivers Starting with Windows Vista], wwan/PWWAN_LTE_MRL
