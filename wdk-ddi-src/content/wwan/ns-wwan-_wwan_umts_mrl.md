...
ms.date: 1/18/2018
ms.keywords: PWWAN_UMTS_MRL, _WWAN_UMTS_MRL, WWAN_UMTS_MRL structure [Network Drivers Starting with Windows Vista], wwan/PWWAN_UMTS_MRL, WWAN_UMTS_MRL, netvista.wwan_umts_mrl, PWWAN_UMTS_MRL structure pointer [Network Drivers Starting with Windows Vista], wwan/WWAN_UMTS_MRL, *PWWAN_UMTS_MRL
