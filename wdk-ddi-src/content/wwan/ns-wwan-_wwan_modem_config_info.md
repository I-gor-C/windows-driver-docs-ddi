...
ms.date : 1/18/2018
ms.keywords : WWAN_MODEM_CONFIG_INFO structure [Network Drivers Starting with Windows Vista], *PWWAN_MODEM_CONFIG_INFO, wwan/PWWAN_MODEM_CONFIG_INFO, WWAN_MODEM_CONFIG_INFO, PWWAN_MODEM_CONFIG_INFO structure pointer [Network Drivers Starting with Windows Vista], netvista.wwan_modem_config_info, _WWAN_MODEM_CONFIG_INFO, PWWAN_MODEM_CONFIG_INFO, wwan/WWAN_MODEM_CONFIG_INFO
...
product : Windows
targetos : Windows
req.typenames : "*PWWAN_MODEM_CONFIG_INFO, WWAN_MODEM_CONFIG_INFO"
