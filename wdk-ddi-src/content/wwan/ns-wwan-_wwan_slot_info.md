...
ms.date: 1/18/2018
ms.keywords: netvista.wwan_slot_info_status, PWWAN_SLOT_INFO structure pointer [Network Drivers Starting with Windows Vista], wwan/PWWAN_SLOT_INFO, _WWAN_SLOT_INFO, wwan/WWAN_SLOT_INFO, PWWAN_SLOT_INFO, WWAN_SLOT_INFO structure [Network Drivers Starting with Windows Vista], WWAN_SLOT_INFO, *PWWAN_SLOT_INFO
