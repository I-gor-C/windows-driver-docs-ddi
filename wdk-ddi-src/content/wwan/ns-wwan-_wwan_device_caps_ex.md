...
ms.date: 1/18/2018
ms.keywords: netvista.wwan_device_caps_ex, *PWWAN_DEVICE_CAPS_EX, WWAN_DEVICE_CAPS_EX structure [Network Drivers Starting with Windows Vista], WWAN_DEVICE_CAPS_EX, _WWAN_DEVICE_CAPS_EX, wwan/PWWAN_DEVICE_CAPS_EX, PWWAN_DEVICE_CAPS_EX, wwan/WWAN_DEVICE_CAPS_EX, PWWAN_DEVICE_CAPS_EX structure pointer [Network Drivers Starting with Windows Vista]
