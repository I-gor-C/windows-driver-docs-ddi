...
ms.date: 12/29/2017
ms.keywords: PVIDEO_POINTER_ATTRIBUTES structure pointer [Display Devices], *PVIDEO_POINTER_ATTRIBUTES, VIDEO_POINTER_ATTRIBUTES structure [Display Devices], Video_Structs_5ade2674-a930-46b3-aaad-6d3a8d017453.xml, VIDEO_MODE_ANIMATE_START, VIDEO_MODE_ASYNC_POINTER, VIDEO_MODE_MONO_POINTER, VIDEO_MODE_COLOR_POINTER, display.video_pointer_attributes, PVIDEO_POINTER_ATTRIBUTES, VIDEO_POINTER_ATTRIBUTES, ntddvdeo/PVIDEO_POINTER_ATTRIBUTES, ntddvdeo/VIDEO_POINTER_ATTRIBUTES, VIDEO_MODE_ANIMATE_UPDATE, _VIDEO_POINTER_ATTRIBUTES
