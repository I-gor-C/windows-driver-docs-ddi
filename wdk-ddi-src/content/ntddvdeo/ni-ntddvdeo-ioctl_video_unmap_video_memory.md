...
### -input-buffer
The VRP <b>InputBuffer</b> contains a <a href="display.video_memory">VIDEO_MEMORY</a> structure, specifying the previously mapped virtual base address to be released with <a href="display.videoportunmapmemory">VideoPortUnmapMemory</a>.
