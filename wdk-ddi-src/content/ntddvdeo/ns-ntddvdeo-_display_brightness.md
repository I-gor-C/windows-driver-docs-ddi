...
ms.date: 12/29/2017
ms.keywords: PDISPLAY_BRIGHTNESS structure pointer [Display Devices], *PDISPLAY_BRIGHTNESS, DISPLAY_BRIGHTNESS, DISPLAY_BRIGHTNESS structure [Display Devices], Video_Structs_9be4657c-394e-4286-8157-e95f3ada36c8.xml, PDISPLAY_BRIGHTNESS, ntddvdeo/PDISPLAY_BRIGHTNESS, _DISPLAY_BRIGHTNESS, display.display_brightness, ntddvdeo/DISPLAY_BRIGHTNESS
