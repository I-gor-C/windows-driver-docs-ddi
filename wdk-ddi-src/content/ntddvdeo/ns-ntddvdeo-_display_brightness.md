...
ms.date: 12/29/2017
ms.keywords: PDISPLAY_BRIGHTNESS structure pointer [Display Devices], _DISPLAY_BRIGHTNESS, ntddvdeo/DISPLAY_BRIGHTNESS, DISPLAY_BRIGHTNESS structure [Display Devices], DISPLAY_BRIGHTNESS, Video_Structs_9be4657c-394e-4286-8157-e95f3ada36c8.xml, ntddvdeo/PDISPLAY_BRIGHTNESS, display.display_brightness, *PDISPLAY_BRIGHTNESS, PDISPLAY_BRIGHTNESS
