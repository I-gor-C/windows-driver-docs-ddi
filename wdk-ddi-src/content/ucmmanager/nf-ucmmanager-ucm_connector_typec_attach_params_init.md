...
## -description
Initializes a <a href="buses.ucm_connector_typec_attach_params">UCM_CONNECTOR_TYPEC_ATTACH_PARAMS</a> structure.
...
Pointer to a caller-allocated <a href="buses.ucm_connector_typec_attach_params">UCM_CONNECTOR_TYPEC_ATTACH_PARAMS</a> structure to initialize.

### -param PortPartnerType [in]

A <a href="buses.ucm_type_c_port_state">UCM_TYPE_C_PORT_STATE</a>-typed flag that indicates the state of the partner port.
