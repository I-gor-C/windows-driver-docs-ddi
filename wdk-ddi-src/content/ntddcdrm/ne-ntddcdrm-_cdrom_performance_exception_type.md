...
ms.date: 1/10/2018
ms.keywords: "_CDROM_PERFORMANCE_EXCEPTION_TYPE, PCDROM_PERFORMANCE_EXCEPTION_TYPE, ntddcdrm/ CdromPerformanceExceptionsOnly, ntddcdrm/CDROM_PERFORMANCE_EXCEPTION_TYPE, CdromNominalPerformance, PCDROM_PERFORMANCE_EXCEPTION_TYPE enumeration pointer [Storage Devices], ntddcdrm/CdromNominalPerformance, CDROM_PERFORMANCE_EXCEPTION_TYPE enumeration [Storage Devices], CdromEntirePerformanceList, CdromPerformanceExceptionsOnly, storage.cdrom_performance_exception_type, ntddcdrm/CdromEntirePerformanceList, CDROM_PERFORMANCE_EXCEPTION_TYPE, ntddcdrm/PCDROM_PERFORMANCE_EXCEPTION_TYPE, *PCDROM_PERFORMANCE_EXCEPTION_TYPE"
