...
<dd>
<p>The type, revision, and size of the DOT11_AUTH_CIPHER_PAIR_LIST structure. This member is
     formatted as an 
...
<dd>
<p>This member must be set to DOT11_AUTH_CIPHER_PAIR_LIST_REVISION_1.</p>
</dd>
...
<p>This member must be set to 
       <code>sizeof(DOT11_AUTH_CIPHER_PAIR_LIST)</code>.</p>
</dd>
</dl>
...
<p>The maximum number of entries that the 
     <b>AuthCipherPairs</b> array can contain.</p>
</dd>

### -field <b>AuthCipherPairs</b>

<dd>
<p>The list of 
     <a href="https://msdn.microsoft.com/301e9c21-69e7-48d3-b170-de01684f4a12">
     DOT11_AUTH_CIPHER_PAIR</a> structures.</p>
</dd>
</dl>

## -remarks
<p>A miniport driver returns the DOT11_AUTH_CIPHER_PAIR_LIST structure when queried by either 
...
<p>If the value of the 
      ...
      DOT11_AUTH_CIPHER_PAIR_LIST structure, the miniport driver must do the following:</p>
...
<p>For the DOT11_AUTH_CIPHER_PAIR_LIST structure, set the 
...
<p> </p>
<p> </p>
<p><a href="mailto:wsddocfb@microsoft.com?subject=Documentation%20feedback [netvista\netvista]:%20DOT11_AUTH_CIPHER_PAIR_LIST structure%20 RELEASE:%20(11/1/2017)&amp;body=%0A%0APRIVACY STATEMENT%0A%0AWe use your feedback to improve the documentation. We don't use your email address for any other purpose, and we'll remove your email address from our system after the issue that you're reporting is fixed. While we're working to fix this issue, we might send you an email message to ask for more info. Later, we might also send you an email message to let you know that we've addressed your feedback.%0A%0AFor more info about Microsoft's privacy policy, see http://privacy.microsoft.com/en-us/default.aspx." title="Send comments about this topic to Microsoft">Send comments about this topic to Microsoft</a></p>
