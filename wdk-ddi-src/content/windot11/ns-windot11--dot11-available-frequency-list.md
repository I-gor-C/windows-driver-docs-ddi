...
title: DOT11_AVAILABLE_FREQUENCY_LIST
...
# DOT11_AVAILABLE_FREQUENCY_LIST structure
...
<dd>
<p>The type, revision, and size of the DOT11_AVAILABLE_FREQUENCY_LIST structure. This member is
     formatted as an 
...
<dd>
<p>This member must be set to DOT11_AVAILABLE_FREQUENCY_LIST_REVISION_1.</p>
</dd>
...
<p>This member must be set to
       <b>sizeof</b>(DOT11_AVAILABLE_FREQUENCY_LIST).</p>
</dd>
</dl>
...
<p>The maximum number of entries that the 
     <b>uFrequencyValue</b> array can contain.</p>
</dd>

### -field <b>uFrequencyValue</b>

<dd>
<p>An array that specifies the list of available frequencies that the NIC can operate with.</p>
</dd>
</dl>
...
<p>This structure is used with 
    ...
    OID_DOT11_AVAILABLE_FREQUENCY_LIST</a>.</p>
