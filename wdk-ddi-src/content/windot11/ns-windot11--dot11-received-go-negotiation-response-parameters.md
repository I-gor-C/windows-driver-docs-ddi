...
title: DOT11_RECEIVED_GO_NEGOTIATION_RESPONSE_PARAMETERS
...
ms.date: 11/28/2017
ms.keywords: DOT11_RECEIVED_GO_NEGOTIATION_RESPONSE_PARAMETERS,
...
# DOT11_RECEIVED_GO_NEGOTIATION_RESPONSE_PARAMETERS structure
...
<dd>
<p>The type, revision, and size of the <b>DOT11_RECEIVED_GO_NEGOTIATION_RESPONSE_PARAMETERS</b> structure. The required settings for the members of <b>Header</b> are the following.</p>
<table>
<tr>
<th>Member</th>
<th>Setting</th>
...
<dd>
<p>The Peer-to-Peer (P2P) device address of the Wi-Fi Direct (WFD) device that sent the GO negotiation response.</p>
</dd>

### -field <b>DialogToken</b>

<dd>
<p>The dialog token received in the GO negotiation response packet.</p>
</dd>

### -field <b>ResponseContext</b>

<dd>
<p>The context data from the miniport driver. The system sends this context with the <a href="https://msdn.microsoft.com/library/windows/hardware/hh451803">OID_DOT11_WFD_SEND_GO_NEGOTIATION_CONFIRMATION</a> request.</p>
</dd>

### -field <b>uIEsOffset</b>

<dd>
<p>The offset, in bytes,  of the array of additional information elements (IEs) received in the GO negotiation response packet. This offset is from the start of the buffer that contains this structure.</p>
</dd>
