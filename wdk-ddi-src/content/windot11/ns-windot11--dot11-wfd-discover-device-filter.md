...
title: DOT11_WFD_DISCOVER_DEVICE_FILTER
...
# DOT11_WFD_DISCOVER_DEVICE_FILTER structure
...
<tr>
<td width="40%">
<p><a id="DISCOVERY_FILTER_BITMASK_DEVICE"></a><a id="discovery_filter_bitmask_device"></a>DISCOVERY_FILTER_BITMASK_DEVICE</p>
</td>
<td width="60%">
<p>The local P2P device discovers the P2P device with the desired <b>DeviceID</b>.</p>
</td>
</tr>
<tr>
<td width="40%">
<p><a id="_DISCOVERY_FILTER_BITMASK_GO"></a><a id="_discovery_filter_bitmask_go"></a> DISCOVERY_FILTER_BITMASK_GO</p>
</td>
<td width="60%">
<p>The local P2P device discovers a group with P2P group ID matching the specified <b>DeviceID</b> and <b>GroupSSID</b>.</p>
</td>
</tr>
<tr>
<td width="40%">
<p><a id="DISCOVERY_FILTER_BITMASK_ANY"></a><a id="discovery_filter_bitmask_any"></a>DISCOVERY_FILTER_BITMASK_ANY</p>
</td>
<td width="60%">
<p> The local P2P device needs only to discover the P2P device or any group owner hosted by the P2P device.</p>
</td>
</tr>
</table>
<p> </p>
...
## -remarks
<p>The local P2P device should not extend the discovery operation to find additional instances.</p>

<p>Note that if the value of <b>ucBitmask</b> is FILTER_BITMASK_DEVICE | FILTER_BITMASK_GO, the local P2P device should discover only one instance of the P2P device - either the P2P device or a GO with the desired P2P <b>DeviceID</b> and <b>GroupSSID</b>.</p>
