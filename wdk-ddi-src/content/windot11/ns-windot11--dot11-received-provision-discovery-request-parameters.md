...
title: DOT11_RECEIVED_PROVISION_DISCOVERY_REQUEST_PARAMETERS
...
ms.date: 11/28/2017
ms.keywords: DOT11_RECEIVED_PROVISION_DISCOVERY_REQUEST_PARAMETERS,
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: DOT11_RECEIVED_PROVISION_DISCOVERY_REQUEST_PARAMETERS
...
<dd>
<p>The type, revision, and size of the <b>DOT11_RECEIVED_PROVISION_DISCOVERY_REQUEST_PARAMETERS</b> structure. The required settings for the members of <b>Header</b> are the following.</p>
<table>
<tr>
<th>Member</th>
<th>Setting</th>
...
<dd>
<p>The BSSID in the received provision discovery request packet.</p>
</dd>

### -field <b>DialogToken</b>

<dd>
<p>The dialog token received  in the provision discovery request packet.</p>
</dd>

### -field <b>RequestContext</b>

<dd>
<p>The context data from the miniport. The system will send this data with angiven initially by the <a href="https://msdn.microsoft.com/library/windows/hardware/hh451808">OID_DOT11_WFD_SEND_PROVISION_DISCOVERY_RESPONSE</a> request.</p>
</dd>

### -field <b>uIEsOffset</b>

<dd>
<p>The offset, in bytes,  of the array of additional information elements (IEs) received in the provision discovery request packet. This offset is from the start of the buffer that contains this structure.</p>
</dd>
