...
title: DOT11_RECEIVED_INVITATION_RESPONSE_PARAMETERS
...
ms.date: 11/22/2017
ms.keywords: DOT11_RECEIVED_INVITATION_RESPONSE_PARAMETERS,
...
# DOT11_RECEIVED_INVITATION_RESPONSE_PARAMETERS structure
...
<dd>
<p>Specifies the type, revision and size of the <b>DOT11_RECEIVED_INVITATION_RESPONSE_PARAMETERS</b> structure. The required settings for the members of <b>Header</b> are the following:</p>
<table>
<tr>
<th>Member</th>
<th>Setting</th>
...
<dd>
<p>The address of the device that transmitted the invitaion response packet.</p>
</dd>

### -field <b>BSSID</b>

<dd>
<p>The BSSID in the received invitation response packet.</p>
</dd>

### -field <b>DialogToken</b>

<dd>
<p>The dialog token received in invitation response packet.</p>
</dd>

### -field <b>uIEsOffset</b>

<dd>
<p>The offset, in bytes,  of the array of additional information elements (IEs) received in the the invitation response packet. This offset is from the start of the buffer that contains this structure.</p>
</dd>
...
<dl>
<dt>
<a href="https://msdn.microsoft.com/library/windows/hardware/hh464143">DOT11_RECEIVED_INVITATION_RESPONSE_PARAMETERS</a>
</dt>
</dl>
<p> </p>
<p> </p>
